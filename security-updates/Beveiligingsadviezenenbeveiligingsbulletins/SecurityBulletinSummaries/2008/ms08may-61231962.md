---
TOCTitle: 'MS08-MAY'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor mei 2008'
ms:assetid: 'ms08-may'
ms:contentKeyID: 61231962
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms08-may(v=Security.10)'
---

Security Bulletin Summary

Samenvatting van de Microsoft-beveiligingsbulletins voor mei 2008
=================================================================
...
In dit bulletin wordt een overzicht gegeven van de beveiligingsbulletins voor mei 2008.

Met de release van de bulletins voor mei 2008 vervangt deze samenvatting van de bulletins de vooraankondiging van de bulletins die oorspronkelijk werd uitgegeven op 8 mei 2008. Ga voor meer informatie over de vooraankondiging van de bulletins naar [Vooraankondiging over Microsoft-beveiligingsbulletins](http://technet.microsoft.com/security/bulletin/advance).
...
| Bulletin-id                               | Microsoft-beveiligingsbulletin MS08-027                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                        | [**Door een beveiligingslek in Microsoft Publisher kan externe code worden uitgevoerd (951208)**](http://technet.microsoft.com/security/bulletin/ms08-027)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Samenvatting**                          | Deze beveiligingsupdate lost een privé gemeld beveiligingslek in Microsoft Publisher op waardoor externe code kan worden uitgevoerd als een gebruiker een speciaal vervaardigd Publisher-bestand opent. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken. |
| **Maximaal prioriteitsniveau**            | [Kritiek](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Gevolgen van het beveiligingslek**      | Uitvoering van externe code mogelijk                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Detectie**                              | Met Microsoft Baseline Security kan worden vastgesteld of deze update voor uw computersysteem is vereist. Opnieuw opstarten van het systeem is niet vereist.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Software waarin dit probleem optreedt** | **Microsoft Office.** Zie de sectie Software waarin het probleem optreedt en de sectie Downloadlocaties.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

| Bulletin-id                               | Microsoft-beveiligingsbulletin MS08-028                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                        | [**Door een beveiligingslek in de Microsoft Jet Database Engine kan externe code worden uitgevoerd (950749)**](http://technet.microsoft.com/security/bulletin/ms08-028)                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Bulletin-id                               | Microsoft-beveiligingsbulletin MS08-029                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                        | [**Beveiligingslekken in de Microsoft Malware Protection-engine kunnen leiden tot denial of service (952044)**](http://technet.microsoft.com/security/bulletin/ms08-029) Toestaan                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| **Detectie**                              | De producten waarin het probleem optreedt, beschikken over ingebouwde mechanismen voor de automatische detectie en implementatie van updates. Opnieuw opstarten van het systeem is niet vereist.                                                                                                                                                                                                                                                                                                                                                                                  |
| **Software waarin dit probleem optreedt** | **Windows Live OneCare, Microsoft Antigen, Microsoft Windows Defender, Microsoft Forefront Security.** Zie de sectie Software waarin het probleem optreedt en de sectie Downloadlocaties.                                                                                                                                                                                                                                                                                                                                                                                         |
...
<table style="border:1px solid black;">
<caption>Microsoft Office-pakketten, -systemen en -onderdelen</caption>
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bulletin-id</strong></td>
...
<table style="border:1px solid black;">
<caption>Microsoft Office voor Mac</caption>
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bulletin-id</strong></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-026"><strong>MS08-026</strong></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=99f54471-ccf9-4d94-a882-a05ecd128adc">Microsoft Office 2004 voor Mac</a><br />
(KB952332)<br />
(Belangrijk)</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2008 voor Mac</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=395d1487-a3a6-4106-a0f8-4d6e1d6d89d2">Microsoft Office 2008 voor Mac</a><br />
(KB952331)<br />
(Belangrijk)</td>
</tr>
</tbody>
...
<table style="border:1px solid black;">
<caption>Overige Microsoft Office-software</caption>
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bulletin-id</strong></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-026"><strong>MS08-026</strong></a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f">Microsoft Office-compatibiliteitspakket voor de bestandsindelingen van Word, Excel en PowerPoint 2007</a><br />
(KB951808)<br />
(Belangrijk)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f">Service Pack 1 voor het Microsoft Office-compatibiliteitspakket voor de bestandsindelingen van Word, Excel en PowerPoint 2007</a><br />
(KB951808)<br />
(Belangrijk)</td>
</tr>
</tbody>
...
**Opmerking** Voor de volgende vermeldingen zijn er geen downloadkoppelingen, omdat de aangegeven software is voorzien van ingebouwde mechanismen voor het automatisch detecteren en implementeren van updates.
...
<td style="border:1px solid black;">Microsoft Antigen voor Exchange<br />
(Gemiddeld)<br />
<br />
Microsoft Antigen voor SMTP Gateway<br />
(Gemiddeld)</td>
</tr>
<tr class="odd">
...
(Gemiddeld)<br />
<br />
Microsoft Forefront Security voor Exchange Server<br />
(Gemiddeld)<br />
<br />
Microsoft Forefront Security voor SharePoint<br />
(Gemiddeld)</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Standalone System Sweeper</td>
<td style="border:1px solid black;">Standalone System Sweeper in Diagnostics and Recovery Toolset 6.0<br />
(Laag)</td>
</tr>
</tbody>
</table>
...
-   Jun Mao, die bij [iDefense Labs](http://labs.idefense.com/) werkt, voor het melden van een probleem dat wordt beschreven in MS08-026.
-   Wushi van [team509](http://www.team509.com/), die samenwerkt met [Zero Day Initiative](http://www.zerodayinitiative.com/), voor het melden van een probleem dat wordt beschreven in MS08-026.
-   Cocoruder van [Fortinet Security Research](http://www.fortinet.com/) voor het melden van een probleem dat wordt beschreven in MS08-027.
-   [CERT/CC](http://www.cert.org/) voor het melden van een probleem dat wordt beschreven in MS08-028.
-   [ISC/SANS](http://isc.sans.org/) voor het melden van een probleem dat wordt beschreven in MS08-028.
-   Aaron Portnoy van [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) voor het melden van een probleem dat wordt beschreven in MS08-028.
-   SoWhat of [Nevis Labs](http://www.nevisnetworks.com) voor het melden van een probleem dat wordt beschreven in MS08-029.
...
-   V1.0 (13 mei 2008): Samenvatting van de gepubliceerde bulletins.
