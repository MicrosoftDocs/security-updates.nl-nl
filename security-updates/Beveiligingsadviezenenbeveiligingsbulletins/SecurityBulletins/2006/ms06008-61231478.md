---
TOCTitle: 'MS06-008'
Title: 'Microsoft-beveiligingsbulletin MS06-008 - Kritiek'
ms:assetid: 'ms06-008'
ms:contentKeyID: 61231478
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms06-008(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS06-008 - Kritiek
=================================================

Door een beveiligingslek in de WebClient-service kan code vanaf een externe locatie worden uitgevoerd (911927)
--------------------------------------------------------------------------------------------------------------
...
**Voorbehoud:** Dit bulletin vervangt een eerdere beveiligingsupdate. Zie de sectie Veelgestelde vragen van dit bulletin voor de volledige lijst.

**Geteste software en downloadlocaties voor de beveiligingsupdate:**

**Software waarin dit probleem optreedt:**

-   Microsoft Windows XP Service Pack 1 en Microsoft Windows XP Service Pack 2 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?displaylang=nl&familyid=62535040-5204-4469-b0bf-eae14567c2d5)
-   Microsoft Windows XP Professional x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=9734f634-6869-434f-aaf0-47b70f84d178)
-   Microsoft Windows Server 2003 en Microsoft Windows Server 2003 Service Pack 1 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=fa073183-0c83-4f1c-be46-a2ee8a1a1440)
-   Microsoft Windows Server 2003 voor Itanium-systemen en Microsoft Windows Server 2003 met SP1 voor Itanium-systemen – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=e186e149-208a-4035-a0fc-e1cbde4e6fef)
-   Microsoft Windows Server 2003 x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=e2f5413a-0b77-4c18-9bab-e2470d3d3f4e)
...
|------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Beveiligingslek met betrekking tot de webclient - [CVE-2006-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0013) | Uitvoering van externe code mogelijk | Belangrijk                | Belangrijk                | Matig               | Matig                              |
...
|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| **MS05-028** | Vervangen                 | Niet van toepassing       | Vervangen           | Niet van toepassing                |
...
<span></span>
#### Beveiligingslek met betrekking tot de webclient - CVE-2006-0013:

In de manier waarop Windows verzoeken van de webclient verwerkt, is een beveiligingslek dat kan leiden tot het uitvoeren van externe code. Een aanvaller kan via dit beveiligingslek de volledige controle krijgen over het systeem waarin dit probleem optreedt.

#### Beperkende factoren voor het beveiligingslek in de webclient - CVE-2006-0013:

-   Een aanvaller moet geldige aanmeldingsreferenties hebben om dit beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie door anonieme gebruikers worden misbruikt. Het onderdeel waarin het probleem optreedt, is echter extern beschikbaar voor gebruikers die een standaardgebruikersaccount hebben. In bepaalde configuraties kan een anonieme gebruiker zich verifiëren als de gastaccount. Zie [Microsoft-beveiligingsadvies 906574](http://technet.microsoft.com/security/advisory/906574) voor meer informatie.
-   Standaard is de WebClient-service uitgeschakeld in Windows Server 2003 en Windows Server 2003 Service Pack 1. Het systeem is alleen kwetsbaar als de beheerder deze service inschakelt.
...
#### Tijdelijke oplossingen voor het beveiligingslek in de webclient - CVE-2006-0013:
...
Als de **WebClient**-service is gestopt, kunt u met behulp van de wizard Webpublicaties geen gegevens meer op internet publiceren voor locaties waar het WebDAV-protocol wordt gebruikt. Als deze service is uitgeschakeld, worden services die van die service afhankelijk zijn, niet meer gestart. Zie de volgende [productdocumentatie](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/844f5e01-4b9e-4dac-897e-2a0bb33f28af.mspx) voor meer informatie over WebDAV.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarvoor dit probleem geldt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

**Wie kan het beveiligingslek misbruiken?**
Een aanvaller moet geldige aanmeldingsreferenties hebben om dit beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet worden misbruikt door anonieme gebruikers. Alhoewel de WebClient-service wordt gebruikt voor de ondersteuning van het WebDAV-protocol op internet, moet een geverifieerde aanvaller de stappen uitvoeren die nodig zijn om deze aanval te kunnen uitvoeren. Als de Gastaccount is ingeschakeld op het systeem waarin dit probleem optreedt, kan deze aanval door iedere gebruiker worden uitgevoerd. Zie Microsoft-beveiligingsadvies 906574 voor meer informatie.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller moet eerst bij het systeem worden geverifieerd. Een aanvaller kan vervolgens het beveiligingslek direct via een netwerk misbruiken door een reeks speciaal ontworpen berichten te maken en deze te verzenden naar een systeem waarin dit probleem optreedt. Door deze berichten voert het desbetreffende systeem mogelijk code uit.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**
Alle besturingssystemen waarin dit probleem optreedt, zijn kwetsbaar voor dit beveiligingslek. De Firewall voor Internet-verbindingen (onderdeel van Windows XP Service Pack 1 en Windows Server 2003) blokkeert de poorten waarvoor het probleem geldt, zodat deze niet reageren op pogingen via het netwerk om misbruik te maken van dit beveiligingslek. De Firewall voor internetverbinding is standaard niet ingeschakeld in Windows XP Service Pack 1. Standaard is de WebClient-service uitgeschakeld in Windows Server 2003.
**Opmerking** Standaard worden uitzonderingen automatisch gegenereerd na het inschakelen van Bestands- en printerdeling, waarmee toegang via het netwerk mogelijk wordt. Deze toegang is standaard beperkt tot het lokale subnet.
...
**Welk verband bestaat er tussen dit beveiligingslek en het beveiligingslek met betrekking tot de webclient dat wordt verholpen door MS05-028?**
Beide beveiligingslekken bevinden zich in de WebClient-service. Met deze update wordt echter een nieuw beveiligingslek verwijderd waarvoor MS05-028 geen oplossing bood. MS05-028 biedt beveiliging tegen het lek dat in dat bulletin wordt behandeld, maar verwijdert dit nieuwe beveiligingslek niet. Deze update vervangt MS05-028 niet. U moet zowel deze update installeren als de update die beschikbaar is gesteld met beveiligingsbulletin MS05-028 om beide beveiligingslekken te dichten.
...
Systeembeheerders kunnen deze beveiligingsupdate ook verwijderen met het hulpprogramma Spuninst.exe. Het hulpprogramma Spuninst.exe bevindt zich in de map %Windir%\\$NTUninstallKB911927$\\Spuninst.
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutel bevat mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien zijn deze registersleutels mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 911927 integreert in de bronbestanden van de Windows-installatie.
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutels bevatten mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien zijn deze registersleutels mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 911927 integreert in de bronbestanden van de Windows-installatie.
...
-   Kostya Kortchinsky van [EADS/CRC](http://www.eads.net/) voor het melden van het beveiligingslek met betrekking tot de webclient (CVE-2006-0013).
