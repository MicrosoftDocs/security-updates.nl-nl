---
TOCTitle: 'MS06-035'
Title: 'Microsoft-beveiligingsbulletin MS06-035 - Kritiek'
ms:assetid: 'ms06-035'
ms:contentKeyID: 61231505
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms06-035(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS06-035 - Kritiek
=================================================

Beveiligingslek in Server-service kan leiden tot uitvoering van externe code (917159)
-------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=b207020d-90f7-4c41-8304-06af0ded6467)
-   Microsoft Windows XP Service Pack 1 en Microsoft Windows XP Service Pack 2 - [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=2592a44c-82fb-4ccd-82a6-fcac7ca33172)
-   Microsoft Windows XP Professional x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=b0f67167-7ede-4355-af6f-50c6615f6bbd)
-   Microsoft Windows Server 2003 en Microsoft Windows Server 2003 Service Pack 1 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=48f03ad7-38f9-48f4-bbfc-14c52e9c942a)
-   Microsoft Windows Server 2003 voor Itanium-systemen en Microsoft Windows Server 2003 met SP1 voor Itanium-systemen – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=41a4a07f-bea3-48d6-b8d2-d7a5600d7179)
-   Microsoft Windows Server 2003 x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=dfbf3fa6-9e11-48b4-894d-5436693d17f7)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Beveiligingslek in de heap-overloop van mailslots - [CVE-2006-1314](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1314)                                | Uitvoering van externe code mogelijk | Kritiek      | Kritiek                   | Kritiek                   | Kritiek             | Kritiek                            |
| Beveiligingslek met betrekking tot het onrechtmatig vrijgeven van SBM-informatie - [CVE-2006-1315](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1315) | Vrijgeven van informatie             | Laag         | Laag                      | Laag                      | Laag                | Laag                               |
...
|--------------|----------------|----------------|------------|---------------------|
| **MS05-027** | Niet vervangen | Niet vervangen | Vervangen  | Vervangen           |
...
<span></span>
#### Beveiligingslek in de heap-overloop van mailslots - CVE-2006-1314:

Er bestaat een beveiligingslek in het serverstuurprogramma dat kan leiden tot het uitvoeren van externe code. Hierdoor kan een aanvaller die misbruik maakt van dit beveiligingslek volledige controle krijgen over het systeem waarin dit probleem optreedt.

#### Verzachtende factoren voor het beveiligingslek in de heap-overloop van mailslots - CVE-2006-1314:
...
-   Microsoft Windows XP Service Pack 2 en Microsoft Windows Server 2003 Service Pack 1 hebben geen diensten die luisteren naar mailslots in standaardconfiguraties.
...
#### Methoden om het beveiligingslek in de heap-overloop van mailslots te omzeilen - CVE-2006-1314:
...
#### Veelgestelde vragen over het beveiligingslek in de heap-overloop van mailslots - CVE-2006-1314:
...
**Wat is een Mailslot?**
Een mailslot is een tijdelijk mechanisme dat door toepassingen en processen wordt benut om gegevensoverdracht in één richting te vergemakkelijken. Ga naar de volgende [website](http://msdn.microsoft.com/library/default.asp?url=/library/en-us/ipc/base/writing_to_a_mailslot.asp) voor meer informatie over mailslots.
...
Elke anonieme gebruiker die ervoor kan zorgen dat een systeem waarin dit probleem optreedt een speciaal samengesteld netwerkpakket ontvangt, kan proberen dit beveiligingslek te misbruiken.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller zou kunnen proberen misbruik te maken van het beveiligingslek door een speciaal vervaardigd netwerkpakket naar een getroffen systeem te sturen. Het document kan er dan voor zorgen dat het systeem waarin dit probleem optreedt code uitvoert.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**
Werkstations en servers zijn beide kwetsbaar voor dit beveiligingslek. Mailslots zouden in gebruik kunnen zijn door enkele toepassingen en programma's van derden. De Messenger-service en de Alerter-service benutten beide de mailslot-functionaliteit. Systemen die deze services actief gebruiken, zijn kwetsbaar. Deze services zijn niet standaard ingesteld om automatisch te worden gestart in Windows XP Service Pack 2 en Windows Server 2003 Service Pack 2
...
**Wat doet de update?**
Met de update verwijdert u het beveiligingslek doordat de manier wordt aangepast waarop het Server-stuurprogramma de lengte van een bericht valideert voordat dit wordt doorgegeven aan de toegewezen buffer.
...
#### Beveiligingslek met betrekking tot het onrechtmatig vrijgeven van SBM-informatie - CVE-2006-1315:

De Server-service bevat een beveiligingslek: de kans bestaat dat een aanvaller tijdens de overdracht van SMB-gegevens fragmenten zal kunnen weergeven van het geheugen dat wordt gebruikt wordt om SMB-verkeer op te slaan.

#### Beperkende factoren voor het beveiligingslek:met betrekking tot het onrechtmatig vrijgeven van SMB-informatie - CVE-2006-1315:
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het onrechtmatig vrijgeven van SMB-informatie - CVE-2006-1315:

**Wat is de omvang van het probleem?**
Dit is een beveiligingslek met betrekking tot het vrijgeven van informatie. Als een aanvaller kans ziet dit beveiligingslek te misbruiken, zou deze op afstand informatie kunnen lezen die in buffers is opgeslagen voor Server Message Block-verkeer. Het beveiligingslek betreft een 'denial-of-service'-probleem. Een aanvaller kan geen code uitvoeren of zichzelf rechtstreeks gebruikersrechten toekennen. Hiermee kan informatie worden achterhaald die verder kan worden misbruikt om het systeem waarin dit probleem optreedt schade toe te brengen.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Een niet-geïnitialiseerde buffer in het Server-protocolstuurprogramma.
...
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Een aanvaller die kans ziet dit beveiligingslek te misbruiken, kan op afstand de inhoud van de SMB-buffers weergeven.
...
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen bericht te maken en te verzenden naar een systeem waarin dit probleem optreedt. De aanvaller zou dan informatie uit de SMB-buffers kunnen ophalen.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**
Zowel werkstations als servers lopen gevaar. Servers zouden eventueel meer gevaar kunnen lopen, met name wanneer deze een grote hoeveelheid SMB-verkeer verzorgen.

**Kan het beveiligingslek via internet worden misbruikt?**
Ja. Een aanvaller kan proberen via internet misbruik te maken van het beveiligingslek. Met aanbevolen procedures voor firewalls en standaardfirewallconfiguraties kunt u een betere beveiliging realiseren tegen aanvallen die vanaf internet komen. Microsoft biedt informatie over de beveiliging van uw pc. Eindgebruikers kunnen naar de volgende website gaan: [Beveilig uw pc](http://go.microsoft.com/fwlink/?linkid=21169). IT-professionals kunnen naar de volgende website gaan: [Security Guidance Center](http://go.microsoft.com/fwlink/?linkid=21171).

**Wat doet de update?**
De update verwijdert het beveiligingslek door de buffer te initialiseren voordat wordt gereageerd op het verzoek van een client.
...
Deze beveiligingsupdate ondersteunt Hotpatching op systemen met Srv.sys-bestandsversie 5.2.3790.2437. Indien u Hotpatching gebruikt, kunt u beveiligingsupdates installeren op systemen met Microsoft Windows Server 2003 Service Pack 1 en hoeft u de servers niet opnieuw op te starten. Zie [Microsoft Knowledge Base-artikel 897341](http://support.microsoft.com/kb/897341) voor meer informatie over Hotpatching en hoe u met behulp van Hotpatching een beveiligingsupdate implementeert.
...
Systeembeheerders kunnen deze beveiligingsupdate ook verwijderen met het hulpprogramma Spuninst.exe. Het hulpprogramma Spuninst.exe bevindt zich in de map %Windir%\\$NTUninstallKB917159$\\Spuninst.
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutel bevat mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien is deze registersleutel mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 917159 integreert in de bronbestanden van de Windows-installatie of tijdens een slipstream daarin heeft opgenomen.
...
-   Pedram Amini van het [Tippingpoint VeiligheidsOnderzoeksteam](http://www.tippingpoint.com/security) in samenwerking met H D Moore voor het melden van het beveilingslek Mailslot Heapoverloop - (CVE-2006-1314).
-   Nicolas de Pouvesle van [Tenable Network Security](http://www.tenablesecurity.com/) voor het melden van een probleem zoals beschreven in het Beveiligingslek met betrekking tot het onrechtmatig vrijgeven van SBM-informatie - (CVE-2006-1315).
-   Mike Price en Rafal Wojtczuk van [McAfee Avert Labs](http://www.mcafee.com/us/threat_center/default.asp) voor het melden van het beveiligingslek met betrekking tot het onrechtmatig vrijgaven van SMB-informatie - (CVE-2006-1315).
...
-   V1.1 (12 juli 2006): Het onderdeel “Veelgestelde vragen over het beveiligingslek in de heap-overloop van mailslots - CVE-2006-1314” van het bulletin is bijgewerkt om standaardservices die mailslots benutten te specificeren. De platformen waarin dit probleem optreedt, worden aangegeven, evenals de platformen die geldige aanmeldingsreferenties vereisen en voorkomen in de lijst in het onderdeel “Beperkende factoren voor het beveiligingslek:met betrekking tot het onrechtmatig vrijgeven van SMB-informatie - CVE-2006-1315”.
