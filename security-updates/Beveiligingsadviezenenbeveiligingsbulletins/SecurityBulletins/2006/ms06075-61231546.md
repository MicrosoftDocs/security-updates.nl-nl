---
TOCTitle: 'MS06-075'
Title: 'Microsoft-beveiligingsbulletin MS06-075 - Belangrijk'
ms:assetid: 'ms06-075'
ms:contentKeyID: 61231546
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms06-075(v=Security.10)'
---
...
Beveiligingslekken in Windows kunnen leiden tot misbruik van bevoegdheden (926255)
----------------------------------------------------------------------------------
...
-   Microsoft Windows XP Service Pack 2 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=966704b5-1a7e-4110-9694-844706a52db7)
-   Microsoft Windows Server 2003— [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=5ea314a2-d76a-46f9-853b-15ff03f8ad95)
-   Microsoft Windows Server 2003 voor Itanium-systemen— [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=7bceaa11-f655-4e3c-a588-5c49097e970b)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Beveiligingslek met betrekking tot beschadigde bestandenlijst</strong> - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5585">CVE-2006-5585</a></td>
...
**Opmerking** De beveiligingsupdate voor Windows Server 2003 geldt ook voor Windows Server 2003 R2.
...
<span></span>
**Ondersteuning voor beveiligingsupdates voor Microsoft Windows 98, Windows 98 Tweede Editie of Windows Millennium Edition is gestopt op 11 juli 2006. Ik gebruik nog steeds een van deze besturingssystemen. Wat moet ik doen?**  
...
<span></span>
#### Beveiligingslek met betrekking tot beschadigde bestandenlijst - CVE-2006-5585:
  
Er bestaat een beveiligingslek met betrekking tot [misbruik van bevoegdheden](http://go.microsoft.com/fwlink/?linkid=21142) in de wijze waarop via Microsoft Windows toepassingen met speciaal gemaakte bestandenlijsten worden gestart. Als gevolg van dit beveiligingslek kan een aangemelde gebruiker volledige controle krijgen over het systeem.
  
#### Beperkende factoren voor beveiligingslek met betrekking tot beschadigde bestandenlijst - CVE-2006-5585:
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot beschadigde bestandenlijst - CVE-2006-5585:
  
Er zijn voor dit beveiligingslek geen tijdelijke oplossingen bekend.
  
#### Veelgestelde vragen over beveiligingslek met betrekking tot beschadigde bestandenlijst - CVE-2006-5585:
...
Onjuiste verwerking en beheer van bestandenlijsten door het Client Server Run Time Subsystem.
  
**Wat is het Client Server Run Time Subsystem?**  
**Csrss** is het gebruikersmodusgedeelte van het Win32-subsysteem (Win32.sys is het kernelmodusgedeelte). Csrss staat voor *client/server runtime subsystem* en is een essentieel subsysteem, dat altijd actief dient te zijn. Csrss is verantwoordelijk voor consoles en maakt en/of verwijdert threads.
...
**Wat doet de update?**  
Met de update verwijdert u het beveiligingslek door aanpassing van de manier waarop het Client Server Run Time Subsystem de ingesloten bestandenlijsten valideert voordat het gegevens aan de toegewezen buffer doorgeeft.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Nee, dit probleem is niet eerder als een beveiligingslek openbaar gemaakt.
  
**Welk verband bestaat er tussen dit beveiligingslek en Microsoft Knowledge Base-artikel 921337**  
In [Microsoft Knowledge Base-artikel 921337](http://support.microsoft.com/kb/921337/en-us) wordt een soortgelijk probleem met de bestandenlijst besproken dat ervoor kan zorgen dat een systeem opnieuw wordt opgestart. Bij het oplossen van dit probleem heeft Microsoft een mogelijk beveiligingslek aangetroffen dat door deze beveiligingsupdate wordt verholpen.
...
Systeembeheerders kunnen deze beveiligingsupdate ook verwijderen met het hulpprogramma Spuninst.exe. Het hulpprogramma Spuninst.exe bevindt zich in de map %Windir%\\$NTUninstallKB926255$\\Spuninst.
...
Windows Server, 2003 Enterprise Edition voor Itanium-systemen; Windows Server 2003, Datacenter Edition voor Itanium-systemen; Windows Server 2003 voor Itanium-systemen.
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutel bevat mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien is deze registersleutel mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 926255 integreert in de bronbestanden van de Windows-installatie of tijdens een slipstream daarin heeft opgenomen.
