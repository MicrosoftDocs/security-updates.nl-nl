---
TOCTitle: 'MS09-002'
Title: 'Microsoft-beveiligingsbulletin MS09-002 - Kritiek'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61231698
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-002(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS09-002 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (961260)
--------------------------------------------------------------

Gepubliceerd: dinsdag 10 februari 2009 | Bijgewerkt: maandag 16 februari 2009
...
Het prioriteitsniveau van deze beveiligingsupdate is kritiek voor Internet Explorer 7 uitgevoerd op ondersteunde versies van Windows XP en Windows Vista. Voor Internet Explorer 7 uitgevoerd op ondersteunde versies van Windows Server 2003 en Windows Server 2008 is het prioriteitsniveau gemiddeld. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 961260](http://support.microsoft.com/kb/961260) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
| Windows XP Service Pack 2 en Windows XP Service Pack 3                                                 | Microsoft Internet Explorer 6                   |
| Windows XP Professional x64 Edition en Windows XP Professional x64 Edition Service Pack 2              | Microsoft Internet Explorer 6                   |
| Windows Server 2003 Service Pack 1 en Windows Server 2003 Service Pack 2                               | Microsoft Internet Explorer 6                   |
| Windows Server 2003 x64 Edition en Windows Server 2003 x64 Edition Service Pack 2                      | Microsoft Internet Explorer 6                   |
| Windows Server 2003 met SP1 voor Itanium-systemen en Windows Server 2003 met SP2 voor Itanium-systemen | Microsoft Internet Explorer 6                   |
...
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 961260](http://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen – CVE-2009-0075
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot CSS-geheugenbeschadiging - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
Zie [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0075
...
-   Dit beveiligingslek treft uitsluitend Windows Internet Explorer 7. Het treft ondersteunde versies van Microsoft Internet Explorer 5 en Microsoft Internet Explorer 6 niet.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0075
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0075
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer CSS-opmaakmodellen verwerkt. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek kan dezelfde rechten op het systeem krijgen als de aangemelde gebruiker.

Zie [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot CSS-geheugenbeschadiging - CVE-2009-0076
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSS-geheugenbeschadiging - CVE-2009-0076
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSS-geheugenbeschadiging - CVE-2009-0076
...
**Waardoor wordt het beveiligingslek veroorzaakt? **
Wanneer Internet Explorer een pagina weergeeft die bepaalde CSS-stijlen bevat, kan het geheugen dusdanig beschadigd raken dat een aanvaller willekeurige code kan uitvoeren binnen de context van de aangemelde gebruiker.
...
**Wat is CSS?**  
CSS (Cascading Style Sheets) is een methode voor het formatteren van websites met HTML. Ga voor meer informatie over CSS naar de [Microsoft TechNet-website](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true).

**Wat doet de update? **
De update wijzigt de manier waarop Internet Explorer Cascading Style Sheets (CSS) afhandelt.
...
| Windows Server 2003 Service Pack 1 en Microsoft Windows Server 2003 Service Pack 2                     | Nee     | Nee                | Ja                                                                     | Ja                         |
...
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde versies van Windows XP:<br />
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB961260-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/961260">Microsoft Knowledge Base-artikel 961260</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) en het [Zero Day Initiative](http://www.zerodayinitiative.com/) voor het melden van een beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen (CVE-2007-0075).  
-   Sam Thomas ([http://eshu.co.uk](http://eshu.co.uk/)/), in samenwerking met [TippingPoint](http://www.tippingpoint.com/) en het [Zero Day Initiative](http://www.zerodayinitiative.com/), voor het melden van het beveiligingslek met betrekking tot CSS-geheugenbeschadiging (CVE-2009-0076)
...
-   V1.1 (16 februari 2009): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 961260 onder Bekende problemen in de **Samenvatting**.
