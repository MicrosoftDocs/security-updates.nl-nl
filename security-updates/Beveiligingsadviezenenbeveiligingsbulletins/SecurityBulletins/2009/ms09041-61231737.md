---
TOCTitle: 'MS09-041'
Title: 'Microsoft-beveiligingsbulletin MS09-041 - Belangrijk'
ms:assetid: 'ms09-041'
ms:contentKeyID: 61231737
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-041(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS09-041 - Belangrijk
====================================================
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de Workstation-service geheugen toewijst en vrijmaakt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9c0e5bff-c248-4e87-a83b-82ba52f5299d)                                                          | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b64a454-d383-47e3-b469-b87e2b3c1a9f)                                                              | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cb0477f-0656-47f5-bd35-5716e0572fbd)                                                                              | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=96fbf65f-1db2-432d-92a0-6669d8abaeb0)                                                                  | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=11321f48-8997-4b99-982a-3ba4ad3f5992)                                                               | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=979ac9da-940f-49e7-91a2-b12db3708076)                                     | Denial of service                       | Matig             | Geen                                            |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9aa04cc-a5c5-47ae-bf0f-250cff275d26) | Denial of service                       | Matig             | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=24c77c27-0b7d-4a35-a871-b453f90e5913)\*         | Denial of service                       | Matig             | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=48d0432e-704a-4bbb-b0a1-cd14069a8e93)\*                 | Denial of service                       | Matig             | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c119223c-f4e0-449b-8e7b-a6bf11c98f94)           | Denial of service                       | Matig             | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging - CVE-2009-1544:</th>
...
Beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging - CVE-2009-1544:  
--------------------------------------------------------------------------------------------------
  
<span></span>
Een beveiligingslek met betrekking tot misbruik van bevoegdheden bestaat in de Windows Workstation-service ten gevolge van een mogelijke "double free"-conditie in de service. Een aanvaller die dit beveiligingslek weet te misbruiken zou door misbruik van bevoegdheden willekeurige code kunnen uitvoeren. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2009-1544](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging - CVE-2009-1544:
...
-   Een aanvaller moet geldige aanmeldingsreferenties hebben voor een kwetsbaar systeem om dit beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet worden misbruikt door anonieme gebruikers.
  
#### Tijdelijke oplossingen voor het beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging - CVE-2006-1544:
...
#### Veelgestelde vragen over het beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging - CVE-2006-1544:
...
Microsoft Remote Procedure Call (RPC) is een mechanisme voor interprocescommunicatie voor gegevensuitwisseling en het aanroepen van functionaliteiten die deel uitmaken van een ander proces. Dat proces kan zich op dezelfde computer, op het lokale netwerk (LAN) of op internet bevinden. Het Microsoft RPC-mechanisme gebruikt andere IPC-mechanismen, zoals named pipes, NetBIOS of Winsock, om een verbinding tussen de client en de server tot stand te brengen. Met RPC kunnen essentiële programmalogica en bijbehorende procedurecode op verschillende computers bestaan, wat van belang is voor gedistribueerde toepassingen. Zie het TechNet-artikel What Is RPC? voor meer informatie.
  
**Kan ik de Workstation-service uitschakelen om te voorkomen dat deze aanval slaagt?**    
Het uitschakelen van de Workstation-service wordt niet aangeraden als een tijdelijke oplossing voor dit beveiligingslek. Als de Workstation-service is uitgeschakeld, kan het systeem geen verbinding maken met eventuele gedeelde bestands- of afdrukbronnen in een netwerk. Gebruik deze tijdelijke oplossing alleen op zelfstandige systemen (zoals veel thuiscomputers) waarmee geen verbinding wordt gemaakt met een netwerk. Services die afhankelijk zijn van de Workstation-service worden niet meer gestart. Er wordt een foutbericht weergegeven in het logboek voor systeemgebeurtenissen. De volgende services zijn afhankelijk van de Workstation-service:
...
Deze services zijn vereist voor toegang tot bronnen op een netwerk en voor domeinverificatie. Het uitschakelen van de bovenstaande services heeft geen invloed op verbinding met en bladeren via internet voor zelfstandige systemen, zoals systemen van gebruikers met inbelverbindingen, DSL-verbindingen of via kabelmodemverbindingen.
  
**Opmerking:&lt;/B2&gt;** De Microsoft Baseline Security Analyzer zal niet functioneren indien de Workstation-service wordt uitgeschakeld.
...
Een aanvaller kan dit lek misbruiken door een speciaal ontworpen RPC-bericht te maken en dat naar een systeem waarin dit probleem optreedt te verzenden. Door het bericht kan de client dan geverifieerde code schrijven in het geheugen in de adresruimte van de Workstation-service.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Alle systemen waarop de Workstation-service is ingeschakeld lopen risico.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop de Workstation-service geheugen toewijst en vrijmaakt.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB971657$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/971657">Microsoft Knowledge Base-artikel 971657</a></td>
</tr>
<tr class="even">
...
-   Cody Pierce van [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) voor het melden van het beveiligingslek in de Workstation-service met betrekking tot geheugenbeschadiging (CVE-2009-1544)
