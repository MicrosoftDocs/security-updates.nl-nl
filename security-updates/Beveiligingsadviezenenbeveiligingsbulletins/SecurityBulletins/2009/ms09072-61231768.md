---
TOCTitle: 'MS09-072'
Title: 'Microsoft-beveiligingsbulletin MS09-072 - Kritiek'
ms:assetid: 'ms09-072'
ms:contentKeyID: 61231768
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-072(v=Security.10)'
---
...
Het prioriteitsniveau van deze beveiligingsupdate is kritiek voor alle ondersteunde releases van Internet Explorer: Internet Explorer 5.01, Internet Explorer 6, Internet Explorer 6 Service Pack 1, Internet Explorer 7 (behalve op ondersteunde edities van Windows Server 2003 en Windows Server 2008), en Internet Explorer 8 (behalve op ondersteunde edities van Windows Server 2003, Windows Server 2008 en Windows Server 2008 R2). Het prioriteitsniveau van deze update is Matig voor Internet Explorer 7 en Internet Explorer 8 op de aangegeven Windows-servers. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost deze beveiligingslekken op door het besturingselement te verbeteren en door de manier te wijzigen waarop Internet Explorer objecten in het geheugen verwerkt. Zie de subsectie Veelgestelde vragen in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 977981](http://technet.microsoft.com/security/advisory/977981).
...
<span></span>
**Bevat deze beveiligingsupdate de oplossing voor bekende problemen voor MS09-054 die zijn opgelost in Microsoft Knowledge Base-artikel 976749?**  
Ja. Deze beveiligingsupdate (976325) bevat de oplossing die wordt beschreven in [Microsoft Knowledge Base-artikel 976749](http://support.microsoft.com/kb/976749) waarmee bekende problemen voor beveiligingsupdate 974455 in Microsoft-beveiligingsbulletin [MS09-054](http://technet.microsoft.com/security/bulletin/ms09-054) worden opgelost.

**Wat is het verband tussen deze beveiligingsupdate en het ATL-probleem dat wordt beschreven in MS09-035?**  
In Microsoft-beveiligingsbulletin [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) worden beveiligingslekken beschreven in de onderdelen en besturingselementen die zijn ontwikkeld met kwetsbare openbare versies van de Active Template Library (ATL). Deze beveiligingsupdate (976325) helpt bekende aanvalsvectoren in Internet Explorer te beperken voor de onderdelen en besturingselementen die zijn ontwikkeld met de versies van de ATL die worden beschreven in [Microsoft-beveiligingsadvies 973882](http://technet.microsoft.com/security/advisory/973882) en MS09-035. Zie ook het beveiligingslek met betrekking tot COM-initialisatie in de ATL, [CVE-2009-2493](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493), in de volgende sectie, **Informatie over het beveiligingslek**.

**Wat is het verband tussen dit beveiligingsbulletin en het ATL-probleem dat wordt beschreven in Microsoft-beveiligingsadvies 973882?**  
In [Microsoft-beveiligingsadvies 973882](http://technet.microsoft.com/security/advisory/973882) worden beveiligingslekken beschreven in openbare versies en privéversies van de Active Template Library (ATL). Deze beveiligingsupdate (976325) werkt een besturingselement bij dat is ontwikkeld met de versies van de ATL die worden beschreven in Microsoft-beveiligingsadvies 973882 en [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131). Zie ook het beveiligingslek met betrekking tot COM-initialisatie in de ATL, [CVE-2009-2493](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493), in de volgende sectie, **Informatie over het beveiligingslek**.
...
Zie Microsoft-beveiligingsbulletin [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) als u de update voor de ATL wilt downloaden.

**Ik heb de update MS09-035 al geïnstalleerd. Moet ik deze update dan toch installeren?**  
Ja. [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) is speciaal gericht op ontwikkelaars die de Active Template Library (ATL) van Microsoft Visual Studio gebruiken. Ontwikkelaars die opnieuw onderdelen en besturingselementen verspreiden die zijn gebouwd met de ATL, dienen de update van MS09-035 te installeren om te zorgen dat de beveiligingslekken die worden beschreven in dat bulletin, niet optreden in deze onderdelen en besturingselementen.

**Waar is de informatie over de bestandsgegevens?**  
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 976325](http://support.microsoft.com/kb/976325).
...
<th>
Beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen – CVE-2009-3671
</th>
<th>
Beveiligingslek met betrekking tot beschadigd geheugen door HTML-objecten – CVE-2009-3672
</th>
<th>
Beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen – CVE-2009-3673
</th>
<th>
Beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen – CVE-2009-3674
</th>
<th>
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in een ActiveX-besturingselement dat is gebouwd met kwetsbare Microsoft Active Template Library-headers (ATL). Dit beveiligingslek treedt slechts rechtstreeks op in systemen waarop onderdelen en besturingselementen zijn geïnstalleerd die zijn gemaakt met de ATL van Visual Studio. Onderdelen en besturingselementen die zijn gemaakt met de ATL kunnen leiden tot het starten van willekeurige objecten die beveiligingsbeleid kunnen omzeilen, zoals kill-bits in Internet Explorer. Door dit beveiligingslek kan een externe, onbevoegde gebruiker externe code uitvoeren op een systeem waarin dit probleem optreedt. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd.
...
Het beveiligingslek wordt veroorzaakt door een ActiveX-besturingselement dat is gebouwd met kwetsbare Microsoft Active Template Library-headers (ATL). Onveilig gebruik van dit besturingselement kan leiden tot het starten van willekeurige objecten die beveiligingsbeleid kunnen omzeilen.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**  
Als het systeem van een gebruiker een kwetsbaar besturingselement bevat en een aanvaller de beperkingen die worden beschreven in [Microsoft-beveiligingsadvies 973882](http://technet.microsoft.com/security/advisory/973882) omzeilt, kan een aanvaller de volledige controle krijgen over het systeem waarin dit probleem optreedt indien de gebruiker is aangemeld met beheerdersrechten. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
...
Het beveiligingslek treedt op in het onderdeel tdc.ocx.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door een besturingselement te verbeteren dat tabelgegevens verwerkt. Dit besturingselement is eerder gebouwd met de kwetsbare Microsoft Active Template Library (ATL).
...
Zie [CVE 2009-3671](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3671) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen - CVE-2009-3671
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3671
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3671
...
Zie [CVE 2009-3672](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadigd geheugen door HTML-objecten - CVE-2009-3672
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot beschadigd geheugen door HTML-objecten - CVE-2009-3672
...
-   **DEP inschakelen voor Internet Explorer 6 of Internet Explorer 7 via automatische Microsoft Fix It-oplossing**
    ...
    Zie [Microsoft Knowledge Base-artikel 976325](http://support.microsoft.com/kb/976325) als u de automatische **Microsoft Fix it**-oplossing wilt gebruiken om deze tijdelijke oplossing in of uit te schakelen.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot beschadigd geheugen door HTML-objecten - CVE-2009-3672

**Wat is de omvang van het beveiligingslek?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Wanneer Internet Explorer in bepaalde omstandigheden probeert toegang te krijgen tot onjuist geïnitialiseerd geheugen, kan het geheugen zodanig beschadigd raken dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2009-3672](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672) toegewezen.
...
Zie [CVE 2009-3673](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3673) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen - CVE-2009-3673
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3673
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3673
...
Zie [CVE 2009-3674](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3674) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen - CVE-2009-3674
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3674
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-3674
...
<td style="border:1px solid black;">Voor Internet Explorer 5.01 Service Pack 4 op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB976325-IE501SP4-20091027.120000$\Spuninst.<br />
<br />
Voor Internet Explorer 6 Service Pack 1 indien geïnstalleerd op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB976325-IE6SP1-20091027.120000$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/976325">Microsoft Knowledge Base-artikel 976325</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB976325$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB976325-IE7\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB976325-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/976325">Microsoft Knowledge Base-artikel 976325</a></td>
...
-   Sam Thomas (http://eshu.co.uk/), in samenwerking met [TippingPoint](http://www.tippingpoint.com/) en het [Zero Day Initiative](http://www.zerodayinitiative.com/), voor het melden van het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen (CVE-2009-3671)  
-   [team509](http://www.team509.com/), in samenwerking met [Verisign IDefense Labs](http://labs.idefense.com/), voor het melden van het beveiligingslek met betrekking tot beschadigd geheugen door HTML-objecten (CVE-2009-3672)  
-   Een anonieme onderzoeker die bij [TippingPoint](http://www.tippingpoint.com/) en [Zero Day Initiative](http://www.zerodayinitiative.com/) werkt voor het melden van het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen - (CVE-2009-3673).  
-   Een anonieme onderzoeker die bij [TippingPoint](http://www.tippingpoint.com/) en [Zero Day Initiative](http://www.zerodayinitiative.com/) werkt voor het melden van het beveiligingslek met betrekking tot beschadiging van niet-geïnitialiseerd geheugen - (CVE-2009-3674).
...
-   V1.1 (9 december 2009): Een verwijzing naar Microsoft Knowledge Base-artikel 976749 in de sectie **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** is gecorrigeerd. Ook is in de sectie **Implementatie van de beveiligingsupdate** de registersleutel voor verificatie van de update voor Internet Explorer 7 voor alle ondersteunde x64-edities van Windows XP gecorrigeerd.
