---
TOCTitle: 'MS10-010'
Title: 'Microsoft-beveiligingsbulletin MS10-010 - Belangrijk'
ms:assetid: 'ms10-010'
ms:contentKeyID: 61231780
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-010(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-010 - Belangrijk
====================================================

Beveiligingslek in Windows Server 2008 Hyper-V kan leiden tot denial of service (977894)
----------------------------------------------------------------------------------------
...
Het prioriteitsniveau van dit bulletin is Belangrijk voor alle ondersteunde x64-versies van Windows 2000 Server 2008 en Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de de Hyper-V-server codering valideert op machine-instructies die worden uitgevoerd op de virtuele gastmachine. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3463a63c-e88a-4036-ab60-f84d4bf4191a)\* | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=3214b347-d901-4aac-85ce-676e4602de87)\*                                                      | Denial of service                       | Belangrijk        | Geen                                            |
...
**Deze update kan handmatig worden geïnstalleerd op** getroffen platforms, zelfs wanneer de Hyper-V-functie niet is ingeschakeld. Via de functie Automatische updates wordt de update echter uitsluitend aangeboden als de Hyper-V-functie is ingeschakeld.

**Moet deze update worden toegepast op virtuele Hyper-V-gastmachines?**
Deze update hoeft niet te worden toegepast op virtuele Hyper-V-gastmachines, alleen op de machine waarop de Hyper-V-functie is ingeschakeld. Via de functie Automatische updates wordt de update uitsluitend aangeboden aan het Hyper-V-serversysteem, niet aan de virtuele gastmachines.
...
Microsoft Hyper-V Server 2008, Microsoft Hyper-V Server 2008 Service Pack 2 en Microsoft Hyper-V Server 2008 R2 worden door dit beveiligingslek getroffen en de updates voor respectievelijk Windows Server 2008 en Windows Server 2008 R2 moeten worden toegepast om dit beveiligingslek te verhelpen. Klanten die de functie Automatische updates hebben ingeschakeld, krijgen deze updates automatisch ter installatie aangeboden.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V - CVE-2010-0026</th>
...
Beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V - CVE-2010-0026  
---------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service in Hyper-V op Windows Server 2008 en Windows Server 2008 R2. Het beveiligingslek wordt veroorzaakt door onvoldoende validatie van specifieke reeksen machine-instructies door Hyper-V. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan ervoor zorgen dat het Hyper-V-systeem waarin dit probleem optreedt niet meer reageert. Dit heeft gevolgen voor alle virtuele machines die door dat systeem worden gehost.
  
Zie [CVE 2010-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V - CVE-2010-0026
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V - CVE-2010-0026
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V - CVE-2010-0026
...
Dit beveiligingslek wordt veroorzaakt doordat de Hyper-V-server de codering van specifieke machine-instructies die worden uitgevoerd op de virtuele gastmachines onjuist valideert. Vanwege dit gebrek aan validatie kan de Hyper-V-servertoepassing niet meer reageren als deze instructies worden verwerkt.
...
Een aanvaller moet een geverifieerde gebruiker zijn in een van de virtuele gastmachines die worden gehost door de Hyper-V-server en moet willekeurige code kunnen uitvoeren op het systeem. Een aanvaller kan dan een niet-vertrouwd bestand uitvoeren op het systeem waardoor een verkeerd ingedeelde reeks machine-instructies wordt aangeroepen en de Hyper-V-server niet meer reageert.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te wijzigen waarop de de Hyper-V-server codering valideert op machine-instructies die worden uitgevoerd op de virtuele gastmachine.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/977894">Microsoft Knowledge Base-artikel 977894</a></td>
</tr>
<tr class="odd">
...
-   Jan Bottorff voor het melden van het beveiligingslek met betrekking tot validatie van instructiereeksen in Hyper-V (CVE-2010-0026)
...
-   V1.1 (10 februari 2010): De vermelding van **Systems Management Server** voor SMS 2003 is gewijzigd in ITMU voor Windows Server 2008 R2. Het gaat alleen om een wijziging in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.
