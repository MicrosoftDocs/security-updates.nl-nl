---
TOCTitle: 'MS10-014'
Title: 'Microsoft-beveiligingsbulletin MS10-014 - Belangrijk'
ms:assetid: 'ms10-014'
ms:contentKeyID: 61231784
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-014(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-014 - Belangrijk
====================================================

Beveiligingslek in Kerberos kan leiden tot denial of service (977290)
---------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Het beveiligingslek kan leiden tot denial of service indien een speciaal vervaardigde aanvraag voor het vernieuwen van tickets via een geverifieerde gebruiker op een vertrouwde niet-Windows Kerberos-realm naar het Windows Kerberos-domein wordt verzonden. De denial of service kan blijven voortduren tot de domeincontroller opnieuw wordt opgestart.
...
Deze update lost het beveiligingslek op doordat de manier wordt verbeterd waarop de Kerberos-server aanvragen voor het vernieuwen van tickets verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=56a9afba-a6ee-4fb9-ba85-e51d9f94de27)                                                            | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=738e2fda-96fc-413d-a5c7-74b1fac1d6b3)                                                                      | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8ad539d-8191-4864-977b-ad4e31c04ba0)                                                          | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=d549c927-add7-4d83-bfc7-15dc35663dfb)                                                       | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=75327470-0f14-4cdd-bcb7-64684c61c267)\* | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d0f8f81-fc10-450a-a653-06f89acba9fa)\*         | Denial of service                       | Belangrijk        | Geen                                            |
...
De update wordt alleen aan systemen aangeboden waarop het getroffen onderdeel is geïnstalleerd en ingeschakeld. Systemen die niet zijn geconfigureerd in de rol van een domeincontroller bevatten het kwetsbare onderdeel maar worden niet door dit probleem getroffen en krijgen deze update niet via de website Automatisch updates aangeboden.
...
<th style="border:1px solid black;" >Beveiligingslek in Kerberos met betrekking tot Null-pointerdereferentie - CVE-2010-0035</th>
...
Beveiligingslek in Kerberos met betrekking tot Null-pointerdereferentie - CVE-2010-0035  
---------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service in implementaties van Kerberos. Het beveiligingslek wordt veroorzaakt door onjuiste verwerking van aanvragen voor het vernieuwen van een ticket dat tickets uitgeeft door een client op een externe, niet-Windows-realm in een Kerberos-implementatie in gemengde modus. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan ervoor zorgen dat de Windows-domeincontroller waarin dit probleem optreedt niet meer reageert.
  
Zie [CVE 2010-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0035) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Kerberos met betrekking tot Null-pointerdereferentie - CVE-2010- 0035
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben voor een realm die wordt vertrouwd door de Windows-domeincontroller om misbruik te kunnen maken van dit beveiligingslek. Het beveiligingslek kan niet worden misbruikt door anonieme gebruikers.  
-   Dit beveiligingslek treft alleen domeincontrollers. Er zijn geen gevolgen voor servers die niet als domeincontroller fungeren.
  
#### Tijdelijke oplossingen voor het beveiligingslek in Kerberos met betrekking tot Null-pointerdereferentie - CVE-2010-0035
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in Kerberos met betrekking tot Null-pointerdereferentie - CVE-2010-0035
  
**Wat is de omvang van het beveiligingslek?**    
Dit beveiligingslek heeft betrekking op een denial of service. Een externe, geverifieerde aanvaller kan een speciaal vervaardigde aanvraag verzenden voor het vernieuwen van een ticket dat tickets uitgeeft (Ticket-Granting-Ticket, TGT) waardoor het getroffen systeem niet meer reageert en een denial of service optreedt. De denial of service kan blijven voortduren tot de domeincontroller opnieuw wordt opgestart.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Dit beveiligingslek wordt veroorzaakt door een onjuiste verwerking van aanvragen voor het vernieuwen van tickets van een niet-Windows Kerberos-domein.
...
**Wat is een Ticket-Granting-Ticket of TGT?**    
In Kerberos wordt aan een client een tijdelijke sleutel toegewezen door het KDC. Deze tijdelijke sleutel kan voor slechts één specifieke aanmelding worden gebruikt. Wanneer een gebruiker zich aanmeldt, vraagt de client een ticket aan voor het KDC, op dezelfde waarop een ticket zou worden aangevraagd voor een andere service. Het KDC reageert door een aanmeldingssleutel en een ticket te maken voor een speciale server, de service voor het uitgeven van tickets van het KDC. Een exemplaar van de aanmeldingssleutel wordt opgenomen in het ticket en het ticket wordt gecodeerd met de hoofdsleutel van het KDC. Een tweede exemplaar van de aanmeldingssleutel wordt gecodeerd met de hoofdsleutel van de gebruiker, afgeleid van het wachtwoord van de gebruiker. Het ticket en de gecodeerde sleutel worden naar de client verzonden.
  
Wanneer de client de reactie van het KDC ontvangt, decodeert de client de aanmeldingssleutel met de hoofdsleutel van de gebruiker, die is afgeleid van het wachtwoord van de gebruiker. De client heeft de sleutel die is afgeleid van het wachtwoord van de gebruiker niet meer nodig omdat de client nu de aanmeldingssleutel gebruikt om serversleutels van het KDC te decoderen. De client slaat de aanmeldingssleutel op in het ticketgeheugen, naast het ticket voor de service voor het uitgeven van tickets van het KDC. Het ticket voor de service voor het uitgeven van ticket wordt een Ticket-Granting-Ticket (TGT) genoemd.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die dit lek weet te misbruiken, kan ervoor zorgen dat het systeem waarin dit probleem optreedt, niet meer reageert. De beheerder moet het systeem handmatig opnieuw opstarten om het weer normaal te laten functioneren. Zelfs als een domeincontroller helemaal niet meer beschikbaar is, betekent dit niet dat gebruikers die al Kerberos-tickets hebben deze niet meer kunnen gebruiken. Zij blijven toegang houden tot alle bronnen waarvoor zij al tickets hebben gekregen. De denial of service voorkomt echter dat de domeincontroller nieuwe tickets voor toegang tot andere bronnen uitgeeft.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller die is geverifieerd op een niet-Windows Kerberos-realm die wordt vertrouwd door het Windows Kerberos-domein kan misbruik maken van dit beveiligingslek door een speciaal vervaardigde aanvraag voor het vernieuwen van ticktes te verzenden naar het Kerberos KDC.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt een risico voor domeincontrollers met een Kerberos-realm in gemengde modus. Kerberos-realms in gemengde modus zijn installaties waarin de Windows Kerberos-real een externe, niet-Microsoft Kerberos-implementatie vertrouwt.
  
**Wat doet de update?**    
Deze update lost het beveiligingslek op doordat de manier wordt verbeterd waarop de Kerberos-server aanvragen voor het vernieuwen van tickets verwerkt.
...
| **Implementatie**                               |                                                                                                                                                    |  
| Installeren zonder tussenkomst van de gebruiker | Windows2000-KB977290-x86-ENU /quiet                                                                                                                |  
| Installeren zonder opnieuw op te starten        | Windows2000-KB977290-x86-ENU /norestart                                                                                                            |  
| Logboekbestand bijwerken                        | kb977290.log                                                                                                                                       |  
...
| **Informatie over verwijderen**                 | Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB977290$\\Spuninst |  
| **Bestandsgegevens**                            | Zie [Microsoft Knowledge Base-artikel 977290](http://support.microsoft.com/kb/977290)                                                              |  
| **Verificatie van registersleutel**             | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB977290\\Filelist                                                          |
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB977290$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/977290">Microsoft Knowledge Base-artikel 977290</a></td>
</tr>
<tr class="even">
