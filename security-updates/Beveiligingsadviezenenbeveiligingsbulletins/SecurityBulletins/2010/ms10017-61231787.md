...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot heap-overloop in MDXTUPLE-records in Microsoft Office Excel - CVE-2010-0260
...
Zie [CVE 2010-0261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/978471">Microsoft Knowledge Base-artikel 978471</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/978474">Microsoft Knowledge Base-artikel 978474</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Voor Excel 2007, zie:<br />
<a href="http://support.microsoft.com/kb/978382">Microsoft Knowledge Base-artikel 978382</a><br />
<br />
Voor Excel Viewer, zie:<br />
<a href="http://support.microsoft.com/kb/978383">Microsoft Knowledge Base-artikel 978383</a><br />
<br />
Voor Microsoft Office-compatibiliteitspakket voor de bestandsindelingen van Word, Excel en PowerPoint 2007, zie:<br />
...
Download en installeer de juiste taalversie van de update voor Microsoft Office 2004 voor Mac 11.5.8 vanuit het [Microsoft Downloadcentrum](http://www.microsoft.com/downloads/details.aspx?familyid=ae5936f8-fe3f-4d23-a37c-d80f228e475e).
...
-   Open het volume van de Microsoft Office 2004 voor Mac 11.5.8-update op uw computer. Deze stap kan al voor u zijn uitgevoerd.  
-   Begin het updateproces door in het venster van het volume van de Microsoft Office 2004 voor Mac 11.5.8-update te dubbelklikken op de Microsoft Office 2004 voor Mac 11.5.8-updatetoepassing. Volg de aanwijzingen op het scherm.  
-   Als de update is geïnstalleerd, kunt u het installatieprogramma van de vaste schijf verwijderen. Zie voor het controleren of de installatie is geslaagd de volgende kop “Controleren of de update is geïnstalleerd”. U verwijdert het installatieprogramma van deze update door eerst het volume van de Microsoft Office 2004 voor Mac 11.5.8-update naar de prullenbak te slepen en vervolgens het gedownloade bestand naar de prullenbak te slepen.
...
Is het versienummer **11.5.8**, dan is de update met succes geïnstalleerd.
...
Download en installeer de juiste taalversie van de update voor Microsoft Office 2008 voor Mac 12.2.4 vanuit het [Microsoft Downloadcentrum.](http://www.microsoft.com/downloads/details.aspx?familyid=e0ed1569-ab2f-407c-b728-4eddc463c385)
  
-   Sluit alle geopende toepassingen, inclusief antivirusprogramma's, alle Microsoft Office-toepassingen, Microsoft Messenger voor Mac en Office Notifications om problemen met de installatie te voorkomen.  
-   Open het volume van de Microsoft Office 2008 voor Mac 12.2.4-update op uw computer. Deze stap kan al voor u zijn uitgevoerd.  
-   Begin het updateproces door in het venster van het volume van de Microsoft Office 2008 voor Mac 12.2.4-update te dubbelklikken op de toepassing Microsoft Office 2008 voor Mac 12.2.4-update. Volg de aanwijzingen op het scherm.  
-   Als de update is geïnstalleerd, kunt u het installatieprogramma van de vaste schijf verwijderen. Zie voor het controleren of de installatie is geslaagd de volgende kop “Controleren of de update is geïnstalleerd”. U verwijdert het installatieprogramma van deze update door eerst het volume van de Microsoft Office 2008 voor Mac 12.2.4-update naar de prullenbak te slepen en vervolgens het gedownloade bestand naar de prullenbak te slepen.
...
Is het versienummer **12.2.4**, dan is de update met succes geïnstalleerd.
...
Download en installeer de desbetreffende taalversie van de update voor het conversieprogramma voor Open XML-bestandsindeling voor Mac 1.1.4 vanuit het [Microsoft Downloadcentrum](http://www.microsoft.com/downloads/details.aspx?familyid=4c5487d5-c912-4087-8c83-769e3fb78ea9).
  
-   Sluit alle geopende toepassingen, inclusief antivirusprogramma's, alle Microsoft Office-toepassingen, Microsoft Messenger voor Mac en Office Notifications om problemen met de installatie te voorkomen.  
-   Open de update voor het conversieprogramma voor Open XML-bestandsindeling voor Mac 1.1.4 op uw computer. Deze stap kan al voor u zijn uitgevoerd.  
-   Begin het updateproces door in het venster van het volume van de update voor het conversieprogramma voor Open XML-bestandsindeling voor Mac 1.1.4 te dubbelklikken op de toepassing voor de update voor het conversieprogramma voor Open XML-bestandsindeling voor Mac 1.1.4. Volg de aanwijzingen op het scherm.  
-   Als de update is geïnstalleerd, kunt u het installatieprogramma van de vaste schijf verwijderen. Zie voor het controleren of de installatie is geslaagd de volgende kop “Controleren of de update is geïnstalleerd”. U verwijdert het installatieprogramma van deze update door eerst het volume van de update voor het conversieprogramma voor Open XML-bestandsindeling voor Mac 1.1.4 naar de prullenbak te slepen en vervolgens het gedownloade bestand naar de prullenbak te slepen.
...
Is het versienummer **1.1.4**, dan is de update met succes geïnstalleerd.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/979439">Microsoft Knowledge Base-artikel 979439</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   Nicolas Joly van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot beschadigd geheugen in records in Microsoft Office Excel (CVE-2010-0257)  
-   Sean Larsson van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot verwarring van objecttypen in werkbladen in Microsoft Office Excel (CVE-2010-0258)  
-   Sean Larsson van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot heap-overloop in MDXTUPLE-records in Microsoft Office Excel (CVE-2010-0260)  
-   Sean Larsson van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot heap-overloop in MDXSET-records in Microsoft Office Excel (CVE-2010-0261)  
-   Sean Larsson van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen in FNGROUPNAME-records in Microsoft Office Excel (CVE-2010-0262)  
-   Een anonieme onderzoeker van [Zero Day Initiative](http://www.zerodayinitiative.com/) van [Tipping Point](http://www.tippingpoint.com/) voor het melden van het beveiligingslek met betrekking tot het uitvoeren van code bij het parseren van XLSX-bestanden in Microsoft Office Excel (CVE-2010-0263)  
-   Damián Frizza van [Core Security Technologies](http://www.coresecurity.com/) voor het melden van het beveiligingslek bij het parseren van DbOrParamQry-records in Microsoft Office Excel (CVE-2010-0264)
...
-   V1.1 (10 maart 2010): Microsoft Office Excel 2003 is toegevoegd aan de prioriteitentabel als software waarin het probleem van CVE-2010-0262 optreedt. De bestandsnaam van het updatepakket voor Excel 2007 is gecorrigeerd. Daarnaast is de lijst met software waarin dit probleem optreedt in de samenvatting gecorrigeerd. Het gaan alleen om wijzigingen in de informatie. Klanten die hun systemen al hebben bijgewerkt, hoeven verder geen actie te ondernemen.
