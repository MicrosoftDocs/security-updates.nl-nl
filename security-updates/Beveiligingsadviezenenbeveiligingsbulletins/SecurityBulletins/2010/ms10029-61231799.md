---
TOCTitle: 'MS10-029'
Title: 'Microsoft-beveiligingsbulletin MS10-029 - Matig'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61231799
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-029(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-029 - Matig
===============================================

Door een beveiligingslek in het Windows-onderdeel ISATAP is spoofing mogelijk (978338)
--------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Het prioriteitsniveau van deze beveiligingsupdate is Gemiddeld voor Windows XP, Windows Server 2003, Windows Vista en Windows Server 2008. Windows 7 en Windows Server 2008 R2 zijn niet kwetsbaar omdat deze besturingssystemen de functie omvatten die door deze beveiligingsupdate wordt geïmplementeerd. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

Door dit beveiligingslek kan een aanvaller een IPv4-adres vervalsen (spoofen) zodat het adres filters op basis van het IPv4-bronadres kan omzeilen. De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop de Windows TCP/IP-stack het IPv6-bronadres controleert in een ISATAP-tunnelpakket. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                          | Spoofing                                | Matig             | Geen                                                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                              | Spoofing                                | Matig             | Geen                                                                |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                              | Spoofing                                | Matig             | Geen                                                                |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                  | Spoofing                                | Matig             | Geen                                                                |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                               | Spoofing                                | Matig             | Geen                                                                |
| [Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                     | Spoofing                                | Matig             | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36) | Spoofing                                | Matig             | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*         | Spoofing                                | Matig             | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*                 | Spoofing                                | Matig             | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)           | Spoofing                                | Matig             | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |

**\*Treedt op bij Server Core-installatie.** Deze update is met hetzelfde prioriteitsniveau van toepassing op aangegeven ondersteunde edities van Windows Server 2008, ongeacht of deze zijn geïnstalleerd met de Server Core-installatieoptie. Zie het MSDN-artikel [Server Core](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) voor meer informatie over deze installatieoptie. De Server Core-installatieoptie kan niet worden toegepast op bepaalde edities van Windows Server 2008. Zie hiervoor [Server Core-installatieopties vergelijken](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
Deze beveiligingsupdate implementeert twee nieuwe beveiligingsfuncties:

-   **Potential Router List (PRL) op ISATAP-clients:** Met PRL kunnen clients bronadressen controleren voor ISATAP-pakketten die via tunnel binnenkomen. PRL wordt standaard ingeschakeld als deze beveiligingsupdate wordt geïnstalleerd en helpt het beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP zoals beschreven in CVE-2010-0812 op te lossen. Zie [Microsoft Knowledge Base-artikel 978338](http://support.microsoft.com/kb/978338) voor meer informatie over PRL.
-   **Neighbor Unreachability Detection (NUD) op ISATAP-interfaces:** NUD wordt gebruikt om te valideren of een neighbor bereikbaar is. NUD wordt door de ISATAP-knooppunten uitgevoerd voordat de ISATAP-pakketten worden verzonden. NUD is standaard niet ingeschakeld en moet handmatig door netwerkbeheerders worden geconfigureerd. Zie [Microsoft Knowledge Base-artikel 978338](http://support.microsoft.com/kb/978338) voor meer informatie over NUD en over het inschakelen van NUD.

**Waarom heeft Microsoft Windows 2000 geen last van dit beveiligingslek?**  
Microsoft Windows 2000 biedt geen ondersteuning voor IPv6 en daarom is dit besturingssysteem niet kwetsbaar.

**Waarom hebben Windows 7 en Windows Server 2008 R2 geen last van dit beveiligingslek?**  
De functies die door deze beveiligingsupdate worden geïmplementeerd, Potential Router List (PRL) en Neighbor Unreachability Detection (NUD), zijn al aanwezig in Windows 7 en Windows Server 2008 R2.

**Opmerking** PRL is standaard ingeschakeld op deze platforms, maar NUD niet. NUD moet handmatig door de netwerkbeheerder worden geconfigureerd. Zie [Microsoft Knowledge Base-artikel 978338](http://support.microsoft.com/kb/978338) voor meer informatie over deze functie.

**Krijg ik deze update ook aangeboden als ik IPv6 niet heb ingeschakeld?**  
Ja, deze beveiligingsupdate zal via Automatische updates worden aangeboden omdat de kwetsbare code op deze systemen aanwezig is. We adviseren klanten de beveiligingsupdate te installeren als ze IPv6 in de toekomst willen implementeren.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP - CVE-2010-0812</th>
...
Beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP - CVE-2010-0812  
--------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot spoofing in de Microsoft Windows IPv6-stack vanwege de manier waarop Windows het IPv6-bronadres van het binnenpakket in een ISATAP-tunnelpakket. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan een adres vervalsen om edge- of host-firewalls te omzeilen. Daarnaast kan informatie worden vrijgegeven wanneer de aangevallen computer reageert op het bericht met het IPv6-bronadres dat de aanvaller heeft opgegeven.
  
Zie [CVE 2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP - CVE-2010-0812
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Dit beveiligingslek treft alleen Windows-systemen waarop de ISATAP-interface is geconfigureerd.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP - CVE-2010-0812
...
-   **De ISATAP IPv6-interface uitschakelen**
  
    Voer de volgende opdracht uit vanaf een opdrachtprompt met verhoogde bevoegdheden om de ISATAP IPv6-interface uit te schakelen:
    ...
    **Gevolgen van de tijdelijke oplossing.** Als u de ISATAP-interface uitschakeld, kan het systeem ISATAP niet meer gebruiken als een IPv6-tunnelmechanisme.
  
    **De tijdelijke oplossing ongedaan maken.**
  
    Voer de volgende opdracht uit vanaf een opdrachtprompt met verhoogde bevoegdheden om de ISATAP IPv6-interface weer in te schakelen:
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP - CVE-2010-0812
  
**Wat is de omvang van het beveiligingslek?**    
Dit is een beveiligingslek dat betrekking heeft op spoofing. Door dit beveiligingslek kan een aanvaller een IPv4-adres vervalsen (spoofen) om filters op basis van het IPv4-bronadres te omzeilen.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek bestaat doordat de Windows TCP/IP-stack het IPv6-bronadres niet goed controleert in een ISATAP-tunnelpakket.
  
**Wat is ISATAP?**    
Het Intra-Site Automatic Tunnel Addressing Protocol (ISATAP) biedt IPv6-connectiviteit binnen een IPv4-intranet. Zie voor meer informatie over ISATAP [RFC5214: Intra-Site Automatic Tunnel Addressing Protocol (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt).
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller kan zich voordoen als een andere gebruiker of een ander systeem, waardoor bronadresfilters, zoals edge- of host-firewalls, kunnen worden omzeild.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller kan proberen misbruik te maken van het beveiligingslek door speciale netwerkpakketten te maken met een speciaal vervaardigd IPv6-bronadres in een ISATAP-verbinding dat niet overeenkomt met het bijbehorende IPv4-bronadres.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt een risico voor alle besturingssystemen waarop de IPv6 ISATAP-functies zijn ingeschakeld.
  
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te wijzigen waarop de Windows TCP/IP-stack het IPv6-bronadres controleert in een ISATAP-tunnelpakket.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB978338$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/978338">Microsoft Knowledge Base-artikel 978338</a></td>
</tr>
<tr class="even">
...
Gabi Nakibly van het National EW Research & Simulation Center (in Rafael) voor het melden van het beveiligingslek met betrekking tot spoofing van het IPv6-bronadres in ISATAP (CVE-2010-0812)
...
-   V1.1 (21 april 2010): De informatie over het vervangen van het bulletin voor alle updatepakketten voor Windows Vista en Windows Server 2008 is gecorrigeerd.
