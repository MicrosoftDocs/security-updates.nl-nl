---
TOCTitle: 'MS10-035'
Title: 'Microsoft-beveiligingsbulletin MS10-035 - Kritiek'
ms:assetid: 'ms10-035'
ms:contentKeyID: 61231805
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-035(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-035 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (982381)
--------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor Internet Explorer 6 Service Pack 1 op Microsoft Windows 2000 Service Pack 4; Kritiek voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-clients; en Matig voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-servers. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost deze beveiligingslekken op door de manier te wijzigen waarop Internet Explorer objecten verwerkt in het geheugen, bij het opschonen van HTML en in inhoud in cache. Zie de subsectie Veelgestelde vragen in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 980088](http://technet.microsoft.com/security/advisory/980088).
...
<tr>
<th colspan="5">
Internet Explorer 5.01 Service Pack 4 en Internet Explorer 6 Service Pack 1
</th>
</tr>
<tr>
...
<sup>[1]</sup>Op deze update zijn geen prioriteitsniveaus van toepassing omdat het beveiligingslek dat wordt besproken in dit bulletin niet optreedt in deze software. Deze update wordt echter aangeboden om een regressieprobleem op te lossen dat voortkomt uit [MS09-054](http://go.microsoft.com/fwlink/?linkid=163979). Zie "Bevat deze update functionaliteitswijzigingen die geen betrekking hebben op beveiliging?" in **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** voor meer informatie.

Veelgestelde vragen met betrekking tot deze beveiligingsupdate
--------------------------------------------------------------

<span></span>
**Welk verband bestaat er tussen deze beveiligingsupdate en** [**MS10-039**](http://go.microsoft.com/fwlink/?linkid=191905)**?**
Het beveiligingslek met betrekking tot het vrijgeven van informatie in toStaticHTML, [CVE-2010-1257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257), dat wordt beschreven in dit bulletin, treft ook Microsoft SharePoint. U kunt echter alleen de update installeren die van toepassing is op de software die u op uw systemen hebt geïnstalleerd. Als u Internet Explorer hebt geïnstalleerd, past u de vereiste updates volgens dit bulletin toe. Als u Microsoft SharePoint hebt geïnstalleerd, past u de noodzakelijke updates volgens [MS10-039](http://go.microsoft.com/fwlink/?linkid=191905) toe.
...
Deze update bevat een ingrijpende beveiligingsupdate voor het Internet Explorer 8 XSS-filter die wijzigt hoe elementen worden verwerkt.

**Bevat deze update functionaliteitswijzigingen die geen betrekking hebben op beveiliging?**
Deze update wordt aangeboden aan gebruikers van Internet Explorer 5.01 Service Pack 4 op Microsoft Windows 2000 Service Pack 4 om een regressieprobleem op te lossen dat voortkomt uit [MS09-054](http://go.microsoft.com/fwlink/?linkid=163979), waarbij tijdens het downloaden het dialoogvenster mogelijk niet meer reageert wanneer de server gecomprimeerde gegevens met extra bytes verzendt. Microsoft raadt alle gebruikers van deze software aan deze beveiligingsupdate toe te passen, ook klanten bij wie het regressieprobleem nog niet is opgetreden, om te voorkomen dat het regressieprobleem optreedt op hun systemen.
...
**Ik heb een andere standaardbrowser dan Internet Explorer geselecteerd. Moet ik deze update nog steeds toepassen?**
...
<th>
Beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-0255
</th>
<th>
Beveiligingslek met betrekking tot het vrijgeven van informatie in toStaticHTML - CVE-2010-1257
</th>
<th>
Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen – CVE-2010-1259
</th>
<th>
Beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen – CVE-2010-1260
</th>
<th>
Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen – CVE-2010-1261
</th>
<th>
Beveiligingslek met betrekking tot ontregeld geheugen - CVE-2010-1262
</th>
<th>
Prioriteitsniveau
</th>
...
-   Het gebruik van Windows Internet Explorer 7 en Internet Explorer 8 op Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2 beperkt de effecten van dit beveiligingslek.
-   De Beveiligde modus op Windows Vista en latere besturingssystemen helpt misbruik van dit beveiligingslek te voorkomen.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-0255
...
-   **Vergrendeling van netwerkprotocollen voor het bestandsprotocol inschakelen**

    Internet Explorer kan worden geconfigureerd om inhoud te blokkeren van bepaalde netwerkprotocollen in bijkomende zones naast de zone Lokale computer. Deze functie stelt de beheerder in staat dezelfde beperkingen voor vergrendeling van de zone Lokale computer toe te passen op elk willekeurig protocol in elke beveiligingszone.
    ...
    **Waarschuwing** Als u de Register-editor onjuist gebruikt, kan dit tot zeer ernstige problemen leiden waardoor u het besturingssysteem mogelijk opnieuw dient te installeren. Microsoft kan niet garanderen dat problemen die ontstaan als gevolg van een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico.
    ...
    Plak de volgende tekst in een tekstverwerker, bijvoorbeeld Kladblok, als u netwerkprotocollen voor het bestandsprotocol wilt vergrendelen. Sla het bestand vervolgens op met de extensie .reg.

    `Windows Registry Editor-versie 5.00[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_PROTOCOL_LOCKDOWN]"explorer.exe"=dword:00000001"iexplore.exe"=dword:00000001"*"=dword:00000001[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols][HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\1]"file"="file"[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\3]"file"="file"[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\4]"file"="file"`
    ...
    **Gevolgen van de tijdelijke oplossing.** Het bestandprotocol wordt vergrendeld.

    **De tijdelijke oplossing ongedaan maken.**

    Als u de vergrendeling van het bestandsprotocol ongedaan wilt maken, plakt u de volgende tekst in een tekstverwerker, bijvoorbeeld Kladblok. Sla het bestand vervolgens op met de extensie .reg.

    `Windows Registry Editor-versie 5.00[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_PROTOCOL_LOCKDOWN]"explorer.exe"=dword:00000000"iexplore.exe"=dword:00000000[-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols]`
...
-   **Vergrendeling van netwerkprotocollen voor het bestandsprotocol inschakelen via de automatische Microsoft Fix it-oplossing**
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-0255
...
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-0255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0255) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 980088](http://technet.microsoft.com/security/advisory/980088).

**Ik heb de tijdelijke oplossing in** [**Microsoft-beveiligingsadvies 980088**](http://technet.microsoft.com/security/advisory/980088) **geïmplementeerd om vergrendeling van netwerkprotocollen voor het bestandsprotocol in te schakelen. Moet ik deze tijdelijke oplossing uitschakelen voordat ik deze beveiligingsupdate installeer?**
Ja. Microsoft raadt u aan deze tijdelijke oplossing ongedaan te maken op systemen waarop u de tijdelijke oplossing hebt toegepast voordat u deze beveiligingsupdate installeert.
...
-   Het beveiligingslek is alleen van toepassing op de rendermodus quirks in Internet Explorer 8.
...
**Wat doet de update?**
De update wijzigt de manier waarop HTML wordt opgeschoond in Internet Explorer met toStaticHTML.

**Is dit beveiligingslek gerelateerd aan CVE-2010-1257 in** [**MS10-039**](http://go.microsoft.com/fwlink/?linkid=191905)**, Beveiligingslekken in Microsoft SharePoint kunnen leiden tot misbruik van bevoegdheden (2028554)?**
Ja, het beveiligingslek met betrekking tot het vrijgeven van informatie in toStaticHTML, [CVE-2010-1257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257), treft ook Microsoft SharePoint.
...
Zie [CVE 2010-1259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1259) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1259
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1259
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1259
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer objecten opent die niet goed zijn geïnitialiseerd of zijn verwijderd in de werkbalk voor ontwikkelaars in IE8. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

Zie [CVE 2010-1260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1260) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-1260

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   In het geval van een aanval vanaf het web kan de aanvaller beschikken over een website waarop zich een webpagina bevindt waarmee dit beveiligingslek wordt misbruikt. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens of advertenties staan of gegevens of advertenties kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan echter een gebruiker er niet toe dwingen om naar deze websites te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller gaat.
-   Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
-   Er is gebruikersinteractie vereist voordat de aanvaller misbruik kan maken van dit beveiligingslek. De gebruiker moet op F12 drukken als reactie op een prompt op een speciaal vervaardigde website.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-1260

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Het onderdeel IEDTViewSource uitschakelen**

    Schakel het onderdeel IEDTViewSource uit om te voorkomen dat de bron van webpagina's kan worden weergegeven met de functie IE DevTool.
    ...
    U moet voor Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2 eigenaar worden van \[HKEY\_CLASSES\_ROOT\\CLSID\\{8fe85d00-4647-40b9-87e4-5eb8a52f4759}\]. Dat doet u als volgt:

    1.  Klik als administrator op **Start** en vervolgens op **Uitvoeren**, typ **regedit** in het vak Openen en klik op **OK**.
    2.  Ga naar \[HKEY\_CLASSES\_ROOT\\CLSID\\{8fe85d00-4647-40b9-87e4-5eb8a52f4759}\].
    ...
    Sla vervolgens het volgende op in een bestand met de extensie REG, bijvoorbeeld Disable\_DT\_ViewSource.reg:

    `Windows Registry Editor Version 5.00[-HKEY_CLASSES_ROOT\CLSID\{8fe85d00-4647-40b9-87e4-5eb8a52f4759}]`

    Voer met de volgende opdracht vanaf een verhoogde opdrachtregel het bestand Disable\_DT\_ViewSource.reg uit:

    `Regedit.exe /s Disable_DT_ViewSource.reg`

    **Gevolgen van de tijdelijke oplossing.** De functie IE DevTool voor het weergeven van de bron, werkt niet. In plaats daarvan gebruikt Internet Explorer Kladblok om de bron weer te geven.

    **De tijdelijke oplossing ongedaan maken.**Herstel de oorspronkelijke status door de volgende opdracht vanaf een verhoogde opdrachtregel uit te voeren:

    `Regedit.exe /s Disable_DT_ViewSource_backup.reg`

#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-1260
...
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller kan over een website beschikken die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen deze website te bekijken en de werkbalk voor ontwikkelaars in IE8 te openen. De aanvaller zou ook misbruik kunnen maken van gemanipuleerde websites en websites die inhoud of advertenties van gebruikers accepteren of hosten. Deze websites kunnen speciaal vervaardigde inhoud bevatten, die misbruik van dit beveiligingslek kan maken. Een aanvaller kan een gebruiker er echter niet toe dwingen de inhoud van de aanvaller weer te geven. In plaats daarvan zou een aanvaller gebruikers ertoe moeten overhalen een handeling uit te voeren, doorgaans door op een koppeling in een e-mailbericht of een Instant Messenger-bericht te klikken, waardoor de gebruiker naar de website van de aanvaller gaat, of door een bijlage bij een e-mail te openen.

**Ik gebruik de werkbalk voor ontwikkelaars voor Internet Explorer 7. Word ik door dit probleem getroffen?**
De werkbalk voor ontwikkelaars voor Internet Explorer 7 is bijgewerkt ter bescherming tegen dit probleem. Er is een bijgewerkte werkbalk beschikbaar in het Microsoft Downloadcentrum, [Werkbalk voor ontwikkelaars voor Internet Explorer](http://www.microsoft.com/downloads/details.aspx?familyid=e59c3964-672d-4511-bb3e-2d5e1db91038&displaylang=en).
...
Zie [CVE 2010-1261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1261) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1261
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1261

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Het onderdeel IEDTExplorer uitschakelen**

    Schakel het onderdeel IEDTExplorer uit om te voorkomen dat de bron van webpagina's kan worden weergegeven met de functie IE DevTool.

    Maak met de volgende opdracht op een verhoogde opdrachtregel een back-up van de registersleutels:

    `Regedit.exe /e Disable_DT_Explorer_backup.reg HKEY_CLASSES_ROOT\CLSID\{1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}`

    U moet voor Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2 eigenaar worden van \[HKEY\_CLASSES\_ROOT\\CLSID\\{1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}\]. Dat doet u als volgt:

    1.  Klik als administrator op **Start** en vervolgens op **Uitvoeren**, typ **regedit** in het vak Openen en klik op **OK**.
    2.  Ga naar \[HKEY\_CLASSES\_ROOT\\CLSID\\{1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}\]
    3.  Klik achtereenvolgens op **Machtigingen**, **Geavanceerd** en **Eigenaar**.
    4.  **Eigenaar** naar Administrator
    5.  Klik op **Volledig beheer toewijzen aan administrator** .
    6.  Voer bovenstaande bewerking voor alle subsleutels uit.

    Sla vervolgens het volgende op in een bestand met de extensie REG, bijvoorbeeld Disable\_DT\_Explorer.reg:

    `Windows Registry Editor-versie 5.00[-HKEY_CLASSES_ROOT\CLSID\{1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}]`

    Voer met de volgende opdracht vanaf een verhoogde opdrachtregel het bestand Disable\_DT\_Explorer.reg uit:

    `Regedit.exe /s Disable_DT_Explorer.reg`

    **Gevolgen van de tijdelijke oplossing.** De functietoets voor IE DevTool, F12, werkt niet.

    **De tijdelijke oplossing ongedaan maken.** Herstel de oorspronkelijke status door de volgende opdracht vanaf een verhoogde opdrachtregel uit te voeren:

    `Regedit.exe /s Disable_DT_Explorer_backup.reg`

#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-1261
...
Zie [CVE 2010-1262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1262) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen - CVE-2010-1262
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen - CVE-2010-1262:
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen - CVE-2010-1262:
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Internet Explorer 6 Service Pack 1 op alle ondersteunde edities van Windows 2000:<br />
...
<td style="border:1px solid black;">Voor Internet Explorer 5.01 Service Pack 4 op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982381-IE501SP4-20100414.120000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Internet Explorer 6 Service Pack 1 op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982381-IE6SP1-20100414.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982381">Microsoft Knowledge Base-artikel 982381</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Internet Explorer 6 Service Pack 1 op alle ondersteunde edities van Microsoft Windows 2000 Service Pack 4:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde x64-edities van Windows XP:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB982381-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB982381-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982381">Microsoft Knowledge Base-artikel 982381</a></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 6 voor alle ondersteunde x64-edities van Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB982381-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde x64-edities van Windows Server 2003:<br />
IE7-WindowsServer2003.WindowsXP-KB982381-x64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde x64-edities van Windows Server 2003:<br />
IE8-WindowsServer2003.WindowsXP-KB982381-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder opnieuw op te starten</td>
...
<tr class="odd">
<td style="border:1px solid black;">Logboekbestand bijwerken</td>
<td style="border:1px solid black;">Internet Explorer 6 voor alle ondersteunde 32-bits edities, x64-edities en Itanium-edities van Windows Server 2003:<br />
KB982381.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde 32-bits edities, x64-edities en Itanium-edities van Windows Server 2003:<br />
KB982381-IE7.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde 32-bits edities, x64-edities en Itanium-edities van Windows Server 2003:<br />
KB982381-IE8.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Meer informatie</td>
...
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 voor alle ondersteunde 32-bits edities, x64-edities en Itanium-edities van Windows Server 2003:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982381$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde 32-bits edities, x64-edities en Itanium-edities van Windows Server 2003:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde 32-bits edities en x64-edities van Windows Server 2003:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB982381-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Internet Explorer 7 op alle ondersteunde 32-bits edities van Windows Vista:<br />
Windows6.0-KB982381-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 op alle ondersteunde x64-edities van Windows Vista:<br />
Windows6.0-KB982381-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde 32-bits edities van Windows Vista:<br />
IE8-Windows6.0-KB982381-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde x64-edities van Windows Vista:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Internet Explorer 7 op alle ondersteunde 32-bits edities van Windows Server 2008:<br />
Windows6.0-KB982381-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 op alle ondersteunde x64-edities van Windows Server 2008:<br />
Windows6.0-KB982381-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde 32-bits edities van Windows Server 2008:<br />
IE8-Windows6.0-KB982381-x86 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde x64-edities van Windows Server 2008:<br />
IE8-Windows6.0-KB982381-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installeren zonder opnieuw op te starten</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde 32-bits edities van Windows 7:<br />
Windows6.1-KB982381-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde x64-edities van Windows 7:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Internet Explorer 8 op alle ondersteunde x64-edities van Windows Server 2008 R2:<br />
Windows6.1-KB982381-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   Takeshi Terada van [Mitsui Bussan Secure Directions, Inc.](http://www.mbsd.jp/) voor het melden van het beveiligingslek met betrekking tot het vrijgeven van informatie in toStaticHTML (CVE-2010-1257)  
-   Michal Zalewski van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen (CVE-2010-1259)  
-   Chris Rohlf van [Matasano Security](http://www.matasano.com/) voor het melden van beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen (CVE-2010-1260)  
-   Chris Rohlf van [Matasano Security](http://www.matasano.com/) voor het melden van beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen (CVE-2010-1261)  
-   Peter Vreugdenhil, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen (CVE-2010-1262)
