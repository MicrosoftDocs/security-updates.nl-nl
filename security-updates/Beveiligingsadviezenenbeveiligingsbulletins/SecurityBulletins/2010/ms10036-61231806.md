---
TOCTitle: 'MS10-036'
Title: 'Microsoft-beveiligingsbulletin MS10-036 - Belangrijk'
ms:assetid: 'ms10-036'
ms:contentKeyID: 61231806
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-036(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-036 - Belangrijk
====================================================

Door een beveiligingslek in COM-validatie in Microsoft Office kan externe code worden uitgevoerd (983235)
---------------------------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in COM-validatie in Microsoft Office opgelost. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een speciaal vervaardigd Excel-, Word-, Visio-, Publisher- of PowerPoint-bestand opent in een getroffen versie van Microsoft Office. Het beveiligingslek kan niet automatisch worden misbruikt via e-mail. Aanvallen via e-mail lukken alleen als een gebruiker een bijlage opent die in een e-mailbericht is verzonden.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor Microsoft Office 2003 en het 2007 Microsoft Office-systeem. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop Microsoft Office te starten COM-objecten valideert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

**Aanbeveling.** Microsoft raadt klanten aan de update zo spoedig mogelijk te installeren.

**Bekende problemen.** In [Microsoft Knowledge Base-artikel 983235](http://support.microsoft.com/kb/983235) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
<sup>[1]</sup>Geen update beschikbaar. Zie voor meer informatie het onderdeel **Veelgestelde Vragen met betrekking tot deze beveiligingsupdate**.
...
| Microsoft Office OneNote 2007 Service Pack 1 en Microsoft Office OneNote 2007 Service Pack 2                                                                                                                                                 |
...
**Waarom geeft Microsoft geen update uit voor Microsoft Office XP terwijl dit product wel wordt genoemd als product waarin het probleem optreedt?**  
De architectuur voor een goede ondersteuning van de oplossingen voor een juiste validatie bestaat niet in Microsoft Office XP, waardoor het niet mogelijk is oplossingen te ontwikkelen voor Microsoft Office XP-producten waarmee het beveiligingslek wordt opgelost. Daarvoor zou een groot deel van de Microsoft Office XP-producten opnieuw moeten worden ontworpen, niet alleen de onderdelen waarin dit probleem optreedt. Nieuw ontworpen producten kunnen zodanig incompatibel zijn met andere toepassingen dat niet kan worden gegarandeerd dat deze Microsoft Office-producten nog naar behoren werken op het bijgewerkte systeem.

Microsoft biedt een **Microsoft Fix it-oplossing** voor gebruikers op Windows XP-systemen waarop Office XP is geïnstalleerd. Hoewel hiermee niet de code in de Office-producten zelf wordt verbetert, biedt de **Microsoft Fix it-oplossing** vergelijkbare bescherming tegen het beveiligingslek dat wordt beschreven in dit bulletin. Hoewel het risico voor de compatibiliteit van toepassingen minimaal is, raadt Microsoft gebruikers aan deze **Microsoft Fix it-oplossing** te testen voordat ze de oplossing distribueren. Zie [Microsoft Knowledge Base-artikel 983235](http://support.microsoft.com/kb/983235) voor de downloadlocatie en aanvullende gegevens.

**Moeten voor de updates voor de onderdelen ook de bijbehorende updates voor Microsoft Office 2003 of het 2007 Microsoft Office-systeem worden geïnstalleerd?**  
Ja, voor deze beveiligingsupdate moeten de updates voor Microsoft Office 2003 Service Pack 3 (KB982311) of 2007 Microsoft Office System Service Pack 1 en 2007 Microsoft Office System Service Pack 2 (KB982312) worden geïnstalleerd, naast de bijbehorende updates voor Excel, Word, Visio, Publisher of PowerPoint in de tabel met software waarin dit probleem optreedt. Alleen dan bent u beschermd tegen de beveiligingslekken die worden beschreven in dit bulletin.

**MS10-038 beschrijft ook beveiligingslekken in Microsoft Office Excel. Wat is het verband tussen MS10-038 en dit bulletin, MS10-036?**  
De beveiligingsupdates voor Microsoft Office Excel 2003 (KB982133) en Microsoft Office Excel 2007 (KB982308) in dit bulletin, MS10-036, lossen ook de beveiligingslekken op die worden beschreven in [MS10-038](http://go.microsoft.com/fwlink/?linkid=191053). Gebruikers met Microsoft Office Excel 2003 of Microsoft Office Excel 2007 hoeven deze beveiligingsupdates slechts eenmaal te installeren. Gebruikers moeten ook de bijbehorende Microsoft Office-update (KB982311 of KB982312) in dit bulletin installeren om zich te beschermen tegen het beveiligingslek dat wordt beschreven in dit bulletin, MS10-036.

**Bevat deze update functionaliteitswijzigingen die geen betrekking hebben op beveiliging?**  
Deze update bevat functionaliteitswijzigingen die geen betrekking hebben op beveiliging. Zie [Microsoft Knowledge Base-artikel 983632](http://support.microsoft.com/kb/983632) voor meer informatie.

Naast de wijzigingen die in het gedeelte **Informatie over het beveiligingslek** van dit bulletin worden beschreven, bevat deze update ook een ingrijpende wijziging. Deze update bevat een beperkende factor die helpt te voorkomen dat onderdelen en besturingselementen die zijn gebouwd met kwetsbare versies van ATL worden misbruikt in de Microsoft Office-producten die worden genoemd in de sectie met informatie over het beveiligingslek in dit bulletin. De nieuwe ingrijpende beschermingsmaatregelen in deze update beschermen tegen misbruik van alle openbaar en privé bekende ATL-beveiligingslekken.

De beperking lost de beveiligingslekken in de ATL die worden beschreven in [Microsoft-beveiligingsadvies (973882)](http://technet.microsoft.com/security/advisory/973882) en [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) op. De wijziging is standaard ingeschakeld voor alle platforms waarin dit probleem optreedt en helpt beveiligingslekken in de ATL te blokkeren voor besturingselementen die worden geladen in Microsoft Office, waaronder ook besturingselementen die niet door Microsoft zijn ontwikkeld.
...
**De Office-onderdelen die in dit artikel aan de orde komen, zijn onderdeel van het Office-pakket dat ik op mijn systeem heb geïnstalleerd, maar ik heb niet alle onderdelen geïnstalleerd. Krijg ik alle updates aangeboden?**  
Ja, als de versie van het Office-pakket is geïnstalleerd op uw systeem is geleverd met de onderdelen die in dit bulletin worden beschreven, worden er voor deze producten updates aangeboden, ongeacht of deze onderdelen wel of niet zijn geïnstalleerd. De detectielogica waarmee naar getroffen systemen wordt gescand, kan ook controleren op updates voor alle onderdelen die bij dat desbetreffende Office-pakket zijn geleverd. De gevonden updates worden vervolgens aan het systeem aangeboden. Het systeem wordt niet kwetsbaarder als gebruikers geen update installeren voor een onderdeel dat niet op het systeem is geïnstalleerd maar wel onderdeel van het Office-pakket is. Wordt de update toch geïnstalleerd, dan heeft dit geen nadelig effect op de beveiliging of prestaties van het systeem.
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Publisher 2007 Service Pack 1 en Microsoft Office Publisher 2007 Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Visio 2007 Service Pack 1 en Microsoft Office Visio 2007 Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop getroffen Microsoft Office-software het starten van COM-objecten valideert. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
...
-   Gebruikers van Microsoft Office 2002 en later wordt gevraagd te openen, op te slaan of te annuleren voordat een document wordt geopend. Dit is een beperkende factor omdat het beveiligingslek meer dan een enkele gebruikersactie nodig heeft voor het misbruiken van het beveiligingslek.
...
Microsoft Office valideert COM-objecten onvoldoende wanneer ze worden gestart in de afzonderlijke toepassingen Excel, PowerPoint, Publisher, Visio en Word.
...
Voor dit beveiligingslek is het noodzakelijk dat een gebruiker een speciaal ontworpen Excel-, PowerPoint-, Publisher-, Visio- of Word-bestand opent in een getroffen versie van Microsoft Office.

In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een speciaal gemaakt Microsoft Office-bestand naar de gebruiker te verzenden en de gebruiker ertoe te bewegen dat bestand te openen.

In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website waarop zich een speciaal ontworpen Microsoft Office-bestand bevindt waarmee wordt geprobeerd dit beveiligingslek te misbruiken. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Het beveiligingslek vormt het grootste risico voor systemen waarop Excel, PowerPoint, Publisher, Visio en Word worden gebruikt, waaronder inclusief werkstations en terminalservers. Servers zouden eventueel meer gevaar kunnen lopen als beheerders toestaan dat gebruikers zich op servers kunnen aanmelden en programma's kunnen uitvoeren. Dit is echter volkomen in strijd met de aanbevolen richtlijnen voor gebruik.

**Wat doet de update?**  
De update corrigeert de manier waarop Microsoft Office te starten COM-objecten valideert.
...
<td style="border:1px solid black;">Voor Microsoft Office 2003 Service Pack 3:<br />
office2003-kb982311-fullfile-enu /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Excel 2003 Service Pack 3:<br />
office2003-kb982133-fullfile-enu /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office PowerPoint 2003 Service Pack 3:<br />
office2003-kb982157-fullfile-enu /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Publisher 2003 Service Pack 3:<br />
office2003-kb982122-fullfile-enu /q:a</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Visio 2003 Service Pack 3:<br />
office2003-kb982126-fullfile-enu /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Word 2003 Service Pack 3:<br />
...
<td style="border:1px solid black;">Voor Microsoft Office 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982311">Microsoft Knowledge Base-artikel 982311</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Excel 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982133">Microsoft Knowledge Base-artikel 982133</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office PowerPoint 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982157">Microsoft Knowledge Base-artikel 982157</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Publisher 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982122">Microsoft Knowledge Base-artikel 982122</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Visio 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982126">Microsoft Knowledge Base-artikel 982126</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Word 2003 Service Pack 3:<br />
Zie <a href="http://support.microsoft.com/kb/982134">Microsoft Knowledge Base-artikel 982134</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor 2007 Microsoft Office System Service Pack 1 en 2007 Microsoft Office System Service Pack 2:<br />
office2007-kb982312-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Excel 2007 Service Pack 1 en Microsoft Office Excel 2007 Service Pack 2:<br />
excel2007-kb982308-fullfile-x86-glb /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office PowerPoint 2007 Service Pack 1 en Microsoft Office PowerPoint 2007 Service Pack 2:<br />
powerpoint2007-kb982158-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Publisher 2007 Service Pack 1 en Microsoft Office Publisher 2007 Service Pack 2:<br />
publisher2007-kb982124-fullfile-x86-glb /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Visio 2007 Service Pack 1 en Microsoft Office Visio 2007 Service Pack 2:<br />
visio2007-kb982127-fullfile-x86-glb /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Word 2007 Service Pack 1 en Microsoft Office Word 2007 Service Pack 2:<br />
...
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Voor 2007 Microsoft Office System Service Pack 1 en 2007 Microsoft Office System Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/982312">Microsoft Knowledge Base-artikel 982312</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Excel 2007 Service Pack 1 en Microsoft Office Excel 2007 Service Pack 2:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office PowerPoint 2007 Service Pack 1 en Microsoft Office PowerPoint 2007 Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/982158">Microsoft Knowledge Base-artikel 982158</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Publisher 2007 Service Pack 1 en Microsoft Office Publisher 2007 Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/982124">Microsoft Knowledge Base-artikel 982124</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Visio 2007 Service Pack 1 en Microsoft Office Visio 2007 Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/982127">Microsoft Knowledge Base-artikel 982127</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Office Word 2007 Service Pack 1 en Microsoft Office Word 2007 Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/982135">Microsoft Knowledge Base-artikel 982135</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   V1.1 (16 juni 2010): De naam van het updatebestand voor Microsoft Office Word 2007 is gecorrigeerd in de sectie **Implementatie van de beveiligingsupdate**. Er is ook een item toegevoegd aan de sectie Veelgestelde vragen om toe te lichten waarom de update mogelijk wordt aangeboden zelfs als de software waarin dit probleem optreedt, niet aanwezig is op het systeem.
