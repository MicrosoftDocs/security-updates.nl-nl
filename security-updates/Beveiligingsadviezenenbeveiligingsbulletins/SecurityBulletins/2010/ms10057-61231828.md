---
TOCTitle: 'MS10-057'
Title: 'Microsoft-beveiligingsbulletin MS10-057 - Belangrijk'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61231828
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-057(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-057 - Belangrijk
====================================================

Door een beveiligingslek in Microsoft Office Excel kan externe code worden uitgevoerd (2269707)
-----------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 10 augustus 2010 | Bijgewerkt: woensdag 11 augustus 2010
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office 2004 voor Mac en Microsoft Office 2008 voor Mac; en Open XML File Format Converter voor Mac. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2269707](http://support.microsoft.com/kb/2269707) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
Een afzonderlijk Office-programma wordt getroffen met hetzelfde prioriteitsniveau als het bijbehorende onderdeel in een Office-pakket. Bijvoorbeeld: een afzonderlijke installatie van Microsoft Office Excel wordt getroffen met hetzelfde prioriteitsniveau als een installatie van Microsoft Office Excel die onderdeel uitmaakt van een Office-pakket.
...
<th>
Beveiligingslek in Excel met betrekking tot ontregeld geheugen - CVE-2010-2562
</th>
<th>
Prioriteitsniveau
</th>
...
Zie [CVE 2010-2562](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in Excel met betrekking tot ontregeling van geheugen - CVE-2010-2562
...
#### Tijdelijke oplossingen voor het beveiligingslek in Excel met betrekking tot ontregeling van geheugen - CVE-2010-2562
...
-   **Open geen Microsoft Office-bestanden die u van niet-vertrouwde bronnen ontvangt of onverwachts van vertrouwde bronnen ontvangt**
...
#### Veelgestelde vragen over het beveiligingslek in Excel met betrekking tot ontregeling van geheugen - CVE-2010-2562
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2264397">Microsoft Knowledge Base-artikel 2264397</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2264403">Microsoft Knowledge Base-artikel 2264403</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   Damián Frizza van [Core Security Technologies](http://www.coresecurity.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in Excel (CVE-2010-2562)
...
-   V1.1 (11 augustus 2010): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2269707 onder Bekende problemen in de Samenvatting.
