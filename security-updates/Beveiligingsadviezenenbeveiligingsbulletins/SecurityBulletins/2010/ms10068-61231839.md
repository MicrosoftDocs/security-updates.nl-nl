---
TOCTitle: 'MS10-068'
Title: 'Microsoft-beveiligingsbulletin MS10-068 - Belangrijk'
ms:assetid: 'ms10-068'
ms:contentKeyID: 61231839
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-068(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-068 - Belangrijk
====================================================

Beveiligingslek in Local Security Authority Subsystem Service kan leiden tot misbruik van bevoegdheden (983539)
---------------------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1452befe-b7b8-4131-b36f-dded2bd16d5e">Active Directory en Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=38eb875f-1869-401b-b7d3-9f18f4ba4f24">Active Directory en Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54f36389-8be4-4a0c-9640-dc32addac9d7">Active Directory en Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
| Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2<sup>[1]</sup> |  
| Windows Server 2008 R2 voor Itanium-systemen<sup>[1]</sup>                                                        |
...
<th style="border:1px solid black;" >
Beveiligingslek in LSASS met betrekking tot heap-overloop – CVE-2010-0820  
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau  
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot geverifieerd misbruik van bevoegdheden in Microsoft Windows door de manier waarop de Local Security Authority Subsystem Service (LSASS) bepaalde LDAP-berichten (Lightweight Directory Access Protocol) verwerkt. Het beveiligingslek komt voor in installaties van Active Directory, Active Directory Application Mode (ADAM) en Active Directory Lightweight Directory Service (AD LDS). Een aanvaller moet zich eerder hebben geverifieerd bij de LSASS-server voordat misbruik kan worden gemaakt van het beveiligingslek. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

Zie [CVE 2010-0820](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in LSASS met betrekking tot heap-overloop - CVE-2010-0820
...
-   Om misbruik te kunnen maken van dit beveiligingslek, moet een aanvaller een account in het aangevallen Windows-domein hebben. Het werkstation van de aanvaller hoeft echter niet te zijn verbonden met het Windows-domein.

#### Tijdelijke oplossingen voor het beveiligingslek in LSASS met betrekking tot heap-overloop - CVE-2010-0820

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **TCP-poort 389 blokkeren op de firewall**

    Blokkeer TCP-poort 389 op de firewall. Deze poort wordt gebruikt om een verbinding tot stand te brengen met het onderdeel waarin dit probleem optreedt.
...
#### Veelgestelde vragen over het beveiligingslek in LSASS met betrekking tot heap-overloop - CVE-2010-0820

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek bestaat doordat de Windows LSASS-installatie specifieke verkeerd ingedeelde pakketten in LDAP-berichten niet goed verwerkt.
...
Een aanvaller kan misbruik maken van dit beveiligingslek door speciaal vervaardigde LDAP-berichten te verzenden naar een verbonden LSASS-server. Een aanvaller moet zich eerder hebben geverifieerd bij de LSASS-server voordat misbruik kan worden gemaakt van het beveiligingslek.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Alle systemen met een besturingssysteem waarin dit probleem voorkomt en waarop Active Directory-services zijn geïnstalleerd, worden getroffen door dit beveiligingslek. Clientsystemen worden niet rechtstreeks getroffen door dit beveiligingslek.

**Wat doet de update?**  
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop LSASS bepaalde LDAP-berichten verwerkt.
...
| Windows Vista Service Pack 2                                                                          | Nee     | Nee               | Ja                | Ja                         |
| Windows Vista x64 Edition Service Pack 2                                                              | Nee     | Nee               | Ja                | Ja                         |
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982000">Microsoft Knowledge Base-artikel 982000</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik voor Active Directory het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB981550$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Gebruik voor Active Directory Application Mode (ADAM) het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/981550">Microsoft Knowledge Base-artikel 981550</a> voor Active Directory op Windows Server 2003</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982000">Microsoft Knowledge Base-artikel 982000</a> voor Active Directory Application Mode (ADAM) op Windows Server 2003</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/981550">Microsoft Knowledge Base-artikel 981550</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
