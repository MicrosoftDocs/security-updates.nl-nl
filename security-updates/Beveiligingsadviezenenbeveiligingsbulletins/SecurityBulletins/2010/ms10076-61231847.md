---
TOCTitle: 'MS10-076'
Title: 'Microsoft-beveiligingsbulletin MS10-076 - Kritiek'
ms:assetid: 'ms10-076'
ms:contentKeyID: 61231847
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-076(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-076 - Kritiek
=================================================

Door een beveiligingslek in de engine voor Embedded OpenType-lettertypen kan externe code worden uitgevoerd (982132)
--------------------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop de engine voor Embedded OpenType-lettertypen bestanden en content met ingesloten lettertypen parseert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c3799399-ca72-4dec-a2a2-3571ad0b2f63)                                                                                    | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=860ff738-205d-430e-b223-b333813fc590)                                                           | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b240b65-f3ca-465c-a606-b561999c1977)                                                                           | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70c9e826-b80b-4a20-82d2-8e52e5cca839)                                                               | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=bd5878bb-f565-4303-afed-4e17b44a02f2)                                                            | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29c4afb1-227d-4572-b136-a78ef7e1df77)                                                 | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=880ad9a0-6ddd-41f4-a608-171d59a31b6a)                         | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor het 32-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50386655-982e-4126-8261-2c972d695bbd)\*\* | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor het 64-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6b2ae1d-9225-4495-8560-97860f87d7b4)\*\*     | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a4e38a77-3835-47b3-bd86-6c039169abf5)        | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=f6cae091-e9f1-48e9-a035-4346b9c6fec6)                                                                              | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=35882477-4e0a-4783-a4b4-0f1ea3398360)                                                                                  | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=b060c516-233a-4e1e-9237-698420e97b2f)\*\*                                                                 | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=0ead2ed9-8b2f-496e-b7d1-3ad2b04be5cc)                                                                 | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop - CVE-2010-1883</th>
...
Beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop - CVE-2010-1883  
---------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop de Embedded OpenType-lettertypetechnologie (EOT) van Microsoft Windows bepaalde tabellen in speciaal ontworpen ingesloten lettertypen parseert. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2010-1883](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1883) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop - CVE-2010-1883
...
#### Tijdelijke oplossingen voor het beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop - CVE-2010-1883
...
-   **Ondersteuning voor het parseren van ingesloten lettertypen in Internet Explorer uitschakelen**
    ...
    **De interactieve methode gebruiken:**
    ...
    1.  Klik in Internet Explorer op het menu **Extra** en vervolgens op **Internetopties**.  
    2.  Klik in **Internetopties** op het tabblad **Beveiliging**, selecteer de **zone Internet** en klik op **Aangepast niveau…**  
    3.  Blader in **Beveiligingsinstellingen - Zone Internet** omlaag naar **Gedownloade elementen** in het deelvenster **Instellingen** en selecteer voor **Lettertype downloaden** de instellingen **Vragen** of **Uitschakelen**.  
    4.  Klik op **OK** om uw selectie op te slaan, en klik nogmaals op **OK** om naar Internet Explorer terug te keren.
  
    **Groepsbeleid gebruiken:**
  
    **Opmerking** De MMC-module voor Groepsbeleid kan worden gebruikt om een beleid in te stellen voor een systeem, voor een organisatie-eenheid of voor een volledig domein. Ga naar de volgende websites van Microsoft voor meer informatie over Groepsbeleid:
  
    -   Verzameling [groepsbeleid](http://technet2.microsoft.com/windowsserver/en/library/6d7cb788-b31d-4d17-9f1e-b5ddaa6deecd1033.mspx?mfr=true)sregels  
    -   [Wat](http://technet2.microsoft.com/windowsserver/en/library/47ba1311-6cca-414f-98c9-2d7f99fca8a31033.mspx?mfr=true)is een Groepsbeleidsobjecteditor?  
    ...
    Ga als volgt te werk om Groepsbeleid te gebruiken:
  
    1.  Open de GPMC (Group Policy Management Console) en stel deze in voor het juiste groepsbeleidsobject (lokale computer, organisatie-eenheid of domein).  
    2.  Klik op **Gebruikersconfiguratie** en klik achtereenvolgens op **Windows-instellingen**, **Internet Explorer-onderhoud** en **Beveiliging**.  
    3.  Dubbelklik op **Beveiligingszones en inhoudsrestricties**, selecteer **Huidige instellingen voor beveiligingszones en privacy importeren** en klik op **Instellingen wijzigen**.
  
    **Opmerking** Hiermee maakt u een groepsbeleid voor Internet Explorer op basis van de instellingen van de gebruiker die op dat moment is aangemeld en opent u Eigenschappen voor Internet.
  
    1.  Klik in Eigenschappen voor Internet op het tabblad **Beveiliging**, zorg dat de zone **Internet** is geselecteerd en klik op **Aangepast niveau**…  
    2.  Blader in **Beveiligingsinstellingen - Zone Internet** omlaag naar **Gedownloade elementen** in het deelvenster **Instellingen** en selecteer voor **Lettertype downloaden** de instellingen **Vragen** of **Uitschakelen**.  
    3.  Klik **OK** om terug te gaan naar **Eigenschappen voor Internet**.  
    4.  Herhaal stap 4-6 voor de zone **Lokaal intranet**.  
    5.  Klik drie keer op **OK** om terug te keren naar de Console Groepsbeleidsbeheer.  
    6.  Vernieuw het groepsbeleid voor alle systemen of wacht tot de nieuwe instellingen van kracht gaan bij het volgende geplande vernieuwingsinterval van het groepsbeleid.
  
    **Een script voor beheerde implementatie gebruiken:**
  
    U kunt deze beveiligingsinstelling handmatig in het register invoeren door een registerscript te maken en het te importeren door erop te dubbelklikken of door regedit.exe uit te voeren als onderdeel van een aanmeldings- of computeropstartscript. Voor beheerde implementaties kan regedit.exe worden gebruikt om een registerscript stil te importeren met de schakeloptie -s. Zie Microsoft Knowledge Base-artikel 82821, 'Registration Info Editor (REGEDIT) Command-Line Switches', voor meer informatie over regedit-opdrachtregelschakelopties.
    ...
    **Waarschuwing** Als u de Register-editor onjuist gebruikt, kan dit tot zeer ernstige problemen leiden waardoor u het besturingssysteem mogelijk opnieuw dient te installeren. Microsoft kan niet garanderen dat problemen die ontstaan als gevolg van een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico.
    ...
    Plak de volgende tekst in een .reg-bestand en importeer het .reg-bestand op beheerde systemen als onderdeel van het proces voor beheerde implementatie van uw organisatie om deze instelling in te stellen op 'Vragen' voor de zones Internet en Lokaal intranet:
  
    `Windows Registry Editor Version 5.00; Zone 1 is de zone lokaal intranet; 1604 is het downloadbeleid voor lettertypen; dword:00000001 stelt het beleid in op vragen[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1]"1604"=dword:00000001; Zone 3 is de zone Internet[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3]"1604"=dword:00000001`
  
    Plak de volgende tekst in een .reg-bestand en importeer het .reg-bestand op beheerde systemen als onderdeel van het proces voor beheerde implementatie van uw organisatie om deze instelling in te stellen op 'Uitschakelen' voor de zones Internet en Lokaal intranet:
  
    `Windows Registry Editor Version 5.00; Zone 1 is de zone lokaal intranet; 1604 is het downloadbeleid voor lettertypen; dword:00000003 stelt het beleid in op uitschakelen[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1]"1604"=dword:00000003; Zone 3 is de zone internet[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3]"1604"=dword:00000003`
...
#### Veelgestelde vragen over het beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop - CVE-2010-1883
...
Het beveiligingslek wordt veroorzaakt door een integeroverloop wanneer de Microsoft Windows-engine voor Embedded OpenType-lettertypen bepaalde tabellen in speciaal ontworpen bestanden en content met ingesloten lettertypen parseert.
...
Voor dit beveiligingslek moet een gebruiker inhoud weergeven waarin een speciaal vervaardigd EOT-lettertype is ingesloten.
  
In een aanval via e-mail kan een aanvaller misbruik maken van het beveiligingslek door een e-mailbericht te verzenden met als bijlage een Microsoft Word- of PowerPoint-bestand met daarin een speciaal ontworpen EOT-lettertype, en de gebruiker over te halen het bestand te openen of er een voorbeeld van te bekijken.
...
**Wat doet de update?**    
De update lost het probleem op door de manier te verbeteren waarop de engine voor Embedded OpenType-lettertypen bestanden en content met ingesloten lettertypen parseert.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982132$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982132">Microsoft Knowledge Base-artikel 982132</a></td>
</tr>
<tr class="even">
...
-   Sebastian Apelt in samenwerking met [Tipping Point](http://www.tippingpoint.com) en het [Zero Day Initiative](http://www.zerodayinitiative.com/) voor het melden van het beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop (CVE-2010-1883)  
-   Ivan Fratric voor het melden via het [iSIGHT Partners Global Vulnerability Partnership](https://gvp.isightpartners.com), van het beveiligingslek in Embedded OpenType-lettertypen met betrekking tot integeroverloop (CVE-2010-1883)
