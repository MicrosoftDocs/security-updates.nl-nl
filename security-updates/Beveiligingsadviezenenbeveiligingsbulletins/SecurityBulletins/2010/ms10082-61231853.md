---
TOCTitle: 'MS10-082'
Title: 'Microsoft-beveiligingsbulletin MS10-082 - Belangrijk'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61231853
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-082(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-082 - Belangrijk
====================================================

Door een beveiligingslek in Windows Media Player kan externe code worden uitgevoerd (2378111)
---------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor Windows Media Player 9 Series, Windows Media Player 10, Windows Media Player 11 en Windows Media Player 12 indien geïnstalleerd op ondersteunde versies van Microsoft Windows behalve Windows Server 2008 en Windows Server 2008 R2 geschat. Voor Windows Media Player 11 en Windows Media Player 12 indien geïnstalleerd op ondersteunde edities van Windows Server 2008 en Windows Server 2008 R2 is het prioriteitsniveau van deze beveiligingsupdate Gemiddeld. Ondersteunde Itanium-edities van Windows Server 2003, Windows Server 2008 en Windows Server 2008 R2 worden niet getroffen door door het beveiligingslek. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De update lost het beveiligingslek op door de manier te corrigeren waarop Windows Media Player de toewijzing van objecten ongedaan maakt wanneer ze opnieuw worden geladen. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=0663e0e8-c5d1-4cd2-b6d3-ff78fb56bba1">Windows Media Player 11</a></td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
...
<th style="border:1px solid black;" >
Beveiligingslek in Windows Media Player met betrekking tot ontregeld geheugen - CVE-2010-2745  
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau  
</th>
...
Windows Media Player 9 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
...
<td style="border:1px solid black;">
Windows Media Player 10 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 10 op Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 10 op Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 10 op Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 op Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 op Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Matig**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 op Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Matig**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 12 op Windows 7 voor 32-bits systemen
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 12 op Windows 7 voor x64-systemen
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 12 op Windows Server 2008 R2 voor x64-systemen\*\*
</td>
<td style="border:1px solid black;">
**Matig**   
Uitvoering van externe code mogelijk
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop in Windows Media Player de toewijzing van objecten ongedaan wordt gemaakt wanneer ze opnieuw worden geladen via een webbrowser. Door dit beveiligingslek kan code worden uitgevoerd als een gebruiker een speciaal vervaardigde webpagina bezoekt. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE-2010-2745](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in Windows Media Player met betrekking tot ontregeld geheugen - CVE-2010-2745
...
-   Ondersteunde edities van Windows Server 2008 en Windows Server 2008 R2 worden niet getroffen door dit probleem, tenzij de functie Desktop Experience is geïnstalleerd. Standaard wordt het getroffen onderdeel van Windows Media Player niet geladen op deze platformen. Raadpleeg het TechNet-artikel [Desktop Experience Overview](http://technet.microsoft.com/en-us/library/cc772567.aspx) voor meer informatie over de Bureaubladervaring.

#### Tijdelijke oplossingen voor het beveiligingslek in Windows Media Player met betrekking tot ontregeld geheugen - CVE-2010-2745

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **De registratie van wmp.dll ongedaan maken**

    Voer de volgende opdrachten uit vanaf een opdrachtprompt met verhoogde bevoegdheden om de registratie van deze DLL ongedaan te maken.
    ...
    **Gevolgen van de tijdelijke oplossing.** Windows Media Player zal ondersteunde bestandsindelingen niet kunnen afspelen.
...
#### Veelgestelde vragen over het beveiligingslek in Windows Media Player met betrekking tot ontregeld geheugen - CVE-2010-2745
...
De Windows Media Player maakt de toewijzing van objecten op onjuiste wijze ongedaan wanneer deze via een webbrowser opnieuw worden geladen.
...
Raadpleeg [Microsoft Knowledge Base-artikel 190990](http://support.microsoft.com/kb/190990) als u wilt weten hoe u bepaalt welke versie van Windows Media Player op uw systeem is geïnstalleerd.

**Is interactie met de gebruiker vereist om misbruik te maken van dit beveiligingslek?**  
Ja. Een aanval kan alleen slagen als een gebruiker door een of meer pop-upvensters klikt wanneer hij of zij naar een webpagina surft. Dit beveiligingslek kan niet automatisch worden misbruikt door een speciaal vervaardigde webpagina te bezoeken.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**  
Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**  
Een aanvaller kan over een website beschikken die speciaal is ontworpen om via Windows Media Player misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen deze website te bekijken. Het misbruik slaagt bovendien pas nadat de gebruiker door een of meer pop-upvensters heeft geklikt. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet hen er dus toe overhalen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door hen ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een chatbericht te klikken waarmee zij naar de website van de aanvaller gaan.
...
**Wat doet de update?**  
De update lost het probleem op door de manier te corrigeren waarop Windows Media Player de toewijzing van objecten ongedaan maakt wanneer ze opnieuw worden geladen.
...
<td style="border:1px solid black;">Voor Windows Media Player 9, Windows Media Player 10 en Windows Media Player 11 op Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows Media Player 10 op Windows XP Professional x64 Edition Service Pack 2:<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows Media Player 11 op Windows XP Professional x64 Edition Service Pack 2:<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installeren zonder opnieuw op te starten</td>
<td style="border:1px solid black;">Voor Windows Media Player 9 op Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows Media Player 10 en Windows Media Player 11 op Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<br />
Voor Windows Media Player 9, Windows Media Player 10 en Windows Media Player 11 op Windows XP Service Pack 3:<br />
%Windir%\$NTUninstallKB2378111_WM9$\Spuninst folder<br />
<br />
Voor Windows Media Player 10 op Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB2378111$\Spuninst folder<br />
<br />
Voor Windows Media Player 11 op Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst folder</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2378111">Microsoft Knowledge Base-artikel 2378111</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Voor Windows Media Player 9, Media Player 10 en Windows Media Player 11 op ondersteunde 32-bits edities van Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows Media Player 10 op alle ondersteunde x64-edities van Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2378111$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2378111">Microsoft Knowledge Base-artikel 2378111</a></td>
...
-   SkyLined van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek in Windows Media Player met betrekking tot ontregeld geheugen (CVE-2010-2745)
...
-   V1.1 (13 oktober 2010): De downloadkoppeling in de tabel met **software waarin dit probleem optreedt** is gecorrigeerd voor Windows Media Player 11 op Windows XP Professional x64 Edition Service Pack 2. Klanten die dit specifieke pakket hebben geïnstalleerd met Automatische updates, hoeven geen actie te ondernemen. Klanten die het pakket handmatig hebben geïnstalleerd vanaf het Microsoft Downloadcentrum, moeten dit nieuwe pakket handmatig installeren.
