---
TOCTitle: 'MS10-083'
Title: 'Microsoft-beveiligingsbulletin MS10-083 - Belangrijk'
ms:assetid: 'ms10-083'
ms:contentKeyID: 61231854
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-083(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-083 - Belangrijk
====================================================

Door een beveiligingslek in COM-validatie in Windows-shell en WordPad kan externe code worden uitgevoerd (2405882)
------------------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 12 oktober 2010 | Bijgewerkt: dinsdag 14 december 2010
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2405882](http://support.microsoft.com/kb/2405882) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen met Service Pack](http://www.microsoft.com/downloads/details.aspx?familyid=fd507e7a-4516-474b-8f33-7fa8fd2afa6d) 2\*\*<sup>[1]</sup>
(KB979687)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen met Service Pack](http://www.microsoft.com/downloads/details.aspx?familyid=4a8c2358-36ea-4757-abfc-5bffcad0a872) 2\*\*<sup>[1]</sup>
(KB979688)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
...
<sup>[1]</sup>Indien zowel het beveiligingsupdatepakketten voor WordPad (KB979687) als dat voor de Windows-shell (KB979688) voor hetzelfde besturingssysteem beschikbaar is, moeten klanten beide installeren om zich te beschermen tegen de beveiligingslekken die in dit bulletin zijn beschreven.

Veelgestelde vragen met betrekking tot deze beveiligingsupdate
--------------------------------------------------------------

<span></span>
**Waarom is dit bulletin op 14 december 2010 opnieuw uitgebracht?**  
Microsoft heeft dit bulletin opnieuw uitgebracht om een aanvullende update aan te bieden voor Windows Vista Service Pack 2 (KB979688) voor gebruikers die Windows Search 4.0 op Windows Vista Service Pack 1 hebben geïnstalleerd, vervolgens de beveiligingsupdate van [Microsoft Knowledge Base-artikel 2405882](http://support.microsoft.com/kb/2405882) hebben geïnstalleerd en toen zijn gemigreerd naar Windows Vista Service Pack 2. Klanten in dit scenario moeten de nieuwe update van [Microsoft Knowledge Base-artikel 2405882](http://support.microsoft.com/kb/2405882) installeren om beschermd te zijn tegen de beveiligingslekken die in dit bulletin worden beschreven. Klanten in dit scenario die Automatische updates hebben ingeschakeld, krijgen deze update aangeboden. Zie [Microsoft Knowledge Base-artikel 2405882](http://support.microsoft.com/kb/2405882) voor meer informatie.
...
Deze update bevat functionaliteitswijzigingen die geen betrekking hebben op beveiliging. Zie [Microsoft Knowledge Base-artikel 2252664](http://support.microsoft.com/kb/2252664) voor meer informatie.

Naast de wijzigingen die in het gedeelte **Informatie over het beveiligingslek** van dit bulletin worden beschreven, bevat deze update ook een ingrijpende wijziging. Deze update bevat een beperkende factor die helpt te voorkomen dat onderdelen en besturingselementen die zijn gebouwd met kwetsbare versies van ATL worden misbruikt in de Microsoft Windows-producten die worden genoemd in de sectie met informatie over het beveiligingslek in dit bulletin. De nieuwe ingrijpende beschermingsmaatregelen in deze update beschermen tegen misbruik van alle openbaar en privé bekende ATL-beveiligingslekken.

De beperking lost de beveiligingslekken in de ATL die worden beschreven in [Microsoft-beveiligingsadvies (973882)](http://technet.microsoft.com/security/advisory/973882) en [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) op. De wijziging is standaard ingeschakeld voor alle platforms waarin dit probleem optreedt en helpt beveiligingslekken in de ATL te blokkeren voor besturingselementen die worden geladen in Microsoft Windows, waaronder ook besturingselementen die niet door Microsoft zijn ontwikkeld.
...
<th>
Beveiligingslek met betrekking tot COM-validatie - CVE-2010-1263
</th>
<th>
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek waardoor externe code kan worden uitgevoerd als gevolg van de manier waarop de Windows-shell en WordPad het starten van COM-objecten valideren. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-1263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot COM-validatie - CVE-2010-1263

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
-   Het beveiligingslek kan niet automatisch via e-mail worden misbruikt. Aanvallen via e-mail lukken alleen als een gebruiker een bijlage opent die in een e-mailbericht is verzonden. De gebruiker wordt gevraagd het bestand te openen, tenzij de gebruiker eerder de optie "Altijd waarschuwen voordat bestanden van dit type worden geopend" heeft uitgeschakeld.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot COM-validatie - CVE-2010-1263

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Gebruik niet WordPad om documenten van niet-vertrouwde bronnen te openen**

    Gebruik WordPad niet om documenten te openen die u van niet-vertrouwde bronnen ontvangt of die u onverwachts van vertrouwde bronnen ontvangt. Dit beveiligingslek kan worden misbruikt wanneer een gebruiker een speciaal gemaakt bestand opent.

#### Veelgestelde vragen over het beveiligingslek met betrekking tot COM-validatie - CVE-2010-1263
...
Windows-shell en WordPad valideren COM-objecten niet nauwkeurig wanneer ze worden gestart.

**Wat is COM?**  
Microsoft COM-technologie (Onderdeel Object Model) in het Microsoft Windows-besturingssysteem zorgt dat softwareonderdelen met elkaar kunnen communiceren. COM wordt door ontwikkelaars gebruikt om herbruikbare softwareonderdelen te maken, onderdelen aan elkaar te koppelen om nieuwe toepassingen te maken, en Windows-services te gebruiken. Zie het Microsoft-artikel [What is COM?](http://www.microsoft.com/com/default.mspx) voor meer informatie over COM.
...
**Wat is WordPad?**  
WordPad is een basistekstverwerker die is opgenomen in Microsoft Windows. Een tekstverwerker is een computerprogramma waarmee u tekstdocumenten kunt maken, bewerken, weergeven en afdrukken. Met WordPad kunt u brieven, rapporten en andere eenvoudige documenten typen. U kunt tekst opmaken, snel zinnen en alinea's verplaatsen en tekst in en tussen documenten kopiëren en plakken. Zie [WordPad gebruiken](http://windows.microsoft.com/en-us/windows-vista/using-wordpad) voor meer informatie over WordPad.
...
Voor de WordPad-aanvalsvector is het noodzakelijk dat een gebruiker een speciaal vervaardigd WordPad-bestand opent in een getroffen versie van Microsoft Windows.

In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een speciaal vervaardigd WordPad-bestand naar de gebruiker te verzenden en de gebruiker ertoe te bewegen dat bestand te openen.

In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website waarop zich een speciaal ontworpen WordPad-bestand bevindt waarmee wordt geprobeerd dit beveiligingslek te misbruiken. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat.

De Windows-shell aanvalsvector gebruikt zoekmogelijkheden. Hiervoor is het noodzakelijk dat een gebruiker een snelkoppelingsbestand opent of selecteer dat zich op een netwerk of een WebDAV-share bevindt. Een aanvaller kan een gebruiker niet dwingen om naar een speciaal vervaardigde WebDAV- of netwerkshare te gaan. De aanvaller moet een gebruiker er dus van overtuigen de share te bezoeken. In de meeste gevallen gebeurt dit door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Alle besturingssystemen in het overzicht met software waarin dit probleem optreedt, lopen risico. Servers zouden eventueel meer gevaar kunnen lopen als beheerders toestaan dat gebruikers zich op servers kunnen aanmelden en programma's kunnen uitvoeren. Dit is echter volkomen in strijd met de aanbevolen richtlijnen voor gebruik.

**Wat doet de update?**  
De update verbetert de manier waarop de Windows-shell en WordPad het starten van COM-objecten valideren.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB979687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/979687">Microsoft Knowledge Base-artikel 979687</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde 32-bits edities van Windows Vista:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 32-bits edities van Windows Vista:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde x64-edities van Windows Vista:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 64-bits edities van Windows Vista:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Raadpleeg voor WordPad <a href="http://support.microsoft.com/kb/979687">Microsoft Knowledge Base-artikel 979687</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Raadpleeg voor Windows-shell <a href="http://support.microsoft.com/kb/979688">Microsoft Knowledge Base-artikel 979688</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde 32-bits versies van Windows Server 2008:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 32-bits edities van Windows Server 2008:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde x64-versies van Windows Server 2008:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 64-bits edities van Windows Server 2008:<br />
Windows6.0-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde Itanium-versies van Windows Server 2008:<br />
Windows6.0-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde Itanium-edities van Windows Server 2008:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde 32-bits edities van Windows 7:<br />
Windows6.1-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 32-bits edities van Windows 7:<br />
Windows6.1-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde x64-edities van Windows 7:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 64-bits edities van Windows 7:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde x64-versies van Windows Server 2008 R2:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde 64-bits edities van Windows Server 2008 R2:<br />
Windows6.1-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor WordPad op alle ondersteunde Itanium-versies van Windows Server 2008 R2:<br />
Windows6.1-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows-shell op alle ondersteunde Itanium-edities van Windows Server 2008 R2:<br />
...
-   HD Moore van [Rapid7](http://www.rapid7.com/) voor het melden van het beveiligingslek met betrekking tot COM (CVE-2010-1263)  
-   David Dewey van [IBM ISS X-Force](http://www.iss.net/) en Ryan Smith van [Accuvant](http://www.accuvant.com/), voorheen van [VeriSign iDefense Labs](http://labs.idefense.com/), voor hun samenwerking aan de ingrijpende wijzigingen in dit bulletin.
...
-   V2.0 (14 december 2010): Er is een veelgestelde vraag over de update toegevoegd om aan te geven dat er een aanvullende update is voor Windows Vista Service Pack 2 (KB979688) voor gebruikers die Windows Search 4.0 op Windows Vista Service Pack 1 hebben geïnstalleerd, vervolgens de beveiligingsupdate van KB2405882 hebben geïnstalleerd en toen zijn gemigreerd naar Windows Vista Service Pack 2. Klanten in dit scenario moeten de nieuwe update van KB2405882 installeren om beschermd te zijn tegen de beveiligingslekken die in dit bulletin worden beschreven.
