---
TOCTitle: 'MS10-090'
Title: 'Microsoft-beveiligingsbulletin MS10-090 - Kritiek'
ms:assetid: 'ms10-090'
ms:contentKeyID: 61231861
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-090(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-090 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (2416400)
---------------------------------------------------------------

Gepubliceerd: dinsdag 14 december 2010 | Bijgewerkt: dinsdag 4 januari 2011
...
De beveiligingsupdate lost de beveiligingslekken op doordat de manier wordt gewijzigd waarop Internet Explorer objecten in het geheugen en script tijdens bepaalde processen verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 2458511](http://technet.microsoft.com/security/advisory/2458511).
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2416400](http://support.microsoft.com/kb/2416400) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<span></span>
**Waarom is dit beveiligingsbulletin bijgewerkt op 4 januari 2011?**  
Microsoft heeft in dit bulletin wijzigingen aangebracht om een detectiewijziging aan te kondigen waarmee kan worden gecontroleerd of eerder uitgegeven cumulatieve updates voor Internet Explorer correct worden aangeboden in de volgorde waarin ze zijn vrijgegeven. Dit is slechts een detectie-update. De bestanden van de beveiligingsupdate zijn niet gewijzigd. Klanten die update al hebben geïnstalleerd, hoeven deze update niet opnieuw te installeren.
...
**Wordt Internet Explorer 9 Beta getroffen door deze beveiligingslekken?**  
Nee. Internet Explorer 9 Beta wordt niet getroffen door de beveiligingslekken die in dit bulletin word beschreven.

**Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging?**  
Deze update bevat een ingrijpende beveiligingsupdate om te helpen interdomeinbeveiliging in Internet Explorer te verbeteren.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen door HTML-objecten – CVE-2010-3340
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3342
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen door HTML-objecten – CVE-2010-3343
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen – CVE-2010-3345
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen – CVE-2010-3346
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3348
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen – CVE-2010-3962
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
Zie [CVE-2010-3340](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3340) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3340
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3340
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3340
...
Zie [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3342
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3342
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3342
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342) toegewezen.
...
Zie [CVE-2010-3343](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3343) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3343
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3343

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **LMClassFactory uitschakelen**

    Verwijder de Liquid Motion Class-sleutel uit het register.
    ...
    **Waarschuwing** Als u de Register-editor onjuist gebruikt, kan dit tot zeer ernstige problemen leiden waardoor u het besturingssysteem mogelijk opnieuw dient te installeren. Microsoft kan niet garanderen dat problemen die ontstaan als gevolg van een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico.
    ...
    1.  Maak met de volgende opdracht op een verhoogde opdrachtregel een back-up van de registersleutels:
        `Regedit.exe /e Disable_LM_Factory_backup.reg HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}`
    2.  Plak de volgende tekst in een teksteditor, bijvoorbeeld Kladblok. Sla het bestand vervolgens op met de extensie .reg, bijvoorbeeld Disable\_LM\_Factory.reg:
        `Windows Registry-editor versie 5.00`
        `[-HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}]`
    3.  Voer met de volgende opdracht vanaf een verhoogde opdrachtregel het bestand Disable\_LM\_Factory.reg uit:
        `Regedit.exe /s Disable_LM_Factory.reg `

    **Gevolgen van de tijdelijke oplossing**. Functionaliteiten die gebruikmaken van Liquid Motion worden geblokkeerd. Zie [Microsoft Knowledge Base-artikel 257557](http://support.microsoft.com/kb/257557) voor meer informatie over Liquid Motion.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van het geheugen door HTML-objecten - CVE-2010-3343
...
Zie [CVE-2010-3345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3345) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3345
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3345
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3345
...
Zie [CVE-2010-3346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3346
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3346
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen - CVE-2010-3346
...
Zie [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3348
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3348
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens - CVE-2010-3348
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348) toegewezen.
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer objecten opent die niet goed zijn geïnitialiseerd of zijn verwijderd. Een aanvaller kan misbruik maken van dit beveiligingslek door de gebruiker over te halen om een schadelijk Word-document te openen. Wanneer een gebruiker het Word-document sluit, kan het beveiligingslek de uitvoering van externe code mogelijk maken. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

Zie [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-3962

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Preventie van gegevensuitvoering (DEP) helpt bij bescherming tegen aanvallen waardoor code kan worden uitgevoerd. DEP is standaard ingeschakeld in Internet Explorer 8 op de volgende Windows-besturingssystemen: Windows XP Service Pack 3, Windows Vista Service Pack 1, Windows Vista Service Pack 2 en Windows 7.
-   In het geval van een aanval vanaf het web kan de aanvaller beschikken over een website waarop zich een webpagina bevindt waarmee dit beveiligingslek wordt misbruikt. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens of advertenties staan of gegevens of advertenties kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan echter een gebruiker er niet toe dwingen om naar deze websites te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller gaat.
-   Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-3962

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **De CSS-stijl van de website vervangen door een door de gebruiker gedefinieerd opmaakmodel**

    Als u een aangepast trapsgewijs opmaakmodel (CSS) wilt toepassen voor het opmaken van documenten die in Internet Explorer zijn geladen, slaat u de volgende tekst op in een bestand met de extensie .CSS, zoals KB2458511.CSS:
    TABLE
    {
        POSI\\TION: relative !important;
    }

    **Opmerking** De "\\" tussen "POSI" en "TION" is als zodanig bedoeld.

    **Gevolgen van de tijdelijke oplossing.** Het toepassen van een door de gebruiker gedefinieerde CSS kan ertoe leiden dat opmaakmodellen van een website niet meer werken. Als u deze tijdelijke oplossing eerder hebt toegepast, moet u de tijdelijke oplossing ongedaan maken voordat u deze beveiligingsupdate toepast. Gebruik de automatische **Microsoft Fix it-oplossing** in [Microsoft Knowledge Base-artikel 2458511](http://support.microsoft.com/kb/2458511) om deze tijdelijke oplossing ongedaan te maken.

    **Ga als volgt te werk om de wijziging interactief toe te passen**

    1.  Klik in Internet Explorer op het menu **Extra** en kies **Internetopties**.
    2.  Klik op het tabblad **Algemeen** op de knop **Toegankelijkheid**.
    3.  Selecteer **Documenten met mijn opmaakmodel opmaken**, klik op **Bladeren** en blader naar de locatie van het bovengenoemde bestand en selecteer het bestand.
    4.  Klik op **Openen**, klik tweemaal op **OK** en start Internet Explorer opnieuw op.

    **De tijdelijke oplossing ongedaan maken.** Herhaal deze stappen, behalve stap 3, en schakel het selectievakje **Documenten met mijn opmaakmodel opmaken** uit.

    **De wijziging toepassen met de Register-editor**

    **Waarschuwing** Als u de Register-editor onjuist gebruikt, kan dit tot zeer ernstige problemen leiden waardoor u het besturingssysteem mogelijk opnieuw dient te installeren. Microsoft kan niet garanderen dat problemen die ontstaan als gevolg van een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico.

    1.  Maak met de volgende opdracht op een verhoogde opdrachtregel een back-up van de registersleutels:
        regedit /e CSS-backup.reg "HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles"
        Als geen CSS-backup.reg is gemaakt, betekent dit dat er geen door de gebruiker gedefinieerde CSS is.
    2.  Sla vervolgens het volgende op in een bestand met de extensie .REG, bijvoorbeeld Apply\_user\_CSS.reg:
        Windows Registry-editor versie 5.00
        ...
        **Opmerking** De \[directorylocatie\] moet overeenkomen met de locatie van het bestand KB2458511.css op het lokale systeem.
    3.  Voer daarna Apply\_user\_CSS.reg uit om de instelling toe te passen.

    **De tijdelijke oplossing ongedaan maken.** Als een vorige door de gebruiker gedefinieerde CSS bestaat, gebruikt u het bestand CSS-backup.reg om de vorige instelling te herstellen. Als dat niet het geval is, slaat u het volgende op in een bestand met de extensie .REG, bijvoorbeeld Remove\_user\_CSS.reg:
    Windows Registry-editor versie 5.00
    \[-HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles\]

    Voer vervolgens met de volgende opdracht vanaf een opdrachtprompt met verhoogde bevoegdheden het bestand Remove\_user\_CSS.reg uit:
    Regedit.exe /s Remove\_user\_CSS.reg

    **Ga als volgt te werk om de wijziging toe te passen met de automatische Microsoft Fix it-oplossing**

    Zie [Microsoft Knowledge Base-artikel 2458511](http://support.microsoft.com/kb/2458511) als u de automatische **Microsoft Fix it**-oplossing wilt gebruiken om deze tijdelijke oplossing in of uit te schakelen.

-   **Preventie van gegevensuitvoering (DEP) inschakelen voor Internet Explorer 7**

    Lokale **beheerders** kunnen DEP/NX instellen door Internet Explorer uit te voeren als beheerder. Gebruik een van de volgende methoden om DEP in te schakelen:
    ...
    **Gevolgen van de tijdelijke oplossing.** Sommige browserextensies zijn mogelijk niet compatibel met DEP en kunnen onverwacht worden afgesloten.

    **De tijdelijke oplossing ongedaan maken.** Als dit gebeurt, kunt u de extensie uitschakelen of de DEP-instelling wijzigen in het onderdeel Internetopties van het Configuratiescherm. De instelling is ook toegankelijk via het onderdeel Systeem van het Configuratiescherm.
    ...
    **De tijdelijke oplossing ongedaan maken.** Als dit gebeurt, kunt u de invoegtoepassing uitschakelen of de DEP-instelling terugzetten met de automatische Fix it-oplossing om de tijdelijke oplossing ongedaan te maken.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2010-3962
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 2458511](http://technet.microsoft.com/security/advisory/2458511).

**Was aan Microsoft gerapporteerd dat er misbruik was gemaakt van dit beveiligingslek op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Microsoft is op de hoogte van actieve aanvallen waarbij wordt geprobeerd het beveiligingslek te misbruiken.
...
Ja. De beveiligingsupdate dicht het beveiligingslek waar momenteel misbruik van wordt gemaakt. Aan het gedichte beveiligingslek is het nummer [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962) toegewezen.

**Ik heb de tijdelijke oplossingen van** [**Microsoft-beveiligingsadvies 2458511**](http://technet.microsoft.com/security/advisory/2458511) **toegepast. Moet ik deze tijdelijke oplossingen ongedaan maken voordat ik deze update toepas?**  
Microsoft raadt u aan de tijdelijke oplossing "De CSS-stijl van de website vervangen" ongedaan te maken op systemen waarop u deze tijdelijke oplossing hebt toegepast, voordat u deze beveiligingsupdate installeert. U kunt de tijdelijke oplossingen "De Enhanced Mitigation Experience Toolkit (EMET)" en "Preventie van gegevensuitvoering (DEP) inschakelen voor Internet Explorer 7" echter als zodanig blijven gebruiken als een ingrijpende veiligheidsmaatregel.
...
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2416400$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB2416400-IE7\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB2416400-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2416400">Microsoft Knowledge Base-artikel 2416400</a></td>
</tr>
<tr class="even">
...
-   Aniway van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen door HTML-objecten (CVE-2010-3340)  
-   Nicolas Joly van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen door HTML-objecten (CVE-2010-3343)  
-   Stephen Fewer, werkzaam bij [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen (CVE-2010-3345)  
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl/), werkzaam bij [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen door HTML-elementen (CVE-2010-3346)  
-   Masatoshi Sato van [AZIA CO., LTD.](http://www.azia.jp) voor het melden van het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens (CVE-2010-3348)  
-   [Yosuke Hasegawa](http://utf-8.jp) voor de samenwerking bij het oplossen van het beveiligingslek met betrekking tot het vrijgeven van interdomeingegevens (CVE-2010-3348)  
-   Jose Antonio Vazquez Gonzalez van [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen (CVE-2010-3962)
...
-   V1.1 (4 januari 2011): Er is een veelgestelde vraag toegevoegd om een detectiewijziging aan te kondigen waarmee kan worden gecontroleerd of eerder uitgegeven cumulatieve updates voor Internet Explorer correct worden aangeboden in de volgorde waarin ze zijn vrijgegeven. Dit is slechts een detectie-update. De bestanden van de beveiligingsupdate zijn niet gewijzigd.
