---
TOCTitle: 'MS10-093'
Title: 'Microsoft-beveiligingsbulletin MS10-093 - Belangrijk'
ms:assetid: 'ms10-093'
ms:contentKeyID: 61231864
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-093(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-093 - Belangrijk
====================================================

Door een beveiligingslek in Windows Movie Maker kan externe code worden uitgevoerd (2424434)
--------------------------------------------------------------------------------------------
...
Deze beveiligingsupdate lost een openbaar gemaakt beveiligingslek in Windows Movie Maker op. Door het beveiligingslek kan externe code worden uitgevoerd als een aanvaller een gebruiker overhaalt om een legitiem Windows Movie Maker-bestand te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd bibliotheekbestand. Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-locatie bezoekt en vanaf die locatie een document opent dat vervolgens door een kwetsbare toepassing wordt geladen.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor Windows Movie Maker 2.6 op alle ondersteunde edities van Windows Vista. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop Windows Movie Maker externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| Windows Vista Service Pack 1 en Windows Vista Service Pack 2                         | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=55141a02-3ad3-4691-98b9-80dd8ecb14c5)<sup>[1]</sup> | Uitvoering van externe code mogelijk    | Belangrijk        | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
| Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2 | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=5b078136-a492-4a2e-939d-82799f774d82)<sup>[1]</sup> | Uitvoering van externe code mogelijk    | Belangrijk        | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot het onveilig laden van bibliotheken - CVE-2010-3967</th>
...
Beveiligingslek met betrekking tot het onveilig laden van bibliotheken - CVE-2010-3967  
--------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de uitvoering van externe code door de manier waarop Windows Movie Maker het laden van DLL-bestanden afhandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot het onveilig laden van bibliotheken - CVE-2010-3967
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het onveilig laden van bibliotheken - CVE-2010-3967
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het onveilig laden van bibliotheken - CVE-2010-3967
...
Het beveiligingslek wordt veroorzaakt doordat Windows Movie Maker onjuist het pad beperkt dat wordt gebruikt voor het laden van externe bibliotheken.
  
**Wat is Windows Movie Maker?**    
Windows Movie Maker is een toepassing waarmee gebruikers speciale effecten in amateurfilms kunnen maken, bewerken en toevoegen. Windows Movie Maker is opgenomen in releases van Windows XP en Windows Vista. Dit beveiligingslek treft alleen Movie Maker 2.6. Dit is een optionele download die op de getroffen besturingssystemen kan worden geïnstalleerd.
...
Een aanvaller kan een gebruiker overhalen om een legitiem Windows Movie Maker-bestand (.mswmm) te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Terwijl het .mswmm-bestand wordt geopend, kan Windows Movie Maker proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitieme .mswmm-bijlage naar een gebruiker te verzenden en de gebruiker over te halen om de bijlage in een map te plaatsen die een speciaal vervaardigd DLL-bestand bevat en het .mswmm-bestand te openen. Terwijl het .mswmm-bestand wordt geopend, kan Windows Movie Maker proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een netwerkscenario kan een aanvaller een legitiem .mswmm-bestand en een speciaal vervaardigde DLL op een UNC- of WebDAV-locatie plaatsen en de gebruiker overhalen om het .mswmm-bestand te openen.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek treft hoofdzakelijk werkstations van gebruikers die gemakkelijk bijlagen van niet-vertrouwde netwerklocaties openen.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop Windows Movie Maker externe bibliotheken laadt.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967) toegewezen.
...
<td style="border:1px solid black;">Voor Movie Maker 2.6 op alle ondersteunde 32-bits van Windows Vista:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows Movie Maker 2.6 op alle ondersteunde x64-edities van Windows Vista:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2424434">Microsoft Knowledge Base-artikel 2424434</a></td>
</tr>
<tr class="odd">
