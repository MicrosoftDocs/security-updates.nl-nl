---
TOCTitle: 'MS10-097'
Title: 'Microsoft-beveiligingsbulletin MS10-097 - Belangrijk'
ms:assetid: 'ms10-097'
ms:contentKeyID: 61231868
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-097(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-097 - Belangrijk
====================================================

Door het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding kan externe code worden uitgevoerd (2443105)
-------------------------------------------------------------------------------------------------------------------------------------------------
...
Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een .ins- of .isp-bestand opent dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd bibliotheekbestand. Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-locatie bezoekt en vanaf die locatie een document opent dat vervolgens door een kwetsbare toepassing wordt geladen.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop de wizard voor het aanmelden voor een internetverbinding externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fa9a1aac-b9c5-4d4e-9083-a080ad4ccc6f)                          | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6dabc306-c858-46b1-815c-cd8d011ff62e) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fa2cfa4-a01d-4910-b69f-736aeb585bab)                 | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17b0b340-73b2-42a7-9d86-1297c63dcc2b)     | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=04a178cc-1afd-4e47-8cab-05e402e5a568)  | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding - CVE-2010-3144</th>
...
Beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding - CVE-2010-3144  
--------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop de wizard voor het aanmelden voor een internetverbinding, een onderdeel van Microsoft Windows, DLL-bestanden laadt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding - CVE-2010-3144
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding - CVE-2010-3144
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding - CVE-2010-3144
...
Dit beveiligingslek wordt veroorzaakt wanneer de wizard voor het aanmelden voor een internetverbinding het pad dat wordt gebruikt voor het laden van externe bibliotheken niet goed beperkt.
  
**Wat is de wizard voor het aanmelden voor een internetverbinding?**  
Met de wizard voor het aanmelden voor een internetverbinding kunnen gebruikers een verbinding op een nieuwe computer configureren of een bestaande internetserviceaccount van een vorige computer gebruiken. De wizard helpt daarnaast gebruikers van wie de internetinstellingen zijn ontregeld. De functie voor automatische configuratie herstelt de instellingen; de gebruiker hoeft alleen de gebruikersnaam, het wachtwoord en de naam van de POP-server (Point of Presence) op te geven.
...
Een aanvaller kan een gebruiker ertoe overhalen om een legitiem .ins- of .isp-bestand te openen dat zich in dezelfde netwerkmap bevindt als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het bestand wordt geopend, kan de wizard voor het aanmelden voor een internetverbinding proberen het DLL-bestand te laden en code in het bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitiem .ins- of .isp-bestand naar een gebruiker te sturen en de gebruiker ertoe over te halen de bijlage in een directory met een speciaal vervaardigd DLL-bestand te plaatsen en het legitieme bestand te openen. Wanneer het .ins- of .isp-bestand wordt geopend, kan de wizard voor het aanmelden voor een internetverbinding proberen het DLL-bestand te laden en code in het bestand uit te voeren.
  
In een aanval via een netwerk kan een aanvaller een legitiem .ins- of .isp-bestand en een speciaal vervaardigd DLL-bestand in een UNC- of WebDAV-locatie plaatsen en de gebruiker er vervolgens toe overhalen het legitieme bestand te openen. Een aanvaller kan ook een website hosten en op deze website naar het legitieme bestand verwijzen, waardoor de aanval wordt ingezet via een webbrowser.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op doordat de manier wordt verbeterd waarop de wizard voor het aanmelden voor een internetverbinding externe bibliotheken laadt.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144) toegewezen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2443105$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2443105">Microsoft Knowledge Base-artikel 2443105</a></td>
</tr>
<tr class="even">
...
-   Muhaimin Dzulfakar van [NGS Software](http://www.ngssoftware.com/) voor het melden van het beveiligingslek met betrekking tot het onveilig laden van bibliotheken in de wizard voor het aanmelden voor een internetverbinding (CVE-2010-3144)
