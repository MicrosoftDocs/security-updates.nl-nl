---
TOCTitle: 'MS10-105'
Title: 'Microsoft-beveiligingsbulletin MS10-105 - Belangrijk'
ms:assetid: 'ms10-105'
ms:contentKeyID: 61231876
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-105(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-105 - Belangrijk
====================================================

Beveiligingslekken in grafische filters van Microsoft Office kunnen leiden tot uitvoering van externe code (968095)
-------------------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 14 december 2010 | Bijgewerkt: woensdag 15 december 2010
...
Het prioriteitsniveau van dit beveiligingsupdate is Belangrijk voor Microsoft Works 9, Microsoft Office Converter Pack en ondersteunde edities van Microsoft Office XP en Microsoft Office 2003. Voor meer informatie raadpleegt u de sectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt**, in dit onderdeel.

De update lost de beveiligingslekken op door de manier te wijzigen waarop Microsoft Office bepaalde afbeeldingsindelingen parseert en gegevens valideert wanneer afbeeldingen worden weergegeven. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

**Aanbeveling.** Microsoft raadt klanten aan de update zo spoedig mogelijk te installeren.

**Bekende problemen.** In [Microsoft Knowledge Base-artikel 968095](http://support.microsoft.com/kb/968095) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 (32-bits versies)](http://www.microsoft.com/downloads/details.aspx?familyid=6d644494-b530-4b37-bc37-8a8a7edefe53)  
(KB2289078)
</td>
<td style="border:1px solid black;">
Geen
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 (64-bits versies)](http://www.microsoft.com/downloads/details.aspx?familyid=58e54779-aa8f-41b3-9993-8cec12c49082)  
(KB2289078)
</td>
<td style="border:1px solid black;">
Geen
...
<sup>[1]</sup>Gebruikers van de aangegeven software moeten op de update voor Microsoft Office van MS10-087 installeren om beschermd te zijn tegen de beveiligingslekken die worden beschreven in dit bulletin (MS10-105).
...
<span></span>
**Moet ik de update van MS10-087 toepassen om beschermd te zijn tegen de beveiligingslekken die worden beschreven in dit bulletin (MS10-105)?**  
Gebruikers van Microsoft Office XP en Microsoft Office 2003 moeten ook de update voor Microsoft Office van [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241), Door beveiligingslekken in Windows Office kan externe code worden uitgevoerd (2423930), installeren om beschermd te zijn tegen de beveiligingslekken die worden beschreven in dit bulletin (MS10-105). Zowel de update van MS10-087 als de update van MS10-105 moet worden geïnstalleerd, maar klanten hoeven de updates niet in een bepaalde volgorde te installeren.
...
Ja. Deze update omvat wijzigingen die niet met beveiliging te maken hebben maar die ondersteuning bieden voor het overschrijven van de lijst met conversieprogramma's en filters die standaard in Microsoft Office 2007 en Microsoft Office 2010 worden geblokkeerd. Voor meer informatie over beveiligingsinstellingen voor grafische filters van Microsoft Office raadpleegt u [Microsoft Knowledge Base-artikel 2479871](http://support.microsoft.com/kb/2479871).

**Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging?**  
Deze update bevat een ingrijpende update die de lijst met conversieprogramma's en filters uitbreidt die standaard in Microsoft Office 2007 en Microsoft Office 2010 worden geblokkeerd.
...
Een afzonderlijk Office-programma wordt getroffen met hetzelfde prioriteitsniveau als het bijbehorende onderdeel in een Microsoft Office-pakket. Zo wordt een zelfstandige installatie van Microsoft Excel, Microsoft Word of Microsoft PowerPoint met hetzelfde prioriteitsniveau getroffen als een installatie van het getroffen Microsoft Office-pakket.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot bufferoverloop in CGM Image Converter - CVE-2010- 3945
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot integeroverloop in PICT Image Converter - CVE-2010-3946
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot heapoverloop in TIFF Image Converter - CVE-2010-3947
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot bufferoverloop in TIFF Image Converter - CVE-2010-3949
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen in TIFF Image Converter - CVE-2010-3950
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot bufferoverloop in FlashPix Image Converter - CVE-2010-3951
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot heap-corruptie in FlashPix Image Converter - CVE-2010-3952
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot de uitvoering van externe code als gevolg van de wijze waarop Microsoft Office de buffergrootte toewijst bij de afhandeling van CGM-afbeeldingsbestanden. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een Office-document opent dat een speciaal vervaardigde CGM-afbeelding bevat. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-3945](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot bufferoverloop in CGM Image Converter - CVE-2010- 3945
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot bufferoverloop in CGM Image Converter - CVE-2010- 3945

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Wijzig de ACL (toegangsbeheerlijst) om alle gebruikers de toegang tot cgmimp32.flt te ontzeggen**

    Voer als beheerder de volgende opdracht uit vanaf een opdrachtprompt:

    **Voor alle ondersteunde 32-bits edities van Windows XP en Windows Server 2003:**
    `cacls "%CommonProgramFiles%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N`

    **Voor alle ondersteunde 64-bits edities van Windows XP en Windows Server 2003:**
    `cacls "%CommonProgramFiles(x86)%\Microsoft Shared\grphflt\cgmimp32.flt" /E /P everyone:N`

    **Voor alle ondersteunde 32-bits edities van Windows** **Vista, Windows Server 2008 en Windows 7:**
    ...
    **Voor alle ondersteunde 64-bits edities van Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2:**
    ...
    **Gevolgen van de tijdelijke oplossing.** Office-toepassingen kunnen geen CGM-afbeeldingen importeren.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot bufferoverloop in CGM Image Converter - CVE-2010- 3945

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer Microsoft Office op onjuiste wijze buffergrootten in het geheugen toewijst.
...
Dit beveiligingslek kan alleen worden misbruikt als een gebruiker een speciaal ontworpen Office-document opent met een getroffen versie van Microsoft Office.

In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een speciaal vervaardigd Office-document naar de gebruiker te verzenden en de gebruiker ertoe te bewegen het bestand te openen.

In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website waarop zich een Office-document bevindt waarmee wordt geprobeerd dit beveiligingslek te misbruiken. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. In plaats daarvan moet de aanvaller een gebruiker ervan overtuigen de website te bezoeken. In de meeste gevallen gebeurt dit door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat. Vervolgens moet de aanvaller de gebruiker ertoe overhalen het speciale Office-document te openen.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te wijzigen waarop Microsoft Office gegevens valideert wanneer CGM-afbeeldingen worden weergegeven.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot de uitvoering van externe code als gevolg van de wijze waarop Microsoft Office de buffergrootte toewijst bij de afhandeling van PICT-afbeeldingsbestanden. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een Office-document opent dat een speciaal vervaardigde PICT-afbeelding bevat. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-3946](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot integeroverloop in PICT Image Converter - CVE-2010-3946
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot integeroverloop in PICT Image Converter - CVE-2010-3946
...
-   **Wijzig de ACL (toegangsbeheerlijst) om alle gebruikers de toegang tot pictim32.flt te ontzeggen**
    ...
    **Gevolgen van de tijdelijke oplossing.** Office-toepassingen kunnen geen PICT-afbeeldingen importeren.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot integeroverloop in PICT Image Converter - CVE-2010-3946
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te wijzigen waarop Microsoft Office gegevens valideert wanneer PICT-afbeeldingen worden weergegeven.
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Microsoft Office speciaal vervaardigde TIFF-afbeeldingsbestanden parseert. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een Office-document opent dat een speciaal vervaardigde TIFF-afbeelding bevat. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-3947](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot heapoverloop in TIFF Image Converter - CVE-2010-3947
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot heapoverloop in TIFF Image Converter - CVE-2010-3947

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Wijzig de ACL (toegangsbeheerlijst) om alle gebruikers de toegang tot tiffim32.flt te ontzeggen**
    ...
    **Gevolgen van de tijdelijke oplossing.** Office-toepassingen kunnen geen TIFF-afbeeldingen importeren.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot heapoverloop in TIFF Image Converter - CVE-2010-3947

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer Microsoft Office op onjuiste wijze gegevens in TIFF-afbeeldingsbestanden parseert.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te wijzigen waarop Microsoft Office gegevens valideert bij de weergave van TIFF-afbeeldingen.
...
Zie [CVE 2010-3949](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot bufferoverloop in TIFF Image Converter - CVE-2010-3949
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot bufferoverloop in TIFF Image Converter - CVE-2010-3949
...
-   **Wijzig de ACL (toegangsbeheerlijst) om alle gebruikers de toegang tot MSPCORE.DLL te ontzeggen**
    ...
    **Gevolgen van de tijdelijke oplossing.** De toepassing Office Document Imaging kan geen TIFF-bestanden importeren.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot bufferoverloop in TIFF Image Converter - CVE-2010-3949

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer Microsoft Office op onjuiste wijze gegevens converteert tijdens het parseren van in TIFF-afbeeldingsbestanden.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te verbeteren waarop Microsoft Office gegevens converteert tijdens het parseren van TIFF-afbeeldingsbestanden.
...
Zie [CVE 2010-3950](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen in TIFF Image Converter - CVE-2010-3950
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen in TIFF Image Converter - CVE-2010-3950
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen in TIFF Image Converter - CVE-2010-3950
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Microsoft Office speciaal vervaardigde FlashPix-afbeeldingsbestanden parseert. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een Office-document opent dat een speciaal vervaardigde FlashPix-afbeelding bevat. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-3951](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot bufferoverloop in FlashPix Image Converter - CVE-2010-3951

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
-   Standaard wordt de FlashPix Image Converter niet door Microsoft Office geïnstalleerd. Alleen systemen waarop de FlashPix Image Converter handmatig wordt geïnstalleerd, worden getroffen door het beveiligingslek.
-   Het beveiligingslek kan niet automatisch worden misbruikt via e-mail. Aanvallen via e-mail lukken alleen als een gebruiker een bijlage opent die in een e-mailbericht is verzonden.
-   In het geval van een aanval vanaf het web kan de aanvaller beschikken over een website waarop zich een webpagina bevindt waarmee dit beveiligingslek wordt misbruikt. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens of advertenties staan of gegevens of advertenties kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan echter een gebruiker er niet toe dwingen om naar deze websites te gaan. De aanvaller zou gebruikers ertoe moeten overhalen de website te bezoeken door hen op een koppeling in een e-mailbericht of Messenger-bericht te laten klikken waardoor zij naar de website van de aanvaller gaan. Daar worden de gebruikers vervolgens verleid om het speciaal vervaardigd Office-bestand te openen.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot bufferoverloop in FlashPix Image Converter - CVE-2010-3951

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Wijzig de ACL (toegangsbeheerlijst) om alle gebruikers de toegang tot fpx32.flt te ontzeggen**
    ...
    **Gevolgen van de tijdelijke oplossing.** Office-toepassingen kunnen geen FlashPix-afbeeldingsbestanden importeren.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot bufferoverloop in FlashPix Image Converter - CVE-2010-3951

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer Microsoft Office op onjuiste wijze gegevens in FlashPix-afbeeldingsbestanden parseert.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te wijzigen waarop Microsoft Office gegevens valideert wanneer FlashPix-afbeeldingen worden weergegeven.
...
Zie [CVE-2010-3952](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot heap-corruptie in FlashPix Image Converter - CVE-2010-3952
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot heap-corruptie in FlashPix Image Converter - CVE-2010-3952
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot heap-corruptie in FlashPix Image Converter - CVE-2010-3952

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek ontstaat door de manier waarop Microsoft Office gegevens in FlashPix-afbeeldingsbestanden parseert.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2289162">Microsoft Knowledge Base-artikel 2289162</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2289163">Microsoft Knowledge Base-artikel 2289163</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2288931">Microsoft Knowledge Base-artikel 2288931</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2289078">Microsoft Knowledge Base-artikel 2289078</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2456849">Microsoft Knowledge Base-artikel 2456849</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2431831">Microsoft Knowledge Base-artikel 2431831</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   Yamata Li van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van het beveiligingslek met betrekking tot bufferoverloop in CGM Image Converter (CVE-2010-3945)  
-   Yamata Li van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van het beveiligingslek met betrekking tot integeroverloop in PICT Image Converter (CVE-2010-3946)  
-   Alin Rad Pop van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot integeroverloop in PICT Image Converter (CVE-2010-3946)  
-   Carsten Eiram van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot heapoverloop in TIFF Image Converter - (CVE-2010-3947)  
-   Carsten Eiram van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot bufferoverloop in TIFF Image Converter - (CVE-2010-3949)  
-   Carsten Eiram van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in TIFF Image Converter - (CVE-2010-3950)  
-   Dyon Balding van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot bufferoverloop in FlashPix Image Converter - (CVE-2010-3951)  
-   Dyon Balding van [Secunia Research](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot heap-corruptie in FlashPix Image Converter - (CVE-2010-3952)
...
-   V1.1 (15 december 2010): Aangegeven dat gebruikers van Microsoft Office XP en Microsoft Office 2003 de update in MS10-087 moeten toepassen om beschermd te zijn tegen de beveiligingslekken die worden beschreven in dit bulletin (MS10-105).
