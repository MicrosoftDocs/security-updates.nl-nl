---
TOCTitle: 'MS11-001'
Title: 'Microsoft-beveiligingsbulletin MS11-001 - Belangrijk'
ms:assetid: 'ms11-001'
ms:contentKeyID: 61231878
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-001(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-001 - Belangrijk
====================================================

Een beveiligingslek in Windows Backup Manager kan leiden tot uitvoering van externe code (2478935)
--------------------------------------------------------------------------------------------------
...
Deze beveiligingsupdate lost een openbaar gemaakt beveiligingslek in Windows Backup Manager op. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een legitiem Windows Backup Manager-bestand opent dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd bibliotheekbestand. Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en het legitieme bestand vanaf die locatie opent. Alleen in dat geval opent Windows Backup Manager het speciaal vervaardigde bibliotheekbestand.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde versies van Microsoft Vista. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop Windows Backup Manager externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4eeaad20-729c-4594-8853-e4ae55e9d491)                         | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b2839cd0-1958-4a22-9aac-0e0aa8f2b52c) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Backup Manager - CVE-2010-3145</th>
...
Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Backup Manager - CVE-2010-3145  
----------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop DLL-bestanden worden geladen in Microsoft Windows Backup Manager. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Backup Manager - CVE-2010- 3145
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en een .wbcat-bestand (Windows Backup Catalog) opent.  
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Backup Manager - CVE-2010- 3145
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Backup Manager - CVE-2010- 3145
...
Het beveiligingslek wordt veroorzaakt wanneer Windows Backup Manager het pad voor het laden van externe bibliotheken niet goed beperkt.
  
**Wat is Windows Backup Manager?**    
Met Windows Backup Manager (sdclt.exe) kunnen gebruikers de systeembestanden van een computer terugzetten op een eerdere toestand. Systeemherstel gebruikt de functie Systeembeveiliging om regelmatig herstelpunten te maken en op de computer op te slaan. Deze herstelpunten bevatten informatie over registerinstellingen en andere systeeminformatie die Windows gebruikt. Deze herstelpunten kunnen ook handmatig worden gemaakt.
...
Misbruik is alleen mogelijk als een gebruiker een legitiem. wbcat-bestand opent dat zich bevindt in dezelfde map als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het. wbcat-bestand wordt geopend, kan de Windows Backup Manager-toepassing proberen het speciaal vervaardigde DLL-bestand te laden en de code in dat bestand uit te voeren.
  
In een aanval via het netwerk kan een aanvaller een legitiem .wbcat-bestand en een speciaal vervaardigde DLL op een netwerkshare plaatsen, zoals een UNC of WebDAV-locatie, en de gebruiker overhalen om het .wbcat-bestand te openen. Wanneer de gebruiker het .wbcat-bestand opent, wordt het speciaal vervaardigde DLL-bestand geopend, dat in dezelfde map staat als het ,wbcat-bestand. Een aanvaller kan gebruikers niet dwingen om een .wbcat-bestand vanaf een netwerkshare te openen. In plaats daarvan moet een aanvaller gebruikers overhalen om het bestand te openen. Dit gebeurt doorgaans door hen op een koppeling in een e-mail- of Messenger-bericht te laten klikken waardoor zij naar de netwerkshare gaan, waarna ze moeten worden overgehaald om het .wbcat-bestand te openen.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een gebruiker een legitieme .wbcat-bijlage te sturen, de gebruiker over te halen om de bijlage in een map te plaatsen die een speciaal vervaardigd DLL-bestand bevat, en de gebruiker vervolgens over te halen om het .wbcat-bestand te openen. Wanneer de gebruiker het .wbcat-bestand opent, wordt het speciaal vervaardigde DLL-bestand geopend, dat in dezelfde map staat als het ,wbcat-bestand. Als een gebruiker op een koppeling in een e-mailbericht klikt, kan de gebruiker door dit beveiligingslek worden getroffen in een aanval via het netwerk.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop Windows Backup Manager externe bibliotheken laadt.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145) toegewezen.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2478935">Microsoft Knowledge Base-artikel 2478935</a></td>
</tr>
<tr class="odd">
