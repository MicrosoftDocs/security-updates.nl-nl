---
TOCTitle: 'MS11-013'
Title: 'Microsoft-beveiligingsbulletin MS11-013 - Belangrijk'
ms:assetid: 'ms11-013'
ms:contentKeyID: 61231890
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-013(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-013 - Belangrijk
====================================================

Beveiligingslekken in Kerberos kunnen leiden tot misbruik van bevoegdheden (2496930)
------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 8 februari 2011 | Bijgewerkt: woensdag 16 maart 2011
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde versies van Windows XP, Windows Server 2003, Windows 7 en Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

Deze update lost de beveiligingslekken op door het gebruik van zwakke hash-algoritmen in Windows Kerberos en Windows KDC te voorkomen en door te voorkomen dat de client de coderingsstandaard te verlagen naar DES voor Kerberos-communicatie tussen client en server. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=856fbcc2-ead9-4ec1-92dd-988e6d22dae9">Windows Server 2003 met SP2 voor Itanium-systemen</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-014">MS10-014</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ffed7c76-0b75-4f57-9b63-3961a8b449f6">Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1</a><br />
(KB2425227)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c26cebcf-683f-4a51-be75-76535fb979a7">Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=46bb3ef1-24c3-41cb-8141-0fdbd85093f7">Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1</a>*<br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965">Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<span></span>
**Waarom is dit bulletin herzien op 16 maart 2011?**   
...
<th style="border:1px solid black;" >Beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde - CVE-2011-0043</th>
<th style="border:1px solid black;" >Beveiligingslek in Kerberos met betrekking tot spoofing - CVE-2011-0091</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde - CVE-2011-0043  
----------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in implementatie van Kerberos. Het beveiligingslek bestaat doordat de Microsoft Kerberos-implementatie een zwak hash-algoritme ondersteunt, waardoor bepaalde aspecten van een Kerberos-serviceticket kan kunnen worden vervalst. Een kwaadwillende gebruiker of een aanvaller misbruik weet te maken van dit beveiligingslek, kan een token met verhoogde bevoegdheden krijgen op het getroffen systeem.
  
Zie [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde - CVE-2011-0043
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Van dit beveiligingslek kan geen misbruik worden gemaakt in domeinen met domeincontrollers waarop Windows Server 2008 of Windows Server 2008 R2 wordt uitgevoerd.  
...
#### Tijdelijke oplossingen voor het beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde - CVE-2011-0043
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde - CVE-2011-0043
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een lokale, geverifieerde aanvaller kan op een systeem een schadelijke service uitvoeren waarmee een speciaal vervaardigd serviceticket kan worden verzonden. Daarmee kan een token worden verkregen waarmee de aanvaller hogere bevoegdheden heeft op het systeem.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer de Microsoft Kerberos-implementatie in Microsoft Windows zwakke hash-mechanismen zoals CRC32 ondersteunt.
...
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de beveiligingscontext van het lokale systeem. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met deze verhoogde bevoegdheden maken.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een lokale, geverifieerde aanvaller die bevoegd is om een schadelijke Kerberos-toepassing met beperkte bevoegdheden te installeren, kan misbruik maken van dit beveiligingslek door een dergelijke schadelijke service te installeren op een computer in een domein. Deze service kan vervolgens een speciaal vervaardigd Kerberos-serviceticket genereren waarmee de aanvaller bevoegdheden op systeemniveau kan krijgen op de lokale computer.
...
**Wat doet de update?**    
Deze update lost het beveiligingslek op door het gebruik van zwakke hash-algoritmen in Windows Kerberos en Windows KDC te voorkomen.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043) toegewezen.
  
**Was aan Microsoft gerapporteerd dat er misbruik was gemaakt van dit beveiligingslek op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Nee. Microsoft beschikte niet over informatie dat dit beveiligingslek was gebruikt voor aanvallen op klanten en had geen voorbeelden van gepubliceerde conceptcode gezien als bewijs toen dat dit beveiligingsbulletin oorspronkelijk werd uitgegeven.
  
Beveiligingslek in Kerberos met betrekking tot spoofing - CVE-2011-0091  
-----------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot spoofing in implementaties van Kerberos op Windows 7 en Windows Server 2008 R2. Het beveiligingslek bestaat omdat het mogelijk is Kerberos-verificatie te verlagen naar DES in plaats van de normale, sterkere coderingsstandaarden in Windows 7 en Windows Server 2008 R2.
  
Zie [CVE-2011-0091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Kerberos met betrekking tot spoofing - CVE-2011-0091
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Het beveiligingslek treft alleen Kerberos-verificatie.
  
#### Tijdelijke oplossingen voor het beveiligingslek in Kerberos met betrekking tot spoofing - CVE-2011-0091
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in Kerberos met betrekking tot spoofing - CVE-2011-0091
  
**Wat is de omvang van het probleem?**    
Dit is een beveiligingslek dat betrekking heeft op spoofing. Door dit beveiligingslek kan een aanvaller de referentie van een legitieme gebruiker nabootsen of alle Kerberos-verkeer in een getroffen sessie vervalsen.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer Windows niet de sterkere, normale coderingsstandaarden in Windows 7 en Windows Server 2008 R2 gebruikt, waardoor een MITM-aanvaller de coderingsstandaard in Kerberos-communicatie kan verlagen naar een zwakkere standaard dan oorspronkelijk werd gebruikt.
...
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller kan de normale coderingsstandaard verlagen naar DES. Vervolgens kan de aanvaller alle Kerberos-verkeer in die sessie lezen en vervalsen. Hierdoor kan de aanvaller de geverifieerde gebruiker van die Kerberos-sessie nabootsen.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
In het geval van een MITM-aanval (man-in-the-middle) moet een aanvaller zich bevinden tussen de doelclient en de server om de communicatie te kunnen onderscheppen en de normale coderingsstandaard te verlagen naar DES.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Windows 7- en Windows Server 2008 R2-systemen die Kerberos-verificatie gebruiken zijn kwetsbaar voor deze aanval.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door te voorkomen dat een MITM-aanvaller de coderingsstandaard verlaagt naar DES voor Kerberos-communicatie tussen de client en server.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2478971$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2478971">Microsoft Knowledge Base-artikel 2478971</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2425227">Microsoft Knowledge Base-artikel 2425227</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
...
-   [Het MIT Kerberos Team](http://web.mit.edu/kerberos) voor het melden van het beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde (CVE-2011-0043)  
-   Scott Stender van [iSEC Partners](http://www.isecpartners.com/) voor het melden van het beveiligingslek in Kerberos met betrekking tot spoofing (CVE-2011-0091)
