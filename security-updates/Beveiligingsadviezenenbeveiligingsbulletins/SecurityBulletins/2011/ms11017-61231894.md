---
TOCTitle: 'MS11-017'
Title: 'Microsoft-beveiligingsbulletin MS11-017 - Belangrijk'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61231894
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-017(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-017 - Belangrijk
====================================================

Door een beveiligingslek in Remote Desktop Client kan externe code worden uitgevoerd (2508062)
----------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 8 maart 2011 | Bijgewerkt: woensdag 4 mei 2011
...
Met deze beveiligingsupdate wordt een openbaar gemaakt beveiligingslek in Windows Remote Desktop Client opgelost. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker een legitiem configuratiebestand (.rdp) voor Extern bureaublad opent dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd bibliotheekbestand. Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-locatie bezoekt en vanaf die locatie een document opent dat vervolgens door een kwetsbare toepassing wordt geladen.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor Remote Desktop Connection 5.2 Client, Remote Desktop Connection 6.0 Client, Remote Desktop Connection 6.1 Client en Remote Desktop Connection 7.0 Client. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in Windows Remote Desktop Client. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2508062](http://support.microsoft.com/kb/2508062) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<tr>
<th colspan="5">
Remote Desktop Connection 6.0 Client en Remote Desktop Connection 6.1 Client
</th>
</tr>
...
| Windows Server 2003 met SP2 voor Itanium-systemen           | Remote Desktop Connection 5.2 Client |
| Windows 7 voor 32-bits systemen Service Pack 1              | Remote Desktop Connection 7.1 Client |
| Windows 7 voor x64-systemen Service Pack 1                  | Remote Desktop Connection 7.1 Client |
| Windows Server 2008 R2 voor x64-systemen Service Pack 1     | Remote Desktop Connection 7.1 Client |
| Windows Server 2008 R2 voor Itanium-systemen Service Pack 1 | Remote Desktop Connection 7.1 Client |
...
<th>
Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Extern bureaublad - CVE-2011-0029
</th>
<th>
Prioriteitsniveau
</th>
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 5.2 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 op Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 op Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI) op Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 op Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen met Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen met Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 op Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen met Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows 7 voor 32-bits systemen
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows 7 voor x64-systemen
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows Server 2008 R2 voor x64-systemen\*\*
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 op Windows Server 2008 R2 voor Itanium-systemen
</td>
<td style="border:1px solid black;">
**Belangrijk**   
Uitvoering van externe code mogelijk
...
<span></span>
Er is een beveiligingslek met betrekking tot de uitvoering van externe code door de manier waarop Windows Remote Desktop Client het laden van DLL-bestanden afhandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE -2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Extern bureaublad - CVE-2011-0029

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en een RDP-bestand opent.
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Extern bureaublad - CVE-2011-0029
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Extern bureaublad - CVE-2011-0029
...
Het beveiligingslek wordt veroorzaakt wanneer Windows Remote Desktop Client het pad voor het laden van externe bibliotheken niet goed beperkt.

**Wat is de Windows Remote Desktop Client?**  
De functie Extern bureaublad in Windows maakt toegang mogelijk tot alle programma's, bronnen en accessoires op de computer van een gebruiker vanaf een tweede op Windows gebaseerde computer. Wanneer de tweede computer is aangesloten, biedt Extern bureaublad muis- en toetsenbordbesturing over de eerste computer en wordt alles wat er gebeurt in het scherm weergegeven.
...
Een aanvaller kan een gebruiker ertoe overhalen om een legitiem RDP-bestand (Remote Desktop-configuratiebestand) te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Terwijl het RDP-bestand wordt geopend, kan Windows Remote Desktop Client proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.

In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitieme RDP-bijlage naar een gebruiker te verzenden en de gebruiker over te halen om de bijlage in een map te plaatsen die een speciaal vervaardigd DLL-bestand bevat en het RDP-bestand te openen. Terwijl het RDP-bestand wordt geopend, kan Windows Remote Desktop Client proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.

In een aanval via een netwerk kan een aanvaller een legitiem RDP-bestand en een speciaal vervaardigd DLL-bestand in een UNC- of WebDAV-locatie plaatsen en de gebruiker er vervolgens toe overhalen het RDP-bestand te openen.
...
**Wat doet de update?**  
De update lost dit beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in Windows Remote Desktop Client.

**Bestaat er een verband tussen dit beveiligingslek en Microsoft-beveiligingsadvies 2269637?**  
Ja, het beveiligingslek dat met deze update wordt opgelost, houdt verband met de klasse van beveiligingslekken, beschreven in [Microsoft-beveiligingsadvies 2269637](http://technet.microsoft.com/security/advisory/2269637), die beïnvloeden hoe toepassingen externe bibliotheken laden. Deze beveiligingsupdate lost een bijzonder geval van dit soort beveiligingslek op.

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) toegewezen.
...
| Windows 7 voor 32-bits systemen Service Pack 1                                                        | Nee     | Nee               | Ja                | Ja                         |
...
<td style="border:1px solid black;">Voor Remote Desktop Connection 5.2 op Windows XP Service Pack 3:<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op Windows XP Service Pack 3:<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op Windows XP Service Pack 3:<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 op Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Voor Remote Desktop Connection 5.2:<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 en Remote Desktop Connection 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Voor Remote Desktop Connection 5.2:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2483618$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 en Remote Desktop Connection 6.1:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2481109$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2483614$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 5.2:<br />
Zie <a href="http://support.microsoft.com/kb/2483618">Microsoft Knowledge Base-artikel 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 en Remote Desktop Connection 6.1:<br />
Zie <a href="http://support.microsoft.com/kb/2481109">Microsoft Knowledge Base-artikel 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0:<br />
Zie <a href="http://support.microsoft.com/kb/2483614">Microsoft Knowledge Base-artikel 2483614</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 op Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI) op Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 op Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installeren zonder opnieuw op te starten</td>
...
<tr class="odd">
<td style="border:1px solid black;">Logboekbestand bijwerken</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI):<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Meer informatie</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI):<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2483619$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI):<br />
Zie <a href="http://support.microsoft.com/kb/2483619">Microsoft Knowledge Base-artikel 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2:<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1:<br />
Zie <a href="http://support.microsoft.com/kb/2481109">Microsoft Knowledge Base-artikel 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op alle ondersteunde 32-bits edities van Windows Server 2008:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op alle ondersteunde x64-edities van Windows Server 2008:<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 6.1 op alle ondersteunde Itanium-edities van Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2481109">Microsoft Knowledge Base-artikel 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;"><strong>Opmerking</strong> Er bestaat geen registersleutel waarmee de aanwezigheid van deze update kan worden gevalideerd.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op alle ondersteunde 32-bits versies van de oorspronkelijke versie van Windows 7:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op alle ondersteunde x64-versies van de oorspronkelijke versie van Windows 7:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2483614">Microsoft Knowledge Base-artikel 2483614</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;"><strong>Opmerking</strong> Er bestaat geen registersleutel waarmee de aanwezigheid van deze update kan worden gevalideerd.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op alle ondersteunde x64-versies van de oorspronkelijke versie van Windows Server 2008 R2:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Remote Desktop Connection 7.0 op alle ondersteunde Itanium-versies van de oorspronkelijke versie van Windows Server 2008 R2:<br />
...
-   Eyal Gruner van [Versafe Anti Fraud](http://www.versafe-login.com/) voor het melden van het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Remote Desktop (CVE-2011-0029)
...
-   V1.1 (8 maart 2011): De Systems Management Server-tabel is gecorrigeerd voor SMS 2.0 en SMS 2003 met SUIT voor Windows XP Service Pack 3 en Windows Server 2003 Service Pack 2. Het gaan alleen om wijzigingen in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.  
-   V1.2 (9 maart 2011): De gegevens over de **software waarin dit probleem niet optreedt** zijn voor de SP1-versies van Windows 7 en Windows Server 2008 R2 gecorrigeerd van Remote Desktop Connection 7.0 Client naar Remote Desktop Connection 7.1 Client. Het gaan alleen om wijzigingen in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.  
-   V1.3 (13 april 2011): De informatie over het vervangen van het bulletin voor Remote Desktop Connection 6.0 Client is gecorrigeerd op ondersteunde edities van Windows Server 2003 en Remote Desktop Connection 6.1 Client op ondersteunde edities van Windows Vista. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.  
-   V1.4 (15 april 2011): De informatie over het vervangen van het bulletin voor Remote Desktop Connection 6.0 Client op ondersteunde edities van Windows Server 2003 en Remote Desktop Connection 6.1 Client op ondersteunde edities van Windows Server 2008 is verbeterd. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.  
-   V1.5 (4 mei 2011): De informatie over het vervangen van het bulletin voor Remote Desktop Connection 5.2 Client op ondersteunde edities van Windows XP Service Pack 3 is verbeterd. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.
