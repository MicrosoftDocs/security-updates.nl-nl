---
TOCTitle: 'MS11-047'
Title: 'Microsoft-beveiligingsbulletin MS11-047 - Belangrijk'
ms:assetid: 'ms11-047'
ms:contentKeyID: 61232014
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-047(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-047 - Belangrijk
====================================================

Beveiligingslek in Hyper-V kan leiden tot denial of service (2525835)
---------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop de Hyper-V-server verkeerd ingedeelde aanvragen van virtuele machines verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-----------------------------------------------------------|
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=24789423-72b7-48d1-bdc1-f0e5174d99bb)\* | Denial of service                       | Belangrijk        | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                      | Denial of service                       | Belangrijk        | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2 voor x64-systemen Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                       | Denial of service                       | Belangrijk        | Geen                                                      |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot aanhoudende DoS in VMBus - CVE-2011-1872</th>
...
Beveiligingslek met betrekking tot aanhoudende DoS in VMBus - CVE-2011-1872  
---------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service in Hyper-V op Windows Server 2008 en Windows Server 2008 R2. Het beveiligingslek wordt veroorzaakt doordat Hyper-V-servers specifieke reeksen machine-instructies onvoldoende valideren. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan ervoor zorgen dat het Hyper-V-systeem waarin dit probleem optreedt niet meer reageert. Dit heeft gevolgen voor alle virtuele machines die door dat systeem worden gehost.
  
Zie [CVE-2011-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot aanhoudende DoS in VMBus - CVE-2011-1872:
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot aanhoudende DoS in VMBus - CVE-2011-1872:
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot aanhoudende DoS in VMBus - CVE-2011-1872:
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op een denial of service. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan ervoor zorgen dat de Hyper-V-server waarin dit probleem optreedt niet meer reageert, waardoor de server opnieuw moet worden opgestart. Het beveiligingslek betreft een 'denial-of-service'-probleem. Een aanvaller kan geen code uitvoeren of zichzelf gebruikersrechten op de Hyper-V-server toekennen, maar kan er wel voor zorgen dat het systeem waarin dit probleem optreedt geen aanvragen meer accepteert.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt door onvoldoende validatie van specifieke pakketten die van de gast naar de host worden verzonden. Door dit tekort aan validatie leidt het verwerken van deze instructies tot overtollig gebruik van middelen in de Hyper-V servertoepassing.
  
**Wat is Hyper-V?**    
Hyper-V is een technologie op basis van hypervisor en vormt een hoofdfunctie van Windows Server 2008 en Windows Server 2008 R2. Het biedt een virtualisatieplatform met een hoge mate van schaalbaarheid, betrouwbaarheid en beschikbaarheid. Een dergelijke omgeving is handig omdat u virtuele machines kunt creëren en beheren, waardoor u meerdere besturingssystemen kunt uitvoeren op één computer en u de besturingssystemen kunt isoleren.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die dit lek weet te misbruiken, kan ervoor zorgen dat het systeem van een gebruiker niet meer reageert en opnieuw moet worden opgestart. Dit beveiligingslek kan leiden tot gebruik van alle middelen van de Hyper-V-server, inclusief alle virtuele gastmachines die door de server worden gehost.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller moet een geverifieerde beheerder zijn in een van de virtuele gastmachines die worden gehost door de Hyper-V-server. De aanvaller moet in staat zijn willekeurige code uit te voeren op dat systeem, bijvoorbeeld door een niet-vertrouwde uitvoerbaar bestand uit te voeren. Dit uitvoerbare bestand kan dan een verkeerd ingedeelde reeks machine-instructies aanroepen die leiden tot het gebruik van middelen, wat leidt tot een oneindige lus op de Hyper-V-server waardoor aanvragen van andere virtuele machines niet kunnen worden verwerkt.
  
**Welke machtigingen heeft een aanvaller nodig om deze Denial of Service-aanval uit te voeren?**    
Om deze denial of service-aanval tegen de Hyper-V-server en alle lopende virtuele machines op de Hyper-V-server uit te voeren, moet de aanvaller beheerderbevoegdheden hebben voor een van de virtuele machines die worden gehost op de Hyper-V-server. De aanvaller hoeft geen beheerrechten op de Hyper-V-server zelf te hebben.
...
**Wat doet de update?**    
Deze update verbetert de manier waarop de Hyper-V-server verkeerd ingedeelde aanvragen van virtuele machines verwerkt. Door de oplossing kan de Hyper-V-servertoepassing VMBus-pakketten die van de gast naar de host worden verzonden, goed valideren.
...
<td style="border:1px solid black;">Voor Hyper-V Server op alle ondersteunde x64-edities van Windows Server 2008:<br />
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2525835">Microsoft Knowledge Base-artikel 2525835</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Hyper-V Server op alle ondersteunde x64-edities van Windows Server 2008 R2:<br />
...
-   Nicolas Economou van [Core Security Technologies](http://www.coresecurity.com/) voor het melden van het beveiligingslek met betrekking tot aanhoudende DoS in VMBus - (CVE-2011-1872)
