---
TOCTitle: 'MS11-085'
Title: 'Microsoft-beveiligingsbulletin MS11-085 - Belangrijk'
ms:assetid: 'ms11-085'
ms:contentKeyID: 61232052
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-085(v=Security.10)'
---
...
Beveiligingslek in Windows Mail en Windows Meeting Space kan leiden tot uitvoering van externe code (2620704)
-------------------------------------------------------------------------------------------------------------
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524)                                                                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38)                                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc)\*\*                                                    | Uitvoering van externe code mogelijk    | Gemiddeld         | Geen                                            |
| [Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9)\*\*                                                        | Uitvoering van externe code mogelijk    | Gemiddeld         | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                        | Uitvoering van externe code mogelijk    | Gemiddeld         | Geen                                            |
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9)                           | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
| [Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960)                                   | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5)\*\*     | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1) | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
...
**Wat is de Bureaubladbelevenis in Windows Server 2008?** 
Er is een aantal bureaubladfuncties, zoals Windows Mail, die niet standaard geïnstalleerd zijn op Windows Server 2008. In plaats daarvan kunt u ze allemaal samen installeren door de Bureaubladbelevenis te installeren op Windows Server 2008. Zie het TechNet-artikel [Windows Mail, Windows Media Player, and Other Features in the Desktop Experience in Windows Server 2008](http://technet.microsoft.com/en-us/library/cc771519(ws.10).aspx) voor meer informatie.

**Waarom wordt deze** **update** **aangeboden aan Windows Server 2008-systemen, ongeacht of de Bureaubladbelevenis** **is geïnstalleerd?** 
De kwetsbare code is aanwezig op installaties van Windows Server 2008, ongeacht of de Bureaubladbelevenis is geïnstalleerd. Aangezien de kwetsbare code aanwezig is, wordt deze update aangeboden.

Aan de andere kant bevatten Windows Mail en Windows Meeting Space een aanvalsvector voor het misbruiken van het beveiligingslek. Standaard zijn Windows Meeting Space en Windows Mail niet geïnstalleerd op Windows Server 2008. Op systemen waarop Windows Meeting Space en Windows Mail niet zijn geïnstalleerd, wordt de kwetsbare code niet gebruikt.

Windows Mail kan worden geïnstalleerd door installatie van de Bureaubladbelevenis op Windows Server 2008. Microsoft raadt gebruikers van Windows Server 2008 aan de update toe te passen om de mogelijke aanvalsvector aan te pakken.

**Waarom is het** **prioriteitsniveau** **lager voor Windows 7- en Windows Server 2008 R2-systemen?  
**Hoewel de kwetsbare code aanwezig is in Windows 7 en Windows Server 2008 R2, is Microsoft niet op de hoogte van aanvalsvectoren waarmee het beveiligingslek kan worden misbruikt op deze besturingssystemen. Gebruikers van deze besturingssystemen wordt echter aangeraden de update toch te installeren, als een ingrijpende veiligheidsmaatregel.
...
**Worden andere e-mailclients, zoals Windows Live Mail of Outlook Express, getroffen door dit probleem?  
**Nee. Dit beveiligingslek treft alleen de Windows Mail-clients op de besturingssystemen die worden genoemd in de tabel met software waarin dit probleem optreedt. Andere e-mailclients worden niet getroffen.
...
<th style="border:1px solid black;" >Beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2016</th>
...
Beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2016  
------------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Windows Mail en Windows Meeting Space DLL-bestanden laden. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2011-2016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2016
...
#### Tijdelijke oplossingen voor het beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2016
...
#### Veelgestelde vragen over het beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2016
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Opgenomen</strong> <strong>in</strong> <strong>toekomstige service packs</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Opnieuwopstartenvereist</strong></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2620704">Microsoft Knowledge Base-artikel 2620704</a></td>
</tr>
<tr class="odd">
...
-   Ivan Sanchez van EvilCode voor het melden van het beveiligingslek in Windows Mail met betrekking tot het onveilig laden van bibliotheken (CVE-2011-2016)
...
) kunt u nagaan of de leveranciers van beveiligingsprogramma's hun producten steeds updaten.
