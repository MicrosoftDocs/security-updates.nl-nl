---
TOCTitle: 'MS11-096'
Title: 'Microsoft-beveiligingsbulletin MS11-096 - Belangrijk'
ms:assetid: 'ms11-096'
ms:contentKeyID: 61232063
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-096(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-096 - Belangrijk
====================================================

Door een beveiligingslek in Microsoft Excel kan externe code worden uitgevoerd (2640241)
----------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Office opgelost. Dit beveiligingslek kan leiden tot het uitvoeren van externe code als een gebruiker een speciaal vervaardigd Excel-bestand opent. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken. Het installeren en configureren van Office-bestandsvalidatie ter voorkoming van het openen van verdachte bestanden, blokkeert de aanvalsvectoren voor het misbruiken van de beveiligingslekken die worden beschreven in CVE-2011-3403. Zie de sectie Veelgestelde vragen over deze beveiligingsupdate voor meer informatie over hoe de functie voor Office-bestandsvalidatie zodanig kan worden geconfigureerd dat de aanvalsvectoren worden geblokkeerd.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van Microsoft Excel 2003 en Microsoft Office 2004 voor Mac. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop Microsoft Excel objecten in het geheugen verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2640241](http://support.microsoft.com/kb/2640241) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|----------------------------------------------------------------------------------------------------------------------|
| Microsoft Excel 2007 Service Pack 2 en Microsoft Excel 2007 Service Pack 3                                           |
...
<th>
Beveiligingslek met betrekking tot ontregeld geheugen in record - CVE-2011-3403
</th>
<th>
Prioriteitsniveau
</th>
...
Zie [CVE 2011-3403](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3403) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor beveiligingslek met betrekking tot ontregeld geheugen in record - CVE-2011-3403
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot ontregeld geheugen in record - CVE-2011-3403
...
#### Veelgestelde vragen over beveiligingslek met betrekking tot ontregeld geheugen in record - CVE-2011-3403
...
Voor misbruik van dit beveiligingslek is het noodzakelijk dat een gebruiker een speciaal ontworpen Excel-bestand opent in een getroffen versie van Microsoft Excel.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2596954">Microsoft Knowledge Base-artikel 2596954</a></td>
</tr>
<tr class="even">
...
Download en installeer de juiste taalversie van de update voor Microsoft Office 2004 voor Mac 11.6.6 vanuit het [Microsoft Downloadcentrum](http://www.microsoft.com/downloads/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a).
...
-   Open het volume van de Microsoft Office 2004 voor Mac 11.6.6-beveiligingsupdate op uw computer. Deze stap kan al voor u zijn uitgevoerd.  
-   Begin het updateproces door in het venster van het volume van de Microsoft Office 2004 voor Mac 11.6.6-update te dubbelklikken op de toepassing Microsoft Office 2004 voor Mac 11.6.6-update. Volg de aanwijzingen op het scherm.  
-   Als de update is geïnstalleerd, kunt u het installatieprogramma van de vaste schijf verwijderen. Zie “Controleren of de update is geïnstalleerd” als u wilt controleren of de update is geslaagd. U verwijdert het installatieprogramma van deze update door eerst het volume van de Microsoft Office 2004 voor Mac 11.6.6-update naar de prullenbak te slepen en vervolgens het gedownloade bestand naar de prullenbak te slepen.
...
Is het versienummer **11.6.6**, dan is de update met succes geïnstalleerd.
...
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com/), voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in record (CVE-2011-3403)
...
-   V1.1 (21 december 2011): Aan de tabel Software waarin het probleem niet optreedt is Microsoft Office Compatibility Pack Service Pack 3 toegevoegd. Het gaat alleen om een wijziging in de informatie. Er waren geen veranderingen in de detectielogica of de updatebestanden.
