---
TOCTitle: 'MS11-098'
Title: 'Microsoft-beveiligingsbulletin MS11-098 - Belangrijk'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61232065
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-098(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-098 - Belangrijk
====================================================

Beveiligingslek in Windows-kernel kan leiden tot misbruik van bevoegdheden (2633171)
------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 13 december 2011 | Bijgewerkt: woensdag 1 februari 2012
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde 32-bits edities van Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, en Windows 7. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek door ervoor te zorgen dat de Windows-kernel objecten in het geheugen initialiseert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

**Aanbeveling.** Als het gaat om beheerders en bedrijfinstallaties of eindgebruikers die deze beveiligingsupdate handmatig willen installeren, adviseert Microsoft klanten de update zo snel mogelijk toe te passen met behulp van de software voor updatebeheer of door op updates te controleren met de service [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).

Zie ook de sectie **Hulpmiddelen en richtlijnen voor detecteren en implementeren**, verderop in dit bulletin.

**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2633171](http://support.microsoft.com/kb/2633171) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                             | Misbruik van bevoegdheden               | Belangrijk        | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                                    | Misbruik van bevoegdheden               | Belangrijk        | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                          | Misbruik van bevoegdheden               | Belangrijk        | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                            | Misbruik van bevoegdheden               | Belangrijk        | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | Misbruik van bevoegdheden               | Belangrijk        | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot uitzonderingshandler in Windows-kernel - CVE-2011-2018</th>
...
Beveiligingslek met betrekking tot uitzonderingshandler in Windows-kernel - CVE-2011-2018  
-----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in de Windows-kernel door de manier waarop de kernel toegang heeft tot een object dat niet correct is geïnitialiseerd. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2011-2018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de Windows-kernel door uitzonderingshandler - CVE-2011-2018
...
#### Tijdelijke oplossingen voor het beveiligingslek in de Windows-kernel door uitzonderingshandler - CVE-2011-2018
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in de Windows-kernel door uitzonderingshandler - CVE-2011-2018
...
Het beveiligingslek wordt veroorzaakt wanneer de Windows-kernel toegang krijgt tot een object dat niet correct is geïnitialiseerd.
...
**Wat doet de update?**  
De update lost het beveiligingslek door ervoor te zorgen dat de Windows-kernel objecten in het geheugen initialiseert.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2633171$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2633171">Microsoft Knowledge Base-artikel 2633171</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2633171$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2633171](http://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com/), voor het melden van het beveiligingslek met betrekking tot uitzonderingshandler in Windows-kernel (CVE-2011-2018)
...
-   V1.1 (1 februari 2012): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2633171 onder Bekende problemen in de Samenvatting.
