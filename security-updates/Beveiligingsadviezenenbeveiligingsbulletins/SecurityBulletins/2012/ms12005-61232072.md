---
TOCTitle: 'MS12-005'
Title: 'Microsoft-beveiligingsbulletin MS12-005 - Belangrijk'
ms:assetid: 'ms12-005'
ms:contentKeyID: 61232072
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-005(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS12-005 - Belangrijk
====================================================

Een beveiligingslek in Microsoft Windows kan leiden tot uitvoering van externe code (2584146)
---------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop Windows Packager controleert op onveilige bestanden. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                       | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                              | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                              | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                  | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                               | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
**Bestaat er een verband tussen deze beveiligingsupdate en** **MS12-002?**
Nee. Hoewel beide beveiligingsupdates van invloed zijn op Windows Packager, zijn de updates van invloed op verschillende onderdelen. Er bestaat geen verband tussen de updates. Deze updates kunnen in willekeurige volgorde worden toegepast.

**Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging?**
Ja, deze update wijzigt de manier waarop Windows Packager onveilige bestanden identificeert.
...
<th>
Beveiligingslek met betrekking tot het uitvoeren van assembly's - CVE-2012-0013
</th>
<th colspan="2">
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop ClickOnce-toepassingen in Microsoft Office-bestanden worden geladen door Windows Packager.

Zie [CVE-2012-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het uitvoeren van assembly's - CVE-2012-0013
...
-   Een ClickOnce-implementatie kan alleen via een netwerk worden gebruikt als het implementatiemanifest en toepassingsmanifest van de implementatie beide zijn ondertekend met een digitaal certificaat.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het uitvoeren van assembly's - CVE-2012-0013

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **De** **.application-bestandskoppeling verwijderen**
    ...
    **Opmerking** Als u de Register-editor onjuist gebruikt, kan dit tot zeer ernstige problemen leiden waardoor u het besturingssysteem mogelijk opnieuw dient te installeren. Microsoft kan niet garanderen dat problemen die ontstaan als gevolg van een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico. Zie voor meer informatie over het bewerken van het register het Help-onderwerp "Sleutels en waarden wijzigen" in de Register-editor (regedit.exe) of de Help-onderwerpen "Toevoegen of verwijderen van registerinformatie" en "Registergegevens bewerken" in regedt32.exe.
    ...
    Voer de volgende stappen uit als u de .application-bestandskoppeling wilt verwijderen:

    **Met de interactieve methode**

    1.  Klik op **Start** en vervolgens op **Uitvoeren**. Typ **regedit** en klik vervolgens op **OK.**
    2.  Vouw **HKEY\_CLASSES\_ROOT** uit, klik op **.application** en klik vervolgens op het menu **Bestand** en selecteer **Exporteren.**
    3.  Typ in het dialoogvenster **Registerbestand exporterenapplication HKCR file association registry backup.reg** en klik op **Opslaan**.
    ...
    5.  Vouw **HKEY\_CURRENT\_USER** uit en vervolgens **Software**, dan **Microsoft**, dan **Windows**, dan **CurrentVersion**, dan **Explorer** en dan **FileExts**.
    6.  Klik op **.application** en klik vervolgens op het menu **Bestand** en selecteer **Exporteren.**
    7.  Typ in het dialoogvenster **Registerbestand exporterenapplication HKCU** **file association registry backup.reg** en klik op **Opslaan**.
        **Opmerking** Hierdoor wordt er standaard een back-up van deze registersleutel in de map Mijn documenten gemaakt**.**
    8.  Druk op **Verwijderen** om de registersleutel te verwijderen. Klik op **Ja** wanneer u wordt gevraagd of u de registerwaarde wilt verwijderen**.**

    **Een script voor een beheerde implementatie gebruiken**

    1.  Maak een back-up van de registersleutels met de volgende opdracht:
    ...
    2.  Sla de volgende gegevens op in een bestand met de extensie .REG, bijvoorbeeld Delete\_Application\_File\_Association.reg:

        `Windows Registry-editor versie 5.00[-HKEY_CLASSES_ROOT\.application][-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application]`
    ...
    **Gevolgen van de tijdelijke oplossing.** Met deze tijdelijke oplossing wordt de .application-bestandskoppeling ongedaan gemaakt. Als u dubbelklikt op een toepassingsbestand, wordt de toepassing niet gestart.
    ...
    **De tijdelijke oplossing ongedaan maken.**
    ...
    3.  Selecteer **application HKCR file association registry backup.reg** in het dialoogvenster Registerbestand importeren en klik op **Openen**.
    4.  Klik op het menu **Bestand** en selecteer **Importeren.**
    5.  Selecteer **application HKCU** **file association registry backup.reg** in het dialoogvenster Registerbestand importeren en klik op **Openen**.

    Een script voor een beheerde implementatie gebruiken

    Herstel de oorspronkelijke toestand door de volgende opdrachten uit te voeren:

    `Regedit.exe /s application_HKCR_registry_backup.regRegedit.exe /s application_HKCU_registry_backup.reg`

#### Veelgestelde vragen over het beveiligingslek met betrekking tot het uitvoeren van assembly's - CVE-2012-0013
...
Dit beveiligingslek wordt veroorzaakt door ClickOnce-toepassingsbestanden die geen deel uitmaken van de lijst met onveilige bestandstypen van Windows Packager, waardoor ClickOnce-toepassingen kunnen worden ingesloten in Microsoft Office-documenten.

**Wat is ClickOnce?**
ClickOnce is een implementatietechnologie waarmee ontwikkelaars toepassingen voor Windows die automatisch worden bijgewerkt kunnen creëren. Deze toepassingen kunnen worden geïnstalleerd en uitgevoerd met minimale gebruikersinteractie. Een ClickOnce-toepassing is een Windows Presentation Foundation (.xbap), Windows Forms (.exe), consoletoepassing (.exe) of Office-oplossing (.dll) die wordt gepubliceerd met behulp van ClickOnce-technologie. ClickOnce-toepassingen kunnen op drie verschillende manieren worden gepubliceerd: op een website, op een gedeelde netwerklocatie of op media zoals een CD-ROM. Zie het MSDN-artikel [ClickOnce Security and Deployment](http://msdn.microsoft.com/en-us/library/t71a733d.aspx) voor meer informatie.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Door dit beveiligingslek kunnen aanvallers installatieprogramma's voor ClickOnce-toepassingen invoegen in Microsoft Office-documenten en code uitvoeren zonder gebruikersinteractie.

**Hoe kan een aanvaller dit beveiligingslek** **misbruiken?**
Dit beveiligingslek kan alleen worden misbruikt als een gebruiker een speciaal vervaardigd Microsoft Office-bestand opent.

In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een speciaal gemaakt Microsoft Office-bestand met een ingesloten ClickOnce-toepassing naar de gebruiker te verzenden en de gebruiker ertoe te bewegen dat bestand te openen.

In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website waarop zich een Office-bestand bevindt waarmee wordt geprobeerd dit beveiligingslek te misbruiken. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat. Vervolgens moet de aanvaller de gebruiker ertoe overhalen het speciaal vervaardigde bestand te openen.
...
**Wat doet de update?**
De update wijzigt de manier waarop Windows Packager op onveilige bestanden controleert.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2584146">Microsoft Knowledge Base-artikel 2584146</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2584146$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2584146](http://support.microsoft.com/kb/2584146)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Yorick Koster in samenwerking met het [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html)-programma voor het melden van het beveiligingslek met betrekking tot het uitvoeren van assembly's - (CVE-2012-0013)
