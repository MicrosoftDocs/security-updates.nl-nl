---
TOCTitle: 'MS12-037'
Title: 'Microsoft-beveiligingsbulletin MS12-037 - Kritiek'
ms:assetid: 'ms12-037'
ms:contentKeyID: 61232104
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-037(v=Security.10)'
---
...
<td style="border:1px solid black;">
KB2675157 in [MS12-023](http://go.microsoft.com/fwlink/?linkid=242739) is vervangen door KB2699988
</td>
</tr>
...
**Welk verband bestaat er tussen deze beveiligingsupdate en MS12-039?**
Het beveiligingslek met betrekking tot het opschonen van HTML (CVE-2012-1858) dat wordt beschreven in dit bulletin, treft ook Microsoft Lync. U kunt echter alleen de updates installeren die van toepassing zijn op de software die u op uw systemen hebt geïnstalleerd. Als u Internet Explorer hebt geïnstalleerd, past u de vereiste updates volgens dit bulletin toe. Als u Microsoft Lync hebt geïnstalleerd, past u de noodzakelijke updates volgens [MS12-039](http://go.microsoft.com/fwlink/?linkid=252488) toe.

**Hoe worden** **Server Core-installaties getroffen door de beveiligingslekken die worden beschreven in dit bulletin?**
De beveiligingslekken die in deze update worden beschreven, hebben geen invloed op ondersteunde edities van Windows Server 2008 of Windows Server 2008 R2 indien geïnstalleerd met behulp van de Server Core-installatieoptie. Zie de TechNet-artikelen [Managing a Server Core Installation](http://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx) en [Servicing a Server Core Installation](http://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx) voor meer informatie over deze installatieoptie. De Server Core-installatieoptie kan niet worden toegepast op bepaalde edities van Windows Server 2008 en Windows Server 2008 R2. Zie hiervoor [Server Core-installatieopties vergelijken](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).

**Wordt Windows 8 Consumer Preview getroffen door de beveiligingslekken die in dit bulletin worden opgelost?**
Ja. De KB2699988-update is beschikbaar voor de Windows 8 Consumer Preview. Klanten met Windows 8 Consumer Preview worden aangeraden de updates toe te passen op hun systemen. De updates zijn alleen beschikbaar via [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
**Bevat deze update** **functionaliteitswijzigingendie geen betrekking hebben op beveiliging?**
Ja. Naast de wijzigingen die in het gedeelte Informatie over het beveiligingslek van dit bulletin zijn opgenomen, bevat deze update ook functionele wijzigingen voor Internet Explorer 7. Deze wijzigingen zorgen ervoor dat er geen compatibiliteitsproblemen ontstaan na de installatie van deze update.
...
Zie [CVE-2012-1523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1523) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in centrale elementen - CVE-2012-1523
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in centrale elementen - CVE-2012-1523
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in centrale elementen - CVE-2012-1523
...
**Wat is de omvang van het beveiligingslek?**
Dit is een beveiligingslek met betrekking tot het vrijgeven van informatie. Een aanvaller die misbruik maakt van het beveiligingslek wanneer een gebruiker een webpagina bekijkt die gebruikmaakt van de toStaticHTML-methode, kan een aanval met cross-site scripting uitvoeren.
...
**Wat is de** **toStaticHTML-** **methode?**
De toStaticHTML-methode kan worden gebruikt om gebeurteniskenmerken en script te verwijderen van gebruikersinvoer voordat deze worden weergegeven als HTML. Zie [toStaticHTML method](http://msdn.microsoft.com/en-us/library/cc848922.aspx) voor meer informatie.

**Bestaat er een verband tussen dit beveiligingslek en CVE-2012-1858 in MS12-039, Door beveiligingslekken in** **Lync** **kan externe code worden uitgevoerd?**
Ja, het beveiligingslek met betrekking tot het opschonen van HTML, CVE-2012-1858, treft ook Microsoft Lync.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Een aanvaller die misbruik weet te maken van het beveiligingslek, kan aanvallen met cross-site scripting uitvoeren tegen gebruikers die een website bekijken die de toStaticHTML-methode gebruikt om HTML op te schonen. Een aanvaller kan dan mogelijk script uitvoeren namens de websitegebruiker die slachtoffer is van deze aanval.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Internet Explorer HTML opschoont met de toStaticHTML-methode.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het vrijgeven van informatie in Internet Explorer waardoor via script aanvallen met cross-site scripting kunnen worden uitgevoerd. Een aanvaller kan misbruik maken van het beveiligingslek door speciaal vervaardigde tekenreeksen in te voegen in een website, waardoor informatie wordt vrijgegeven wanneer een gebruiker de website bekijkt.

Zie [CVE-2012-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1872) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot tekencodering in EUC-JP - CVE-2012-1872
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot tekencodering in EUC-JP - CVE-2012-1872
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot tekencodering in EUC-JP - CVE-2012-1872

**Wat is de omvang van het beveiligingslek?**
Dit is een beveiligingslek met betrekking tot cross-site scripting dat kan leiden tot onrechtmatig vrijgeven van informatie.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Bij bepaalde processen verwerkt Internet Explorer bepaalde tekenreeksen onjuist, waardoor websites onvoldoende filtering toepast.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Een aanvaller die misbruik weet te maken van dit beveiligingslek kan aanvallen met cross-site scripting uitvoeren, waardoor onrechtmatig informatie wordt vrijgegeven wanneer een gebruiker een getroffen website bekijkt.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller kan tekenreeksen invoegen in een website die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen deze website te bekijken. Een aanvaller kan een gebruiker er echter niet toe dwingen om naar deze website te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een chatbericht te klikken waarmee de gebruiker naar de website met de schadelijke inhoud gaat.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het vrijgeven van informatie in Internet Explorer dat ertoe kan leiden dat een aanvaller toegang krijgt tot het procesgeheugen van Internet Explorer en dit geheugen kan lezen. Een aanvaller kan het beveiligingslek misbruiken door een speciale webpagina samen te stellen die vrijgave van informatie mogelijk maakt als een gebruiker de webpagina heeft bezocht. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan inhoud weergeven uit het procesgeheugen van Internet Explorer.

Zie [CVE-2012-1873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1873) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het vrijgeven van informatie door null-bytes - CVE-2012-1873
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van informatie door null-bytes - CVE-2012-1873
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van informatie door null-bytes - CVE-2012-1873

**Wat is de omvang van het beveiligingslek?**
Dit is een beveiligingslek met betrekking tot het vrijgeven van informatie.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Tijdens bepaalde processen wordt in Internet Explorer ten onrechte toegestaan dat aanvallers toegang hebben tot en inhoud lezen uit het procesgeheugen.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan inhoud weergeven uit het procesgeheugen van Internet Explorer.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Internet Explorer tekenreeksen maakt en initialiseert.
...
Zie [CVE-2012-1874](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1874) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in de werkbalk voor ontwikkelaars - CVE-2012-1874
...
-   HTML-e-mailberichten worden door alle ondersteunde versies van Microsoft Outlook en Microsoft Outlook Express en Windows Mail standaard geopend in de zone Websites met beperkte toegang. De zone Websites met beperkte toegang, die script- en ActiveX-besturingselementen uitschakelt, vermindert het risico dat een aanvaller gebruik kan maken van dit beveiligingslek om schadelijke code uit te voeren. Als een gebruiker op een koppeling in een e-mailbericht klikt, kan deze nog wel als gevolg van het beveiligingslek via een aanval vanaf het web worden getroffen.
-   Standaard wordt Internet Explorer op Windows Server 2003, Windows Server 2008 en Windows Server 2008 R2 uitgevoerd in een beperkte modus genaamd [Verbeterde beveiliging](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Deze modus vermindert het probleem van dit beveiligingslek. Zie het gedeelte Veelgestelde vragen met betrekking tot dit beveiligingslek voor meer informatie over Verbeterde beveiliging van Internet Explorer.
-   Er is gebruikersinteractie vereist voordat de aanvaller misbruik kan maken van dit beveiligingslek. De gebruiker moet de werkbalk voor ontwikkelaars voor Internet Explorer openen tijdens het bezoeken van een speciaal vervaardigde website.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in de werkbalk voor ontwikkelaars - CVE-2012-1874
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in de werkbalk voor ontwikkelaars - CVE-2012-1874
...
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller kan over een website beschikken die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen deze website te bekijken en de werkbalk voor ontwikkelaars in Internet Explorer te openen. Een aanvaller kan ook een ActiveX-besturingselement dat is gemarkeerd als "veilig voor initialisering" invoegen in een toepassing of Microsoft Office-document met de IE-engine. De aanvaller zou ook misbruik kunnen maken van gemanipuleerde websites en websites die inhoud of advertenties van gebruikers accepteren of hosten. Deze websites kunnen speciaal vervaardigde inhoud bevatten, die misbruik van dit beveiligingslek kan maken. Een aanvaller kan een gebruiker er echter niet toe dwingen de inhoud van de aanvaller weer te geven. In plaats daarvan zou een aanvaller gebruikers ertoe moeten overhalen een handeling uit te voeren, doorgaans door op een koppeling in een e-mailbericht of een Instant Messenger-bericht te klikken, waardoor de gebruiker naar de website van de aanvaller gaat, of door een bijlage bij een e-mail te openen.
...
Zie [CVE-2012-1875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1875) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID - CVE-2012-1875
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID - CVE-2012-1875
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID - CVE-2012-1875
...
**Was aan Microsoft gerapporteerd dat er misbruik was gemaakt van dit beveiligingslek op het moment dat dit beveiligingsbulletin werd uitgegeven?**
Ja. Microsoft is op de hoogte van beperkte aanvallen waarbij wordt geprobeerd het beveiligingslek te misbruiken. Op het moment dat het beveiligingslek werd uitgegeven had Microsoft echter nog geen voorbeelden van bewijs van gepubliceerde conceptcode gezien.

Beveiligingslek met betrekking tot uitvoering van externe code in COL-elementen - CVE-2012-1876
-----------------------------------------------------------------------------------------------

<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer een object opent dat niet bestaat. Het beveiligingslek kan geheugen op dusdanige wijze ontregelen dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.

Zie [CVE 2012-1876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1876) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in COL-elementen - CVE-2012-1876
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in COL-elementen - CVE-2012-1876
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in COL-elementen - CVE-2012-1876

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op de uitvoering van externe code.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Wanneer Internet Explorer toegang probeert te krijgen tot een object dat niet bestaat, kan het geheugen dusdanig worden ontregeld dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Internet Explorer objecten in het geheugen opent.
...
Zie [CVE-2012-1877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1877) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in titelelementen - CVE-2012-1877
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in titelelementen - CVE-2012-1877
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in titelelementen - CVE-2012-1877
...
Zie [CVE-2012-1878](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1878) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in OnBeforeDeactivate met betrekking tot het uitvoeren van externe code - CVE-2012-1878
...
#### Tijdelijke oplossingen voor het beveiligingslek in OnBeforeDeactivate met betrekking tot het uitvoeren van externe code - CVE-2012-1878
...
#### Veelgestelde vragen over het beveiligingslek in OnBeforeDeactivate met betrekking tot het uitvoeren van externe code - CVE-2012-1878
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop Internet Explorer een ongedefinieerde geheugenlocatie opent. Het beveiligingslek kan geheugen op dusdanige wijze ontregelen dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.

Zie [CVE-2012-1879](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1879) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in insertAdjacentText met betrekking tot het uitvoeren van externe code - CVE-2012-1879
...
#### Tijdelijke oplossingen voor het beveiligingslek in insertAdjacentText met betrekking tot het uitvoeren van externe code - CVE-2012-1879
...
#### Veelgestelde vragen over het beveiligingslek in insertAdjacentText met betrekking tot het uitvoeren van externe code - CVE-2012-1879

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op de uitvoering van externe code.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Wanneer Internet Explorer in bepaalde omstandigheden probeert toegang te krijgen tot een ongedefinieerde geheugenlocatie, kan het geheugen zodanig ontregeld raken dat een aanvaller willekeurige code kan uitvoeren in de context van de huidige gebruiker.
...
Zie [CVE-2012-1880](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1880) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in insertRow - CVE-2012-1880
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in insertRow - CVE-2012-1880
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in insertRow - CVE-2012-1880
...
Zie [CVE-2012-1881](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1881) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in OnRowsInserted met betrekking tot het uitvoeren van externe code - CVE-2012-1881
...
#### Tijdelijke oplossingen voor het beveiligingslek in OnRowsInserted met betrekking tot het uitvoeren van externe code - CVE-2012-1881
...
#### Veelgestelde vragen over het beveiligingslek in OnRowsInserted met betrekking tot het uitvoeren van externe code - CVE-2012-1881
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het vrijgeven van informatie in Internet Explorer waardoor een aanvaller toegang kan krijgen tot informatie in een ander domein of andere Internet Explorer-zone. Een aanvaller kan het beveiligingslek misbruiken door een speciale webpagina samen te stellen die vrijgave van informatie mogelijk maakt als een gebruiker de webpagina heeft bezocht. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan inhoud van een ander domein of een andere Internet Explorer-zone bekijken.

Zie [CVE-2012-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het vrijgeven van informatie bij bladeren - CVE-2012-1882
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van informatie bij bladeren - CVE-2012-1882
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van informatie bij bladeren - CVE-2012-1882

**Wat is de omvang van het beveiligingslek?**
Dit is een beveiligingslek met betrekking tot het vrijgeven van informatie.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Internet Explorer kan bladeren naar een ander domein niet blokkeren, waardoor aanvallers toegang kunnen krijgen tot inhoud van andere domeinen.
...
**Wat doet de update?**
De update lost het beveiligingslek doordat bladeren naar een ander domein wordt geblokkeerd in Internet Explorer.

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2012-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882) toegewezen.
...
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2699988$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB2699988-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB2699988-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2699988">Microsoft Knowledge Base-artikel 2699988</a></td>
</tr>
<tr class="even">
...
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com/), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in centrale elementen (CVE-2012-1523)  
...
-   Code Audit Labs van [VulnHunt](http://www.vulnhunt.com) voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in de werkbalk voor ontwikkelaars (CVE-2012-1874)  
-   Dark Son van [VulnHunt](http://www.vulnhunt.com) voor het melden van het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID (CVE-2012-1875)  
-   [Qihoo 360 Security Center](http://www.360.cn/) voor de samenwerking bij het oplossen van het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID (CVE-2012-1875)  
...
-   [Google Inc.](http://www.google.com/) voor de samenwerking bij het oplossen van het beveiligingslek met betrekking tot het uitvoeren van externe code in dezelfde ID (CVE-2012-1875)  
-   [VUPEN Security](http://www.vupen.com), in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in COL-elementen (CVE-2012-1876)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in titelelementen (CVE-2012-1877)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek in OnBeforeDeactivate met betrekking tot het uitvoeren van externe code (CVE-2012-1878)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek in insertAdjacentText met betrekking tot het uitvoeren van externe code (CVE-2012-1879)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in insertRow (CVE-2012-1880)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/), voor het melden van het beveiligingslek in OnRowsInserted met betrekking tot het uitvoeren van externe code (CVE-2012-1881)
