---
TOCTitle: 'MS06-SEP'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor september 2006'
ms:assetid: 'ms06-sep'
ms:contentKeyID: 61231941
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms06-sep(v=Security.10)'
author: SharonSears
...
Samenvatting van de Microsoft-beveiligingsbulletins voor september 2006
=======================================================================
...
-   Eindgebruikers kunnen naar de volgende website gaan: [Beveilig uw pc](http://www.microsoft.com/netherlands/thuisgebruikers/beveiliging/protect/windowsxp/default.mspx).
...
<span></span>
| Bulletin-id                           | Microsoft-beveiligingsbulletin MS06-054                                                                                                                                  |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                    | [**Door een beveiligingslek in Microsoft Publisher is externe uitvoering van code mogelijk (910729) (910729)**](http://technet.microsoft.com/security/bulletin/ms06-054) |
| **Samenvatting**                      | Met deze update herstelt u een beveiligingslek in Publisher waardoor code extern kan worden uitgevoerd.                                                                  |
...
<span></span>
| Bulletin-id                           | Microsoft-beveiligingsbulletin MS06-052                                                                                                                                                                            |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                    | [**Met deze update wordt een beveiligingslek in het betrouwbare Multicast-programma (PGM) opgelost dat kan leiden tot een 'denial of service' (919007)**](http://technet.microsoft.com/security/bulletin/ms06-052) |
| **Samenvatting**                      | Met deze update wordt een beveiligingslek in het betrouwbare Multicast-programma (PGM) opgelost dat kan leiden tot een 'denial of service'.                                                                        |
...
<span></span>
| Bulletin-id                           | Microsoft-beveiligingsbulletin MS06-053                                                                                                                |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titel bulletin**                    | [**Beveiligingslek in de Indexing-service kan cross-site scripting mogelijk maken (920685)**](http://technet.microsoft.com/security/bulletin/ms06-053) |
| **Samenvatting**                      | Met deze update wordt een beveiligingslek in de Indexing-service opgelost dat kan leiden tot het vrijgeven van informatie.                             |
...
#### Software waarin het probleem optreedt, en downloadlocaties voor MS06-052 tot en met MS06-054
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0182e8e7-9755-46cc-a393-c1e95fd508b2">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e3e4a66c-ca9d-453b-8875-fb57528117ac">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=acf35f34-0d26-4b79-b81f-1111a784a66d">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ce264ac4-6ca3-4732-9016-3143ff1bca2f">Belangrijk</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2731c0bf-6034-4c16-bb57-66e70a31a3d6">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3f604b2a-1383-4a45-b25b-c468deefbfc1">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=778294ae-c5e3-4f17-b0e4-308e46e00105">Matig</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=461a126b-596f-4e84-99fd-03554ac55213">Kritiek</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Publisher 2002</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0356b9fb-2cd5-4a50-95f6-54846d39b6ea">Belangrijk</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Publisher 2003</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2eeb43f1-e2b6-4b78-98a1-e8b04242438a">Belangrijk</a></td>
</tr>
</tbody>
</table>
...
-   David Warden voor het melden van een probleem dat wordt beschreven in [MS06-052](http://technet.microsoft.com/security/bulletin/ms06-052).  
-   Eiji James Yoshida voor het melden van een probleem dat wordt beschreven in [MS06-053](http://technet.microsoft.com/security/bulletin/ms06-053).  
-   Stuart Pearson van [Computer Terrorism](http://www.computerterrorism.com/) voor het melden van een probleem dat wordt beschreven in [MS06-054](http://technet.microsoft.com/security/bulletin/ms06-054).
