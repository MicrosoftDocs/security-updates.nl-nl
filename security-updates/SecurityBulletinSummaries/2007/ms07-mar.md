---
TOCTitle: 'MS07-MAR'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor maart 2007'
ms:assetid: 'ms07-mar'
...
Samenvatting van de Microsoft-beveiligingsbulletins voor maart 2007
===================================================================
...
In dit bulletin wordt een overzicht gegeven van de beveiligingsbulletins voor maart 2007.

**Beveiligingscentrum:** Microsoft biedt op de volgende locaties informatie over de beveiliging van uw pc:
...
-   IT-professionals kunnen naar de volgende website gaan: [TechNet Security Center](http://www.microsoft.com/netherlands/thuisgebruikers/beveiliging/default.mspx).
...
Microsoft heeft geen beveiligingsbulletins uitgegeven op 13 maart 2007.
...
-   Microsoft heeft op Microsoft Update (MU) en Windows Server Update Services (WSUS) twee belangrijke **niet-beveiligingsupdates** voor Windows uitgegeven.
-   Microsoft heeft vier belangrijke **niet-beveiligingsupdates** voor Windows op Windows Update (WU) en Software Update Services (SUS) uitgegeven.
...
-   V1.0 (13 maart 2007): Samenvatting van de gepubliceerde bulletins.
