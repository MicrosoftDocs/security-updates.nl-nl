---
TOCTitle: 'MS09-SEP'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor september 2009'
ms:assetid: 'ms09-sep'
...
Samenvatting van de Microsoft-beveiligingsbulletins voor september 2009
=======================================================================
...
In dit bulletin wordt een overzicht gegeven van de beveiligingsbulletins voor september 2009.

Met de bulletins voor september 2009 wordt de vooraankondiging van de bulletins, die oorspronkelijk werd uitgegeven op 3 september 2009, vervangen. Ga voor meer informatie over de vooraankondiging naar [Vooraankondiging van Microsoft-beveiligingsbulletins](http://technet.microsoft.com/security/bulletin/advance).
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in de scripting engine voor JScript kan externe code worden uitgevoerd (971961)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in de Wireless LAN AutoConfig-service kan externe code worden uitgevoerd (970710)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door beveiligingslekken in Windows Media Format kan externe code worden uitgevoerd (973812)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door beveiligingslekken in Windows TCP/IP kan externe code worden uitgevoerd (967723)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in het ActiveX-besturingselement DHTML Editing-onderdeel kan externe code worden uitgevoerd (956844)</strong><br />
<br />
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in het ActiveX-besturingselement DHTML Editing-onderdeel opgelost. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Kritiek</a><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Opnieuw starten mogelijk vereist</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|  
| [MS09-045](http://technet.microsoft.com/security/bulletin/ms09-045) | Door een beveiligingslek in de scripting engine voor JScript kan externe code worden uitgevoerd (971961)                      | [CVE-2009-1920](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1920) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Consistente exploitatiecode is waarschijnlijk   | (Geen)                                                                                                                             |  
| [MS09-046](http://technet.microsoft.com/security/bulletin/ms09-046) | Door een beveiligingslek in het ActiveX-besturingselement DHTML Editing-onderdeel kan externe code worden uitgevoerd (956844) | [CVE-2009-2519](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Inconsistente exploitatiecode is waarschijnlijk | (Geen)                                                                                                                             |  
| [MS09-047](http://technet.microsoft.com/security/bulletin/ms09-047) | Door beveiligingslekken in Windows Media Format kan externe code worden uitgevoerd (973812)                                   | [CVE-2009-2498](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2498) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Consistente exploitatiecode is waarschijnlijk   | (Geen)                                                                                                                             |  
| [MS09-047](http://technet.microsoft.com/security/bulletin/ms09-047) | Door beveiligingslekken in Windows Media Format kan externe code worden uitgevoerd (973812)                                   | [CVE-2009-2499](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2499) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Consistente exploitatiecode is waarschijnlijk   | (Geen)                                                                                                                             |  
| [MS09-048](http://technet.microsoft.com/security/bulletin/ms09-048) | Door beveiligingslekken in Windows TCP/IP kan externe code worden uitgevoerd (967723)                                         | [CVE-2008-4609](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4609) | [**3**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Kans op werkende exploitatiecode is gering      | Dit is een type Denial of Service door geheugenverbruik.                                                                           |  
| [MS09-048](http://technet.microsoft.com/security/bulletin/ms09-048) | Door beveiligingslekken in Windows TCP/IP kan externe code worden uitgevoerd (967723)                                         | [CVE-2009-1925](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1925) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Inconsistente exploitatiecode is waarschijnlijk | De kans op werkende exploitatiecode bestaat maar is niet echt waarschijnlijk. Denial of service is een waarschijnlijker resultaat. |  
| [MS09-048](http://technet.microsoft.com/security/bulletin/ms09-048) | Door beveiligingslekken in Windows TCP/IP kan externe code worden uitgevoerd (967723)                                         | [CVE-2009-1926](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1926) | [**3**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Kans op werkende exploitatiecode is gering      | Dit is een type Denial of Service door geheugenverbruik.                                                                           |  
| [MS09-049](http://technet.microsoft.com/security/bulletin/ms09-049) | Door een beveiligingslek in de Wireless LAN AutoConfig-service kan externe code worden uitgevoerd (970710)                    | [CVE-2009-1132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1132) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Inconsistente exploitatiecode is waarschijnlijk | Door heap-bescherming is het moeilijk op betrouwbare wijze misbruik te maken van dit beveiligingslek.                              |
...
<td style="border:1px solid black;">
[JScript 5.1 en JScript 5.6](http://www.microsoft.com/downloads/details.aspx?familyid=2bb3af8d-f36c-4497-9f48-fc59bcff2583)  
(KB971961)  
(Kritiek)  
...
<td style="border:1px solid black;">
[JScript 5.6 op Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0af373b2-2240-4079-a748-a38d1bc06f39)  
(KB971961)  
(Kritiek)  
[JScript 5.7 op Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c933377d-e0bc-4334-bc75-029045d7a62a)<sup>[1]</sup>
(KB971961)  
(Kritiek)  
[JScript 5.7 op Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c933377d-e0bc-4334-bc75-029045d7a62a)  
(KB971961)  
(Kritiek)  
...
<td style="border:1px solid black;">
Windows XP Service Pack 2 en Windows XP Service Pack 3<sup>[3]</sup>
(Laag)
</td>
<td style="border:1px solid black;">
[Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8523d5be-88a2-4124-9b02-660f612e2a12)  
(Kritiek)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=c948c4d8-5788-4c1a-9fb6-a969b06a888d)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=8d881ff8-f51f-4476-8cb6-2bebd5b2047f)  
(Gemiddeld)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9fe967f-d78d-43c2-bbcc-5098bd20267e)  
(Kritiek)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d72f845-9feb-4685-a669-f9d6ab54f9ed)  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f93470bd-2e6d-4340-88c6-bb212baf750a)  
(Kritiek)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b2930ff1-5f0a-4a5d-bf2a-9fb76dd8da63)  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac3f6800-bc3e-4b35-a482-54e1a2da1ab5)\*\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=35c1d5a9-a953-4fc6-90c0-d2358c7b89e6)\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d1b9b4f-bf35-44aa-a660-afb2ef2c9e30)\*\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e46822e-f79d-492d-ad01-ee680ad324f5)\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ac76ee2-b1b6-4300-9cba-af33d9dd54eb)  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
**Opmerkingen voor MS09-045**

<sup>[1]</sup>Op systemen waarop Internet Explorer 7 is geïnstalleerd

<sup>[2]</sup>Op systemen waarop Internet Explorer 8 is geïnstalleerd

**Opmerking voor MS09-048**

<sup>[3]</sup> Geen update beschikbaar. Zie het onderdeel **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** in [MS09-048](http://technet.microsoft.com/security/bulletin/ms09-048) voor meer informatie.
...
-   Ling en Wushi van [team509](http://www.team509.com/), die samenwerken met [Zero Day Initiative](http://www.zerodayinitiative.com/) van Tipping Point, voor het melden van een probleem dat wordt beschreven in MS09-045
-   Tavis Ormandy van [Google Inc.](http://www.google.com/) voor het melden van een probleem dat wordt beschreven in MS09-046
-   Peter Winter-Smith van [NGS Software](http://www.ngssoftware.com/) voor het melden van een probleem dat wordt beschreven in MS09-047
-   Hiroshi Noguchi van de Alice Carroll-fanclub voor het melden van een probleem dat wordt beschreven in MS09-047
-   Jack C. Louis van www.outpost24,com voor het melden van een probleem dat wordt beschreven in MS09-048
-   Fabian Yamaguchi van [Recurity Labs GmbH](http://www.recurity-labs.com/) voor het melden van een probleem dat wordt beschreven in MS09-048
...
-   V1.0 (8 september 2009): Samenvatting van de gepubliceerde bulletins.
-   V2.0 (9 september 2009): Windows XP Service Pack 2, Windows XP Service Pack 3 en Windows XP Professional x64 Edition Service Pack 2 is toegevoegd aan het overzicht met software die kwetsbaar is voor MS09-048. Voor deze platforms is echter geen update beschikbaar. Zie het onderdeel **Veelgestelde Vragen met betrekking tot deze beveiligingsupdate** in MS09-048. De in dit bulletin aangeboden beveiligingsupdates zijn niet gewijzigd.
-   V3.0 (10 november 2009): JScript 5.7 op Microsoft Windows 2000 Service Pack 4 is toegevoegd aan de tabel met software waarin dit probleem optreedt tabel voor MS09-045.
