---
TOCTitle: 'MS11-DEC'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor december 2011'
ms:assetid: 'ms11-dec'
ms:contentKeyID: 61231992
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-dec(v=Security.10)'
author: SharonSears
...
Samenvatting van de Microsoft-beveiligingsbulletins voor december 2011
======================================================================
...
In dit bulletin wordt een overzicht gegeven van de beveiligingsbulletins voor december 2011.

Met de beveiligingsbulletins voor december 2011 wordt de vooraankondiging vervangen van de bulletins, die oorspronkelijk werd uitgegeven op 28 december 2011. Ga voor meer informatie over de vooraankondiging naar [Vooraankondiging van Microsoft-beveiligingsbulletins](http://go.microsoft.com/fwlink/?linkid=217213).
...
Op 14 december 2011 om 11:00 AM Pacific Time (VS en Canada) zal Microsoft tijdens een webcast vragen van gebruikers over deze bulletins beantwoorden. [Schrijf u nu in voor de webcast over de beveiligingsbulletins van december](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032487961). Na deze datum is de webcast op verzoek beschikbaar. Zie [Samenvattingen van de Microsoft-beveiligingsbulletins en webcasts](http://go.microsoft.com/fwlink/?linkid=217214) voor meer informatie.

Op 29 december 2011 om 13:00 AM Pacific Time (VS en Canada) zal Microsoft tijdens een webcast vragen van gebruikers over dit bijzondere bulletin beantwoorden. [Schrijf u nu in voor de webcast over de beveiligingsbulletins van 29 december, 13:00 u](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032502798&culture=en-us). Na deze datum is de webcast op verzoek beschikbaar. Zie [Samenvattingen van de Microsoft-beveiligingsbulletins en webcasts](http://go.microsoft.com/fwlink/?linkid=217214) voor meer informatie.
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in de Windows-stuurprogramma's voor de kernelmodus kan externe code worden uitgevoerd (2639417)</strong><br />
<br />
Deze beveiligingsupdate lost een openbaar gemaakt beveiligingslek in Microsoft Windows op. Door het beveiligingslek kan externe code worden uitgevoerd indien een gebruiker een speciaal vervaardigd document opent of een schadelijke webpagina met TrueType-lettertypebestanden bezoekt.</td>
...
<td style="border:1px solid black;"><strong>Cumulatieve beveiligingsupdate voor ActiveX Kill-bits (2618451)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in Windows Media</strong> <strong>kan externe code worden uitgevoerd (2648048)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in Microsoft Office</strong> <strong>kan externe code worden uitgevoerd (2590602)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door beveiligingslekken in Microsoft Publisher</strong> <strong>kan externe code worden uitgevoerd (2607702)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Een beveiligingslek in OLE kan leiden tot uitvoering van externe code (2624667)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door beveiligingslekken in Microsoft PowerPoint kan externe code worden uitgevoerd (2639142)</strong><br />
<br />
Met deze beveiligingsupdate worden twee<strong></strong>privé gemelde beveiligingslekken in Microsoft Office opgelost. Door deze beveiligingslekken kan externe code worden uitgevoerd als een gebruiker een speciaal vervaardigd PowerPoint-bestand opent. Een aanvaller die de beveiligingslekken weet te misbruiken, kan volledige controle krijgen over het systeem waarin dit probleem optreedt. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Opnieuw starten mogelijk vereist</td>
<td style="border:1px solid black;">Microsoft Office:</td>
...
<td style="border:1px solid black;"><strong>Beveiligingslek in Active Directory kan leiden tot uitvoering van externe code (2640045)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Beveiligingslek in Windows Client/Server</strong> <strong>Run-time Subsystem kan leiden tot misbruik van bevoegdheden (2620712)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Beveiligingslek in Windows-kernel kan leiden tot misbruik van bevoegdheden (2633171)</strong><br />
<br />
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Het beveiligingslek kan leiden tot misbruik van bevoegdheden als een aanvaller zich aanmeldt op een getroffen systeem en een toepassing uitvoert die speciaal is vervaardigd om misbruik te maken van het beveiligingslek. Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Moet opnieuw worden opgestart</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<td style="border:1px solid black;"><strong>Cumulatieve beveiligingsupdate</strong> <strong>voor Internet Explorer (2618444)</strong><br />
<br />
Met deze beveiligingsupdate worden drie privé gemelde beveiligingslekken in Internet Explorer opgelost. Het ernstigste beveiligingslek kan leiden tot uitvoering van externe code als een gebruiker een legitiem HTML-bestand (Hypertekst Markup Language) opent dat zich bevindt in dezelfde map als een speciaal vervaardigd DLL-bestand (dynamic-link library).</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Moet opnieuw worden opgestart</td>
...
<td style="border:1px solid black;"><strong>Beveiligingslekken</strong> <strong>in</strong> <strong>.NET Framework kunnen leiden</strong> <strong>tot</strong> <strong>misbruik van bevoegdheden</strong> <strong>(2638420)</strong><br />
<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=227070">MS11-088</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot misbruik van bevoegdheden in Pinyin IME</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot Word Use After Free</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232507">MS11-090</a></td>
<td style="border:1px solid black;">Microsoft in Microsoft-tijd met betrekking tot het uitvoeren van externe code</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=235287">MS11-091</a></td>
<td style="border:1px solid black;">Beveiligingslek in Publisher met betrekking tot indexering van een matrix buiten bereik</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=235287">MS11-091</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot een ongeldige pointer</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=235287">MS11-091</a></td>
<td style="border:1px solid black;">Beveiligingslek in Publisher met betrekking tot ontregeld geheugen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232517">MS11-092</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot ontregeld DVR-MS-geheugen in Windows Media Player</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232516">MS11-093</a></td>
<td style="border:1px solid black;">Beveiligingslek in een OLE-eigenschap</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232493">MS11-094</a></td>
<td style="border:1px solid black;">Beveiligingslek in PowerPoint met betrekking tot het onveilig laden van bibliotheken</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3396">CVE-2011-3396</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;">Niet van toepassing</td>
<td style="border:1px solid black;">Microsoft PowerPoint 2010 wordt alleen getroffen als de nieuwste servicepack niet is geïnstalleerd.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232493">MS11-094</a></td>
<td style="border:1px solid black;">RCE-beveiligingslek in OfficeArt Shape</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232666">MS11-095</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot bufferoverloop in Active Directory</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3406">CVE-2011-3406</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;">Permanent</td>
<td style="border:1px solid black;">Alleen is systemen waarop Active Directory, AD LDS of ADAM wordt uitgevoerd, worden getroffen.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232696">MS11-096</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot ontregeld geheugen in record</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232663">MS11-097</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot misbruik van lokale bevoegdheden in CSRSS</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232424">MS11-098</a></td>
<td style="border:1px solid black;">Beveiligingslek in de Windows-kernel door uitzonderings-handler</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232505">MS11-099</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot het vrijgeven van informatie in XSS-filter</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232505">MS11-099</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Internet Explorer</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232432">MS11-100</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot botsingen in hashtabel die een denial of service kunnen veroorzaken</td>
...
<td style="border:1px solid black;">Dit beveiligingslek is slechts een denial of service alleen en is openbaar gemaakt.
<div>
  
</div>
<div>
<a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">Beveiligingslekken met betrekking tot een denial of service krijgen de beoordeling '3' in de exploitatie-index.</a>
</div></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232432">MS11-100</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot het niet uitvoeren van verificatie van ASP.NET-formulieren</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3416">CVE-2011-3416</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Exploitatiecode is waarschijnlijk</td>
<td style="border:1px solid black;">Niet van toepassing</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden - overname van account</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=232432">MS11-100</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot caching van verificatietickets van ASP.NET-formulieren</td>
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=7726ddbe-0578-44fb-a40f-49b804a45989)  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=4cdde8a9-6d44-41fa-82c0-a25404cdfbb5)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=147ec6d3-3401-4aa3-a409-55346bcc7bd7)  
(Belangrijk)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25)\*\*\*\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f485d4c3-a4af-4ae6-9404-e79afcbb4f6e)\*\*  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Active Directory and Active Directory Lightweight Directory Service (AD LDS)](http://www.microsoft.com/downloads/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4)\*  
(KB2621146)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6f934885-b134-400c-a452-50fd4eeedd5e)\*  
(Belangrijk)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416)\*\*\*\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=28598ef6-13fb-44fd-8c76-599af7b0a01d)\*\*  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Active Directory and Active Directory Lightweight Directory Service (AD LDS)](http://www.microsoft.com/downloads/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670)\*  
(KB2621146)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7ade3832-bc20-4fce-8eac-8a3d072d2f1c)\*  
(Belangrijk)
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5915e19c-b576-453b-b621-5737774f5955)  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4bd7a02b-c6d8-4eb5-a46d-e494a1233dc8)  
(Belangrijk)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d112623c-86ce-434a-8fe1-ec3e3e632763)  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b6e44069-dec5-48f6-8fc4-8ab375a10b4e)  
(KB2619339)  
(Kritiek)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0666bdf5-9eed-44c9-84ee-b45f9b3e14b3)  
(Belangrijk)
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=81114ecd-0c73-4ca6-8a66-09c6c636a5db)  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f7997ab8-27e0-4714-845a-d237f4326587)  
(KB2619339)  
(Kritiek)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=620f94f9-1f61-45a0-a22e-e7510b56b9b8)  
(Belangrijk)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea)\*\*\*\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=bc018647-08cb-431a-8e7c-5dc04980eaa9)\*\*  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Active Directory and Active Directory Lightweight Directory Service (AD LDS)](http://www.microsoft.com/downloads/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408)\*  
(KB2621146)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=04878e9a-539a-4549-a5af-11d45add91da)\*  
(Belangrijk)
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9323b9b9-e9b0-4941-afe0-196d22df9ab4)  
(Geen prioriteitsniveau<sup>[1]</sup>)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5b2ebec4-cebb-47b6-864a-12d59a9a3e18)  
(Belangrijk)
</td>
</tr>
</table>
...
**Opmerking bij MS11-090**

<sup>[1]</sup>Dit specifieke besturingssysteem is niet getroffen door het beveiligingslek dat in dit bulletin wordt beschreven. De beschikbare update stelt de kill-bits voor besturingselementen van derden in.
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Publisher 2007 Service Pack 2 en Microsoft Publisher 2007 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d)  
(KB2596705)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2004 voor Mac](http://www.microsoft.com/downloads/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a)  
(KB2644358)  
(Belangrijk)
</td>
</tr>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office Pinyin SimpleFast Style 2010 en Microsoft Office Pinyin New Experience Style 2010 (32-bits versie)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
Microsoft Office Pinyin SimpleFast Style 2010 en Microsoft Office Pinyin New Experience Style 2010 (64-bits versie)
</td>
<td style="border:1px solid black;">
...
**Opmerking bij MS11-088**

<sup>[1]</sup>Deze versie van Microsoft Office Pinyin wordt niet meer ondersteund.
...
-   Symantec en het Laboratory of Cryptography and System Security (CrySyS) voor de samenwerking bij het oplossen van een probleem dat wordt beschreven in MS11-087
-   Yang Yanbei voor het melden van een probleem dat wordt beschreven in MS11-088
-   Nikita Tarakanov (CISS Research Team) en Alexey Sintsov (Digital Security Research Group), in samenwerking met [het Zero Day Initiative](http://www.zerodayinitiative.com/)[van TippingPoint](http://www.tippingpoint.com/), voor het melden van een probleem dat wordt beschreven in MS11-089
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com), voor het melden van een probleem dat wordt beschreven in MS11-090
-   Will Dormann van de [CERT/CC](http://www.cert.org/) voor het melden van drie problemen die worden beschreven in MS11-091
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com), voor het melden van een probleem dat wordt beschreven in MS11-092
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com), voor het melden van een probleem dat wordt beschreven in MS11-093
-   Greg MacManus van [iSIGHT Partners Labs](http://www.isightpartners.com/) voor het melden van een probleem dat wordt beschreven in MS11-094
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/) voor het melden van een probleem dat wordt beschreven in MS11-094
-   Een anonieme onderzoeker, in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com), voor het melden van een probleem dat wordt beschreven in MS11-096
-   Alex Ionescu van Winsider Seminars & Solutions Inc. voor het melden van een probleem dat wordt beschreven in MS11-097
-   Matthew Jurczyk in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van een probleem dat wordt beschreven in MS11-098
-   Thomas Stehle voor het melden van een probleem dat wordt beschreven in MS11-099
-   Andy Cooper van het [Citrix Security Team](http://www.citrix.com) voor het melden van een probleem dat wordt beschreven in MS11-099
-   [Robert Swiecki](http://www.swiecki.net/) van [Google Inc.](http://www.google.com/) voor het melden van een probleem dat wordt beschreven in MS11-099
-   [Yosuke Hasegawa](http://utf-8.jp/) voor de samenwerking bij het oplossen van een probleem dat wordt beschreven in MS11-099
-   [Jan Schejbal](http://janschejbal.wordpress.com/)voor de samenwerking bij het ontwikkelen van ingrijpende wijzigingen die worden beschreven in MS11-099.
-   Irene Abezgauz van [Seeker](http://www.seekersec.com) voor het melden van een probleem dat wordt beschreven in MS11-100
-   Kestutis Gudinavicius van [SEC Consult](https://www.sec-consult.com/) voor het melden van een probleem dat wordt beschreven in MS11-100
-   Oliver Dewdney van [LBi](http://www.lbi.com/) voor het melden van een probleem dat wordt beschreven in MS11-100
...
-   V1.0 (13 december 2011): Samenvatting van de gepubliceerde bulletins.
-   V1.1 (13 december 2011): Voor MS11-099 zijn de prioriteitsniveaus verbeterd in de tabel met software waarin dit probleem optreedt. Voor MS11-088 is de Belangrijke opmerking in de Exploitatie-index verbeterd. Het gaan alleen om wijzigingen in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.
-   V2.0 (29 december 2011): Toegevoegd is Microsoft-beveiligingsbulletin MS11-100, Beveiligingslekken in .NET Framework kunnen leiden tot misbruik van bevoegdheden (2638420). Ook is de webcastkoppeling voor dit bijzondere beveiligingsbulletin toegevoegd.
-   V2.1 (22 februari 2012): Voor MS11-088 is de status van de productondersteuning voor Microsoft Office Pinyin SimpleFast Style 2010 en Microsoft Office Pinyin New Experience Style 2010 verduidelijkt. Deze versies van Microsoft Office Pinyin worden niet meer ondersteund. Zie bulletin voor details.
