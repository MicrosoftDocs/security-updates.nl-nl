---
TOCTitle: 'MS11-FEB'
Title: 'Samenvatting van de Microsoft-beveiligingsbulletins voor februari 2011'
ms:assetid: 'ms11-feb'
...
Samenvatting van de Microsoft-beveiligingsbulletins voor februari 2011
======================================================================

Gepubliceerd: dinsdag 8 februari 2011 | Bijgewerkt: vrijdag 18 maart 2011

**Versie:** 1.1

In dit bulletin wordt een overzicht gegeven van de beveiligingsbulletins voor februari 2011.

Met de beveiligingsbulletins voor februari 2011 wordt de vooraankondiging van de bulletins, die oorspronkelijk werd uitgegeven op 3 februari 2011, vervangen. Ga voor meer informatie over de vooraankondiging naar [Vooraankondiging van Microsoft-beveiligingsbulletins](http://technet.microsoft.com/security/bulletin/advance).
...
<td style="border:1px solid black;"><strong>Cumulatieve beveiligingsupdate voor Internet Explorer (2482017)</strong><br />
<br />
Met deze beveiligingsupdate worden twee privé gemelde beveiligingslekken en twee openbaar gemaakte beveiligingslekken in Internet Explorer opgelost. Door de beveiligingslekken kan externe code worden uitgevoerd als een gebruiker een speciaal vervaardigde webpagina bekijkt met Internet Explorer of als een gebruiker een legitiem HTML-bestand opent dat een speciaal vervaardigd bibliotheekbestand laadt. Een aanvaller die erin slaagt misbruik te maken van een van deze beveiligingslekken, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.</td>
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in grafische verwerking van de Windows-shell kan externe code worden uitgevoerd (2483185)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door een beveiligingslek in het OpenType CFF-stuurprogramma (Compact Font Format) kan externe code worden uitgevoerd (2485376)</strong><br />
<br />
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in het Windows OpenType CFF-stuurprogramma (Compact Font Format) opgelost. Door het beveiligingslek kan externe code worden uitgevoerd als een gebruiker inhoud bekijkt in een speciaal vervaardigd CFF-lettertype. Een aanvaller kan een gebruiker er echter niet toe dwingen om de speciaal vervaardigde inhoud weer te geven. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan een website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller gaat.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Kritiek</a><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Moet opnieuw worden opgestart</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<td style="border:1px solid black;"><strong>Beveiligingslek in Active Directory kan leiden tot denial of service (2478953)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Door beveiligingslekken in Microsoft Visio kan externe code worden uitgevoerd (2451879)</strong><br />
<br />
Met deze beveiligingsupdate worden twee privé gemelde beveiligingslekken in Microsoft Visio opgelost. Door deze beveiligingslekken kan externe code worden uitgevoerd als een gebruiker een speciaal vervaardigd Visio-bestand opent. Een aanvaller die erin slaagt misbruik te maken van een van deze beveiligingslekken, kan dezelfde rechten over het systeem krijgen als de aangemelde gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Opnieuw starten mogelijk vereist</td>
...
<td style="border:1px solid black;"><strong>Beveiligingslek in scripting engines voor JScript en VBScript kan leiden tot het vrijgeven van informatie (2475792)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Een beveiligingslek in het Windows Client/Server Run-time Subsystem kan leiden tot misbruik van bevoegdheden (2476687)</strong><br />
<br />
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in het Microsoft Windows Client/Server Run-time Subsystem (CSRSS) in Windows XP en Windows Server 2003 opgelost.<br />
<br />
...
<td style="border:1px solid black;"><strong>Beveiligingslekken in de Windows-stuurprogramma's voor de kernelmodus kunnen leiden tot misbruik van bevoegdheden (2479628)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Beveiligingslekken in Kerberos kunnen leiden tot misbruik van bevoegdheden (2496930)</strong><br />
<br />
Met deze beveiligingsupdate worden een privé gemeld beveiligingslek en een openbaar gemeld beveiligingslek in Microsoft Windows opgelost. Het ernstigste beveiligingslek kan leiden tot misbruik van bevoegdheden indien een lokale, geverifieerde aanvaller een schadelijke service installeert op een computer in het domein.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Moet opnieuw worden opgestart</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<td style="border:1px solid black;"><strong>Beveiligingslek in Local Security Authority Subsystem Service kan leiden tot lokaal misbruik van bevoegdheden (2478960)</strong><br />
<br />
Deze beveiligingsupdate lost een privé gemeld beveiligingslek in de Local Security Authority Subsystem Service (LSASS) in Windows XP en Windows Server 2003 op.<br />
<br />
Het beveiligingslek kan leiden tot misbruik van bevoegdheden als een aanvaller zich aanmeldt op een systeem en een speciaal vervaardigde toepassing uitvoert. Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140">Belangrijk</a><br />
Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Moet opnieuw worden opgestart</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-006">MS11-006</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot overloop in de grafische verwerking van de Windows-shell</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970">CVE-2010-3970</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Is consistente exploitatiecode waarschijnlijk?</td>
<td style="border:1px solid black;"><strong>Dit beveiligingslek is openbaar gemaakt en er is exploitatiecode verkrijgbaar</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-003">MS11-003</a></td>
<td style="border:1px solid black;">Beveiligingslek in CSS met betrekking tot ontregeld geheugen</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971">CVE-2010-3971</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Is consistente exploitatiecode waarschijnlijk?</td>
<td style="border:1px solid black;"><strong>Dit beveiligingslek is openbaar gemaakt en wordt in het internet-ecosysteem misbruikt</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-011">MS11-011</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot onjuiste communicatie tussen stuurprogramma's en de Windows-kernel</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398">CVE-2010-4398</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">1</a> - Is consistente exploitatiecode waarschijnlijk?</td>
<td style="border:1px solid black;"><strong>Dit beveiligingslek is openbaar gemaakt</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-010">MS11-010</a></td>
<td style="border:1px solid black;">Beveiligingslek in CSRSS met betrekking tot misbruik van bevoegdheden</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-003">MS11-003</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-014">MS11-014</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot lengtevalidatie in LSASS</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-013">MS11-013</a></td>
<td style="border:1px solid black;">Beveiligingslek in Kerberos met betrekking tot een ongecodeerde controlewaarde</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-011">MS11-011</a></td>
<td style="border:1px solid black;">Beveiligingslek in de Windows-kernel met betrekking tot afkapping van gehele getallen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Beveiligingslek door onjuiste validatie van gebruikersinvoer in Win32k</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Beveiligingslek door onvoldoende validatie van gebruikersinvoer in Win32k</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Beveiligingslek door onduidelijke aanwijzer uit Win32k-vensterklasse</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Beveiligingslek door onjuiste validatie van aanwijzer uit Win32k-vensterklasse</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Beveiligingslek in Win32k met betrekking tot ontregeld geheugen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-013">MS11-013</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot ontregeld geheugen in Visio-objecten</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-008">MS11-008</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot ontregeld geheugen in Visio-gegevenstypen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-004">MS11-004</a></td>
<td style="border:1px solid black;">Beveiligingslek door heapbufferoverloop in FTP-service van IIS</td>
...
<td style="border:1px solid black;"><strong>Dit beveiligingslek is openbaar gemaakt en er kan PoC-code verkrijgbaar zijn</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-007">MS11-007</a></td>
<td style="border:1px solid black;">Beveiligingslek in gecodeerde tekens van OpenType-lettertypen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-009">MS11-009</a></td>
<td style="border:1px solid black;">Beveiligingslek in scripting engines met betrekking tot het vrijgeven van informatie</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-005">MS11-005</a></td>
<td style="border:1px solid black;">Beveiligingslek met betrekking tot SPN-validatie in Active Directory</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040">CVE-2011-0040</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">3</a> – Kans op werkende exploitatiecode is gering</td>
<td style="border:1px solid black;"><strong>Dit beveiligingslek is openbaar gemaakt</strong><br />
<br />
...
<td style="border:1px solid black;">Beveiligingslek in Kerberos met betrekking tot spoofing</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091">CVE-2011-0091</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx">3</a> – Kans op werkende exploitatiecode is gering</td>
<td style="border:1px solid black;">Dit is een beveiligingslek dat alleen betrekking heeft op spoofing</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=bc09e42b-2eed-41b3-a03f-cb8cc94adfee)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=fcd48499-1bb4-4304-b9cc-27d9d92e11cd)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=856fbcc2-ead9-4ec1-92dd-988e6d22dae9)  
(KB2478971)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41)  
(Belangrijk)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d60a2098-7351-4fce-83b2-2c1c3a24faa0)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.0 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=c09ccc72-8f94-416b-9a7f-ed16e90342a2)<sup>[1]</sup>
(Belangrijk)  
[Microsoft FTP Service 7.5 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=da9b7982-1c6b-45ac-8dd0-d7101bb83949)<sup>[1]</sup>
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=66978514-bb7f-42cc-9360-2fd1c686f4e6)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=065ad8fe-1caf-488e-a2e1-96db29f2fa57)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.0 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=e88d072f-0f5f-4c85-ad2f-91b9b8bf6b3a)<sup>[1]</sup>
(Belangrijk)  
[Microsoft FTP Service 7.5 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=6e4b9878-b5d2-4025-8839-b41515932cf2)<sup>[1]</sup>
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fdb8c37-1b22-457b-bdc0-21f6a5061dd3)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb)\*\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88ba83b9-c14e-499a-8335-04bac1c49c0c)\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.0 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=3cc55af7-5cd9-4923-8ec5-462ff201d734)<sup>[1]</sup>\*  
(Belangrijk)  
[Microsoft FTP Service 7.5 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=4dfa0a25-b7e3-4fb6-a351-58ec3f8a8435)<sup>[1]</sup>\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b37418a-e044-415e-b566-4507f157934a)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c)\*\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c74d7f4-6372-4809-89b8-c79b05e54cdd)\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.0 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=f485b30d-dcaf-47c3-ac62-982b14670a1f)<sup>[1]</sup>\*  
(Belangrijk)  
[Microsoft FTP Service 7.5 voor IIS 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=a98a74c1-0c91-446d-b822-fe57ff06d90b)<sup>[1]</sup>\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=163d3aca-3703-452e-b1cb-73932e2bcf8c)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91d5d34b-9d7e-4e83-89a4-f1aa388dc4e4)  
(Kritiek)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=55b07bc0-dff5-4cd7-87c9-c08e5a49197d)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1da57fbc-9ea4-4fc4-911d-d5c7825e012c)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.5 voor IIS 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=9dabd1d1-3f1e-46d1-b171-aafd3f08d291)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=e1224c90-b0bc-4e4b-999a-efae327213b4)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=ffed7c76-0b75-4f57-9b63-3961a8b449f6)  
(KB2425227)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=587adb89-2f6a-4893-9906-b6d6d9ada2bd)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.5 voor IIS 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=66fb4efe-bcd3-4e90-8e35-b013e014a952)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=ddcf352e-742c-485e-9ed5-19cdba673562)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c26cebcf-683f-4a51-be75-76535fb979a7)  
(KB2425227)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=638318ed-4000-4b1a-bb4b-65b795f59784)\*  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.5 voor IIS 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=1e075f57-1723-4933-9b8e-7bce4a44a1c1)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=70f5056a-72ad-46ff-a43f-ee151639b9a7)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e)\*  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=46bb3ef1-24c3-41cb-8141-0fdbd85093f7)\*  
(KB2425227)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4688ea0d-a467-4f24-ac52-104d05c8cae8)  
(Kritiek)
</td>
<td style="border:1px solid black;">
[Microsoft FTP Service 7.5 voor IIS 7.5](http://www.microsoft.com/downloads/details.aspx?familyid=bfddd539-c64f-4467-88ee-6bdfe645b478)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
Niet van toepassing
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=1646b3a5-714f-4ea5-b109-566fa9b933b6)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965)  
(KB2425227)  
(Belangrijk)
</td>
<td style="border:1px solid black;">
...
-   Yuki Chen van [Trend Micro](http://www.trendmicro.com) voor het melden van een probleem dat wordt beschreven in MS11-003
-   SkyLined van [Google Inc.](http://www.google.com/) voor het melden van een probleem dat wordt beschreven in MS11-003
-   Haifei Li van [FortiGuard Labs van Fortinet](http://www.fortiguard.com/) voor het melden van een probleem dat wordt beschreven in MS11-003
-   Kobi Pariente en Yaniv Miron in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com/) voor het melden van een probleem dat wordt beschreven in MS11-006
-   Procyun in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/) voor het melden van een probleem dat wordt beschreven in MS11-008
-   Xin Ouyang van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van twee problemen die worden beschreven in MS11-008
-   Yamata Li van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van een probleem dat wordt beschreven in MS11-009
-   Sihan Qing (Professor), Weiping Wen (Associate Professor), Liang Yin en Husheng Zhou (academici), [Department of Information Security, Beijing University](http://www.ss.pku.edu.cn/en/), voor het melden van een probleem dat wordt beschreven in MS11-010
-   Zhengwenbin van [360safe](http://www.360.cn) voor het melden van een probleem dat wordt beschreven in MS11-011
-   Guo Bojun voor het melden van een probleem dat wordt beschreven in MS11-011
-   Wei Zhang voor het melden van een probleem dat wordt beschreven in MS11-011
-   Marco Giuliani van [PrevX](http://www.prevx.com/) voor de samenwerking bij het oplossen van een probleem dat wordt beschreven in MS11-011
-   std\_logic in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/) voor het melden van een probleem dat wordt beschreven in MS11-011
-   Tarjei Mandt van [Norman](http://www.norman.com) voor het melden van vijf problemen die worden beschreven in MS11-012
-   [Het MIT Kerberos Team](http://web.mit.edu/kerberos) voor het melden van een probleem dat wordt beschreven in MS11-013
-   Scott Stender van [iSEC Partners](http://www.isecpartners.com/) voor het melden van een probleem dat wordt beschreven in MS11-013
-   Beveiligingstester Jorge Moura van Primavera BSS voor het melden van een probleem dat wordt beschreven in MS11-014
...
-   V1.0 (8 februari 2011): Samenvatting van de gepubliceerde bulletins.
-   V1.1 (9 februari 2011): Voor MS11-013 is de Beoordeling van de exploitatie-index voor CVE-2011-0091 gecorrigeerd naar "3 – Kans op werkende exploitatiecode is gering." Het gaat alleen om een wijziging in de informatie.
-   V2.0 (8 maart 2011): Het onderdeel Software waarin dit probleem optreedt is verduidelijkt en aangevuld met Windows 7 voor 32-bits systemen met Service Pack 1, Windows 7 voor x64-systemen met Service Pack 1, Windows Server 2008 R2 voor x64-systemen met Service Pack 1 en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1 voor MS11-003, MS11-004, MS11-007, en MS11-009. Zie de veelgestelde vragen van deze bulletins voor meer informatie.
-   V3.0 (16 maart 2011): Het onderdeel Software waarin dit probleem optreedt is verduidelijkt en aangevuld met Windows 7 voor 32-bits systemen Service Pack 1, Windows 7 voor x64-systemen Service Pack 1, Windows Server 2008 R2 voor x64-systemen Service Pack 1 en Windows Server 2008 R2 voor Itanium-systemen Service Pack 1 voor MS11-013. Zie de veelgestelde vragen van dit bulletin voor meer informatie.
-   V4.0 (18 maart 2011): Het onderdeel Software waarin dit probleem optreedt is verduidelijkt en aangevuld met Windows 7 voor 32-bits systemen Service Pack 1, Windows 7 voor x64-systemen Service Pack 1, Windows Server 2008 R2 voor x64-systemen Service Pack 1 en Windows Server 2008 R2 voor Itanium-systemen Service Pack 1 voor MS11-012. Zie de veelgestelde vragen van dit bulletin voor meer informatie.
