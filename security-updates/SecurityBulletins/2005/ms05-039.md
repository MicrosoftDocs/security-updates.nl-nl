---
TOCTitle: 'MS05-039'
Title: 'Microsoft-beveiligingsbulletin MS05-039 - Kritiek'
ms:assetid: 'ms05-039'
ms:contentKeyID: 61231454
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms05-039(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS05-039 - Kritiek
=================================================

Door een beveiligingslek in Plug and Play kan externe code worden uitgevoerd en kunnen bevoegdheden worden misbruikt (899588)
-----------------------------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?displaylang=nl&familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f)
-   Microsoft Windows XP Service Pack 1 en Microsoft Windows XP Service Pack 2 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?displaylang=nl&familyid=9a3bfbdd-62ea-4db2-88d2-415e095e207f)
-   Microsoft Windows XP Professional x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=89d90e25-4773-4782-ad06-9b7517bab3c8)
-   Microsoft Windows Server 2003 en Microsoft Windows Server 2003 Service Pack 1 – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?displaylang=nl&familyid=6275d7b7-dab1-47c8-8745-533eb471072c)
-   Microsoft Windows Server 2003 voor Itanium-systemen en Microsoft Windows Server 2003 met SP1 voor Itanium-systemen – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=be18d39d-3e4c-4c6f-b841-2ccd8d4c3f50)
-   Microsoft Windows Server 2003 x64 Edition – [De update downloaden](http://www.microsoft.com/downloads/details.aspx?familyid=d976316d-3b17-4ad4-9198-513ffdac98e4)
...
Met deze update wordt een pas ontdekt beveiligingslek opgelost. Er bestaat een beveiligingslek in Plug and Play (PnP) dat kan leiden tot het uitvoeren van externe code, waardoor een aanvaller die misbruik maakt van dit beveiligingslek, volledige controle kan krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Het beveiligingslek wordt beschreven in de sectie “Informatie over de beveiligingslekken“ van dit bulletin.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Beveiligingslek met betrekking tot Plug and Play - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1983">CAN-2005-1983</a></td>
<td style="border:1px solid black;">Uitvoering van externe code en misbruik van bevoegdheden</td>
...
<span></span>
#### Beveiligingslek met betrekking tot Plug and Play - CAN-2005-1983:
  
Er komt een beveiligingslek voor in Plug and Play dat uitvoering van externe code en [lokaal misbruik van bevoegdheden](http://go.microsoft.com/fwlink/?linkid=21142) mogelijk maakt. Hierdoor kan een aanvaller die dit beveiligingslek succesvol misbruikt de controle over het systeem waarop dit probleem optreedt geheel overnemen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot Plug and Play - CAN-2005-1983:
...
-   In Windows XP Service Pack 1 moet een aanvaller geldige aanmeldingsreferenties hebben om dit beveiligingslek te misbruiken. Het beveiligingslek kan niet vanaf een externe locatie door anonieme gebruikers worden misbruikt. Het onderdeel waarin het probleem optreedt, is echter extern beschikbaar voor gebruikers die een standaardgebruikersaccount hebben.  
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot Plug and Play - CAN-2005-1983:
...
**Opmerking** Zoals omschreven in het gedeelte “Beperkende factoren” zijn Windows XP Service Pack 2 en Windows Server 2003 met name kwetsbaar voor dit probleem wanneer lokaal aangemelde gebruikers het probleem misbruiken. De volgende tijdelijke oplossingen zijn vooral bedacht voor eerdere besturingssysteemversies die kwetsbaar zijn voor anonieme netwerkaanvallen.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot Plug and Play - CAN-2005-1983:
  
**Wat is de omvang van het probleem?**
  
Dit beveiligingslek maakt uitvoering van externe code en [lokaal misbruik van bevoegdheden](http://go.microsoft.com/fwlink/?linkid=21142) mogelijk. In Windows 2000 kan een anonieme aanvaller proberen dit beveiligingslek op afstand te misbruiken. In Windows XP Service Pack 1 kan alleen een geverifieerde gebruiker proberen dit beveiligingslek te misbruiken. In Windows XP Service Pack 2 en Windows Server 2003 kan alleen een beheerder op afstand het onderdeel openen waarin dit probleem optreedt. Daarom is in Windows XP Service Pack 2 en Windows Server 2003 het enige gevolg van dit beveiligingslek het feit dat misbruik van bevoegdheden mogelijk wordt. Een anonieme gebruiker kan niet proberen op afstand dit beveiligingslek te misbruiken in Windows XP Service Pack 2 en Windows Server 2003.  
Een aanvaller die dit beveiligingslek succesvol heeft misbruikt, kan de controle over het systeem waarop dit probleem optreedt geheel overnemen. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**  
Een ongecontroleerde buffer in de Plug and Play-service.
...
In Windows 2000 kan een aanvaller het beveiligingslek misbruiken door een speciaal ontworpen bericht te maken en te verzenden naar een systeem waarin dit probleem optreedt. Het bericht kan er dan voor zorgen dat het systeem waarin dit probleem optreedt code uitvoert. In Windows XP Service Pack 1 kunnen alleen geverifieerde gebruikers dit op afstand doen. Als een aanvaller in Windows XP Service Pack 2 of in Windows Server 2003 het beveiligingslek wil misbruiken, moet deze zich lokaal op een systeem aanmelden en vervolgens proberen een speciaal gemaakte toepassing uit te voeren.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Voor Windows 2000 vormt dit beveiligingslek het grootste risico. Op Windows XP Service Pack 1, Windows XP Service Pack 2 en Windows Server 2003 moet een aanvaller de juiste aanmeldingsreferenties hebben om dit beveiligingslek te misbruiken. Het beveiligingslek kan niet op afstand worden misbruikt door een anonieme gebruiker in Windows XP Service Pack 1, Windows XP Service Pack 2, of Windows Server 2003.
  
**Kan het beveiligingslek via internet worden misbruikt?**  
Ja, door anonieme gebruikers in Windows 2000 en door geverifieerde gebruikers in Windows XP Service Pack 1. Door de aanbevolen richtlijnen voor gebruik van de firewall te volgen en de standaardinstellingen voor de firewall aan te brengen kunt u aanvallen die via internet worden uitgevoerd voor een groot deel afweren. Microsoft biedt informatie over de beveiliging van uw pc. Eindgebruikers kunnen naar de volgende website gaan: [Beveilig uw pc](http://go.microsoft.com/fwlink/?linkid=21169). IT-professionals kunnen naar de volgende website gaan: [Security Guidance Center](http://go.microsoft.com/fwlink/?linkid=21171). In Windows XP Service Pack 2 en Windows Server 2003 moet een aanvaller zich aanmelden op het specifieke systeem dat hij wil aanvallen. Een anonieme aanvaller kan als gevolg van dit beveiligingslek niet een programma vanaf een externe locatie laden en uitvoeren.
  
**Wat doet de update?**  
Met de update dicht u het beveiligingslek door aanpassing van de manier waarop de Plug and Play-service de lengte van een bericht valideert voordat dit aan de toegewezen buffer wordt doorgegeven. Bovendien beperkt de update in Windows 2000 de anonieme toegang tot de onderdelen waarin dit probleem optreedt. Alleen geverifieerde gebruikers kunnen deze functie dus op afstand gebruiken. Deze wijziging is consistent met de standaardinstellingen van Windows XP Service Pack 1.
...
Systeembeheerders kunnen deze beveiligingsupdate ook verwijderen met het hulpprogramma Spuninst.exe. Het hulpprogramma Spuninst.exe bevindt zich in de map %Windir%\\$NTUninstallKB899588$\\Spuninst.
...
|-----------------|---------------|-------------|-------|---------|--------|
| Umpnpmgr.dll    | 5.2.3790.360  | 30-jun-2005 | 02:43 | 124.416 | RTMGDR |
| Umpnpmgr.dll    | 5.2.3790.360  | 30-jun-2005 | 02:50 | 124.416 | RTMQFE |
| Umpnpmgr.dll    | 5.2.3790.2477 | 30-jun-2005 | 02:52 | 138.752 | SP1GDR |
| Umpnpmgr.hp.dll |               | 30-jun-2005 | 02:52 | 3.072   | SP1GDR |
| Umpnpmgr.dll    | 5.2.3790.2477 | 30-jun-2005 | 03:13 | 129.536 | SP1QFE |
...
|--------------|---------------|-------------|-------|---------|-------|--------|
| Umpnpmgr.dll | 5.2.3790.360  | 30-jun-2005 | 17:06 | 322.048 | IA-64 | RTMGDR |
| Umpnpmgr.dll | 5.2.3790.360  | 30-jun-2005 | 17:06 | 322.048 | IA-64 | RTMQFE |
| Umpnpmgr.dll | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 331.264 | IA-64 | SP1GDR |
| Umpnpmgr.dll | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 331.264 | IA-64 | SP1QFE |
| Arpidfix.exe | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 74,752  | IA-64 |        |
...
| Bestandsnaam | Versie        | Datum       | Tijd  | Grootte | CPU | Map    |
|--------------|---------------|-------------|-------|---------|-----|--------|
| Umpnpmgr.dll | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 209.920 | x64 | SP1GDR |
| Umpnpmgr.dll | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 209.920 | x64 | SP1QFE |
| Arpidfix.exe | 5.2.3790.2477 | 30-jun-2005 | 17:06 | 43.008  | x64 |        |
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutel bevat mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien is deze registersleutel mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 899588 integreert in de bronbestanden van de Windows-installatie.
...
| Bestandsnaam | Versie        | Datum       | Tijd  | Grootte | Map    |
|--------------|---------------|-------------|-------|---------|--------|
| Umpnpmgr.dll | 5.1.2600.1711 | 30-jun-2005 | 02:15 | 107.520 | SP1QFE |
| Umpnpmgr.dll | 5.1.2600.2710 | 30-jun-2005 | 02:02 | 118,272 | SP2GDR |
| Umpnpmgr.dll | 5.1.2600.2710 | 30-jun-2005 | 02:06 | 118,272 | SP2QFE |
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutels bevatten mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien zijn deze registersleutels mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 899588 integreert in de bronbestanden van de Windows-installatie.
...
|--------------|---------------|-------------|-------|---------|
| Umpnpmgr.dll | 5.0.2195.7057 | 29-jun-2005 | 06:45 | 89.360  |
...
-   **Verificatie van registersleutel**
    ...
    **Opmerking** Deze registersleutel bevat mogelijk geen volledige lijst met geïnstalleerde bestanden. Bovendien is deze registersleutel mogelijk niet correct als een beheerder of een OEM beveiligingsupdate 899588 in de bronbestanden van de Windows-installatie integreert.
...
-   Neel Mehta van [ISS X-Force](http://www.iss.net) voor het melden van het beveiligingslek met betrekking tot Plug and Play (CAN-2005-1983).
-   Jean-Baptiste Marchand van [Herve Schauer Consultants](http://www.hsc.fr) omdat hij samen met ons heeft gewerkt aan een oplossing met betrekking tot de onderdelen waarin het probleem optreedt.
