---
TOCTitle: 'MS07-044'
Title: 'Microsoft-beveiligingsbulletin MS07-044 - Kritiek'
ms:assetid: 'ms07-044'
ms:contentKeyID: 61231593
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms07-044(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS07-044 - Kritiek
=================================================

Door beveiligingslekken in Microsoft Excel kan externe code worden uitgevoerd (940965)
--------------------------------------------------------------------------------------
...
Deze beveiligingsupdate is kritiek voor ondersteunde edities van Microsoft Office 2000. Voor ondersteunde edities van Microsoft Office XP, Microsoft Office 2003 en Microsoft Office 2004 voor Mac is het prioriteitsniveau van deze update belangrijk. Deze update is tevens beoordeeld als belangrijk voor Excel Viewer 2003. Raadpleeg voor meer informatie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b0130e9e-8845-4d79-aaa1-a21cc9388abe">Microsoft Office 2003 Service Pack 2</a>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/mac/downloads.aspx">Microsoft Office 2004 voor Mac</a></td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-036">MS07-036</a></td>
</tr>
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten - CVE-2007-3890</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten - CVE-2007-3890  
-----------------------------------------------------------------------------------------
...
Zie [CVE-2007-3890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3890) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten - CVE-2007-3890
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten - CVE-2007-3890
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten - CVE-2007-3890
...
Er vindt onvoldoende verificatie plaats in Excel bij het identificeren van de indexwaarde voor een werkruimte.
...
**Wat doet de update?**  
De update verwijdert het beveiligingslek doordat de manier wordt gewijzigd waarop in Microsoft Excel de eigenschappen voor de indexwaarde voor een werkruimte worden gevalideerd.
...
-   Dyon Balding van [Secunia](http://secunia.com/) voor het melden van het beveiligingslek met betrekking tot een beschadigd geheugen in werkruimten ( CVE-2007-3890)
...
-   V1.1 (29 augustus 2007): Bulletin is bijgewerkt met gewijzigde tekst die in de tabel 'Software waarin dit probleem optreedt' bij de downloadkoppeling voor Office-onderdelen wordt weergegeven.
