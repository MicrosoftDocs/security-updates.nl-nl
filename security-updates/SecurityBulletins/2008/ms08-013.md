---
TOCTitle: 'MS08-013'
Title: 'Microsoft-beveiligingsbulletin MS08-013 - Kritiek'
ms:assetid: 'ms08-013'
ms:contentKeyID: 61231631
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms08-013(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS08-013 - Kritiek
=================================================

Door een beveiligingslek in Microsoft Office kan externe code worden uitgevoerd (947108)
----------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 12 februari 2008 | Bijgewerkt: dinsdag 12 januari 2010
...
Dit is een kritieke beveiligingsupdate voor alle gesteunde edities van Microsoft Office 2000 en een belangrijke beveiligingsupdate voor Microsoft Office XP, Microsoft Office 2003 en Microsoft Office 2004 voor Mac. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

Met deze beveiligingsupdate verwijdert u het beveiligingslek door de wijze aan te passen waarop Microsoft Office documenten met ingevoegde objecten laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Waarom kan ik deze update niet verwijderen nadat ik hem heb geïnstalleerd?**  
Er bestaat een probleem in Microsoft Office XP en Office 2003 waardoor Office gedeeltelijk wordt verwijderd wanneer updates voor bepaalde onderdelen worden geïnstalleerd of verwijderd. Deze update verhelpt dat probleem. Wanneer deze update wordt verwijderd, ontstaat het probleem echter opnieuw en wordt Office gedeeltelijk verwijderd. Om dit te voorkomen, heeft Microsoft ervoor gezorgd dat deze update niet kan worden verwijderd.
...
**Ik heb niet de volledige Microsoft Office-suite die in de tabel 'Software waarin dit probleem optreedt' staat, maar alleen een van de onderdelen van deze suite, zoals Word. Wordt de beveiligingsupdate toch aangeboden?**    
Het beveiligingslek dat het onderwerp van dit beveiligingsbulletin is, is alleen bedoeld voor de volledige Microsoft Office-suite uit de tabel 'Software waarin dit probleem optreedt'. Bepaalde Microsoft Office-programma's gebruiken echter enkele van de bestanden die ook door de volledige Microsoft Office-suite worden gebruikt waarvoor de beveiligingsupdate is bedoeld. U kunt het beste de update installeren om te voorkomen dat de beveiligingsupdate opnieuw wordt aangeboden.
...
<th style="border:1px solid black;" >Beveiligingslek in Microsoft Office met betrekking tot uitvoersprong - CVE-2008-0103</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek in Microsoft Office met betrekking tot uitvoersprong - CVE-2008-0103  
------------------------------------------------------------------------------------
  
<span></span>
Door dit beveiligingslek kan externe code worden uitgevoerd als een gebruiker een speciaal ontworpen Microsoft Office-document opent dat een verkeerd ingedeeld object bevat. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2008-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0103) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de uitvoersprong van Microsoft Office - CVE-2008-0103
...
-   Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.  
...
#### Tijdelijke oplossingen voor het beveiligingslek in de uitvoersprong van Microsoft Office - CVE-2008-0103
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   Toegang tot VBE6.dll beperken
  
    Om de toegang tot VBE6.dll te beperken, typt u het volgende op de opdrachtprompt:
    ...
    **Gevolgen van de tijdelijke oplossing:** Het gevolg van deze tijdelijke oplossing is dat Microsoft Office-bestanden met VBA-inhoud (zoals macro's) niet meer worden geladen.
...
#### Veelgestelde vragen over het beveiligingslek in de uitvoersprong van Microsoft Office - CVE-2008-0103
  
**Wat is de omvang van het beveiligingslek? **  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code in Microsoft Office. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
**Waardoor wordt het beveiligingslek veroorzaakt? **  
Het beveiligingslek wordt veroorzaakt door een geheugenverwerkingsfout in Microsoft Office wanneer een gebruiker een speciaal ontworpen Office-bestand opent dat verkeerd ingedeelde objecten bevat. Hierdoor kan het systeemgeheugen dusdanig ontregeld raken dat een aanvaller willekeurige code kan uitvoeren.
...
**Wat doet de update? **  
Met de update herstelt u het beveiligingslek door de wijze aan te passen waarop Office geheugentoewijzingen verwerkt bij het openen van Office-documenten die objectgegevens bevatten.
...
Zie voor meer informatie over MBSA 2.0.1 [Veelgestelde vragen over MBSA 2.0.](http://www.microsoft.com/technet/security/tools/mbsa2/qa.mspx)
...
| Microsoft Office 2004 voor Mac       | Nee     | Nee                | Nee               | Ja        |
...
|--------------|-----------|-------------|-------|-----------|  
| Vbe6.dll     | 6.5.10.24 | 10-mei-2007 | 00:19 | 2.585.936 |
...
-   Shaun Colley van [NGSSoftware](http://www.ngssoftware.com/) voor het melden van het beveiligingslek met betrekking tot de uitvoersprong in Microsoft Office (CVE-2008-0103).
...
-   V1.1 (13 februari 2008): Dit bulletin is bijgewerkt om aan te geven dat er geen bekende problemen zijn bij het installeren van deze beveiligingsupdate.  
-   V1.2 (27 februari 2008): Het bulletin is bijgewerkt met de reden waarom deze update niet kan worden geïnstalleerd voor Office XP en Office 2003.  
-   V1.3 (16 april 2008): Bulletin bijgewerkt: Item toegevoegd aan de update met veelgestelde vragen waarin aanvullende beveiligingsfuncties worden beschreven die zijn inbegrepen voor Microsoft Office 2003 Service Pack 2.  
-   V1.4 (12 januari 2010): Bulletin bijgewerkt: De informatie over het vervangen van het bulletin voor Microsoft Office 2003 Service Pack 2 is gecorrigeerd.
