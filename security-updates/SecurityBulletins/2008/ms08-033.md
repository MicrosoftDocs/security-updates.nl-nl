---
TOCTitle: 'MS08-033'
Title: 'Microsoft-beveiligingsbulletin MS08-033 - Kritiek'
ms:assetid: 'ms08-033'
ms:contentKeyID: 61231651
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms08-033(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS08-033 - Kritiek
=================================================

Door beveiligingslekken in DirectX kan externe code worden uitgevoerd (951698)
------------------------------------------------------------------------------

Gepubliceerd: dinsdag 10 juni 2008 | Bijgewerkt: dinsdag 12 augustus 2008
...
Het prioriteitsniveau van dit bulletin is Kritiek voor alle ondersteunde edities van Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista en Windows Server 2008. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

Met deze beveiligingsupdate verwijdert u het beveiligingslek doordat de wijze wordt aangepast waarop DirectX MJPEG- en SAMI-bestanden verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

**Aanbeveling.** Microsoft raadt klanten aan de update onmiddellijk toe te passen.

**Bekende problemen.** In [Microsoft Knowledge Base-artikel 951698](http://support.microsoft.com/kb/951698) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=4dc47e04-5e95-4636-a814-3f912d961461)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=7aaa6427-1e22-4566-960c-836a3b9e5f36)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=5e8e7e9d-828d-442c-acac-8d91e80dfb36)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=2274ecb2-2802-47e2-84fd-6621fcb17758)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=5ba63bb7-ed6d-4c59-88b3-456eda07e190)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c](http://www.microsoft.com/downloads/details.aspx?familyid=be71c002-2f64-49e9-9f4b-ba99c4f3caf6)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
</td>
...
In dit bulletin staat dat [Microsoft Knowledge Base-artikel 951698](http://support.microsoft.com/kb/951698) is bijgewerkt met een beschrijving van een oplossing voor een bekend probleem in Microsoft Baseline Security Analyzer (MBSA) 2.1 en voor de detectie van deze update.

**Waarom zijn er op 16 juli 2008 wijzigingen in dit bulletin aangebracht?**  
Aan dit bulletin is DirectX 9.0a toegevoegd als software waarin dit probleem optreedt. Microsoft Update, Windows Update, de Microsoft Baseline Security Analyzer (MBSA) en Microsoft Systems Management Server (SMS) bieden de update al aan voor klanten die DirectX 9.0a hebben geïnstalleerd. Klanten die DirectX 9.0a hebben geïnstalleerd, wordt aangeraden de nieuwste beveiligingsupdate toe te passen.

**Waar is de informatie over de bestandsgegevens?**  
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 951698](http://support.microsoft.com/kb/951698).

**Welk verband bestaat er tussen deze beveiligingsupdate en MS07-064?**  
Deze beveiligingsupdate wijzigt de bestanden in MS07-064. Deze beveiligingsupdate bevat de fixes in MS07-064 en de fix voor de in deze update beschreven beveiligingslekken in één enkele update.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot de MJPEG-decoder - CVE-2008-0011</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot het parseren van de SAMI-indeling - CVE-2008-1444</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 met DirectX 7.0</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 met DirectX 8.1</td>
<td style="border:1px solid black;"><strong>Kritiek</strong><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong><br />
Uitvoering van externe code mogelijk</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 met DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c</td>
<td style="border:1px solid black;"><strong>Kritiek</strong><br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Niet van toepassing</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
...
Beveiligingslek met betrekking tot de MJPEG-decoder - CVE-2008-0011  
-------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop de MJPEG-codec in Windows MJPEG-streams in AVI- of ASF-bestanden verwerkt. Het beveiligingslek kan alleen worden misbruikt als een gebruiker het voorbeeld van een speciaal vervaardigd MJPEG-bestand bekijkt of dit bestand afspeelt.
  
Zie [CVE-2008-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0011) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot de MJPEG-decoder - CVE-2008-0011
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot de MJPEG-decoder - CVE-2008-0011
...
-   **De toegangsbeheerlijst voor quartz.dll wijzigen**
    ...
    **Zo kunt u de tijdelijke oplossing ongedaan maken:** In Windows XP (alle edities ) voert u de volgende opdracht uit vanaf een opdrachtprompt (hiervoor zijn beheerdersbevoegdheden vereist):
...
-   **De MJPEG Encoder uitschakelen**
  
    Volg deze stappen om de registersleutel te wijzigen om de MJPEG Encoder uit te schakelen:
    ...
    **Opmerking** Onjuist gebruik van de Register-editor kan ernstige problemen veroorzaken die ertoe kunnen leiden dat u het besturingssysteem opnieuw moet installeren. Microsoft kan niet garanderen dat problemen die voortkomen uit een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico. Zie voor meer informatie over het bewerken van het register het Help-onderwerp 'Sleutels en waarden wijzigen' in de Register-editor (regedit.exe) of de Help-onderwerpen 'Toevoegen of verwijderen van registerinformatie' en 'Registergegevens bewerken' in regedt32.exe.
    ...
    3.  Klik met de rechtermuisknop op {301056D0-6DFF-11D2-9EEB-006008039E37} en selecteer **Exporteren**. Sla het bestand op schijf op.  
    4.  Verwijder de volledige sleutel {301056D0-6DFF-11D2-9EEB-006008039E37}.  
    5.  Sluit de Register-editor.
  
    **Gevolgen van de tijdelijke oplossing:** Gebruikers zullen MJPEG bestanden niet kunnen weergeven.
    ...
    **Zo kunt u de tijdelijke oplossing ongedaan maken:**
    ...
    4.  Selecteer de correcte bestandsnaam en klik **Openen**.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot de MJPEG-decoder - CVE-2008-0011
...
Het beveiligingslek wordt veroorzaakt door de manier waarop Windows MJPEG-videostreams in ASF- of AVI-mediabestanden op fouten controleert.
  
**Wat is een MJPEG-bestand?**    
Een MJPEG-bestand is een mediabestand waarin een aantal JPEG-afbeeldingen worden samengevoegd om een videostream te maken. De MJPEG-videostream kan dan worden ingevoegd in een AVI-bestand of een ander bestand met een veelgebruikte videobestandsindeling.
  
**Wat zijn AVI- en ASF-bestanden?**    
Audio Video Interleave- (AVI) en Advanced Systems Format-bestanden (ASF) zijn twee typen multimediabestanden die veel worden gebruikt door Windows Media Player.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Het misbruik van dit beveiligingslek kan alleen plaatsvinden wanneer een gebruiker een mediabestand met een speciaal vervaardigd en ingesloten MJPEG-bestand opent en bekijkt.
  
In het geval van een aanval per e-mail kan een aanvaller het beveiligingslek misbruiken door een mediabestand met daarin een speciaal vervaardigd MJPEG-bestand naar de gebruiker te verzenden en de gebruiker ertoe te bewegen het bestand te openen.
...
Dit beveiligingslek vereist dat een gebruiker is aangemeld en het speciaal vervaardigde bestand opent. Voor werkstations en terminalservers is het risico het grootst. Servers zouden eventueel meer gevaar kunnen lopen als beheerders toestaan dat gebruikers zich op servers kunnen aanmelden en programma's kunnen uitvoeren. Dit is echter volkomen in strijd met de aanbevolen richtlijnen voor gebruik.
  
**Wat doet de update?**    
De update verwijdert het beveiligingslek door de controle te verhogen die de parser op MJPEG-videostreams uitvoert.
...
Beveiligingslek met betrekking tot het parseren van de SAMI-indeling - CVE-2008-1444  
------------------------------------------------------------------------------------
  
<span></span>
Als gevolg van de wijze waarop bestanden met ondersteunde indelingen in DirectX worden verwerkt, bestaat er een beveiligingslek waardoor externe code kan worden uitgevoerd. Door dit beveiligingslek kan externe code worden uitgevoerd als een gebruiker een speciaal vervaardigd bestand heeft geopend.
  
Zie [CVE-2008-1444](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1444) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot het parseren van de SAMI-indeling - CVE-2008-1444
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het parseren van de SAMI-indeling - CVE-2008-1444
...
-   **De toegangsbeheerlijst voor quartz.dll wijzigen**
    ...
    **Gevolgen van de tijdelijke oplossing:** WAV- en AVI-bestanden kunnen niet worden afgespeeld in DirectX-toepassingen op Windows XP.
    ...
    **Gevolgen van de tijdelijke oplossing:** WAV- en AVI-bestanden kunnen niet worden afgespeeld in DirectX-toepassingen op Windows Vista.
  
    **Zo kunt u de tijdelijke oplossing ongedaan maken:** Voer de volgende opdracht uit vanaf een opdrachtprompt met verhoogde bevoegdheden:
  
    `Regsvr32.exe %WINDIR%\SYSTEM32\QUARTZ.DLL`
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het parseren van de SAMI-indeling - CVE-2008-1444
  
**Wat is de omvang van het beveiligingslek?**    
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan op afstand volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
DirectX parseert de parameters van SAMI-bestandstypen (Synchronized Accessible Media Interchange) niet goed.
  
**Wat is SAMI?**  
Microsoft Synchronized Accessible Media Interchange (SAMI) is een indeling waarmee inhoudsontwikkelaars onderschriften in digitale mediabestanden kunnen invoegen. SAMI is ontworpen en ontwikkeld om digitale media van onderschriften te voorzien die beschikbaar zijn op pc-systemen. SAMI-onderschriften zijn afzonderlijke, eenvoudige tekstbestanden. De onderschriften kunnen eenvoudig worden gewijzigd, onderhouden, aangepast en gelokaliseerd voor verschillende talen.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Om dit beveiligingslek te misbruiken, zou een aanvaller een gebruiker ertoe moeten overhalen om een speciaal vervaardigd SAMI-bestand te openen. Omdat het beveiligingslek zich in het streaming-onderdeel van Microsoft Windows bevindt, kunnen er aanvallen worden gestart vanaf een speciaal vervaardigde website of toepassing die webinhoud levert. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet hen er dus toe overhalen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door hen ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee zij naar de website van de aanvaller gaan.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 met DirectX 7.0:
...
Microsoft Windows 2000 Service Pack 4 met DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c:
...
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB951698$\Spuninst<br />
<br />
Microsoft Windows 2000 Service Pack 4 met DirectX 8.1:  
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB951698_DX8$\Spuninst<br />
<br />
Microsoft Windows 2000 Service Pack 4 met DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c:
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB951698_DX9$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikel 951698</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikel 951698</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/951698">Microsoft Knowledge Base-artikel 951698</a></td>
...
-   Mark Dowd, onderzoeker voor [IBM Internet Security Systems X-Force](http://xforce.iss.net/) voor het melden van een beveiligingslek met betrekking tot de MJPEG-decoder (CVE-2008-0011)  
-   Een anonieme onderzoeker van [Tipping Point](http://www.tippingpoint.com/) en het [Zero Day Initiative](http://www.zerodayinitiative.com/) voor het melden van een beveiligingslek met betrekking tot het parseren van een indeling (CVE-2008-1444)
...
-   V2.0 (16 juli 2008): DirectX 9.0a is toegevoegd als software waarin dit probleem optreedt.  
-   V2.1 (12 augustus 2008): Koppeling naar toegevoegde bekende problemen. Er is aan de sectie met veelgestelde vragen over deze beveiligingsupdate een item over de bekende problemen en oplossingen toegevoegd. De oplossingen bevatten een wijziging voor Microsoft Baseline Security Analyzer (MBSA) 2.1 waardoor de update op de juiste wijze wordt gedetecteerd.
