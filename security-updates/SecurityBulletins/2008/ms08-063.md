---
TOCTitle: 'MS08-063'
Title: 'Microsoft-beveiligingsbulletin MS08-063 - Belangrijk'
ms:assetid: 'ms08-063'
ms:contentKeyID: 61231681
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms08-063(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS08-063 - Belangrijk
====================================================

Door een beveiligingslek in SMB kan externe code worden uitgevoerd (957095)
---------------------------------------------------------------------------
...
Deze beveiligingsupdate lost een privé gemeld beveiligingslek in het Microsoft SMB-protocol (Server Message Block) op. Door het beveiligingslek kan code worden uitgevoerd vanaf een externe locatie op een server waarop mappen of bestanden worden gedeeld. De aanvaller die dit beveiligingslek kan misbruiken, kan programma's installeren, gegevens bekijken, wijzigen of wissen, en nieuwe accounts met volledige gebruikersrechten maken.
...
Met deze beveiligingsupdate verwijdert u het beveiligingslek doordat de wijze wordt aangepast waarop SMB de validatie van de lengte van bestandsnamen en het delen van bestanden verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=9ed29c3a-0682-4586-bbc2-a73deaa18e4c)                                 | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                                   | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                                       | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2003 met SP1 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                     | Uitvoering van externe code mogelijk    | Belangrijk        | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                     | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Vista en Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=72dd6015-25d1-45f4-a769-88ac43074b44)                         | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Vista x64 Edition en Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f793af16-5464-4db1-a42b-1c5f17c538ed) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2008 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=cf6744e6-b54c-40f6-a78d-7ba9453133c0)\*                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2008 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=223236e8-7b19-4b47-8a90-bfc35eb9318a)\*                               | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
| [Windows Server 2008 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=077b697c-04a0-45bd-b08c-331d5c30cb47)                             | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                                                |
...
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 957095](http://support.microsoft.com/kb/957095).
...
<th style="border:1px solid black;" >Beveiligingslek in SMB door negatieve bufferoverloop - CVE-2008-4038</th>
...
Beveiligingslek in SMB door negatieve bufferoverloop - CVE-2008-4038  
--------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop het Microsoft SMB-protocol (serverberichtblok) speciaal vervaardigde bestandsnamen verwerkt, waardoor externe code kan worden uitgevoerd. Om dit beveiligingslek te kunnen misbruiken, moet er worden geverifieerd, omdat de kwetsbare functie alleen kan worden gebruikt wanneer het type share een schijf is en schijfshares standaard moeten worden geverifieerd. De aanvaller die dit beveiligingslek kan misbruiken, kan programma's installeren, gegevens bekijken, wijzigen of wissen, en nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2008-4038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4038) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in SMB door negatieve bufferoverloop - CVE-2008-4038
...
#### Tijdelijke oplossingen voor het beveiligingslek in SMB door negatieve bufferoverloop - CVE-2008-4038
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in SMB door negatieve bufferoverloop - CVE-2008-4038
...
Het beveiligingslek wordt veroorzaakt doordat speciaal vervaardigde bestandsnamen onvoldoende door het Microsoft SMB-protocol (serverberichtblok) worden gevalideerd.
...
Een aanvaller op een schadelijke client kan dit beveiligingslek misbruiken door speciaal gemaakte pakketten naar een server te sturen. Om dit beveiligingslek te kunnen misbruiken moet een aanvaller het IP-adres van de doelhost, de NetBIOS-computernaam en het nummer van een poort hebben om de schadelijke gegevens te kunnen versturen.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Elk Windows-systeem waarop bestanden kunnen worden gedeeld, loopt mogelijk risico
  
**Wat doet de update?**    
De update verwijdert het beveiligingslek door SMB-validatie van bestandsnamen met een bepaalde lengte toe te voegen.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/957095">Microsoft Knowledge Base-artikel 957095</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/957095">Microsoft Knowledge Base-artikel 957095</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/957095">Microsoft Knowledge Base-artikel 957095</a>.</td>
...
-   Joshua Morin van [Codenomicon](http://www.codenomicon.com/) voor het melden van het beveiligingslek met betrekking tot negatieve bufferoverloop bij SMB (CVE-2008-4038)
...
-   V1.1 (15 oktober 2008): Het bulletin is bijgewerkt om duidelijk te maken dat bij de updates voor Windows Vista en Windows 2008 opnieuw opstarten niet is vereist en om de vermelding over de verificatie van een registersleutel voor Windows XP te verbeteren.
