---
TOCTitle: 'MS09-006'
Title: 'Microsoft-beveiligingsbulletin MS09-006 - Kritiek'
ms:assetid: 'ms09-006'
ms:contentKeyID: 61231702
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-006(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS09-006 - Kritiek
=================================================

Door beveiligingslekken in de Windows-kernel kan externe code worden uitgevoerd (958690)
----------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate worden verschillende privé gemelde beveiligingslekken in de Windows-kernel opgelost. Het ernstigste beveiligingslek kan leiden tot uitvoering van externe code als een gebruiker een speciaal vervaardigd EMF- of WMF-afbeeldingsbestand van een getroffen systeem weergeeft.
...
De beveiligingsupdate lost de beveiligingslekken op door invoer te valideren die vanuit de gebruikersmodus via het kernel-onderdeel van de GDI wordt doorgegeven door de manier te verbeteren waarop de kernel handles valideert en door de manier te wijzigen waarop de Windows-kernel speciaal vervaardigde ongeldige wijzers afhandelt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=98bb7d40-89a0-470a-8eb7-06f15072a635)                                                                  | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e09641ba-6cbe-4095-82b5-703d3a7dc33b)                                                 | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Professional x64 Edition en Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d0d704c6-48c2-4907-b6c3-2455d7cf21c8)              | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 Service Pack 1 en Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f5cfb8da-e7cc-4183-8631-507c2a406500)                               | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 x64 Edition en Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ecf75c70-8489-41ad-9759-3a07e13957be)                      | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 met SP1 voor Itanium-systemen en Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=04be3d7e-7dda-4dca-887a-e7a8156ede1c) | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista en Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4b1aaaba-f355-4265-83c0-50b901856ced)                                                          | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista x64 Edition en Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fcac480-d6db-4a94-8c7d-b7319282cf56)                                  | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=38851df2-4fb5-4d28-9d15-181c260cf8cf)\*                                                            | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=ec15acc4-3e0f-4414-9383-61c122ff1382)\*                                                                | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=eead6f93-10fd-4492-8137-481d9876a5fe)                                                              | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
...
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 958690](http://support.microsoft.com/kb/958690).
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot invoervalidatie in Windows-kernel - CVE-2009-0081</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot handle-validatie in Windows-kernel - CVE-2009-0082</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot ongeldige wijzer in Windows-kernel - CVE-2009-0083</th>
...
Beveiligingslek met betrekking tot invoervalidatie in Windows-kernel - CVE-2009-0081  
------------------------------------------------------------------------------------
  
<span></span>
Er komt in de Windows-kernel een beveiligingslek voor waardoor externe code kan worden uitgevoerd ten gevolge van onjuiste validatie van invoer uit de gebruikersmodus die wordt doorgegeven via het kernel-onderdeel van de GDI. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2009-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot invoervalidatie in Windows-kernel - CVE-2009-0081
...
-   **Schakel de verwerking van metabestanden uit door het register te wijzigen**  
    Klanten die de beveiligingsupdate uit Microsoft-beveiligingsbulletin MS07-017 hebben toegepast en klanten die werken met Windows Vista of Windows Server 2008 kunnen het verwerken van metabestanden uitschakelen door het register te wijzigen. Deze instelling biedt het getroffen systeem bescherming tegen pogingen dit beveiligingslek te misbruiken.
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot invoervalidatie in Windows-kernel - CVE-2009-0081
...
De Windows-kernel valideert invoer niet goed die afkomstig is van de gebruikersmodus en die wordt doorgegeven via het kernel-onderdeel van de GDI.
...
**Wat is GDI?**    
Door de Microsoft Windows Graphics Device Interface (GDI) kunnen toepassingen afbeeldingen en opgemaakte tekst op het beeldscherm weergeven en op een printer afdrukken. Windows-toepassingen benaderen de grafische hardware niet rechtstreeks. In plaats daarvan communiceert de GDI namens de toepassingen met de apparaatstuurprogramma's. Ga naar de [startpagina van Windows GDI](http://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx) voor meer informatie over GDI.
...
Zie [artikel 320314 in de Microsoft Knowledge Base](http://support.microsoft.com/kb/320314) voor meer informatie over afbeeldingstypen en -indelingen. Kijk ook op de [website van de MSDN Library](http://msdn2.microsoft.com/en-us/library/ms536391.aspx) voor aanvullende informatie over deze bestandsindelingen.
...
Om uitvoering van externe code via dit beveiligingslek mogelijk te maken moet een gebruiker een speciaal vervaardigd afbeeldingsbestand weergeven. Dit beveiligingslek kan tevens worden misbruikt door een aanvaller die is aangemeld op het lokale systeem. Een aanvaller kan dan een speciaal ontworpen programma uitvoeren om misbruik te maken van het beveiligingslek en om volledige controle te krijgen over het systeem waarin dit probleem optreedt.
  
In een aanval via e-mail kan een aanvaller het beveiligingslek misbruiken door een e-mail met een speciaal gemaakt EMF- of WMF-afbeeldingsbestand naar de gebruiker te versturen en de gebruiker over te halen de e-mail weer te geven. Een aanvaller kan ook een speciaal gemaakt EMF- of WMF-afbeeldingsbestand in een Office-document insluiten en proberen de gebruiker ertoe over te halen dat bestand te openen.
...
Beveiligingslek met betrekking tot handle-validatie in Windows-kernel - CVE-2009-0082  
-------------------------------------------------------------------------------------
  
<span></span>
Een beveiligingslek met betrekking tot misbruik van bevoegdheden bestaat in de Windows-kernel ten gevolge van de manier waarop de kernel handles valideert. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2009-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot handle-validatie in Windows-kernel - CVE-2009-0082
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot handle-validatie in Windows-kernel - CVE-2009-0082
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot handle-validatie in Windows-kernel - CVE-2009-0082
...
**Waardoor wordt het beveiligingslek veroorzaakt?**    
De Windows-kernel valideert handles niet goed bij het uitvoeren van bepaalde acties.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop de kernel handles valideert.
...
Beveiligingslek met betrekking tot ongeldige wijzer in Windows-kernel - CVE-2009-0083  
-------------------------------------------------------------------------------------
  
<span></span>
Er is sprake van een beveiligingslek met betrekking tot misbruik van bevoegdheden in de Windows-kernel ten gevolge van onjuiste verwerking van een speciaal vervaardigde ongeldige wijzer. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2009-0083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot ongeldige wijzer in Windows-kernel - CVE-2009-0083
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal bij een kwetsbaar systeem aanmelden om dit beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ongeldige wijzer in Windows-kernel - CVE-2009-0083
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot ongeldige wijzer in Windows-kernel - CVE-2009-0083
  
**Wat is de omvang van het beveiligingslek?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
De Windows-kernel handelt speciaal vervaardigde ongeldige wijzers niet goed af.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te wijzigen waarop de Windows-kernel speciaal vervaardigde ongeldige wijzers afhandelt.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/958690">Microsoft Knowledge Base-artikel 958690</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel Software in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/958690">Microsoft Knowledge Base-artikel 958690</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/958690">Microsoft Knowledge Base-artikel 958690</a></td>
...
-   Helmut Buhler ([http://home.arcor.de/clipboarder](http://home.arcor.de/clipboarder/)/) voor het melden van het beveiligingslek met betrekking tot invoervalidatie in Windows-kernel (CVE-2009-0081)  
-   Thomas Garnier van [SkyRecon](http://www.skyrecon.com/) voor het melden van het beveiligingslek met betrekking tot handle-validatie in Windows-kernel (CVE-2009-0082)
