---
TOCTitle: 'MS09-011'
Title: 'Microsoft-beveiligingsbulletin MS09-011 - Kritiek'
ms:assetid: 'ms09-011'
ms:contentKeyID: 61231707
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-011(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS09-011 - Kritiek
=================================================
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop DirectShow mediabestanden decomprimeert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 961373](http://support.microsoft.com/kb/961373).
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot MJPEG-decompressie - CVE-2009-0084
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition en Windows XP Professional x64 Edition Service Pack 2 met DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Kritiek**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 1 en Windows Server 2003 Service Pack 2 met DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Kritiek**   
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition en Windows Server 2003 x64 Edition Service Pack 2 met DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Kritiek**   
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 met SP1 voor Itanium-systemen en Windows Server 2003 met SP2 voor Itanium-systemen met DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Kritiek**   
Uitvoering van externe code mogelijk
...
<span></span>
Als gevolg van de wijze waarop bestanden met ondersteunde indelingen in Microsoft DirectShow worden verwerkt, bestaat er een beveiligingslek waardoor externe code kan worden uitgevoerd. Door dit beveiligingslek kan code worden uitgevoerd als een gebruiker een speciaal vervaardigd MJPEG-bestand heeft geopend. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2009-0084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot MJPEG-decompressie - CVE-2009-0084
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot MJPEG-decompressie - CVE-2009-0084

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Decodering van MJPEG-content in Quartz.dll uitschakelen**
    ...
    **De interactieve methode gebruiken**
    ...
    2.  Zoek de volgende subsleutel in het register op en klik erop: HKEY\_CLASSES\_ROOT\\CLSID\\{301056D0-6DFF-11D2-9EEB-006008039E37}
    3.  Klik op het menu **Bestand** en selecteer **Exporteren.**
    4.  Typ in het dialoogvenster Registerbestand exporteren de tekst **MJPEG\_Decoder\_Backup.reg** en klik op **Opslaan**.
    ...
    **Gevolgen van de tijdelijke oplossing: **Het afspelen van MJPEG-inhoud wordt uitgeschakeld.
    ...
    **Zo kunt u tijdelijke oplossingen ongedaan maken.**
    ...
    3.  Selecteer in het dialoogvenster Registerbestand importeren het bestand **MJPEG\_Decoder\_Backup.reg** en klik op **Openen**.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot MJPEG-decompressie - CVE-2009-0084
...
Het onderdeel Microsoft DirectShow verwerkt speciaal vervaardigde gecomprimeerde bestanden niet goed.
...
Voor dit beveiligingslek moet een gebruiker een speciaal vervaardigd MJPEG-bestand openen of speciaal vervaardigde streaming content ontvangen van een website of een toepassing die webcontent levert.
...
**Wat doet de update?**  
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop DirectShow media-bestanden decomprimeert.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 met DirectX 8.1:<br />
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/961373">Microsoft Knowledge Base-artikel 961373</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder opnieuw op te starten</td>
<td style="border:1px solid black;">Alle ondersteunde 32-bits edities van Windows XP met DirectX 9.0, DirectX 9.0a, DirectX 9.0b of DirectX 9.0c:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB961373$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/961373">Microsoft Knowledge Base-artikel 961373</a></td>
...
-   Piotr Bania van [Kryptos Logic](http://www.kryptoslogic.com/) voor het melden van het beveiligingslek met betrekking tot MJPEG-decompressie (CVE-2009-0084)
...
-   V1.1 (22 april 2009): Microsoft Windows 2000 Service Pack 4 met DirectX 7.0 toegevoegd aan de tabel met software waarin dit probleem niet optreedt. Het gaat alleen om een wijziging in de informatie.
