---
TOCTitle: 'MS09-014'
Title: 'Microsoft-beveiligingsbulletin MS09-014 - Kritiek'
ms:assetid: 'ms09-014'
ms:contentKeyID: 61231710
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-014(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS09-014 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (963027)
--------------------------------------------------------------

Gepubliceerd: dinsdag 14 april 2009 | Bijgewerkt: dinsdag 25 augustus 2009
...
Dit is een kritieke beveiligingsupdate voor Internet Explorer 5.01 en Internet Explorer 6 Service Pack 1 in alle ondersteunde edities van Microsoft Windows 2000, voor Internet Explorer 6 en Internet Explorer 7 in ondersteunde edities van Windows XP en voor Internet Explorer 7 in ondersteunde edities van Windows Vista. Voor Internet Explorer 6 en Internet Explorer 7 in ondersteunde edities van Windows Server 2003 en Windows Server 2008 is het prioriteitsniveau Belangrijk. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost deze beveiligingslekken op door de manier te wijzigen waarop Internet Explorer in het systeem zoekt naar te laden bestanden, verificatieantwoorden valideert, overgangsfouten bij het navigeren tussen webpagina's verwerkt en geheugenobjecten verwerkt. Zie de subsectie Veelgestelde vragen in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 963027](http://support.microsoft.com/kb/963027) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
|--------------------------------------------------------------------------------------------------------|-----------------------------|
| Windows XP Service Pack 2 en Windows XP Service Pack 3                                                 | Windows Internet Explorer 8 |
| Windows XP Professional x64 Edition en Windows XP Professional x64 Edition Service Pack 2              | Windows Internet Explorer 8 |
| Windows Server 2003 Service Pack 1 en Windows Server 2003 Service Pack 2                               | Windows Internet Explorer 8 |
| Windows Server 2003 x64 Edition en Windows Server 2003 x64 Edition Service Pack 2                      | Windows Internet Explorer 8 |
| Windows Server 2003 met SP1 voor Itanium-systemen en Windows Server 2003 met SP2 voor Itanium-systemen | Windows Internet Explorer 8 |
| Windows Vista en Windows Vista Service Pack 1                                                          | Windows Internet Explorer 8 |
| Windows Vista x64 Edition en Windows Vista x64 Edition Service Pack 1                                  | Windows Internet Explorer 8 |
| Windows Server 2008 voor 32-bits systemen                                                              | Windows Internet Explorer 8 |
| Windows Server 2008 voor x64-systemen                                                                  | Windows Internet Explorer 8 |
| Windows Server 2008 voor Itanium-systemen                                                              | Windows Internet Explorer 8 |
...
De informatie over de bestandsgegevens vindt u in [Microsoft Knowledge Base-artikel 963027](http://support.microsoft.com/kb/963027).

**Welk verband bestaat er tussen deze beveiligingsupdate en MS09-013?**  
Het beveiligingslek met betrekking tot hergebruik van WinINet-referenties, [CVE-2009-0550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550), dat wordt beschreven in dit beveiligingsbulletin, is ook van invloed op Windows HTTP Services. Microsoft raadt aan dat gebruikers ook de beveiligingsupdate [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852), Door beveiligingslekken in Windows HTTP Services kan externe code worden uitgevoerd (960803), installeren.

**Welk verband bestaat er tussen deze beveiligingsupdate en MS09-015?**  
Het beveiligingslek door bedreiging met betrekking tot het uitvoeren van externe code, [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540), dat wordt beschreven in dit beveiligingsbulletin is ook van toepassing op de SearchPath-functie in Windows. Microsoft raadt gebruikers aan ook de beveiligingsupdate te installeren van [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803), Dreiging van beveiligingslek in SearchPath kan leiden tot misbruik van bevoegdheden (959426).

**Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging?**  
Ja. Naast de wijzigingen die in het gedeelte **Informatie over de beveiligingslekken** van dit bulletin worden beschreven, bevat deze update de volgende wijzigingen:

-   Een wijziging die overeenkomt met de correctie in [MS09-010](http://go.microsoft.com/fwlink/?linkid=139849) (Door een beveiligingslek in WordPad en Office-tekstconversieprogramma's kan externe code worden uitgevoerd (960477))
-   Een wijziging waarmee het protocol **about:** wordt versterkt om vervalsing (spoofing) te beperken
-   Een wijziging die overeenkomt met de correctie in [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Bedreiging in SearchPath kan leiden tot misbruik van bevoegdheden (959426)). Dit biedt een beperking van het gecombineerde bedreigingsprobleem dat van toepassing is op Apple Safari, Microsoft Windows en Microsoft Internet Explorer en dat openbaar bekend is gemaakt met nummer [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540). Zie ook de veelgestelde vragen hieronder over **bedreiging.**

**Lost deze beveiligingsupdate het bekende probleem voor MS09-002 op dat wordt beschreven in Microsoft Knowledge Base-artikel 967941?**  
Ja, deze update lost het bekende probleem voor [MS09-002](http://technet.microsoft.com/security/bulletin/ms09-002) op dat wordt omschreven in [Microsoft Knowledge Base-artikel 967941](http://support.microsoft.com/kb/967941) ("De navigatie wordt geannuleerd wanneer u naar webpagina's gaat die zich in verschillende beveiligingszones van Internet Explorer bevinden").

**Als ik de tijdelijke registeroplossing al heb uitgevoerd voor het probleem dat wordt omschreven in Microsoft Knowledge Base-artikel 967941, wat moet ik dan nog meer doen?**  
Als u de instructies in [Microsoft Knowledge Base-artikel 967941](http://support.microsoft.com/kb/967941) voor het bewerken van het register (handmatig of via de wizard) al had gevolgd om de functiebesturingssleutel in te schakelen waarmee de functionaliteit wordt uitgeschakeld die wordt beschreven in [MS09-002](http://technet.microsoft.com/security/bulletin/ms09-002), moet u deze functiebesturingssleutel nu terugdraaien. Zie [Microsoft Knowledge Base-artikel 967941](http://support.microsoft.com/kb/967941) voor instructies.

**Ben ik volledig beschermd tegen het bedreigingsprobleem dat wordt beschreven in CVE-2008-2540 als ik alleen deze update toepas?**  
Nee, u moet de ingrijpende veiligheidsmaatregel van deze cumulatieve beveiligingsupdate voor Internet Explorer afzonderlijk inschakelen en daarbij [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Bedreiging in SearchPath kan leiden tot misbruik van bevoegdheden (959426)) toepassen. U moet echter nagaan of het inschakelen van deze ingrijpende veiligheidsmaatregel tegen het bedreigingsprobleem geschikt is voor uw omgeving.

Voer de volgende stappen uit om de ingrijpende verdedigingsmaatregel in te schakelen:

1.  Sla het volgende op in een bestand met de extensie REG, bijvoorbeeld Enable\_SearchPath.reg, om de functiebesturingssleutel toe te voegen:
...
2.  Voer vervolgens met de volgende opdracht vanaf een verhoogde opdrachtregel het bestand Enable\_SearchPath.reg uit:
    Regedit.exe /s Enable\_SearchPath.reg

Zie [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Bedreiging in SearchPath kan leiden tot misbruik van bevoegdheden (959426)) en [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540) voor meer informatie over het bedreigingsprobleem.

**Is het mogelijk de ingrijpende veiligheidsmaatregel voor Internet Explorer voor de gemengde bedreiging rond beveiligingslekken in Microsoft Windows 2000 in te schakelen?**
Nee. Vanwege architecturale verschillen is de ingrijpende verdedigingsmaatregel tegen de gemengde bedreiging, [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540), niet van toepassing op het Microsoft Windows 2000-platform. Het inschakelen van de ingrijpende veiligheidsmaatregel voor Internet Explorer op Microsoft Windows 2000 zal geen invloed hebben. Microsoft is echter niet op de hoogte van geldige aanvalsvectors die gericht zouden zijn op Microsoft Windows 2000-systemen.
...
<th style="border:1px solid black;" >
Beveiligingslek door bedreiging met betrekking tot het uitvoeren van externe code - CVE-2008-2540
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot hergebruik van WinINet-referenties - CVE-2009-0550
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot beschadigd geheugen bij paginaovergang - CVE-2009-0551
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen – CVE-2009-0552
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen – CVE-2009-0553
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen – CVE-2009-0554
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<tr>
<td style="border:1px solid black;">
Internet Explorer 7 in Windows Vista en Windows Vista Service Pack 1
</td>
<td style="border:1px solid black;">
Niet van toepassing
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Explorer 7 in Windows Vista x64 Edition en Windows Vista x64 Edition Service Pack 1
</td>
<td style="border:1px solid black;">
Niet van toepassing
</td>
...
<span></span>
Er bestaat een beveiligingslek door een bedreiging met betrekking tot het uitvoeren van externe code in de manier waarop Internet Explorer bestanden in het systeem opspoort en opent. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
#### Beperkende factoren voor het beveiligingslek door bedreiging met betrekking tot het uitvoeren van externe code - CVE-2008-2540

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Dit beveiligingslek komt niet voor in Windows Internet Explorer 8.

#### Tijdelijke oplossingen voor het beveiligingslek door bedreiging met betrekking tot het uitvoeren van externe code - CVE-2008-2540

Microsoft heeft nog geen oplossingen voor dit beveiligingslek.

#### Veelgestelde vragen voor het beveiligingslek door bedreiging met betrekking tot het uitvoeren van gemengde code - CVE-2008-2540
...
Een aanvaller kan dit beveiligingslek misbruiken door een speciaal vervaardigd bestand voor de gebruiker te maken en naar het bureaublad te downloaden met Apple Safari. De aanvaller kan een website hosten die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek en vervolgens de gebruiker ertoe overhalen deze website te bekijken. De aanvaller zou ook misbruik kunnen maken van gemanipuleerde websites en websites die inhoud of advertenties van gebruikers accepteren of hosten. Deze websites kunnen speciaal vervaardigde inhoud bevatten, die misbruik van dit beveiligingslek kan maken. Een aanvaller kan echter een gebruiker er niet toe dwingen om naar deze websites te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller gaat. Speciaal ontworpen webinhoud kan ook worden weergegeven via banneradvertenties of andere manieren waarop webinhoud bij de kwetsbare systemen wordt afgeleverd.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Alle systemen, zoals werkstations en servers, waar gebruikers bestanden downloaden en toepassingen starten, lopen het risico te worden getroffen door dit beveiligingslek.

**Wat doet de update?**  
De update wijzigt de manier waarop Internet Explorer bestanden van het bureaublad laadt.

**Waarom is aan dit beveiligingslek en aan de dreiging van het beveiligingslek met betrekking tot misbruik van bevoegdheden hetzelfde CVE-nummer (CVE-2008-2540) toegewezen in MS09-015, Dreiging van beveiligingslek in SearchPath kan leiden tot misbruik van bevoegdheden (959426)?**
[CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540) treft Internet Explorer 7 voor Windows XP Service Pack 2 en Windows XP Service Pack 3 en Internet Explorer 7 voor Windows XP Professional x64 Edition en Windows XP Professional x64 Edition Service Pack 2 enerzijds, en de SearchPath-functie van Windows anderzijds. Microsoft raadt gebruikers aan ook de beveiligingsupdate te installeren van [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803), Dreiging van beveiligingslek in SearchPath kan leiden tot misbruik van bevoegdheden (959426). Een ingrijpende wijziging voor dit beveiligingslek in deze update komt ook overeen met de oplossing in [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803). Zie ook "Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging? in de sectie **Veelgestelde vragen met betrekking tot deze beveiligingsupdate.**

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 953818](http://technet.microsoft.com/security/advisory/953818).
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code aanwezig in de manier waarop WinINet NTLM-referenties verwerkt wanneer een gebruiker via het HTTP-protocol verbinding maakt met de webserver van een aanvaller. Dit beveiligingslek stelt de aanvaller in staat de referenties van de gebruiker te herhalen en code uit te voeren in de context van de aangemelde gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
#### Beperkende factoren voor het beveiligingslek met betrekking tot hergebruik van WinINet-referenties - CVE-2009-0550
...
-   De meest waarschijnlijke aanvalsvector voor misbruik van dit beveiligingslek is SMB. Standaard wordt SMB-verkeer geblokkeerd door de firewall van Windows Vista. Op een kwetsbare client zou een service moeten worden uitgevoerd die NTLM-verificatie accepteert om de aanval te laten slagen en de referenties te kunnen hergebruiken. Als een Vista-systeem niet in een Windows-domeinomgeving is geïmplementeerd, is het profiel van de firewall van Windows Vista standaard "openbaar", waardoor SMB-verkeer wordt geblokkeerd.
-   Internet Explorer geeft referenties niet automatisch door aan de zone Internet. Een gebruiker zou de referenties moeten invoeren via de browser.
-   Dit beveiligingslek komt niet voor in Windows Internet Explorer 8.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot hergebruik van WinINet-referenties - CVE-2009-0550- CVE-2009-0550

Microsoft heeft nog geen oplossingen voor dit beveiligingslek.

#### Veelgestelde vragen voor het beveiligingslek met betrekking tot hergebruik van WinINet-referenties - CVE-2009-0550 - CVE-2009-0550

**Wat is de omvang van het beveiligingslek?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
WinINet meldt zich niet juist aan voor NTLM-bescherming tegen opnieuw afspelen van referenties zodat de referenties van een gebruiker niet opnieuw worden herhaald voor een aanvaller en tegen de gebruiker worden gebruikt.

**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**  
Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als de gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**  
Dit beveiligingslek vereist dat een gebruiker met een getroffen implementatie van WinINet verbinding maakt met een speciaal vervaardigde server.
...
**Wat is WinINet?**  
WinINet verwijst naar de Windows Internet-API (Application Programming Interface), waarmee toepassingen kunnen communiceren met standaardprotocollen, zoals FTP en HTTP, voor de toegang tot internetresources. Naarmate standaarden verder worden ontwikkeld, verwerkt WinINet de wijzigingen in de onderliggende protocollen, waardoor de toepassingen consistent gedrag kunnen behouden.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Voor dit beveiligingslek is het noodzakelijk dat een gebruiker aangemeld is, een website bezoekt en bestands- en printerdeling heeft ingeschakeld (zodat SMB-verkeer kan worden uitgewisseld) voordat er een schadelijke actie kan plaatsvinden. Daarom lopen systemen waarin Internet Explorer veelvuldig wordt gebruikt in een domeinomgeving, zoals werkstations en terminalservers, het meeste risico.

**Wat doet de update?**  
De update wijzigt de manier waarop WinINet verificatieantwoorden valideert om de herhaling van referenties te voorkomen.

**Waarom is aan dit beveiligingslek en het beveiligingslek in Windows HTTP Services met betrekking tot hergebruik van referenties hetzelfde CVE-nummer (CVE-2009-0550) toegewezen in MS09-013, Door beveiligingslekken in Windows HTTP Services kan kan externe code worden uitgevoerd (960803)?**
CVE-2009-0550 is van invloed op zowel WinINet, dat wordt gebruikt door Internet Explorer, als Windows HTTP Services, dat deel uitmaakt van het Windows-besturingssysteem. Microsoft raadt aan dat gebruikers ook de beveiligingsupdate [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852), Door beveiligingslekken in Windows HTTP Services kan externe code worden uitgevoerd (960803), installeren.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop Internet Explorer overgangen bij het navigeren tussen webpagina's verwerkt. Hierdoor kan het systeemgeheugen zodanig beschadigd raken dat een aanvaller willekeurige code kan uitvoeren wanneer een gebruiker een speciaal vervaardigde website bezoekt. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

Zie [CVE 2009-0551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0551) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadigd geheugen bij paginaovergang - CVE-2009-0551
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot beschadigd geheugen bij paginaovergang - CVE-2009-0551
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot beschadigd geheugen bij paginaovergang - CVE-2009-0551

**Wat is de omvang van het beveiligingslek?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Wanneer Internet Explorer overgangen verwerkt bij het navigeren tussen webpagina's, kan het geheugen dusdanig beschadigd raken dat een aanvaller willekeurige code kan uitvoeren binnen de context van de aangemelde gebruiker.
...
**Wat doet de update?**  
De update wijzigt de manier waarop Internet Explorer overgangsfouten verwerkt bij het navigeren tussen webpagina's.
...
Zie [CVE 2009-0552](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0552) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0552
...
-   HTML-e-mailberichten worden door alle ondersteunde versies van Microsoft Outlook en Microsoft Outlook Express standaard geopend in de zone Websites met beperkte toegang. De zone Websites met beperkte toegang beperkt het aantal aanvallen die dit beveiligingslek kunnen misbruiken, doordat er bij het lezen van e-mailberichten in HTML-indeling geen scripts actief worden uitgevoerd en geen ActiveX-besturingselementen meer worden gebruikt. Als een gebruiker echter op een koppeling in een e-mailbericht klikt, kan deze nog wel als gevolg van het beveiligingslek via een aanval vanaf het web worden getroffen.
-   Standaard wordt Internet Explorer op Windows Server 2003 en Windows Server 2008 uitgevoerd in een beperkte modus genaamd [Verbeterde beveiliging](http://go.microsoft.com/fwlink/?linkid=92039). In deze modus wordt het beveiligingsniveau voor de zone Internet ingesteld op Hoog. Dit is een beperkende factor voor websites die u niet aan de zone Vertrouwde websites van Internet Explorer hebt toegevoegd. Zie de subsectie Veelgestelde vragen van dit beveiligingslek voor meer informatie over Verbeterde beveiliging van Internet Explorer.
-   Dit beveiligingslek komt niet voor in Windows Internet Explorer 7 en Windows Internet Explorer 8.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0552
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0552
...
**Wat doet de update?**  
De update wijzigt de manier waarop Internet Explorer geheugenobjecten verwerkt.
...
Zie [CVE 2009-0553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0553) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0553
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0553
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0553
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop Internet Explorer objecten opent die niet zijn geïnitialiseerd of zijn verwijderd. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker.

Zie [CVE 2009-0554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0554) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0554
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0554
...
#### Veelgestelde vragen voor het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen - CVE-2009-0554
...
| Windows Vista en Windows Vista Service Pack 1                                                          | Nee     | Nee                | Zie de **Opmerking voor Windows Vista** **en Windows Server 2008** hieronder   | Ja                         |
...
<td style="border:1px solid black;">Voor Internet Explorer 5.01 Service Pack 4 op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB963027-IE501SP4-20090303.120000$\Spuninst<br />
<br />
Voor Internet Explorer 6 Service Pack 1 indien geïnstalleerd op alle ondersteunde edities van Windows 2000:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB963027-IE6SP1-20090303.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/963027">Microsoft Knowledge Base-artikel 963027</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 voor alle ondersteunde versies van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB963027$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde versies van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB963027-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/963027">Microsoft Knowledge Base-artikel 963027</a></td>
...
-   [Aviv Raff](http://aviv.raffon.net/) voor het melden van de dreiging van het beveiligingslek met betrekking tot uitvoeren van externe code (CVE-2008-2540)  
-   Michal Zalewski van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot beschadigd geheugen bij paginaovergang (CVE-2009-0551)  
-   Ivan Fratric van [iSIGHT Partners Labs](http://www.isightpartners.com/) voor het melden van het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen (CVE-2009-0552)  
-   Skylined van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen (CVE-2009-0553)  
-   ADLab van [VenusTech](http://www.venustech.com.cn/) voor het melden van het beveiligingslek met betrekking tot niet-geïnitialiseerd geheugen (CVE-2009-0554)
...
-   V1.1 (15 april 2009): Veelgestelde vragen toegevoegd aan de sectie **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** en aan de sectie Beveiligingslek voor CVE-2008-2540 ter verduidelijking van het verband tussen CVE-2008-2540 in dit bulletin en in MS09-015.  
-   V1.2 (22 april 2009): De veelgestelde vraag "Is het mogelijk de ingrijpende veiligheidsmaatregel voor Internet Explorer voor de gemengde bedreiging rond beveiligingslekken in Microsoft Windows 2000 in te schakelen?" in het onderdeel **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** is gecorrigeerd.  
-   V1.3 (25 augustus 2009): De SearchPath-functiebesturingssleutel, genoemd in de vermelding over CVE-2008-2540 in het onderdeel **Veelgestelde vragen over deze beveiligingsupdate**, is gecorrigeerd.
