---
TOCTitle: 'MS09-059'
Title: 'Microsoft-beveiligingsbulletin MS09-059 - Belangrijk'
ms:assetid: 'ms09-059'
ms:contentKeyID: 61231755
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-059(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS09-059 - Belangrijk
====================================================

Beveiligingslek in de Local Security Authority Subsystem-service kan leiden tot denial of service (975467)
----------------------------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Het beveiligingslek kan leiden tot denial of service als een aanvaller een schadelijk pakket verzendt tijdens de NTLM-verificatie.

Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 en Windows 7. Ondersteunde edities van Windows XP en Windows Server 2003 worden alleen getroffen als eerder de niet-beveiligingsupdate is geïnstalleerd die wordt beschreven in KB968389. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door extra validatie te implementeren van specifieke sets waarden die worden gebruikt in het verificatieproces. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 975467](http://support.microsoft.com/kb/975467) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e997ea40-668e-40df-bd50-0ca53437b375)\*                                                        | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17008892-7950-44c4-850d-002c8d73495f)\*                                                            | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9dff4662-7771-4bdc-87ec-7899d79b3a55)\*                                                                            | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8df7a2d9-2f97-4f18-84e8-415a1632cf09)\*                                                                | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=83c77015-7f96-4c0d-bd56-60aef90ea2f8)\*                                                             | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04ae306b-0d0d-4767-ab54-cc11aec477ed)                                     | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58c995ca-f308-4e07-8e60-2e542384d95d) | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor het 32-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f2f617c2-f149-4e9b-bfdd-08ed0f3f99db)\*\*    | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor het 64-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=deb84cb8-2ba3-47e3-9185-2bbc5b0a7e18)\*\*        | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=abc94857-37d8-4bb8-ad9e-46e687fca40e)           | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=35b85783-90df-4f67-a3cb-02351432133e)                                                                                 | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=97010f2c-6c10-4fda-84fd-6c8749968db5)                                                                                     | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=597ac3a7-e02d-49a5-9b8e-d097e867acea)\*\*                                                                    | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=4aac0e3e-9b49-4a4a-ab17-707ff03b4d9b)                                                                    | Denial of service                       | Belangrijk        | Geen                                            |

**\***Dit besturingssysteem wordt alleen getroffen als KB968389, Uitgebreide bescherming voor verificatie (zie [Microsoft-beveiligingsadvies 973811](http://support.microsoft.com/kb/973811)), is geïnstalleerd. Zie voor meer informatie het onderdeel **Veelgestelde Vragen met betrekking tot deze beveiligingsupdate**.

**\*\*Server Core-installatie is getroffen.** Deze update is met hetzelfde prioriteitsniveau van toepassing op ondersteunde edities van Windows Server 2008 en Windows Server 2008 R2, ongeacht of deze zijn geïnstalleerd met de optie Server Core-installatie. Voor meer informatie over deze installatieoptie raadpleegt u de MSDN artikelen [Server Core](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) en [Server Core voor Windows Server 2008 R2](http://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx). Let wel: de Server Core-installatieoptie is niet van toepassing op bepaalde edities van Windows Server 2008 en Windows Server 2008 R2. Zie [Server Core-installatieopties vergelijken](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
Dit beveiligingslek treft systemen met Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2. Daarnaast treft het ook systemen met Windows XP en Windows Server 2003 waarop KB968389 is geïnstalleerd, een niet-beveiligingsupdate waarmee Uitgebreide bescherming wordt geïmplementeerd.

**Is mijn computer kwetsbaar als ik KB968389 niet heb geïnstalleerd?**  
Ondersteunde edities van Windows XP en Windows Server 2003 waarop KB968389 niet is geïnstalleerd, zijn niet kwetsbaar. Ondersteunde edities van Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2 die KB968389 niet hebben geïnstalleerd, zijn wel kwetsbaar.

**Waarom wordt KB968389 alleen aangeboden via Windows Update of Microsoft Update?**  
Als u KB968389 via Windows Update of Microsoft Update na de release van deze beveiligingsupdate verkrijgt, wordt beveiligingsupdate KB975467 automatisch geïnstalleerd. Als KB968389 is geïnstalleerd, worden zowel KB968389 als de MS09-059-beveiligingsupdate KB975467 als geïnstalleerde software vermeld.

Als u KB968389 hebt geïnstalleerd vóór de release van deze beveiligingsupdate, bieden Windows Update en Microsoft Update beveiligingsupdate KB975467 aan om het beveiligingslek op te lossen.
...
<th style="border:1px solid black;" >Beveiligingslek in de Local Security Authority Subsystem-service met betrekking tot integeroverloop - CVE-2009-2524</th>
...
**\*Dit besturingssysteem wordt alleen getroffen als KB968389, Uitgebreide beveiliging voor verificatie (zie** [**Microsoft-beveiligingsadvies 973811**](http://support.microsoft.com/kb/973811)**) is geïnstalleerd.** Zie voor meer informatie het onderdeel **Veelgestelde Vragen met betrekking tot deze beveiligingsupdate**.
  
**\*\*Server Core-installatie is getroffen.** Deze update is met hetzelfde prioriteitsniveau van toepassing op ondersteunde edities van Windows Server 2008 en Windows Server 2008 R2, ongeacht of deze zijn geïnstalleerd met de optie Server Core-installatie. Voor meer informatie over deze installatieoptie raadpleegt u de MSDN artikelen [Server Core](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) en [Server Core voor Windows Server 2008 R2](http://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx). Let wel: de Server Core-installatieoptie is niet van toepassing op bepaalde edities van Windows Server 2008 en Windows Server 2008 R2. Zie [Server Core-installatieopties vergelijken](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
  
Beveiligingslek in de Local Security Authority Subsystem-service met betrekking tot integeroverloop - CVE-2009-2524  
-------------------------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot een denial of service in de Microsoft Windows Local Security Authority Subsystem-service (LSASS) vanwege een onjuiste verwerking van ongeldige pakketten tijdens NTLM-verificatie. Een aanvaller kan speciaal ontworpen anonieme NTLM-verificatieaanvragen maken die een crash veroorzaken in de LSASS-service waardoor de computer stopt met reageren en vervolgens opnieuw wordt opgestart.
  
Zie [CVE 2009-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de Local Security Authority Subsystem-service met betrekking tot integeroverloop - CVE-2009-2524
  
Microsoft heeft nog geen beperkende factoren voor dit beveiligingslek.
  
#### Tijdelijke oplossingen voor het beveiligingslek in de Local Security Authority Subsystem-service met betrekking tot integeroverloop - CVE-2009-2524
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **KB968389 verwijderen van computers met Windows XP of Windows Server 2003**
  
    1.  Klik op **Start**, **Configuratiescherm** en vervolgens op het onderdeel **Software**.  
    2.  Selecteer **KB968389** en klik vervolgens op **Verwijderen**.
  
    **Gevolgen van de tijdelijke oplossing.** Computers met Windows XP en Windows Server 2003 profiteren niet van de uitgebreide bescherming voor verificatie wanneer deze KB is uitgeschakeld.
  
    **De tijdelijke oplossing ongedaan maken.** Installeer KB968389 door het installatiepakket te downloaden naar uw besturingssysteem via [Microsoft Knowledge Base-artikel 936389](http://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0).
...
#### Veelgestelde vragen over het beveiligingslek in de Local Security Authority Subsystem-service met betrekking tot integeroverloop - CVE-2009-2524
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op een denial of service. Door een speciaal ontworpen verificatieraamwerk kan een niet-geverifieerde aanvaller ervoor zorgen dat het LSASS-proces aan de serverzijde niet meer reageert en de computer opnieuw wordt opgestart.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek is aanwezig omdat de Windows NTLM-implementatie in LSASS specifieke ongeldige pakketten niet goed verwerkt tijdens het verificatieproces. Een specifiek ongeldig pakket kan leiden tot een negatieve overloop van gehele getallen in het LSASS-proces.
...
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan ervoor zorgen dat het systeem automatisch opnieuw wordt opgestart.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller kan misbruik maken van dit beveiligingslek door een schadelijk pakket te verzenden tijdens het NTLM-verificatieproces.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Servers die clients toestaan te verifiëren met NTLM het lopen risico.
  
**Wat doet de update?**    
De update zorgt dat LSASS specifieke waarden die worden gebruikt in het verificatieproces, juist verwerkt.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB975467$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/975467">Microsoft Knowledge Base-artikel 975467</a></td>
</tr>
<tr class="even">
...
<strong>Opmerking</strong> Opnieuw opstarten kan voor Windows Server 2003 worden vermeden door de Local Security Authority Subsystem-service te stoppen, de update te installeren en vervolgens de Local Security Authority Subsystem-service opnieuw te starten. Wanneer de Local Security Authority Subsystem-service niet is gestopt voordat de update wordt geïnstalleerd, moet het systeem toch opnieuw worden opgestart.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
...
<br />
Voor alle ondersteunde Itanium-edities van Windows Server 2008 met R2:<br />
...
-   V1.1 (14 oktober 2009): De inleidende beschrijving voor CVE-2009-2524 in de sectie met informatie over het beveiligingslek is gecorrigeerd.
