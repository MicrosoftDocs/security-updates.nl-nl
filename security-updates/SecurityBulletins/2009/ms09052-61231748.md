---
TOCTitle: 'MS09-052'
Title: 'Microsoft-beveiligingsbulletin MS09-052 - Kritiek'
ms:assetid: 'ms09-052'
ms:contentKeyID: 61231748
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms09-052(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS09-052 - Kritiek
=================================================

Door een beveiligingslek in Windows Media Player kan externe code worden uitgevoerd (974112)
--------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 13 oktober 2009 | Bijgewerkt: dinsdag 12 januari 2010
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Media Player opgelost. Door het beveiligingslek kan externe code worden uitgevoerd indien een speciaal vervaardigd ASF-bestand wordt afgespeeld met Microsoft Windows Media Player 6.4. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde gebruikersrechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor Microsoft Windows Media Player 6.4 indien geïnstalleerd op alle ondersteunde edities van Microsoft Windows 2000, Windows XP en Windows Server 2003. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop Windows Media Player 6.4 speciaal vervaardigde ASF-bestanden afhandelt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|--------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                  | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=13035ef7-7e47-487c-8b7c-7795d33ce7de) | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                                                |
| Windows XP Service Pack 2 en Windows XP Service Pack 3 | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=b2efe1ac-d8d7-41bb-b87d-fc5e22afef0f) | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows XP Professional x64 Edition Service Pack 2     | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=a9e7dfd8-7ba1-4f14-8e60-92ef00d91467) | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows Server 2003 Service Pack 2                     | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=5f82d01c-573e-425e-b9f2-86a54f377b19) | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows Server 2003 x64 Edition Service Pack 2         | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=65e9036e-2e1b-40ff-a84b-c507107bcce8) | Uitvoering van externe code mogelijk    | Kritiek           | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |

**Software waarin dit probleem niet optreedt**

| Besturingssysteem                                                                                               | Onderdeel           |
|-----------------------------------------------------------------------------------------------------------------|---------------------|
| Windows Server 2003 met SP2 voor Itanium-systemen                                                               | Niet van toepassing |
| Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2                                     | Niet van toepassing |
| Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2 | Niet van toepassing |
| Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2           | Niet van toepassing |
| Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2                   | Niet van toepassing |
...
| Windows 7 voor 32-bits systemen                                                                                 | Niet van toepassing |
| Windows 7 voor x64-systemen                                                                                     | Niet van toepassing |
| Windows Server 2008 R2 voor x64-systemen                                                                        | Niet van toepassing |
| Windows Server 2008 R2 voor Itanium-systemen                                                                    | Niet van toepassing |

Veelgestelde vragen met betrekking tot deze beveiligingsupdate
--------------------------------------------------------------

<span></span>
**Ik heb Windows Media Player 6.4 niet op mijn systeem geïnstalleerd. Waarom krijg ik deze update aangeboden?**  
Nadat van Microsoft Windows Media Player 6.4 is bijgewerkt naar een latere versie van Windows Media Player, zijn bepaalde onderdelen met betrekking tot Microsoft Windows Media Player 6.4 niet volledig van het systeem verwijderd om de compatibiliteit met eerdere versies te verzekeren. Deze onderdelen worden door dit bulletin bijgewerkt. Hoewel latere versies van Windows Media Player niet door dit beveiligingslek worden getroffen, blijft een gebruiker kwetsbaar als een programma deze oudere onderdelen aanroept tijdens het afspelen van media. Als u deze update niet hebt toegepast nadat u de upgrade van Microsoft Windows Media Player 6.4 hebt toegepast, zullen geautomatiseerde scanprogramma's zoals MBSA detecteren dat uw systeem kwetsbaar is, zelfs als Microsoft Windows Media Player 6.4 niet de standaardmediaspeler op het systeem is. Microsoft Windows Media Player 6.4 is de enige versie van Windows Media Player die is getroffen door het probleem dat in dit bulletin is omschreven, maar alle klanten die de update automatisch krijgen aangeboden, moeten deze toepassen om ervoor te zorgen dat zij tegen dit beveiligingslek worden beschermd.
...
**Wat is het verband tussen dit bulletin en MS09-051, Door een beveiligingslek in Windows Media Runtime kan externe code worden uitgevoerd?**  
Er is geen verband tussen dit bulletin en [MS09-051](http://go.microsoft.com/fwlink/?linkid=125438): Door een beveiligingslek in Windows Media Runtime kan externe code worden uitgevoerd. Gebruikers dienen beide updates te installeren om te zorgen dat ze volledig beschermd zijn.
...
<th style="border:1px solid black;" >Beveiligingslek in WMP met betrekking tot heap-overloop – CVE-2009-2527</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Voor Microsoft Windows Media Player 6.4 op Microsoft Windows 2000 Service Pack 4:</td>
<td style="border:1px solid black;"><strong>Kritiek</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Voor Microsoft Windows Media Player 6.4 op Windows XP Service Pack 2 en Windows XP Service Pack 3:</td>
<td style="border:1px solid black;"><strong>Kritiek</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Voor Microsoft Windows Media Player 6.4 op Windows XP Professional x64 Edition Service Pack 2:</td>
<td style="border:1px solid black;"><strong>Kritiek</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Voor Microsoft Windows Media Player 6.4 op Windows Server 2003 Service Pack 2:</td>
<td style="border:1px solid black;"><strong>Kritiek</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Voor Microsoft Windows Media Player 6.4 op Windows Server 2003 x64 Edition Service Pack 2:</td>
<td style="border:1px solid black;"><strong>Kritiek</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;"><strong>Kritiek</strong></td>
</tr>
...
Beveiligingslek in WMP met betrekking tot heap-overloop – CVE-2009-2527  
-----------------------------------------------------------------------
  
<span></span>
In Windows Media Player 6.4 komt een beveiligingslek voor waardoor externe code kan worden uitgevoerd. Een aanvaller kan misbruik maken van het lek door een speciaal ontworpen ASF-bestand te maken waardoor externe code kan worden uitgevoerd wanneer het bestand wordt afgespeeld met Windows Media Player 6.4. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt.
  
Zie [CVE-2009-2527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2527) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in WMP met betrekking tot heap-overloop - CVE-2009-2527
...
#### Tijdelijke oplossingen voor het beveiligingslek in WMP met betrekking tot heap-overloop - CVE-2009-2527
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **De toegangsbeheerlijst voor strmdll.dll wijzigen**
  
    Als u de toegangsbeheerlijst voor strmdll.DLL verder wilt beperken op Windows XP en Windows Server 2003, voert u met beheerdersbevoegdheden de volgende opdrachten achter de opdrachtprompt uit:
    ...
    **Gevolgen van de tijdelijke oplossing:** Windows Media Player 6.4 zal geen media-bestanden kunnen spelen.
  
    **Zo kunt u tijdelijke oplossingen ongedaan maken.**
  
    Voer op Windows XP of Windows Server 2003 met beheerdersbevoegdheden de volgende opdrachten uit achter de opdrachtprompt:
...
-   **Voor mappen die niet voor multimedia zijn bedoeld, kan de aanvalsvector van de Windows-shell worden gemigreerd met behulp van de optie Klassieke Windows-mappen**
    ...
    Voer de volgende stappen uit om de mapopties te wijzigen:
  
    1. Klik op **Start**, **Configuratiescherm**, click **Weergave en thema's** en **Mapopties**. Of open een map, bijvoorbeeld **Mijn documenten**, en klik op **Mapopties** in het menu **Extra**.
  
    2. Selecteer op het tabblad **Algemeen** onder **Taken** de optie **Klassieke Windows-mappen gebruiken**.
  
#### Veelgestelde vragen over het beveiligingslek in WMP met betrekking tot heap-overloop - CVE-2009-2527
...
Windows Media Player 6.4 handelt speciaal vervaardigde ASF-bestanden verkeerd af.
...
Om misbruik te kunnen maken van dit beveiligingslek moet een gebruiker een speciaal vervaardigd ASF-bestand openen of speciaal vervaardigde streaming inhoud ontvangen van een website of een toepassing die webinhoud levert.
  
Als een schadelijk ASF-bestand wordt gehost op een computer met de software waarin dit probleem optreedt, wordt het beveiligingslek al geactiveerd door naar de map in Windows Verkenner te bladeren.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Alle systemen met Windows Media Player 6.4, zoals werkstations of terminalservers, zijn kwetsbaar voor dit beveiligingslek.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop Windows Media Player 6.4 speciaal vervaardigde ASF-bestanden afhandelt.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB974112_WM41$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/974112">Microsoft Knowledge Base-artikel 974112</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB974112$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/974112">Microsoft Knowledge Base-artikel 974112</a></td>
...
-   Yamata Li van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van het beveiligingslek met betrekking tot heap-overloop in WMP (CVE-2009-2527)
...
-   V1.1 (29 oktober 2009): Er is een tijdelijke oplossing verwijderd. Er is ook een vermelding aan het onderdeel **Veelgestelde Vragen met betrekking tot deze beveiligingsupdate** toegevoegd, om uit te leggen waarom deze update ook wordt aangeboden aan sommige klanten die Windows Media Player 6.4 niet op hun systeem hebben geïnstalleerd.
-   V1.2 (12 januari 2010): Verbeterde registersleutels voor Windows Media Player 6.4 voor Microsoft Windows 2000 Service Pack 4. Dit is slechts een informatieve update.
