---
TOCTitle: 'MS10-015'
Title: 'Microsoft-beveiligingsbulletin MS10-015 - Belangrijk'
ms:assetid: 'ms10-015'
ms:contentKeyID: 61231785
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-015(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-015 - Belangrijk
====================================================

Beveiligingslekken in de Windows-kernel kunnen leiden tot misbruik van bevoegdheden (977165)
--------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 9 februari 2010 | Bijgewerkt: woensdag 17 maart 2010
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 en Windows 7 voor 32-bits systemen. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost de beveiligingslekken op door te zorgen dat de Windows-kernel uitzonderingen juist verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 979682](http://technet.microsoft.com/security/advisory/979682).
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 977165](http://support.microsoft.com/kb/977165) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=ed8ac6a5-c8bb-4ed4-8994-810e9a1863c3)                                                                           | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e2b348f5-ec8d-4782-bb03-5de550adea77)                                                          | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e534d00c-6ddc-4eb3-9464-5db6e90afa3e)                                                              | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=defd8603-ed9b-42f9-a539-2b6a690e9575)                                                                              | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9873c962-9d3d-46ef-b54b-2a50696fb6b2)                                                                  | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=c3c21225-8534-4c7f-96b6-20a743dcea74)                                                               | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Vista, Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2761c7b4-d472-4f00-949b-af3ebafdc08d)                                     | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=38b40dab-6b4d-434b-9997-12ef70d6bbcc) | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=21e87558-9bd2-4aa9-aaa5-7fd26a5b60e6)\*         | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0b93047d-f2c6-403b-9200-c251898bc1e0)\*                 | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd6b234b-8e96-4128-a77a-645a0882996a)           | Misbruik van bevoegdheden               | Belangrijk        | [MS09-058](http://technet.microsoft.com/security/bulletin/ms09-058) |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=66f14bb4-40fc-4ae3-9baf-429b7106cd91)                                                                                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                                                |
...
<span></span>
**Waarom zijn er op 2 maart 2010 wijzigingen in dit bulletin aangebracht?**
Microsoft heeft dit bulletin gewijzigd om aan te kondigen dat op Windows Update gereviseerde pakketten voor de update MS10-015 worden aangeboden. Deze revisie is het gevolg van een wijziging in de installatielogica van het pakket die de installatie van de beveiligingsupdate voorkomt als zich bepaalde afwijkende omstandigheden op een systeem voordoen. Deze afwijkende omstandigheden op een systeem kunnen het gevolg zijn van infectie met een computervirus dat sommige besturingssysteembestanden wijzigt. De besmette computer is dan niet meer compatibel met update MS10-015. In sommige gevallen heeft de installatie van beveiligingsupdate MS10-015 op een besmette computer tot gevolg dat de computer herhaaldelijk opnieuw moet worden opgestart. Zie de volgende [webpagina](http://www.microsoft.com/security/updates/015) voor meer informatie over dit probleem. Het betreft alleen een wijziging in de pakketinstallatielogica voor updates die zijn verspreid via Windows Update. Er zijn geen wijzigingen in de binaire bestanden van de beveiligingsupdate of in de detectielogica van Windows Update. De updates in het Microsoft Downloadcentrum zijn niet gewijzigd en bevatten deze nieuwe pakketinstallatielogica niet. Klanten die hun systemen al hebben bijgewerkt, inclusief klanten die Automatische updates hebben ingeschakeld, hoeven geen actie te ondernemen. Klanten die Automatische updates hebben ingeschakeld en deze update nog niet hebben geïnstalleerd, wordt geadviseerd de update zo snel mogelijk toe te passen.
...
Ja, het updatepakket voor alle getroffen Windows-platformen (KB977165) bevat de wijzigingen in de Windows-kernel die worden beschreven in [Microsoft Knowledge Base-artikel 977165](http://support.microsoft.com/kb/977165).
...
<th style="border:1px solid black;" >Beveiligingslek in de Windows-kernel door uitzonderings-handler - CVE-2010-0232</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel - CVE-2010-0233</th>
...
Beveiligingslek in de Windows-kernel door uitzonderings-handler - CVE-2010-0232  
-------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in de Windows-kernel ten gevolge van de manier waarop de kernel bepaalde uitzonderingen verwerkt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de Windows-kernel door uitzonderings-handler - CVE-2010-0232
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   64-bits Microsoft Windows-besturingssystemen worden niet door dit beveiligingslek getroffen.  
...
#### Tijdelijke oplossingen voor het beveiligingslek in de Windows-kernel door uitzonderings-handler - CVE-2010-0232
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   Het NTVDM-subsysteem uitschakelen
  
    **Opmerking** Zie [Microsoft Knowledge Base-artikel 979682](http://support.microsoft.com/kb/979682) voor informatie over het automatisch implementeren van deze tijdelijke oplossing.
  
    1.  Klik op **Start** en vervolgens op **Uitvoeren**, typ **gpedit.msc** in het vak **Openen** en klik op **OK**.  
        De Console Groepsbeleidbeheer wordt geopend.  
    2.  Vouw de map **Beheersjablonen** uit en klik vervolgens op **Windows-onderdelen**.  
    3.  Klik op de map **Compatibiliteit van de toepassing**.  
    4.  Dubbelklik op de instelling **Toegang tot 16-bits toepassingen verhinderen**. Standaard is deze instelling **Niet geconfigureerd**.  
    5.  Wijzig de beleidsinstelling in **Ingeschakeld** en klik vervolgens op **OK**.
  
    **Gevolgen van de tijdelijke oplossing.** Gebruikers zullen 16-bits toepassingen niet kunnen uitvoeren.
  
#### Veelgestelde vragen over het beveiligingslek in de Windows-kernel door uitzonderings-handler - CVE-2010-0232
...
**Wat is Windows Virtual DOS Machine (NTVDM)?**    
Windows Virtual Dos Machine (NTVDM) is een subsysteem in een beveiligde omgeving waarin op MS-DOS en 16-bits Windows-systemen worden geëmuleerd tot besturingssystemen op basis van Windows NT. Een VDM wordt gemaakt zodra een gebruiker een MS-DOS-toepassing start op een Windows NT-besturingssysteem.
...
**Wat doet de update?**    
De update lost het beveiligingslek op doordat er voor wordt gezorgd dat de Windows-kernel de uitzondering juist verwerkt.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 979682](http://technet.microsoft.com/security/advisory/979682).
...
Beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel - CVE-2010-0233  
--------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in de Windows-kernel vanwege een 'double free'-conditie. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-0233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel - CVE-2010-0233
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel - CVE-2010-0233
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel - CVE-2010-0233
  
**Wat is de omvang van het beveiligingslek?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
De Windows-kernel stelt een pointer niet juist opnieuw in bij het vrijmaken van geheugen. Dit leidt tot een 'double free'-conditie in de Windows-kernel.
...
Meestal zal dit beveiligingslek leiden tot een 'denial of service'. In sommige omstandigheden kan ook code worden uitgevoerd. Vanwege de unieke indeling van het geheugen op elk systeem waarin dit probleem optreedt, is het waarschijnlijk moeilijk om dit beveiligingslek op grote schaal te misbruiken.
...
**Wat doet de update?**    
De update lost het beveiligingslek op doordat ervoor wordt gezorgd dat de Windows-kernel pointers op de juiste manier opnieuw instelt bij het vrijmaken van geheugen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB977165$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/977165">Microsoft Knowledge Base-artikel 977165</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Voor de update die is uitgegeven op 9 februari 2010:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows 2000\SP5\KB977165\Filelist<br />
Voor de gereviseerde update die is uitgegeven op 2 maart 2010:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Voor alle ondersteunde 32-bits edities van Windows XP die gebruikmaken van de update die is uitgegeven op 9 februari 2010:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB977165\Filelist<br />
Voor alle ondersteunde 32-bits edities van Windows XP die gebruikmaken van de gereviseerde update die is uitgegeven op 2 maart 2010:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Voor alle ondersteunde 32-bits edities van Windows Server 2003 die gebruikmaken van de update die is uitgegeven op 9 februari 2010:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165\Filelist<br />
Voor alle ondersteunde 32-bits edities van Windows Server 2003 die gebruikmaken van de gereviseerde update die is uitgegeven op 2 maart 2010:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165-v2\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor alle ondersteunde x64- en Itanium-edities van Windows Server 2003 die gebruikmaken van de updates die zijn uitgegeven op 9 februari 2010:<br />
...
-   Tavis Ormandy van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot een 'double free'-conditie in de Windows-kernel (CVE-2010-0233)
...
-   V1.2 (2 maart 2010): Er is een item toegevoegd aan de sectie **Veelgestelde vragen over deze beveiligingsupdate** om aan te kondigen dat op Windows Update gereviseerde pakketten worden aangeboden. Klanten die hun systemen al hebben bijgewerkt, hoeven geen actie te ondernemen.  
-   V1.3 (17 maart 2010): Er zijn registersleutels voor verificatie toegevoegd voor de gereviseerde updates die zijn uitgegeven op 2 maart 2010 voor Microsoft Windows 2000, Windows XP en Windows Server 2003. Het gaat alleen om een wijziging in de informatie.
