---
TOCTitle: 'MS10-042'
Title: 'Microsoft-beveiligingsbulletin MS10-042 - Kritiek'
ms:assetid: 'ms10-042'
ms:contentKeyID: 61231812
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-042(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-042 - Kritiek
=================================================

Door een beveiligingslek in Help en ondersteuning kan externe code worden uitgevoerd (2229593)
----------------------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een openbaar gemeld beveiligingslek opgelost in Help en ondersteuning van Windows, dat wordt geleverd bij ondersteunde edities van Windows XP en Windows Server 2003. Door dit beveiligingslek kan externe code worden uitgevoerd indien een gebruiker een speciaal vervaardigde webpagina bekijkt in een webbrowser of op een speciaal vervaardigde koppeling in een e-mailbericht klikt. Het beveiligingslek kan niet automatisch worden misbruikt via e-mail. Een aanval lukt alleen als een gebruiker op een koppeling in een e-mailbericht klikt.

Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor alle ondersteunde versies van Windows XP en Laag voor alle ondersteunde versies van Windows Server 2003. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop gegevens worden gevalideerd wanneer ze worden doorgestuurd naar Help en ondersteuning van Windows. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 2219475](http://technet.microsoft.com/security/advisory/2219475).
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7c2122bb-0ecf-4467-a3ba-6fb862f603c5) | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9232a336-9ded-4820-bac4-2d68877ee76c)     | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd4363b2-d7a7-4fff-8bcd-6fd02bd1ac07)                     | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6bafd3b-c921-466d-bee0-59a3fe126712)         | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=b61cc2d5-8432-4681-aa2c-a8807ec1fcf4)      | Uitvoering van externe code mogelijk    | Laag              | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot URL-validatie in Help en ondersteuning - CVE-2010-1885</th>
...
Beveiligingslek met betrekking tot URL-validatie in Help en ondersteuning - CVE-2010-1885  
-----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een niet-geverifieerd beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop speciaal vervaardigde URL's worden gevalideerd in Microsoft Help en ondersteuning. Door dit beveiligingslek kan externe code worden uitgevoerd indien een gebruiker een speciaal vervaardigde webpagina met een webbrowser bekijkt of op een speciaal vervaardigde koppeling in een e-mailbericht klikt. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot URL-validatie in Help en ondersteuning - CVE-2010-1885
...
-   Het beveiligingslek kan niet automatisch worden misbruikt via e-mail. Aanvallen lukt alleen als een gebruiker op een koppeling in een e-mailbericht klikt.  
-   Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot URL-validatie in Help en ondersteuning - CVE-2010-1885
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **Het HCP-protocol verwijderen uit het register**
  
**Opmerking** Zie [Microsoft Knowledge Base-artikel 2229593](http://support.microsoft.com/kb/2229593) als u de automatische **Microsoft Fix it**-oplossing wilt gebruiken om deze tijdelijke oplossing in of uit te schakelen.
...
Als u het HCP-protocol verwijdert, kan van dit probleem geen misbruik meer worden gemaakt op getroffen systemen.
...
4.  Typ in het dialoogvenster Registerbestand exporteren de tekst **HCP\_Procotol\_Backup.reg** en klik op **Opslaan**.  
...
2.  Sla vervolgens het volgende op in een bestand met de extensie REG, bijvoorbeeld Disable\_HCP\_Protocol.reg:  
...
**Gevolgen van de tijdelijke oplossing:** Als het HCP-protocol uit het register is verwijderd, worden alle lokale, betrouwbare koppelingen verbroken die gebruikmaken van hcp://. Het is bijvoorbeeld mogelijk dat koppelingen in het Configuratiescherm niet meer werken.
...
3.  Selecteer in het dialoogvenster Registerbestand importeren de tekst **HCP\_Procotol\_Backup.reg** en klik op **Openen**.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot URL-validatie in Help en ondersteuning - CVE-2010-1885
...
De functie Help en ondersteuning van Windows valideert URL's niet goed bij gebruik van het HCP-protocol.
  
**Wat is de functie Help en ondersteuning?**    
Help en ondersteuning is een functie van Windows die bij diverse onderwerpen ondersteuning en informatie biedt. Zo kunnen gebruikers met Help en ondersteuning meer te weten komen over Windows-functies, software-updates downloaden en installeren, vaststellen of bepaalde hardware compatibel is met Windows, Microsoft om hulp vragen, enzovoort. Gebruikers en programma's kunnen met URL-koppelingen naar Help en ondersteuning gaan door als voorvoegsel in een URL-koppeling 'hcp://' te gebruiken.
  
**Wat is het HCP-protocol?**    
Dit protocol is vergelijkbaar met het HTTP-protocol dat wordt gebruikt voor URL-koppelingen waarmee een webbrowser wordt geopend. Het HCP-protocol kan worden gebruikt voor URL-koppelingen waarmee de functie Help en ondersteuning wordt geopend.
  
**Worden toepassingen van andere leveranciers rechtstreeks getroffen door dit probleem?**    
Nee. Dit probleem kan echter door webtransacties worden misbruikt, ongeacht het type webbrowser. In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website die een speciaal vervaardigde URI bevat. Toepassingen die het HCP-protocol kunnen verwerken, kunnen worden gebruikt als een vector voor misbruik van dit beveiligingslek.
  
**Waarom is het prioriteitsniveau van dit beveiligingslek lager voor Windows Server 2003?**    
Het beveiligingslek bestaat in Windows Server 2003, maar wij hebben geen methode gevonden voor het extern misbruiken van het beveiligingslek op servers met Windows Server 2003. Desondanks lost deze update het beveiligingslek op voor Windows Server 2003 om de beschreven dreiging van een externe vector te verwijderen.
...
Dit beveiligingslek vormt het grootste risico voor Windows XP-systemen. Windows Server 2003-systemen lopen ook risico, maar wij hebben geen manier kunnen vinden waarop extern misbruik kan worden gemaakt van dit probleem op Windows Server 2003.
  
**Wat doet de update?**    
Deze update lost dit beveiligingslek op door de manier te wijzigen waarop gegevens worden gevalideerd wanneer ze worden doorgestuurd naar Help en ondersteuning van Windows.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 2219475](http://technet.microsoft.com/security/advisory/2219475).
  
**Was aan Microsoft gerapporteerd dat er misbruik was gemaakt van dit beveiligingslek op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Microsoft is op de hoogte van actieve aanvallen waarbij wordt geprobeerd het beveiligingslek te misbruiken. Op basis van de geanalyseerde voorbeelden lopen Windows Server 2003-systemen geen risico op deze aanvallen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2229593$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2229593">Microsoft Knowledge Base-artikel 2229593</a></td>
</tr>
<tr class="even">
