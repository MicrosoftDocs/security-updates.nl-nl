---
TOCTitle: 'MS10-059'
Title: 'Microsoft-beveiligingsbulletin MS10-059 - Belangrijk'
ms:assetid: 'ms10-059'
ms:contentKeyID: 61231830
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-059(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-059 - Belangrijk
====================================================

Beveiligingslekken in de traceerfunctie voor services kunnen leiden tot misbruik van bevoegdheden (982799)
----------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost de beveiligingslekken op door de manier te wijzigen waarop tokens worden verkregen en de lengte van een tekenreeks in het register wordt berekend. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfb31aa2-7457-4581-9e28-7984a360edf4)                                            | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=110f932f-d13c-4486-a295-e6068d5d8d7a)                    | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c9b3e60-e166-40c9-8938-3cba0a399c47)\* | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fa84e547-2190-402f-9467-2450deeff565)\*         | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84f89dca-108c-4956-9aa2-866e17a872fc)   | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=ce6233f3-2ee5-4329-908d-ba9b28ecc553)                                                                         | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=146270fa-cd6f-440a-aa3e-e93af0bff447)                                                                             | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=333fb6e4-f867-4dcb-beb3-2d88e428ca2e)\*                                                              | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=62034ecb-a6bd-46c5-a03d-9642880bc2d6)                                                            | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in de ACL voor registersleutels voor traceren - CVE-2010-2554</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot ontregeling van geheugen bij traceren – CVE-2010-2555</th>
...
Beveiligingslek in de ACL voor registersleutels voor traceren - CVE-2010-2554  
-----------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden wanneer Windows onjuiste toegangsbeheerlijsten (ACL's) plaatst voor de registersleutels voor de traceerfunctie voor services. Het beveiligingslek zou ertoe kunnen leiden dat een aanvaller code kan uitvoeren door misbruik te maken van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de ACL voor registersleutels voor traceren - CVE-2010-2554
...
#### Tijdelijke oplossingen voor het beveiligingslek in de ACL voor registersleutels voor traceren - CVE-2010-2554
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in de ACL voor registersleutels voor traceren - CVE-2010-2554
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer Windows onjuiste toegangsbeheerlijsten (ACL's) plaatst op registersleutels voor de traceerfunctie voor services. Hierdoor kan een aanvaller de traceerdirectory wijzigen in een named pipe en een named pipe listener maken. Zodra de named pipe is gemaakt, kan een aanvaller zich voordoen als die named pipe om tokens te verkrijgen van de service die de named pipe maakt. Als het programma waarmee de named pipe wordt gemaakt, wordt uitgevoerd in de context van het lokale systeem (bijvoorbeeld IpHlpSvc-service), kan de aanvaller tokens van het lokale systeem verkrijgen en gebruiken.
...
Een named pipe is een eenrichtingsverbinding of dubbele verbinding met een naam voor communicatie tussen de pipe-server en een of meer pipe-clients. Alle installaties van een named pipe hebben dezelfde naam, maar elke installatie heeft zijn eigen buffers en middelen en biedt een afzonderlijke verbinding voor communicatie tussen client en server. Door het gebruik van meerdere installaties kunnen meerdere pipe-clients dezelfde named pipe tegelijkertijd gebruiken. Elk proces heeft toegang tot named pipes, afhankelijk van beveiligingscontroles, waardoor named pipes een eenvoudig communicatiemiddel tussen gerelateerde of ongerelateerde processen vormen. Zie het MSDN-artikel [Named Pipes](http://msdn.microsoft.com/en-us/library/aa365590(vs.85).aspx) voor meer informatie.
  
**Wat is het Routing Utilities Component (rtutils.dll)?**    
Het Routing Utilities Component (rtutils.dll) is een module met traceerfuncties die een uniform mechanisme vormt voor het genereren van diagnostische resultaten voor de verschillende serviceonderdelen. Wanneer een onderdeel het Rtutils-traceermechanisme gebruikt, worden specifieke traceerinstellingen voor dat onderdeel die zijn opgeslagen in het register onder de sleutel HKLM\\Software\\Microsoft\\Tracing\\, gebruikt voor het opslaan van de traceergegevens.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te wijzigen waarop tokens worden verkregen via nabootsing.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554) toegewezen.
...
Beveiligingslek met betrekking tot ontregeling van geheugen bij traceren – CVE-2010-2555  
----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden door de manier waarop de traceerfunctie voor services geheugen toewijst bij het verwerken van speciaal vervaardigde lange tekenreeksen uit het register. Een aanvaller die dit beveiligingslek weet te misbruiken zou door misbruik van bevoegdheden op systeemniveau willekeurige code kunnen uitvoeren. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-2555](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2555) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van geheugen bij traceren - CVE-2010-2555
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van geheugen bij traceren - CVE-2010-2555
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van geheugen bij traceren - CVE-2010-2555
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer de traceerfunctie voor services de lengte van bepaalde tekenreeksen in het register onjuist berekent.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop de traceerfunctie voor services de lengte van een tekenreeks in het register berekent.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982799">Microsoft Knowledge Base-artikel 982799</a></td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo van [Argeniss](http://www.argeniss.com/) voor het melden van het beveiligingslek in de ACL voor registersleutels bij traceren - (CVE-2010-2554)  
-   Cesar Cerrudo van [Argeniss](http://www.argeniss.com/) voor het melden van het beveiligingslek met betrekking tot ontregeling van geheugen bij traceren (CVE-2010-2555)
