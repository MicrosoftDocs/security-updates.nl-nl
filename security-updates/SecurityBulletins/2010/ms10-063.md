---
TOCTitle: 'MS10-063'
Title: 'Microsoft-beveiligingsbulletin MS10-063 - Kritiek'
ms:assetid: 'ms10-063'
ms:contentKeyID: 61231834
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-063(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-063 - Kritiek
=================================================

Door een beveiligingslek in de Unicode Scripts Processor kan externe code worden uitgevoerd (2320113)
-----------------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor alle ondersteunde edities van Windows XP, Windows Server 2003, Windows Vista en Windows Server 2008, en Belangrijk voor Microsoft Office XP, Microsoft Office 2003 en Microsoft Office 2007. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop specifieke kenmerken van OpenType-lettertypen worden geparseerd in Windows. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=be7b3310-ffb7-4528-9c9e-aebe14d264d6">Windows Server 2003 met SP2 voor Itanium-systemen</a><br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac1b0260-3802-45d4-985e-ac827d784e4f">Windows Vista Service Pack 1 en Windows Vista Service Pack 2</a><br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ebfdcd6d-413e-4359-8863-e992327a607f">Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2</a><br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b679fe0c-5498-4fc5-84c8-0cd24b625907">Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2</a>*<br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1b38b87-24f6-4aaa-afa9-40f4015d6694">Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2</a>*<br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ceb856e8-f4a6-4229-bd26-b1a763d7d443">Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2</a><br />
(KB981322)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office-pakket</th>
<th style="border:1px solid black;" >Maximale omvang van het beveiligingslek</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
<th style="border:1px solid black;" >Bulletins die door deze update worden vervangen</th>
</tr>
...
**In welke mate worden Office-onderdelen en afzonderlijke Office-programma's getroffen door dit beveiligingslek?**    
Office-onderdelen en afzonderlijke Office-programma's worden getroffen met hetzelfde prioriteitsniveau als het getroffen Office-pakket. Bijvoorbeeld: geïnstalleerde onderdelen en afzonderlijke installaties van Microsoft Excel, Microsoft Word en Microsoft PowerPoint worden getroffen met hetzelfde prioriteitsniveau als het bijbehorende Office-pakket dat wordt genoemd in de sectie **Software waarin dit probleem optreedt**.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen - CVE-2010-2738  
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau  
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in getroffen versies van Microsoft Windows en Microsoft Office. Het beveiligingslek wordt veroorzaakt doordat specifieke lettertypen in Windows en Office worden geparseerd op een manier waardoor externe code kan worden uitgevoerd. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan zich voordoen als de aangemelde gebruiker en zo willekeurige programmacode uitvoeren.

Zie [CVE 2010-2738](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2738) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen - CVE-2010-2738
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen - CVE-2010-2738

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **De toegangsbeheerlijst voor usp10.dll wijzigen**

    Wijzig de toegangsbeheerlijst voor usp10.dll zodat de toegang wordt beperkt.

    Voer voor 32-bits versies van Windows XP de volgende opdrachten uit vanaf een opdrachtprompt met beheerdersbevoegdheden:
    `cacls %WINDIR%\SYSTEM32\usp10.DLL /E /P everyone:N`

    Voer voor 64-bits versies van Windows XP de volgende opdrachten uit vanaf een opdrachtprompt met beheerdersbevoegdheden:
    `cacls %WINDIR%\SYSWOW64\usp10.DLL /E /P everyone:N `

    Voer in 32-bits versies van Windows Vista en Windows 7 de volgende opdrachten uit vanaf een opdrachtprompt met verhoogde bevoegdheden:
    ...
    Voer in 64-bits versies van Windows Vista en Windows 7 de volgende opdrachten uit vanaf een opdrachtprompt met verhoogde bevoegdheden:
    ...
    **Gevolgen van de tijdelijke oplossing.** FireFox wordt mogelijk niet geladen. Sommige lettertypen worden mogelijk niet goed weergegeven.
...
-   **Ondersteuning voor het parseren van ingesloten lettertypen in Internet Explorer uitschakelen**
    ...
    **Opmerking** de MMC-module voor Groepsbeleid kan worden gebruikt om een beleid in te stellen voor een computer, voor een organisatie-eenheid of voor een volledig domein. Ga naar de volgende websites van Microsoft voor meer informatie over Groepsbeleid:
    ...
    1.  Open de Console Groepsbeleidsbeheer en stel de console in voor het juiste Groepbeleid-object, zoals lokale computer, organisatie-eenheid of domein-GPO.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen - CVE-2010-2738
...
Het beveiligingslek ontstaat wanneer in Windows en Office een tabel met OpenType-lettertypen onjuist wordt gevalideerd.

**Wat is de Unicode Script Processor?**  
De nieuwe Unicode Script Processor (USP10.DLL), ook bekend als Uniscribe, is een verzameling API's waarmee een client voor tekstlay-out complexe schriften kan indelen. Uniscribe ondersteunt de complexe regels van schriften zoals Arabisch, Indiaas en Thai. Uniscribe verwerkt ook schriften die van rechts naar links worden geschreven, zoals Arabisch of Hebreeuws, en ondersteunt het combineren van schriften. Voor clients voor tekst zonder opmaak biedt Uniscribe verschillende ScriptString-functies die vergelijkbaar zijn met TextOut, met extra ondersteuning voor caret-plaatsing. De overige Uniscribe-interfaces zorgen voor een betere besturing van clients.
...
De Unicode Scripts Processor is een Windows-onderdeel dat kan worden gebruikt door Windows en toepassingen van derden.

Een aanvaller kan misbruik maken van dit beveiligingslek door een speciaal document te maken dat is gekoppeld aan een toepassing die ondersteuning biedt voor EOT-lettertypen, zoals Microsoft Office.

Daarnaast kunnen webbrowsers deze lettertypen parseren van een speciaal vervaardigde website. Een aanvaller kan een website maken die speciaal is ontworpen om misbruik te maken van dit beveiligingslek, en vervolgens een gebruiker ertoe overhalen deze website te bekijken.

**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Dit beveiligingslek vormt het grootste risico voor desktopclients of terminalservers waarop gebruikers inhoud bekijken die schadelijke OpenType-lettertypen kan bevatten.

**Wat doet de update?**  
De update lost dit beveiligingslek op door de manier te verbeteren waarop Windows en Office specifieke kenmerken van OpenType-lettertypen parseren.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB981322$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/981322">Microsoft Knowledge Base-artikel 981322</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2288608">Microsoft Knowledge Base-artikel 2288608</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2288613">Microsoft Knowledge Base-artikel 2288613</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2288621">Microsoft Knowledge Base-artikel 2288621</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   Carsten Book van voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen (CVE-2010-2738)  
-   Marc Schoenefeld van het Red Hat Security Response Team voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in de Uniscribe-engine voor het parseren van lettertypen (CVE-2010-2738)
