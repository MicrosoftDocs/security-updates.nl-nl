---
TOCTitle: 'MS10-066'
Title: 'Microsoft-beveiligingsbulletin MS10-066 - Belangrijk'
ms:assetid: 'ms10-066'
ms:contentKeyID: 61231837
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-066(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-066 - Belangrijk
====================================================

Door een beveiligingslek in Remote Procedure Call kan externe code worden uitgevoerd (982802)
---------------------------------------------------------------------------------------------
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6)                          | Uitvoering van externe code mogelijk    | Belangrijk        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d) | Uitvoering van externe code mogelijk    | Belangrijk        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c)                 | Uitvoering van externe code mogelijk    | Belangrijk        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39)     | Uitvoering van externe code mogelijk    | Belangrijk        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73)  | Uitvoering van externe code mogelijk    | Belangrijk        | [MS09-026](http://technet.microsoft.com/security/bulletin/ms09-026) |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot ontregeld geheugen in RPC - CVE-2010-2567</th>
...
Beveiligingslek met betrekking tot ontregeld geheugen in RPC - CVE-2010-2567  
----------------------------------------------------------------------------
  
<span></span>
Er bestaat een niet-geverifieerd beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop de RPC-client (Remote Procedure Call) geheugen toewijst bij het parseren van speciaal vervaardigde RPC-reacties. Er is geen verificatie nodig om het beveiligingslek te kunnen misbruiken. Dat betekent dat een aanvaller dit beveiligingslek kan misbruiken door een speciaal vervaardigde RPC-reactie te verzenden op een RPC-aanvraag van de client. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen in RPC - CVE-2010-2567
...
-   De aanvaller moet de gebruiker overhalen om een RPC-verbinding tot stand te brengen met een schadelijke server waarover de aanvaller de controle heeft. Een aanvaller kan alleen op afstand misbruik maken van dit beveiligingslek als de gebruiker een handeling uitvoert.  
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen in RPC - CVE-2010-2567
...
Het beveiligingslek ontstaat wanneer de Microsoft RPC-client (Remote Procedure Call) onjuist geheugen toewijst bij het parseren van speciaal vervaardigde RPC-reacties.
  
**Wat is RPC (Remote Procedure Call)?**  
Microsoft Remote Procedure Call (RPC) is een standaard voor netwerkprogrammering die werd ontwikkeld in de jaren tachtig. Op een RPC-locatie kan een programmeur een toepassing maken die bestaat uit een willekeurig aantal procedures, waarvan er een aantal lokaal worden uitgevoerd en een aantal op externe computers via een netwerk.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan externe code uitvoeren in de beveiligingscontext van de RPC-clienttoepassing. Als de RPC-clienttoepassing wordt uitgevoerd onder LocalSystem of onder een account met beheerdersbevoegdheden, kan een aanvaller volledige controle krijgen over een getroffen systeem.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller kan een speciaal vervaardigde RPC-server hosten die is ontworpen om misbruik te maken van dit beveiligingslek en vervolgens een gebruiker ertoe overhalen een RPC-aanvraag naar de server te verzenden. Daarnaast kan een aanvaller op het lokale netwerk een MITM-aanval uitvoeren door een schadelijke RPC-reactie te verzenden op een geldige RPC-aanvraag.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt een risico voor alle systemen met ondersteunde edities van Windows XP en Windows Server 2003.
  
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te verbeteren waarop de RPC-client geheugen toewijst voordat RPC-reacties van een externe server worden geladen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB982802$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/982802">Microsoft Knowledge Base-artikel 982802</a></td>
</tr>
<tr class="even">
...
-   Yamata Li van [Palo Alto Networks](http://www.paloaltonetworks.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in RPC (CVE-2010-2567)
