---
TOCTitle: 'MS10-069'
Title: 'Microsoft-beveiligingsbulletin MS10-069 - Belangrijk'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61231840
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-069(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-069 - Belangrijk
====================================================

Beveiligingslek in Windows Client/Server Runtime Subsystem kan leiden tot misbruik van bevoegdheden (2121546)
-------------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate verwijdert het beveiligingslek door de manier te veranderen waarop het Client/Server Runtime Subsystem (CSRSS) geheugen toewijst tijdens de afhandeling van bepaalde transacties. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
Als het gaat om beheerders en bedrijfinstallaties of eindgebruikers die deze beveiligingsupdate handmatig willen installeren, adviseert Microsoft klanten de update zo snel mogelijk toe te passen.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305)                          | Misbruik van bevoegdheden               | Belangrijk        | Geen                                                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6) | Misbruik van bevoegdheden               | Belangrijk        | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7)                 | Misbruik van bevoegdheden               | Belangrijk        | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85)     | Misbruik van bevoegdheden               | Belangrijk        | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5)  | Misbruik van bevoegdheden               | Belangrijk        | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
...
**Ik gebruik geen Chinese, Japanse of Koreaanse taalversie van Windows. Is dit beveiligingsbulletin op mij van toepassing?**
Alle taaledities van getroffen besturingssystemen bevatten het beveiligingslek dat wordt besproken in dit bulletin, maar er kan alleen misbruik worden gemaakt van het beveiligingslek als het systeem is geconfigureerd met een Chinese, Japanse, of Koreaanse landinstelling van het systeem.
...
<th style="border:1px solid black;" >Beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891</th>
...
Beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891  
--------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop door het CSRSS geheugen voor wordt toegewezen voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de beveiligingscontext van het lokale systeem. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Alleen systemen die zijn geconfigureerd met een Chinese, Japanse of Koreaanse landinstelling, worden getroffen.  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal of extern kunnen aanmelden om het beveiligingslek te kunnen misbruiken.
  
#### Tijdelijke oplossingen voor het beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891
...
Het Windows CSRSS wijst niet altijd voldoende geheugen toe bij het verwerken van specifieke gebruikerstransacties op Windows-systemen die zijn geconfigureerd met een Chinese, Japanse of Koreaanse landinstelling van het systeem.
  
**Wat is het Windows Client/Server Runtime Subsystem (CSRSS)?**    
Het CSRSS is het gebruikersmodusgedeelte van het Win32-subsysteem (Win32.sys is het kernelmodusgedeelte). CSRSS is de afkorting van Client/Server Runtime Subsystem en is een essentieel subsysteem dat altijd actief dient te zijn. Het CSRSS is verantwoordelijk voor consoles en maakt en/of verwijdert threads.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de beveiligingscontext van het lokale systeem. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
**Hebben alle Windows-taalversies last van dit beveiligingslek?**      
Alle taalversies van de getroffen besturingssystemen bevatten het beveiligingslek, maar er kan alleen misbruik worden gemaakt van het beveiligingslek als de landinstelling van het systeem Chinees, Japans of Koreaans is. Microsoft raadt klanten aan de update op alle taalversies van getroffen besturingssystemen te installeren, als een ingrijpende veiligheidsmaatregel. Er worden pakketten aangeboden via Automatische updates, ongeacht de taalconfiguratie van een systeem.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt het grootste risico voor werkstations en terminalservers waarop een taal met meerdere bytes wordt gebruikt (Chinees, Japans en Koreaans). Servers zouden eventueel meer gevaar kunnen lopen als beheerders toestaan dat gebruikers zich op servers kunnen aanmelden en programma's kunnen uitvoeren. Dit is echter volkomen in strijd met de aanbevolen richtlijnen voor gebruik.
  
**Hoe kan ik de huidige landinstelling op mijn computer bepalen of wijzigen?  **  
De standaardlandinstelling van het systeem is afhankelijk van de taalversie van Windows die is geïnstalleerd. U kunt de landinstelling van het systeem als volgt controleren of wijzigen:
  
1.  Klik op **Start** en klik op **Configuratiescherm**.  
2.  Klik in **Landinstellingen** op het **Geavanceerd**.  
3.  Selecteer de gewenste landinstelling van het systeem in het onderdeel **Taal voor programma's die niet met Unicode compatibel zijn**.
  
**Opmerking** U moet zijn aangemeld met een beheerdersaccount om de landinstelling van het systeem te kunnen controleren en wijzigen.
  
**Wat is de landinstelling van het systeem?**      
De landinstelling van het systeem bepaalt welke standaardtekenset (letters, symbolen en cijfers) en welk lettertype wordt gebruikt om informatie weer te geven in programma's die geen gebruikmaken van Unicode. Hierdoor kunnen programma's die niet met Unicode compatibel zijn, worden uitgevoerd op uw computer met de opgegeven taal. De landinstelling van het systeem heeft geen invloed op de taal in menu's en dialoogvensters voor Windows of andere programma's die Unicode gebruiken.
  
**Wat doet de update?**      
De update verwijdert het beveiligingslek door de manier te veranderen waarop het CSRSS geheugen toewijst tijdens de afhandeling van bepaalde transacties.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2121546$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2121546">Microsoft Knowledge Base-artikel 2121546</a></td>
</tr>
<tr class="even">
...
-   [IBM Japan](http://www.ibm.com/jp/ja/) voor het melden van het beveiligingslek dat kan leiden tot lokaal misbruik van bevoegdheden in CSRSS - CVE-2010-1891
