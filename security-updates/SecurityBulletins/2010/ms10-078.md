---
TOCTitle: 'MS10-078'
Title: 'Microsoft-beveiligingsbulletin MS10-078 - Belangrijk'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61231849
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-078(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-078 - Belangrijk
====================================================

Beveiligingslek in het OTF-opmaakstuurprogramma (OpenType Font) kan leiden tot misbruik van bevoegdheden (2279986)
------------------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost de beveiligingslekken door de manier te verbeteren waarop het OTF-opmaakstuurprogramma (OpenType Font) geheugen toewijst en integerberekeningen uitvoert tijdens de verwerking van OpenType-lettertypen. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc)                          | Misbruik van bevoegdheden               | Belangrijk        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b) | Misbruik van bevoegdheden               | Belangrijk        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d)                 | Misbruik van bevoegdheden               | Belangrijk        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963)     | Misbruik van bevoegdheden               | Belangrijk        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa)  | Misbruik van bevoegdheden               | Belangrijk        | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot parsering van OpenType-lettertypen - CVE-2010-2740</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot validatie van OpenType-lettertypen - CVE-2010-2741</th>
...
Beveiligingslek met betrekking tot parsering van OpenType-lettertypen - CVE-2010-2740  
-------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden door de onjuiste manier waarop het OTF-opmaakstuurprogramma OpenType Font) van Windows speciaal vervaardigde OpenType-lettertypen parseert. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2010-2740](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot parsering van OpenType-lettertypen - CVE-2010-2740
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot parsering van OpenType-lettertypen - CVE-2010-2740
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot parsering van OpenType-lettertypen - CVE-2010-2740
...
Het beveiligingslek wordt veroorzaakt wanneer het OTF-opmaakstuurprogramma (OpenType Font) op onjuiste wijze geheugen toewijst tijdens de parsering van een speciaal vervaardigd lettertype.
  
**Wat is de OpenType Font-indeling?**    
OpenType is een lettertype-indeling die gezamenlijk door Microsoft en Adobe is ontwikkeld als een uitbreiding van de TrueType-lettertype-indeling van Apple. Een OpenType-lettertypebestand bevat gegevens in tabelindeling, bestaande uit een TrueType- of een PostScript-omtreklettertype. Rasterizers gebruiken combinaties van gegevens uit de tabellen die in het lettertype zijn opgenomen, om de TrueType- of PostScript-glyphcontouren weer te geven. Sommige van deze ondersteunende gegevens worden bij elke omtrekindeling gebruikt, andere gegevens hebben specifiek betrekking op TrueType of PostScript. Voor meer informatie raadpleegt u de [Veelgestelde vragen over Microsoft-typografie OpenType](http://www.microsoft.com/typography/opentypefaq.mspx).
...
Ja. Webbrowsers van derden worden door dit beveiligingslek getroffen indien zij OpenType-lettertypen (OTF) zelf renderen. Voor deze toepassingen kan dit beveiligingslek leiden tot uitvoering van externe code in de context van de aangemelde gebruiker als de toepassing wordt gebruikt om een website met een ingesloten, speciaal vervaardigd lettertype weer te geven. Standaard wordt Internet Explorer niet getroffen door dit probleem.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop het OTF-opmaakstuurprogramma (OpenType Font) geheugen toewijst bij het parseren van een lettertype.
...
Beveiligingslek met betrekking tot validatie van OpenType-lettertypen - CVE-2010-2741  
-------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden door de onjuiste manier waarop het OTF-opmaakstuurprogramma OpenType Font) van Windows speciaal vervaardigde OpenType-lettertypen parseert. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2010-2741](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot validatie van OpenType-lettertypen - CVE-2010-2741
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot validatie van OpenType-lettertypen - CVE-2010-2741
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot validatie van OpenType-lettertypen - CVE-2010-2741
  
**Wat is de omvang van het beveiligingslek?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer het OTF-opmaakstuurprogramma (OpenType Font) op onjuiste wijze een integerberekening uitvoert tijdens de verwerking van speciaal vervaardigde OpenType-lettertypen.
...
Worden webbrowsers **van derden door dit beveiligingslek getroffen?**  
Ja. Webbrowsers van derden worden door dit beveiligingslek getroffen indien zij OpenType-lettertypen (OTF) zelf renderen. Voor deze toepassingen kan dit beveiligingslek leiden tot uitvoering van externe code in de context van de aangemelde gebruiker als de toepassing wordt gebruikt om een website met een ingesloten, speciaal vervaardigd lettertype weer te geven.
  
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop het OTF-opmaakstuurprogramma (OpenType Font) integerberekeningen uitvoert bij het verwerken van OpenType-lettertypen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2279986$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2279986">Microsoft Knowledge Base-artikel 2279986</a></td>
</tr>
<tr class="even">
...
-   Sebastian Apelt van [Siberas](http://www.siberas.de/) voor het melden van het beveiligingslek met betrekking tot parsering van OpenType-lettertypen (CVE-2010-2740)
-   Diego Juarez van [Core Security Technologies](http://www.coresecurity.com) voor het melden van het beveiligingslek met betrekking tot validatie van OpenType-lettertypen (CVE-2010-2741)
