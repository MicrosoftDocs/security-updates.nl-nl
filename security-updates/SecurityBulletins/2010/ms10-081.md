---
TOCTitle: 'MS10-081'
Title: 'Microsoft-beveiligingsbulletin MS10-081 - Belangrijk'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61231852
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-081(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-081 - Belangrijk
====================================================

Door een beveiligingslek in Windows Common Control Library kan externe code worden uitgevoerd (2296011)
-------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de gemeenschappelijke besturingselementen van Windows berichten afhandelen die worden doorgegeven door een SVG-viewer (Scalable Vector Graphics) van derden. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1)                                                                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45)                                                                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb)                                                               | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                            | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd)                                                 | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb)                         | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor het 32-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c)\*\* | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor het 64-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da)\*\*     | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6)        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c)                                                                              | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28)                                                                                  | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418)\*\*                                                                 | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                 | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in Comctl32 met betrekking tot heapoverloop – CVE-2010-2746</th>
...
Beveiligingslek in Comctl32 met betrekking tot heapoverloop – CVE-2010-2746  
---------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop de Windows Common Controls Library speciaal vervaardigd websites weergeeft wanneer gebruik wordt gemaakt van een SVG-viewer (Scalable Vector Graphics) van derden. Door dit beveiligingslek kan code worden uitgevoerd als een gebruiker een speciaal vervaardigde webpagina bezoekt. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2010-2746](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Comctl32 met betrekking tot heapoverloop - CVE-2010-2746
...
-   Dit beveiligingslek kan in de standaardconfiguratie van Windows niet worden misbruikt. Er kan alleen misbruik worden gemaakt van dit probleem als een SVG-toepassing (Scalable Vector Graphics) van derden op het systeem is geïnstalleerd.
  
#### Tijdelijke oplossingen voor het beveiligingslek in Comctl32 met betrekking tot heapoverloop - CVE-2010-2746
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in Comctl32 met betrekking tot heapoverloop - CVE-2010-2746
...
De Windows Common Controls Library handelt bepaalde berichten niet goed af bij de weergave van schaalbare vectorafbeeldingen die zijn doorgegeven door een SVG-viewer (Scalable Vector Graphics).
  
**Wat zijn de Windows Common Control Libraries?**    
De gemeenschappelijke besturingselementen zijn verschillende vensters die worden geïmplementeerd door de bibliotheek met gemeenschappelijke besturingselementen, Comctl32.dll. Dit is een DLL die in het Windows-besturingssysteem is opgenomen. Net als andere besturingsvensters, is een gemeenschappelijk besturingselement een onderliggend venster dat een toepassing samen met een ander venster gebruikt om interactie met de gebruiker mogelijk te maken. Voor meer informatie over deze bibliotheken raadpleegt u het MSDN-artikel, [About Common Controls](http://msdn.microsoft.com/en-us/library/bb775493(vs.85).aspx).
  
**Kan dit probleem worden misbruikt in de standaardconfiguratie van Windows?**    
Nee. Er kan alleen misbruik worden gemaakt van dit probleem als een SVG-toepassing (Scalable Vector Graphics) van derden op het systeem is geïnstalleerd. Microsoft heeft geen aanvalsvector vastgesteld waarbij deze viewer van derden niet op het systeem was geïnstalleerd. Raadpleeg de W3C-lijst (World Wide Web Consortium) met [SVG-implementaties](http://www.w3.org/graphics/svg/wg/wiki/implementations) voor een lijst met SVG-implementaties.
  
**Wat zijn Scalable Vector Graphics (schaalbare vectorafbeeldingen)?**    
SVG (Scalable Vector Graphics) is een standaard voor het schrijven en implementeren van tweedimensionale vectorafbeeldingen met XML-documenten. Het is een W3C-aanbeveling (World Wide Web Consortium) die door een aantal industriële organisaties is geschreven en goedgekeurd. Een SVG is in principe een XML-document conform het schema dat is gedefinieerd als onderdeel van het SVG-ratificatieproces. In de specificatie zijn diverse geometrische basisvormen gedefinieerd, zoals rechthoeken, cirkels, ovalen, lijnen, polylijnen, veelhoeken en omtrekelementen zoals tekst. Met het padelement kunt u complexere vormen maken zodat u vormen kunt definiëren als een opeenvolging van lijnen, bogen en complexe Bezier-curven. Met deze basisvormen en wat vindingrijkheid kunt u zelfs de meest ingewikkelde geometrische constructies maken.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te verbeteren waarop de Windows Common Controls Library bepaalde berichten afhandelt die worden door een SVG-viewer (Scalable Vector Graphics) van derden.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2296011$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2296011">Microsoft Knowledge Base-artikel 2296011</a></td>
</tr>
<tr class="even">
...
-   Krystian Kloskowski (h07) in samenwerking met [Secunia](http://secunia.com/) voor het melden van het beveiligingslek in Comctl32 met betrekking tot heapoverloop (CVE-2010-2746)
