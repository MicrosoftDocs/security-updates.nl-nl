---
TOCTitle: 'MS10-086'
Title: 'Microsoft-beveiligingsbulletin MS10-086 - Matig'
ms:assetid: 'ms10-086'
ms:contentKeyID: 61231857
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-086(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-086 - Matig
===============================================

Beveiligingslek in gedeelde clusterschijven van Windows kan leiden tot onrechtmatige wijzigingen (2294255)
----------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 12 oktober 2010 | Bijgewerkt: woensdag 10 november 2010
...
Het prioriteitsniveau van deze beveiligingsupdate is Matig voor ondersteunde versies van Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost dit beveiligingslek op doordat de manier wordt gewijzigd waarop de gebruikersinterface van Microsoft Cluster-service (MSCS) machtigingen instelt op administratieve shares bij het toevoegen of maken van nieuwe gedeelde clusterschijven. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

**Aanbeveling**. Microsoft raadt klanten aan deze beveiligingsupdate toe te passen met updatebeheersoftware of door op updates te controleren met de service [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=1de12fdf-b439-4020-9313-a193d47dcfb2)\*   | Onrechtmatige wijzigingen               | Matig             | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=1c607c7d-6144-4a39-beea-a31b62085047) | Onrechtmatige wijzigingen               | Matig             | Geen                                            |
...
<span></span>
**Waarom is dit bulletin op 10 november 2010 bijgewerkt?**  
Microsoft heeft dit bulletin gewijzigd om aan te geven dat de update de machtigingen voor bestaande gedeelde clusterschijven wel corrigeert. Eerder werd in het bulletin verklaard dat de update machtigingen op bestaande clusterschijven niet corrigeert. Het gaat alleen om een wijziging in de informatie. Klanten die hun systemen al hebben bijgewerkt, hoeven geen actie te ondernemen.

**Stelt deze beveiligingsupdate de juiste machtigingen in op bestaande gedeelde clusterschijven?**  
Ja, door de beveiligingsupdate op alle knooppunten van het cluster te installeren en de computers opnieuw te starten, worden de machtigingen op bestaande gedeelde clusterschijven gecorrigeerd.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot machtigingen op nieuwe clusterschijven - CVE-2010-3223</th>
...
Beveiligingslek met betrekking tot machtigingen op nieuwe clusterschijven - CVE-2010-3223  
-----------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot onrechtmatige wijzigingen aanwezig in de wijze waarop de gebruikersinterface van Failoverclusterbeheer machtigingen op gedeelde clusterschijven verwerkt. Dit beveiligingslek bestaat omdat Failoverclusterbeheer onbeveiligde standaardmachtigingen gebruikt bij het toevoegen van schijven aan een cluster. Wanneer een beheerder een schijf aan een gedeelde cluster toevoegt, stelt Failoverclusterbeheer machtigingen op de gedeelde clusterschijf in op een wijze die ertoe kan leiden dat onbevoegde gebruikers (iedereen) rechten voor lezen/schrijven/verwijderen op de administratieve shares van de failoverclusterschijf krijgen.
  
Zie [CVE 2010-3223](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3223) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot machtigingen op nieuwe clusterschijven - CVE-2010-3223
  
Microsoft heeft nog geen beperkende factoren voor dit beveiligingslek.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot machtigingen op nieuwe clusterschijven - CVE-2010-3223
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   Configureer na het maken van een administratieve share op een clusterschijf handmatig de toegangsbeheerlijst (ACL) zodat de toegangsmachtigingen geschikt zijn voor de desbetreffende omgeving. Verander bijvoorbeeld de machtigingen Iedereen - Volledig beheer toewijzen aan administrator - Volledig beheer op administratieve shares.  
-   Serverbeheerders kunnen ook de getroffen schijven opnieuw clusteren nadat de update is toegepast. Hierdoor zullen de machtigingen op de nieuwe gedeelde clusterschijven op de juiste wijze worden ingesteld.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot machtigingen op nieuwe clusterschijven - CVE-2010-3223
  
**Wat is de omvang van het probleem?**    
Dit is een beveiligingslek dat betrekking heeft op onrechtmatige wijzigingen. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan op willekeurige wijze gegevens toevoegen, veranderen, verwijderen of lezen op een getroffen bestandssysteem.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Dit beveiligingslek is een gevolg van de manier waarop Windows standaardmachtigingen instelt bij het toevoegen van een schijf aan een schijfcluster.
  
**Waarvoor worden administratieve shares gebruikt?**    
Administratieve shares zijn de standaard netwerkshares die door Windows-besturingssystemen worden gemaakt. Standaard staan deze shares iedereen die lid is van de groep Administrators toe om de hoofdmap van schijven die aan het systeem zijn gekoppeld te beheren.
  
**In welke onderdeel treedt dit beveiligingslek op?**    
Het door dit beveiligingslek getroffen onderdeel is Microsoft Cluster-service (MSCS).
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die dit beveiligingslek weet te misbruiken kan gegevens toevoegen, veranderen, verwijderen of lezen op de administratieve shares van een getroffen clusterschijfconfiguratie.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller kan op afstand toegang tot het bestandssysteem van administratieve share van een clusterschijf verkrijgen.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Systemen waarop failoverclustering is ingeschakeld zijn het meest kwetsbaar voor dit beveiligingslek. Servers die niet deel uitmaken van een failovercluster worden niet getroffen door dit beveiligingslek en zullen de update niet aangeboden krijgen.
  
**Wat doet de update?**    
Deze update lost dit beveiligingslek op doordat de manier wordt gewijzigd waarop de gebruikersinterface van de Microsoft-clusterservice machtigingen op administratieve shares instelt bij het toevoegen van nieuwe gedeelde clusterschijven.
  
Zie voor meer informatie in Veelgestelde vragen de vermelding, "Stelt deze beveiligingsupdate de juiste machtigingen in op bestaande gedeelde clusterschijven?" in de sectie **Veelgestelde vragen met betrekking tot deze beveiligingsupdate** hierboven.
...
<td style="border:1px solid black;">Voor alle ondersteunde x64-edities van Windows Server 2008 R2 met een Microsoft Cluster-service (MSCS) configuratie:<br />
windows6.1-kb2294255-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor alle ondersteunde Itanium-edities van Windows Server 2008 R2 met een Microsoft Cluster-service (MSCS) configuratie:<br />
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2294255">Microsoft Knowledge Base-artikel 2294255</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (10 november 2010): Er is een veelgestelde vraag toegevoegd om uit te leggen dat deze update de machtigingen voor bestaande gedeelde clusterschijven wel corrigeert. Het gaat alleen om een wijziging in de informatie. Klanten die hun systemen al hebben bijgewerkt, hoeven geen actie te ondernemen.
