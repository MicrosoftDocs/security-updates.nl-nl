---
TOCTitle: 'MS10-092'
Title: 'Microsoft-beveiligingsbulletin MS10-092 - Belangrijk'
ms:assetid: 'ms10-092'
ms:contentKeyID: 61231863
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-092(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-092 - Belangrijk
====================================================

Beveiligingslek in Taakplanner kan leiden tot misbruik van bevoegdheden (2305420)
---------------------------------------------------------------------------------

Gepubliceerd: dinsdag 14 december 2010 | Bijgewerkt: vrijdag 3 december 2010
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de Taakplanner integriteitscontroles uitvoert om te verifiëren dat taken worden uitgevoerd met de bedoelde gebruikersbevoegdheden. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2305420](http://support.microsoft.com/?kbid=2305420) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846)                                            | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613)                    | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17)\* | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6)\*         | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee)   | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a)                                                                         | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d)                                                                             | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb)\*                                                              | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961)                                                            | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in Taakplanner - CVE-2010-3338</th>
...
Beveiligingslek in Taakplanner - CVE-2010-3338  
----------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot misbruik van bevoegdheden door de manier waarop de Windows Taakplanner onjuist valideert of geplande taken worden uitgevoerd binnen de bedoelde beveiligingscontext. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de beveiligingscontext van het lokale systeem. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in de Taakplanner - CVE-2010-3338
...
#### Tijdelijke oplossingen voor het beveiligingslek in de Taakplanner - CVE-2010-3338
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **Schakel de service Taakplanner uit**
    ...
    **Opmerking** Onjuist gebruik van de Register-editor kan ernstige problemen veroorzaken die ertoe kunnen leiden dat u het besturingssysteem opnieuw moet installeren. Microsoft kan niet garanderen dat problemen die voortkomen uit een onjuist gebruik van de Register-editor, kunnen worden opgelost. Het gebruik van de Register-editor is voor eigen risico. Zie voor meer informatie over het bewerken van het register het Help-onderwerp 'Sleutels en waarden wijzigen' in de Register-editor (regedit.exe) of de Help-onderwerpen 'Toevoegen of verwijderen van registerinformatie' en 'Registergegevens bewerken' in regedt32.exe.
    ...
    3.  Dubbelklik op de sleutel **Start**, verander de waarde van **2** in **4** en klik op **OK**.  
    4.  Sluit Register-editor af en start de computer opnieuw op.
  
    **Gevolgen van de tijdelijke oplossing.** De gebruiker kan geen geplande taken op de computer uitvoeren.
    ...
    **De tijdelijke oplossing ongedaan maken.**
    ...
    2.  Zoek de volgende registersleutel op en klik erop:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\services\\Schedule  
    3.  Dubbelklik op de sleutel **Start**, verander de waarde van **4** in **2** en klik op **OK**.  
    4.  Sluit Register-editor af en start de computer opnieuw op.
  
#### Veelgestelde vragen over het beveiligingslek in de Taakplanner - CVE-2010-3338
...
Het beveiligingslek wordt veroorzaakt wanneer de Windows Taakplanner onjuist valideert of geplande taken worden uitgevoerd binnen de bedoelde beveiligingscontext. Een lokale aanvaller kan hierdoor een taak plannen om te worden uitgevoerd in de context van de systeem- of beheerdersaccount.
  
**Wat is de Windows Taakplanner?**    
Taakplanner is een Windows-service die de automatisering van routinetaken op een gekozen computer inschakelt. Taakplanner doet dit door de criteria te bewaken die de gebruiker voor het starten van taken (zogenaamde triggers) heeft gekozen, en vervolgens de taken uit te voeren wanneer aan de criteria wordt voldaan. Voor meer informatie raadpleegt u het item [Taak Scheduler](http://msdn.microsoft.com/en-us/library/aa383614(vs.85).aspx) in de MSDN Library.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop de Taakplanner integriteitscontroles uitvoert om te verifiëren dat taken worden uitgevoerd met de bedoelde gebruikersbevoegdheden.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) toegewezen.
...
Ja. Deze beveiligingsupdate dicht het beveiligingslek dat mogelijk kon worden misbruikt via het gepubliceerde voorbeeld van conceptcode. Het beveiligingslek is opgelost en hieraan is het nummer [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) toegewezen.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2305420">Microsoft Knowledge Base-artikel 2305420</a></td>
</tr>
<tr class="odd">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin en Alexey Monastyrsky van [Kaspersky Lab](http://usa.kaspersky.com/), en Vitaly Kiktenko en Alexander Saprykin van [Design and Test Lab](http://www.dnt-lab.com/) voor het melden van het beveiligingslek in Taakplanner (CVE-2010-3338)  
-   Liam O Murchu van [Symantec](http://www.symantec.com/index.jsp) voor het melden van het beveiligingslek in Taakplanner - (CVE-2010-3338)  
-   Alexandr Matrosov, Eugene Rodionov, Juraj Malcho en David Harley van [ESET](http://www.eset.com/) voor het melden van het beveiligingslek in Taakplanner - (CVE-2010-3338)
...
-   V1.1 (2 maart 2 2011): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2305420 onder Bekende problemen in de Samenvatting.
