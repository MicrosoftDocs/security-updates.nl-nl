---
TOCTitle: 'MS10-100'
Title: 'Microsoft-beveiligingsbulletin MS10-100 - Belangrijk'
ms:assetid: 'ms10-100'
ms:contentKeyID: 61231871
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-100(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-100 - Belangrijk
====================================================

Beveiligingslek in gebruikersinterface van Toestemming tot beheertoepassingen kan leiden tot misbruik van bevoegdheden (2442962)
--------------------------------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de UI van Toestemming tot beheertoepassingen waarden verwerkt die uit het register worden gelezen. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664)                                                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348)                         | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor het 32-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a)\*\* | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor het 64-bits Systems Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f)\*\*     | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164)        | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401)                                                                              | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384)                                                                                  | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a)\*\*                                                                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90)                                                                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - CVE-2010-3961</th>
...
Beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - CVE-2010-3961  
---------------------------------------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden door de onjuiste manier waarop de gebruikersinterface van Toestemming tot beheertoepassingen speciale waarden verwerkt die uit het register worden gelezen. Het beveiligingslek zou ertoe kunnen leiden dat een aanvaller code kan uitvoeren door misbruik te maken van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-3961](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende Factoren voor het beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - CVE-2010-3961
...
-   Om misbruik te kunnen maken van dit beveiligingslek, moet de aanvaller het SeImpersonatePrivilege hebben. De volgende onderdelen hebben deze gebruikersbevoegdheid ook:  
    - Services die door de Service Control Manager worden gestart  
    - COM-servers (Component Object Model) die door de COM-infrastructuur worden gestart en die zijn geconfigureerd om te worden uitgevoerd onder een specifieke account  
    - IIS-services, als ze zijn geconfigureerd om te worden uitgevoerd als een gewone gebruiker
  
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - CVE-2010-3961
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - CVE-2010-3961
...
Het beveiligingslek wordt veroorzaakt wanneer de gebruikersinterface van Toestemming tot beheertoepassingen op onjuiste wijze een registersleutel verwerkt die op een specifieke waarde is ingesteld.
  
**Wat is de gebruikersinterface van Toestemming tot beheertoepassingen?**    
De gebruikersinterface van Toestemming tot beheertoepassingen maakt deel uit van UAC (Gebruikersaccountbeheer). Als UAC volledig is ingeschakeld, hebben interactieve beheerders normaliter minimaal gebruikersbevoegdheden. Ze kunnen zichzelf echter meer bevoegdheden geven om beheerderstaken uit te voeren door expliciete toestemming te geven via de UI van Toestemming tot beheertoepassingen. Dergelijke beheerderstaken omvatten het installeren van software en stuurprogramma's, het veranderen van systeeminstellingen, het bekijken of wijzigen van andere gebruikersaccounts en het uitvoeren van systeembeheer. Zie het MSDN-artikel [User Account Control](http://msdn.microsoft.com/en-us/library/aa511445.aspx) voor meer informatie.
  
**Wat is het SeImpersonatePrivilege?**    
SeImpersonatePrivilege of de gebruikersbevoegdheid 'Een client nabootsen na verificatie' is een beveiligingsinstelling die het eerst werd geïntroduceerd in Microsoft Windows 2000 Service Pack 4. Standaard is deze gebruikersbevoegdheid toegewezen aan leden van de lokale groep Administrators van het apparaat en aan de LocalService-account van het apparaat. De SeImpersonatePrivilege-instelling wordt beschreven in [Microsoft Knowledge Base-artikel 821546](http://support.microsoft.com/kb/821546).
...
Alleen gebruikersaccounts met het SeImpersonatePrivilege kunnen deze aanval uitvoeren. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan speciaal vervaardigde code uitvoeren met LocalSystem-bevoegdheid. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop de UI van Toestemming tot beheertoepassingen waarden verwerkt die uit het register worden gelezen.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2442962">Microsoft Knowledge Base-artikel 2442962</a></td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo van [Argeniss](http://www.argeniss.com/) voor het melden van het beveiligingslek met betrekking tot het imiteren van gebruikers in UI van Toestemming tot beheertoepassingen - (CVE-2010-3961)
