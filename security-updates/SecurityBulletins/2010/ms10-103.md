---
TOCTitle: 'MS10-103'
Title: 'Microsoft-beveiligingsbulletin MS10-103 - Belangrijk'
ms:assetid: 'ms10-103'
ms:contentKeyID: 61231874
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-103(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS10-103 - Belangrijk
====================================================

Door beveiligingslekken in Microsoft Publisher kan externe code worden uitgevoerd (2292970)
-------------------------------------------------------------------------------------------
...
Dit is een belangrijke beveiligingsupdate voor ondersteunde versies van Microsoft Publisher 2002, Microsoft Publisher 2003, Microsoft Publisher 2007 en Microsoft Publisher 2010. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost de beveiligingslekken op doordat de manier wordt verbeterd waarop Microsoft Publisher speciaal vervaardigde Publisher-bestanden opent. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.

**Aanbeveling.** Microsoft raadt klanten aan de update zo spoedig mogelijk te installeren.

**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2292970](http://support.microsoft.com/kb/2292970) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office Suite en andere software</th>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2010 (32-bits versies)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2">Microsoft Publisher 2010 (32-bits edities)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 (64-bits versies)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966">Microsoft Publisher 2010 (64-bits edities)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll - CVE-2010-2569</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot heap-overloop in pubconv.dll - CVE-2010-2570</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll - CVE-2010-2571</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher - CVE-2010-3954</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen - CVE-2010-3955</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2010 (32-bits edities)</td>
<td style="border:1px solid black;">Niet van toepassing</td>
<td style="border:1px solid black;"><strong>Belangrijk</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2010 (64-bits edities)</td>
<td style="border:1px solid black;">Niet van toepassing</td>
<td style="border:1px solid black;"><strong>Belangrijk</strong> <br />
Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
Beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll - CVE-2010-2569  
-----------------------------------------------------------------------------------------------------
...
Zie [CVE 2010-2569](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll - CVE-2010-2569
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll - CVE-2010-2569
...
-   **DLL van het Publisher-conversieprogramma uitschakelen**
    ...
    **Voor 32-bits versies van Windows XP en Windows Server 2003:**
    ...
    `cacls "c:\program files\Microsoft Office\<office-versie>\pubconv.dll" /E /P everyone:N`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    **Voor 64-bits versies van Windows XP en Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /E /P everyone:N`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    **Voor 32-bits versies van Windows** **Vista, Windows Server 2008 en Windows 7:**
  
    `takeown /f "c:\program files\Microsoft Office\<office-versie>\pubconv.dll"icacls "c:\program files\Microsoft Office\<office-versie>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "c:\program files\Microsoft Office\<office-versie>\pubconv.dll" /deny everyone(F)`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    **Voor 64-bits versies van Windows** **Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2:**
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll"icacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /deny everyone (F)`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    **Gevolgen van de tijdelijke oplossing.** Gebruikers die de DLL van het Publisher-conversieprogramma hebben uitgeschakeld, kunnen geen Publisher-bestanden openen indien deze bestanden zijn gemaakt in oudere versies dan Microsoft Publisher 2007.
    ...
    **Zo kunt u tijdelijke oplossingen ongedaan maken:**
    ...
    `cacls "c:\program files\Microsoft Office\<office-versie>\pubconv.dll" /E /R everyone`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    Voor 64-bits versies van Windows XP en Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /E /R everyone`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    Voor 32-bits versies van Windows Vista, Windows Server 2008 en Windows 7:
  
    `icacls "c:\program files\Microsoft Office\<office-versie>\" /restore %TEMP%\PUBCONV_ACL.TXT`
  
    **Opmerking** Voor &lt;office-versie&gt; vult u de versie van het betreffende Microsoft Office-onderdeel in uw systeem in, bijvoorbeeld "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003 en "Office12" voor Microsoft Publisher 2007. Open het Microsoft Office-onderdeel en klik op **Help** om de versie te controleren.
  
    Voor 64-bits versies van Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2:
  
    `icacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\" /restore %TEMP%\PUBCONV_ACL.TXT`
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll - CVE-2010-2569
...
Het beveiligingslek bestaat door de manier waarop speciaal vervaardigde Publisher-bestanden worden geparseerd in Microsoft Publisher.
  
**Wat is pubconv.dll?**    
De DLL van het Publisher-conversieprogramma wordt door Microsoft Publisher gebruikt om Publisher-bestanden te openen die zijn gemaakt in oudere versies dan Microsoft Publisher 2007.
...
Beveiligingslek met betrekking tot heap-overloop in pubconv.dll - CVE-2010-2570  
-------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop Publisher-bestanden worden geparseerd in Microsoft Publisher. Een aanvaller kan het beveiligingslek misbruiken door een speciaal Publisher-bestand te maken dat als een e-mailbijlage kan worden opgenomen of op een speciaal vervaardigde of gemanipuleerde website kan staan, en de gebruiker vervolgens ertoe te bewegen het speciaal vervaardigde Publisher-bestand te openen. Als een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-2570](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot heap-overloop in pubconv.dll - CVE-2010-2570
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot heap-overloop in pubconv.dll - CVE-2010-2570
...
-   **DLL van het Publisher-conversieprogramma uitschakelen**
    ...
    **Opmerking** Gebruik de versie van de betreffende Microsoft Office-software voor uw systeem, zoals "Office10" voor Microsoft Publisher 2002, "Office11" voor Microsoft Publisher 2003, "Office12" voor Microsoft Publisher 2007 en "Office14" voor Microsoft Publisher 2010.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot heap-overloop in pubconv.dll - CVE-2010-2570
...
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Voor dit beveiligingslek is het noodzakelijk dat een gebruiker een speciaal ontworpen Publisher-bestand in Microsoft Publisher opent.
...
Beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll - CVE-2010-2571  
---------------------------------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop Publisher-bestanden worden geopend in Microsoft Publisher. Een aanvaller kan het beveiligingslek misbruiken door een speciaal Publisher-bestand te maken dat als een e-mailbijlage kan worden opgenomen of op een speciaal vervaardigde of gemanipuleerde website kan staan, en de gebruiker vervolgens ertoe te bewegen het speciaal vervaardigde Publisher-bestand te openen. Als een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-2571](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll - CVE-2010-2571
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll - CVE-2010-2571
...
-   **DLL van het Publisher-conversieprogramma uitschakelen**
    ...
    **Voor 64-bits versies van Windows** **Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2:**
    ...
    `takeown /f "<64BIT_PATH_AND_FILENAME>"icacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<office-versie>\pubconv.dll" /deny everyone (F)`
    ...
    **Opmerking** Gebruik de versie van de betreffende Microsoft Office-software voor uw systeem, zoals "Office10" voor Microsoft Publisher 2002 en "Office11" voor Microsoft Publisher 2003.
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll - CVE-2010-2571
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek bestaat door de manier waarop Publisher 97-bestanden worden geparseerd in Microsoft Publisher.
...
**Wat doet de update?**    
Deze beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Publisher 97-bestanden worden geconverteerd in Microsoft Publisher.
...
Beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher - CVE-2010-3954  
---------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop Publisher-bestanden worden geopend in Microsoft Publisher. Een aanvaller kan het beveiligingslek misbruiken door een speciaal Publisher-bestand te maken dat als een e-mailbijlage kan worden opgenomen of op een speciaal vervaardigde of gemanipuleerde website kan staan, en de gebruiker vervolgens ertoe te bewegen het speciaal vervaardigde Publisher-bestand te openen. Als een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher - CVE-2010-3954
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher - CVE-2010-3954
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher - CVE-2010-3954
...
Beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen - CVE-2010-3955  
----------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop Publisher-bestanden worden geopend in Microsoft Publisher. Een aanvaller kan het beveiligingslek misbruiken door een speciaal Publisher-bestand te maken dat als een e-mailbijlage kan worden opgenomen of op een speciaal vervaardigde of gemanipuleerde website kan staan, en de gebruiker vervolgens ertoe te bewegen het speciaal vervaardigde Publisher-bestand te openen. Als een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE 2010-3955](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen - CVE-2010-3955
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen - CVE-2010-3955
...
-   **DLL van het Publisher-conversieprogramma uitschakelen**
    ...
    **Zo kunt u tijdelijke oplossingen ongedaan maken:**
    ...
    Voer in 32-bits versies van Windows Vista, Windows Server 2008 en Windows 7 de volgende opdracht uit vanaf een opdrachtprompt met verhoogde bevoegdheden:
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen - CVE-2010-3955
...
De software- en beveiligingsupdate beheren waarmee u de servers, desktops en mobiele systemen binnen uw organisatie kunt implementeren. Zie het [TechNet Update Management Center](http://go.microsoft.com/fwlink/?linkid=69903) voor meer informatie. De website Microsoft TechNet Security bevat extra informatie over beveiliging in Microsoft-producten.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2284692">Microsoft Knowledge Base-artikel 2284692</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2284695">Microsoft Knowledge Base-artikel 2284695</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2284697">Microsoft Knowledge Base-artikel 2284697</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Microsoft Publisher 2010 (32-bits edities):<br />
Publisher2010-kb2409055-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft Publisher 2010 (64-bits edities):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2409055">Microsoft Knowledge Base-artikel 2409055</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;">Niet van toepassing</td>
...
-   Chaouki Bekrar van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot heap-corruptie van de groottewaarde in pubconv.dll (CVE-2010-2569)  
-   Chaouki Bekrar van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot heap-overloop in pubconv.dll (CVE-2010-2570)  
-   Chaouki Bekrar van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen door ongeldige indexering naar reeksen in Pubconv.dll (CVE-2010-2571)  
-   Chaouki Bekrar van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot beschadigd geheugen in Microsoft Publisher (CVE-2010-3954)  
-   Chaouki Bekrar van [VUPEN Vulnerability Research Team](http://www.vupen.com/) voor het melden van het beveiligingslek met betrekking tot beschadigd geheugen bij het indexeren van reeksen (CVE-2010-3955)
