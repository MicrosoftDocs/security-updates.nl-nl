---
TOCTitle: 'MS10-007'
Title: 'Microsoft-beveiligingsbulletin MS10-007 - Kritiek'
ms:assetid: 'ms10-007'
ms:contentKeyID: 61231777
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-007(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-007 - Kritiek
=================================================

Door een beveiligingslek in de Windows-shellhandler kan externe code worden uitgevoerd (975713)
-----------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3)                  | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows XP Service Pack 2 en Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4) | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)     | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11)                     | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=90360537-9311-45e2-8047-9a971f90c3c3)         | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da)      | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
...
**Wat is het verband tussen deze beveilingsupdate en CVE-2010-0027, beschreven in MS10-002?**  
Het beveiligingslek met betrekking tot URL-validatie (CVE-2010-0027) wordt opgelost door toepassing van deze update (MS10-007) of door toepassing van de [Cumulatieve beveiligingsupdate voor Internet Explorer (MS10-002)](http://go.microsoft.com/fwlink/?linkid=179104), afhankelijk van de versie van Microsoft Windows en de versie van Internet Explorer die zijn geïnstalleerd op het systeem van de gebruiker.
...
Raadpleeg de volgende tabel om na te gaan welke update van toepassing is op uw omgeving.
...
<td style="border:1px solid black;">Ofwel<br />
...
<strong>Internet Explorer</strong> <br />
(<a href="http://go.microsoft.com/fwlink/?linkid=179104">MS10-002</a>)</td>
<td style="border:1px solid black;">Beide<br />
<strong>Windows</strong> <br />
(MS10-007)<br />
en<br />
<strong>Internet Explorer</strong> <br />
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot URL-validatie - CVE-2010-0027</th>
...
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die misbruik weet te maken van dit beveiligingslek kan vervolgens handelingen uitvoeren met dezelfde rechten als de aangemelde gebruiker.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Wanneer een toepassing, zoals een webbrowser, de ShellExecute API gebruikt om speciaal vervaardigde gegevens te verwerken, kan ShellExecute die gegevensstroom onjuist valideren en een binair bestand van het lokale clientsysteem uitvoeren.
...
**Wat is ShellExecute?**    
ShellExecute is een deel van de Windows-shell API (Application Programming Interface). Het verricht een handeling op een opgegeven bestand, bijvoorbeeld het aanroepen van de juiste handler voor dat specifieke bestandstype. In het MSDN-artikel [ShellExecute Function](http://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx) vindt u meer informatie over de ShellExecute-functie.
  
**Wat is een application programming interface (API)?**    
Een API is een reeks functies die u kunt gebruiken in combinatie met een onderdeel, toepassing of besturingssysteem. Normaal bestaat een API uit een of meer DLL's die bepaalde specifieke functionaliteit leveren.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die misbruik weet te maken van dit beveiligingslek kan zich voordoen als de aangemelde gebruiker en zo willekeurige programmacode uitvoeren. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
Een aanvaller kan inhoud aanleveren zoals een speciaal vervaardigde webpagina waardoor een toepassing een verkeerd ingedeelde tekenreeks parseert. Wanneer deze inhoud wordt verzonden naar de ShellExecute API-oproep, bijvoorbeeld als een hyperlink, kan de aanvaller een binair bestand uitvoeren op het clientsysteem zonder dat de aangemelde gebruiker dat weet.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Clientsystemen die door niet-vertrouwde internetinhoud bladeren lopen het grootste risico op dit beveiligingslek, dat kan leiden tot misbruik van bevoegdheden in de context van de aangemelde gebruiker.
  
**Wat doet de update?**    
Deze update lost het beveiligingslek op door de wijze te verbeteren waarop de ShellExecute API invoerparameters valideert op ondersteunde edities van Microsoft Windows 2000, Windows XP en Windows Server 2003.
...
| **Implementatie**                               |                                                                                                                                                    |  
| Installeren zonder tussenkomst van de gebruiker | Windows2000-KB975713-x86-ENU /quiet                                                                                                                |  
| Installeren zonder opnieuw op te starten        | Windows2000-KB975713-x86-ENU /norestart                                                                                                            |  
| Logboekbestand bijwerken                        | kb975713.log                                                                                                                                       |  
...
| **Informatie over verwijderen**                 | Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB975713$\\Spuninst |  
| **Bestandsgegevens**                            | Zie [Microsoft Knowledge Base-artikel 975713](http://support.microsoft.com/kb/975713)                                                              |  
| **Verificatie van registersleutel**             | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB975713\\Filelist                                                          |
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB975713$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/975713">Microsoft Knowledge Base-artikel 975713</a></td>
</tr>
<tr class="even">
