---
TOCTitle: 'MS10-099'
Title: 'Microsoft-beveiligingsbulletin MS10-099 - Belangrijk'
ms:assetid: 'ms10-099'
ms:contentKeyID: 61231870
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms10-099(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS10-099 - Belangrijk
====================================================

Beveiligingslek in Routering en RAS kan leiden tot misbruik van bevoegdheden (2440591)
--------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek door de validatie in het onderdeel Routering en RAS te verbeteren. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                          | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50) | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)     | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0)  | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - CVE-2010-3963</th>
...
Beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - CVE-2010-3963  
---------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het NDProxy-onderdeel Routering en RAS van de Windows-kernel door onjuiste validatie van invoer die door de gebruikersmodus aan de kernel wordt doorgegeven. Het beveiligingslek zou ertoe kunnen leiden dat een aanvaller code kan uitvoeren door misbruik te maken van bevoegdheden. Een lokale aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE 2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - CVE-2010-3963
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - CVE-2010-3963
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - CVE-2010-3963
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het NDProxy-onderdeel Routering en RAS valideert de gegevens die door een gebruiker zijn ingevoerd, niet goed wanneer gegevens van de gebruikersmodus aan de kernel worden doorgegeven.
...
Dankzij de Remote Access-service kunnen gebruikers via de telefoonlijn verbinding maken met een externe computer. Op die manier lijkt het net of de computer fysiek is aangesloten op het externe netwerk. Dankzij deze services kunnen externe gebruikers onder andere e-mail verzenden en ontvangen, documenten faxen, bestanden ophalen en documenten afdrukken op een kantoorprinter.
  
De RAS is een oorspronkelijke service in Windows XP en Windows Server 2003.
  
**Wat is NDProxy?**    
NDPROXY is een door het systeem verstrekt stuurprogramma dat WAN-minipoortstuurprogramma's, oproepmanagers en minipoortoproepmanagers koppelt aan de TAPI-diensten (Telephony Application Programming Interfaces). Voor aanvullende informatie raadpleegt u het MSDN-artikel [NDPROXY Overview](http://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx).
...
**Wat doet de update?**    
De update verwijdert het beveiligingslek door de invoer die vanuit de gebruikersmodus via het onderdeel Routering en RAS aan de Windows-kernel wordt doorgegeven, op de juiste wijze te valideren.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2440591$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2440591">Microsoft Knowledge Base-artikel 2440591</a></td>
</tr>
<tr class="even">
...
-   Honggang Ren van [FortiGuard Labs van Fortinet](http://www.fortiguard.com/) voor het melden van het beveiligingslek met betrekking tot bufferoverloop in NDProxy van kernel - (CVE-2010-3963)
