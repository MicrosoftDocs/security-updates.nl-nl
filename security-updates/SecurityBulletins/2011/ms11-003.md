---
TOCTitle: 'MS11-003'
Title: 'Microsoft-beveiligingsbulletin MS11-003 - Kritiek'
ms:assetid: 'ms11-003'
ms:contentKeyID: 61231880
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-003(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-003 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (2482017)
---------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-clients, en Matig voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-servers. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost de beveiligingslekken op doordat de manier wordt gewijzigd waarop Internet Explorer objecten in het geheugen verwerkt, Cascading Style Sheets (CSS) verwerkt en externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.

Deze beveiligingsupdate verwijdert ook het beveiligingslek dat voor het eerst werd beschreven in [Microsoft-beveiligingsadvies 2488013](http://technet.microsoft.com/security/advisory/2488013).
...
Internet Explorer 9 Beta wordt getroffen door de beveiligingslekken die in dit bulletin word beschreven. Wij raden klanten met deze bètaversie aan de update te downloaden en op hun systemen toe te passen. Beveiligingsupdates zijn beschikbaar op [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) en [Windows Update.](http://go.microsoft.com/fwlink/?linkid=21130) De beveiligingsupdates voor deze bètaversie kunnen ook worden gedownload van het [Microsoft Downloadcentrum](http://go.microsoft.com/fwlink/?linkid=21129).
...
**Ik heb de tijdelijke oplossingen van Microsoft-beveiligingsadvies 2488013 toegepast. Moet ik deze tijdelijke oplossingen ongedaan maken voordat ik deze update toepas?**  
Microsoft raadt u aan om de tijdelijke oplossing "Het recursief laden van Cascading Style Sheets (CSS) in Internet Explorer voorkomen" ongedaan te maken op systemen waarop u deze tijdelijke oplossing hebt toegepast, en pas daarna deze beveiligingsupdate te installeren. Zie [Microsoft Knowledge Base-artikel 2482017](http://support.microsoft.com/kb/2482017) als u de automatische **Microsoft Fix it**-oplossing wilt gebruiken om deze tijdelijke oplossing uit te schakelen.

**Bestaat er een verband tussen deze update en Microsoft-beveiligingsadvies 2269637?**  
Ja, het beveiligingslek [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) dat wordt opgelost in deze update behoort tot de groep beveiligingslekken die van invloed zijn op hoe toepassingen externe bibliotheken laden. Deze groep wordt beschreven in [Microsoft-beveiligingsadvies 2269637](http://technet.microsoft.com/security/advisory/2269637). Deze beveiligingsupdate lost een bijzonder geval van dit soort beveiligingslek op.
...
<th style="border:1px solid black;" >
Beveiligingslek in CSS met betrekking tot ontregeld geheugen - CVE-2010-3971
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0035
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0036
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Internet Explorer - CVE-2011-0038
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer toegang krijgt tot geheugen tijdens het importeren van een Cascading Style Sheet (CSS) dat recursief naar zichzelf verwijst. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken. Als een gebruiker die webpagina bekijkt, kan via het beveiligingslek code vanaf een externe locatie worden uitgevoerd. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Als er een gebruiker met beheerdersrechten is aangemeld, kan een aanvaller die misbruik weet te maken van dit beveiligingslek, volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.

Zie [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in CSS met betrekking tot ontregeld geheugen - CVE-2010-3971
...
#### Tijdelijke oplossingen voor het beveiligingslek in CSS met betrekking tot ontregeld geheugen - CVE-2010-3971
...
-   **Het recursief laden van Cascading Style Sheets (CSS) in Internet Explorer voorkomen**

    Deze tijdelijke oplossing helpt misbruik van het beveiligingslek voorkomen door de aanvalsvector via het Cascading Style Sheet (CSS) in Internet Explorer te voorkomen.

    Deze tijdelijke oplossing is alleen verkrijgbaar als een **Microsoft Fix it-oplossing**. Zie [Microsoft Knowledge Base-artikel 2482017](http://support.microsoft.com/kb/2482017) als u de automatische **Microsoft Fix it**-oplossing wilt gebruiken om deze tijdelijke oplossing in of uit te schakelen.

    **Opmerking** Gebruikers van Internet Explorer die update [MS10-090](http://technet.microsoft.com/security/bulletin/ms10-090) nog niet hebben toegepast, moeten ook update MS10-090 toepassen voordat ze deze tijdelijke oplossing inschakelen.

    **Gevolgen van de tijdelijke oplossing.** Er zijn bijwerkingen van het voorkomen dat Cascading Style Sheets (CSS) recursief worden geladen. Gebruikers kunnen enige prestatieproblemen ervaren door de extra controle die nodig is om het laden van CSS-bestanden te blokkeren.

    **Opmerking** Voor systemen waarop deze tijdelijke oplossing is ingeschakeld, raadt Microsoft u aan de tijdelijke oplossing uit te schakelen voordat u deze beveiligingsupdate toepast.

#### Veelgestelde vragen over het beveiligingslek in CSS met betrekking tot ontregeld geheugen - CVE-2010-3971
...
Internet Explorer verwerkt geheugen niet goed bij het parseren van een speciaal vervaardigd Cascading Style Sheet (CSS) dat recursief naar zichzelf verwijst.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te wijzigen waarop Internet Explorer Cascading Style Sheets (CSS) verwerkt.

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971) toegewezen. Dit beveiligingslek is voor het eerst beschreven in [Microsoft-beveiligingsadvies 2488013](http://technet.microsoft.com/security/advisory/2488013).
...
Zie [CVE-2011-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0035
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0035
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0035

**Wat is de omvang van het probleem?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**  
Internet Explorer verwerkt objecten in het geheugen niet goed bij het parseren van speciaal vervaardigde webinhoud.
...
Zie [CVE-2011-0036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0036
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0036
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen - CVE-2011-0036
...
Zie [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Internet Explorer - CVE-2011-0038
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Internet Explorer - CVE-2011-0038
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Internet Explorer - CVE-2011-0038
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) toegewezen.
...
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2482017$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB2482017-IE7\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB2482017-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2482017">Microsoft Knowledge Base-artikel 2482017</a></td>
</tr>
<tr class="even">
...
-   Yuki Chen van [Trend Micro](http://www.trendmicro.com) voor het melden van het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen (CVE-2011-0035)  
-   SkyLined van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot ontregeling van niet-geïnitialiseerd geheugen (CVE-2011-0036)  
-   Haifei Li van [FortiGuard Labs van Fortinet](http://www.fortiguard.com/) voor het melden van het beveiligingslek met betrekking tot het onveilig laden van bibliotheken in Internet Explorer (CVE-2011-0038)
