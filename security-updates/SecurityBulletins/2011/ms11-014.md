---
TOCTitle: 'MS11-014'
Title: 'Microsoft-beveiligingsbulletin MS11-014 - Belangrijk'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61231891
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-014(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-014 - Belangrijk
====================================================

Beveiligingslek in Local Security Authority Subsystem Service kan leiden tot misbruik van bevoegdheden (2478960)
----------------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 8 februari 2011 | Bijgewerkt: donderdag 28 april 2011
...
Deze beveiligingsupdate lost een privé gemeld beveiligingslek op in de Local Security Authority Subsystem Service (LSASS) in Windows XP en Windows Server 2003. Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van deze besturingssystemen. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.
...
De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop LSASS specifieke waarden afhandelt die in het verificatieproces worden gebruikt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2478960](http://support.microsoft.com/kb/2478960) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                          | Misbruik van bevoegdheden               | Belangrijk        | Geen                                                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e) | Misbruik van bevoegdheden               | Belangrijk        | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                 | Misbruik van bevoegdheden               | Belangrijk        | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)     | Misbruik van bevoegdheden               | Belangrijk        | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41)  | Misbruik van bevoegdheden               | Belangrijk        | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot lengtevalidatie in LSASS - CVE-2011-0039</th>
...
Beveiligingslek met betrekking tot lengtevalidatie in LSASS - CVE-2011-0039  
---------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot misbruik van bevoegdheden in de manier waarop de Microsoft Windows Local Security Authority Subsystem Service (LSASS) speciaal vervaardigde verificatieaanvragen verwerkt. Het beveiligingslek zou ertoe kunnen leiden dat een aanvaller code kan uitvoeren door misbruik te maken van bevoegdheden. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige beheerdersrechten maken.
  
Zie [CVE -2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot lengtevalidatie in LSASS - CVE-2011-0039
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot lengtevalidatie in LSASS - CVE-2011-0039
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot lengtevalidatie in LSASS - CVE-2011-0039
...
Het beveiligingslek wordt veroorzaakt wanneer de Windows LSASS een speciaal vervaardigde verificatieaanvraag verwerkt.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te wijzigen waarop LSASS specifieke waarden afhandelt die in het verificatieproces worden gebruikt.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2478960">Microsoft Knowledge Base-artikel 2478960</a></td>
</tr>
<tr class="even">
...
-   Beveiligingstester Jorge Moura van Primavera BSS voor het melden van het beveiligingslek met betrekking tot lengtevalidatie in LSASS - (CVE-2011-0039)
...
-   V1.1 (28 april 2011): Koppeling toegevoegd naar Microsoft Knowledge Base-artikel 2478960 onder Bekende problemen in de Samenvatting.
