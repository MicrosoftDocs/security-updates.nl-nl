---
TOCTitle: 'MS11-016'
Title: 'Microsoft-beveiligingsbulletin MS11-016 - Belangrijk'
ms:assetid: 'ms11-016'
ms:contentKeyID: 61231893
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-016(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-016 - Belangrijk
====================================================

Door een beveiligingslek in Microsoft Groove kan externe code worden uitgevoerd (2494047)
-----------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor Microsoft Groove 2007 Service Pack 2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De update lost dit beveiligingslek op door de manier te verbeteren waarop Microsoft Groove 2007 externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office-programma's</th>
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove - CVE-2011-0108</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove - CVE-2011-0108  
------------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de manier waarop DLL-bestanden worden geladen in Microsoft Groove 2007. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE -2011-0108](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0108) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove - CVE-2011-0108
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en een aan Groove gerelateerd bestand opent (bijvoorbeeld een VCG- of GTA-bestand).  
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove - CVE-2011-0108
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove - CVE-2011-0108
...
Het beveiligingslek wordt veroorzaakt wanneer Microsoft Groove 2007 onjuist gebruikmaakt van het pad voor het laden van extern bibliotheken.
...
Een aanvaller kan een gebruiker overhalen om een legitiem aan Groove gerelateerd bestand (bijvoorbeeld een VCG- of GTA-bestand) te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het legitieme bestand wordt geopend, kan Microsoft Groove 2007 proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitieme aan Groove gerelateerde bestandsbijlage (bijvoorbeeld een VCG- of GTA-bestand) naar een gebruiker te sturen, de gebruiker over te halen om de bijlage te plaatsen in een map die een speciaal vervaardigd DLL-bestand bevat en het legitieme bestand te openen. Wanneer het legitieme bestand wordt geopend, kan Microsoft Groove 2007 proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een aanval via het netwerk kan een aanvaller een legitiem aan Groove gerelateerd bestand en een speciaal vervaardigde DLL in een netwerkshare plaatsen, bijvoorbeeld een UNC- of WebDAV-locatie, en de gebruiker overhalen om het bestand te openen.
  
**Wat is een Microsoft Groove vCard-bestand (.vcg)?**    
De vCard-indeling is een bestandsindelingsstandaard voor elektronische visitekaartjes. Microsoft Groove vCard-bestanden (.vcg) worden gebruikt om contactpersonen in de vCard-indeling op te slaan.
  
**Wat is een Microsoft Groove Tool Archive-bestand (.gta)?**    
Microsoft Groove Tool Archive-bestanden (.gta) worden gebruikt voor Groove-hulpprogramma's. Dit zijn mini-toepassingen die zijn gebaseerd op de onderliggende mogelijkheid van Groove om inhoud te verspreiden en te synchroniseren met exemplaren van de Groove-werkruimte van andere leden.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te verbeteren waarop Microsoft Groove 2007 externe bibliotheken laadt.
  
**Bestaat er een verband tussen dit beveiligingslek en Microsoft-beveiligingsadvies 2269637?**    
Ja, het beveiligingslek dat met deze update wordt opgelost, houdt verband met de klasse van beveiligingslekken, beschreven in [Microsoft-beveiligingsadvies 2269637](http://technet.microsoft.com/security/advisory/2269637), die beïnvloeden hoe toepassingen externe bibliotheken laden. Deze beveiligingsupdate lost een bijzonder geval van dit soort beveiligingslek op.
  
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**    
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-0108](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0108) toegewezen.
...
Ja. Deze beveiligingsupdate dicht het beveiligingslek dat mogelijk kon worden misbruikt via het gepubliceerde voorbeeld van conceptcode. Het beveiligingslek is opgelost en hieraan is het nummer [CVE-2011-0108](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0108) toegewezen.
...
|--------------------------------------|---------|-------------------|-------------------|----------------------------|  
| Microsoft Groove 2007 Service Pack 2 | Nee     | Nee               | Ja                | Ja                         |
...
#### Microsoft Groove 2007 (alle edities)
...
<td style="border:1px solid black;">Voor Microsoft Office Groove 2007 Service Pack 2:<br />
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2494047">Microsoft Knowledge Base-artikel 2494047</a></td>
</tr>
<tr class="even">
...
-   HD Moore van [Rapid 7](http://www.rapid7.com/) voor het melden van het beveiligingslek met betrekking tot onveilig laden van bibliotheken in Microsoft Groove (CVE-2011-0108)
