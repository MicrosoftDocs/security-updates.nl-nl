---
TOCTitle: 'MS11-018'
Title: 'Microsoft-beveiligingsbulletin MS11-018 - Kritiek'
ms:assetid: 'ms11-018'
ms:contentKeyID: 61231895
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-018(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-018 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (2497640)
---------------------------------------------------------------

Gepubliceerd: dinsdag 12 april 2011 | Bijgewerkt: maandag 16 mei 2011
...
Met deze beveiligingsupdate worden vier privé gemelde beveiligingslekken en een openbaar gemaakt beveiligingslek in Internet Explorer opgelost. Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-clients, en Matig voor Internet Explorer 6, Internet Explorer 7 en Internet Explorer 8 op Windows-servers. Deze beveiligingslekken treden niet op in Internet Explorer 9. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.
...
<span></span>
**Waarom zijn er op 16 mei 2011 wijzigingen in dit bulletin aangebracht?**  
Microsoft heeft dit bulletin opnieuw uitgebracht om een probleem op te lossen in de detectielogia voor Internet Explorer 7 op ondersteunde edities van Windows XP en Windows Server 2003. Dit probleem kan optreden bij klanten met specifieke configuraties. Het probleem kan ertoe leiden dat de detectielogica de update niet aanbiedt of ten onrechte vaststelt dat de update is toegepast. Dit opnieuw uitgebrachte bulletin is slechts een detectiewijziging om de logica te corrigeren en bevat geen wijzigingen van de binaire bestanden van de beveiligingsupdate.

Eindgebruikers met Internet Explorer 7 op ondersteunde edities van Windows XP en Windows Server 2003 die de update handmatig of via Automatische updates hebben toegepast, worden niet getroffen door het probleem en hoeven geen actie te ondernemen. Eindgebruikers met de getroffen configuraties, die de update niet goed aangeboden hebben gekregen vanwege het probleem met detectielogica, krijgen de update nu aangeboden via Automatische updates en moeten de update onmiddellijk toepassen.

Voor IT-beheerders kan het probleem met detectielogica ertoe leiden dat Enterprise-scanfuncties (zoals WSUS, System Center Configuration Manager 2007 en SMS 2003 met ITMU) ten onrechte vaststellen dat de update is toegepast op getroffen systemen. Systemen waarop voorheen ten onrechte werd vastgesteld dat de update was toegepast, worden nu goed herkend als systemen waarop de update nog moet worden toegepast.

Alleen getroffen klanten krijgen de update aangeboden. Klanten die de update handmatig hebben geïnstalleerd en klanten met configuraties waarop de detectiewijziging niet van toepassing is, hoeven geen actie te ondernemen.
...
Deze update bevat een ingrijpende beveiligingsupdate om te helpen geheugenbeveiliging in Internet Explorer te verbeteren.
...
**Internet Explorer 6 worden Internet Explorer 7 genoemd als producten waarin dit probleem optreedt voor CVE-2011-1244. Waarom brengt Microsoft geen update uit voor CVE-2011-1244 voor deze getroffen producten?**  
De architectuur die de oplossingen voor clickjacking ondersteunt, is niet aanwezig in Internet Explorer 6 en Internet Explorer 7. Daardoor is het niet mogelijk oplossingen voor deze producten te ontwikkelen om het beveiligingslek dat wordt beschreven in CVE-2011-1244 te dichten.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen - CVE-2011-0094
</th>
<th style="border:1px solid black;" >
Beveiligingslek door ontregeld geheugen in MSHTML - CVE-2011-0346
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot het vrijgeven van informatie van frametags - CVE-2011-1244
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot het vrijgeven van informatie in Javascript - CVE-2011-1245
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen bij objectbeheer - CVE-2011-1345
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<td style="border:1px solid black;">
**Gemiddeld**  
Vrijgeven van informatie<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Belangrijk**   
...
Zie [CVE-2011-0094](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0094) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen - CVE-2011-0094
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen - CVE-2011-0094
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen - CVE-2011-0094
...
Zie [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek door ontregeld geheugen in MSHTML - CVE-2011-0346
...
#### Tijdelijke oplossingen voor het beveiligingslek door ontregeld geheugen in MSHTML - CVE-2011-0346
...
#### Veelgestelde vragen over het beveiligingslek door ontregeld geheugen in MSHTML - CVE-2011-0346
...
**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**  
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346) toegewezen.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het vrijgeven van informatie in Internet Explorer. Een aanvaller kan het beveiligingslek misbruiken door een speciaal ontworpen webpagina te maken die eruit ziet als een normale webpagina. De acties van de gebruiker op de pagina kunnen leiden tot het vrijgeven van informatie of tot clickjacking, waarbij de muisklikken van de gebruiker leiden tot ongewenste acties.

Zie [CVE-2011-1244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1244) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het vrijgeven van informatie van frametags - CVE-2011-1244
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het vrijgeven van informatie van frametags - CVE-2011-1244

Microsoft heeft nog geen oplossingen voor dit beveiligingslek.

#### Veelgestelde vragen over het beveiligingslek met betrekking tot het vrijgeven van informatie van frametags - CVE-2011-1244

**Wat is de omvang van het probleem?**  
Dit is een beveiligingslek met betrekking tot het vrijgeven van informatie. Een aanvaller die misbruik maakt van het beveiligingslek kan een gebruiker ertoe overhalen op schadelijke inhoud te klikken door deze inhoud legitiem te laten lijken op een speciaal vervaardigde website.
...
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**  
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan een gebruiker ertoe overhalen op schadelijke inhoud te klikken via een methode die clickjacking wordt genoemd.

**Wat is clickjacking?**  
Clickjacking is een onlinebedreiging waarbij de webpagina van een aanvaller de gebruiker ertoe overhaalt op schadelijke inhoud te klikken door deze inhoud legitiem te laten lijken. Een legitieme webpagina kan bijvoorbeeld worden verborgen als een frame in een schadelijke pagina. Wanneer een gebruiker in de schadelijke pagina klikt, klikt de gebruiker eigenlijk op iets anders: de gebruiker koopt iets van de website, bepaalde instellingen in de browser of van de computer van de gebruiker worden gewijzigd of er wordt reclame weergegeven waarvoor cybercriminelen betaald krijgen.

**Hoe kan een aanvaller dit beveiligingslek misbruiken?**  
Een aanvaller kan over een website beschikken die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen handelingen uit te voeren op deze website. De aanvaller zou ook misbruik kunnen maken van gemanipuleerde websites en websites die inhoud of advertenties van gebruikers accepteren of hosten. Deze websites kunnen speciaal vervaardigde inhoud bevatten, die misbruik van dit beveiligingslek kan maken. Een aanvaller kan echter een gebruiker er niet toe dwingen om naar deze websites te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller gaat. Speciaal ontworpen webinhoud kan ook worden weergegeven via banneradvertenties of andere manieren waarop webinhoud bij de kwetsbare systemen wordt afgeleverd.
...
**Wat doet de update?**  
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Internet Explorer inhoud tijdens bepaalde processen verwerkt.
...
Zie [CVE-2011-1245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1245) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende Factoren voor beveiligingslek met betrekking tot het vrijgeven van informatie in Javascript - CVE-2011-1245
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot het vrijgeven van informatie in Javascript - CVE-2011-1245
...
#### Veelgestelde vragen over beveiligingslek met betrekking tot het vrijgeven van informatie in Javascript - CVE-2011-1245
...
**Waardoor wordt het beveiligingslek veroorzaakt?**  
Dit beveiligingslek wordt veroorzaakt wanneer door bepaalde processen in Internet Explorer scripts ten onrechte toegang krijgen tot inhoud van andere domeinen.
...
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Voor dit beveiligingslek is het noodzakelijk dat een gebruiker zich heeft aangemeld en een website bezoekt die koppelingen naar inhoud in externe vensters bevat voordat er een schadelijke actie kan plaatsvinden. Computers waarop Internet Explorer regelmatig wordt gebruikt, zoals werkstations en terminalservers, lopen het meeste risico.
...
Zie [CVE-2011-1345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1345) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen bij objectbeheer - CVE-2011-1345
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen bij objectbeheer - CVE-2011-1345
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen bij objectbeheer - CVE-2011-1345
...
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2497640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB2497640-IE7\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB2497640-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2497640">Microsoft Knowledge Base-artikel 2497640</a></td>
</tr>
<tr class="even">
...
-   Een anonieme onderzoeker, werkzaam bij [VeriSign iDefense Labs](http://labs.idefense.com/), voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen (CVE-2011-0094)  
-   [MITRE](http://mitre.org/) voor de samenwerking bij het oplossen van het beveiligingslek met betrekking tot ontregeld geheugen bij verwerking van indelingen (CVE-2011-0094)  
-   Michal Zalewski van [Google Inc.](http://www.google.com/) voor de samenwerking bij het oplossen van het beveiligingslek door ontregeld geheugen in MSHTML (CVE-2011-0346)  
-   David Bloom van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot het vrijgeven van informatie van frametags (CVE-2011-1244)  
-   David Bloom van [Google Inc.](http://www.google.com/) voor het melden van het beveiligingslek met betrekking tot het vrijgeven van informatie in Javascript (CVE-2011-1245)  
-   Stephen Fewer van [Harmony Security](http://www.harmonysecurity.com) in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen bij objectbeheer (CVE-2011-1345)
