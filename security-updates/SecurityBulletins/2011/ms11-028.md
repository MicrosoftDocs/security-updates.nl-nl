---
TOCTitle: 'MS11-028'
Title: 'Microsoft-beveiligingsbulletin MS11-028 - Kritiek'
ms:assetid: 'ms11-028'
ms:contentKeyID: 61231905
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-028(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-028 - Kritiek
=================================================

Een beveiligingslek in .NET Framework kan leiden tot uitvoering van externe code (2484015)
------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 12 april 2011 | Bijgewerkt: woensdag 30 november 2011
...
De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop het .NET Framework bepaalde soorten functieaanroepen afhandelt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2484015](http://support.microsoft.com/kb/2484015) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=1407aaec-b3e0-404c-b84f-0c8e808614c4)Service Pack 1  
(KB2449742)
</td>
<td style="border:1px solid black;">
Uitvoering van externe code mogelijk
...
Microsoft heeft dit beveiligingsbulletin bijgewerkt om een detectiewijziging aan te kondigen in het WU-pakket (Windows Update) voor KB2446709. Het WU-pakket vermeldt nu correct het bulletin dat door deze update is vervangen. Dit is slechts een detectie-update. Klanten die hun systemen al hebben bijgewerkt, hoeven geen actie te ondernemen.

**Waarom zijn er op 10 mei 2011 wijzigingen in dit bulletin aangebracht?**
Microsoft heeft dit bulletin is opnieuw gepubliceerd om de hotfix KB979744 opnieuw aan te bieden met de beveiligingsupdates KB2446709 en KB2449742 en daarmee een bekend probleem in SQL- en Exchange-servers op te lossen. Dit probleem wordt uitgebreid beschreven in [Microsoft Knowledge Base-artikel 2540222](http://support.microsoft.com/kb/2540222). Voor klanten die de oorspronkelijke versie (V1) van hotfix KB979744 hebben geïnstalleerd, zal deze update zowel de beveiligingsupdate als de nieuwe versie van hotfix KB979744 automatisch aanbieden en installeren. Klanten die de update al hebben uitgevoerd op hun systeem en die hotfix KB979744 niet hebben geïnstalleerd, hoeven deze update niet opnieuw te installeren.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot stack-beschadiging in .NET Framework - CVE-2010-3958
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<tr>
<th colspan="3">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1
</th>
</tr>
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 met SP2 voor Itanium-systemen
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Vista Service Pack 1 en Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .Net Framework 2.0 Service Pack 2 en Microsoft .Net Framework 3.5 Service Pack 1 op Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .Net Framework 2.0 Service Pack 2 en Microsoft .Net Framework 3.5 Service Pack 1 op Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .Net Framework 2.0 Service Pack 2 en Microsoft .Net Framework 3.5 Service Pack 1 op Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 indien geïnstalleerd op Windows Server 2003 met SP2 voor Itanium-systemen
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 indien geïnstalleerd op Windows Vista Service Pack 1 en Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 indien geïnstalleerd op Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 op Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code in de wijze waarop Microsoft .NET Framework bepaalde functieaanroepen afhandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE 2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot stack-beschadiging in .NET Framework - CVE-2010-3958
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot stack-beschadiging in .NET Framework - CVE-2010-3958
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot stack-beschadiging in .NET Framework - CVE-2010-3958
...
Dit beveiligingslek wordt veroorzaakt doordat de x86 JIT-compiler in het .NET Framework bepaalde soorten functieaanroepen onjuist compileert.
...
**Wat doet de update?**
Deze update lost het beveiligingslek op door de manier te wijzigen waarop de x86 JIT-compiler in .NET Framework bepaalde soorten functieaanroepen afhandelt.

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958) toegewezen.
...
<td style="border:1px solid black;">Voor Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows XP Service Pack 3:<br />
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2484015">Microsoft Knowledge Base-artikel 2484015</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1 op Windows Server 2003 met SP2 voor Itanium-systemen:<br />
...
-   V2.0 (10 mei 2011): Het bulletin is opnieuw uitgebracht om de updates KB2446709 en KB2449742 opnieuw aan te bieden. Hiermee wordt een bekend probleem met SQL- en Exchange-servers waarop hotfix KB979744 is geïnstalleerd, opgelost.  
-   V2.1 (14 juni 2011): Er is een veelgestelde vraag toegevoegd om een detectiewijziging aan te kondigen die het vervangende bulletin verbetert voor Microsoft .NET Framework 3.5.1 op ondersteunde edities van Windows 7 en Windows Server 2008 R2. Dit is slechts een detectiewijziging. De bestanden van de beveiligingsupdate zijn niet gewijzigd. Klanten die hun systemen al hebben bijgewerkt, hoeven geen actie te ondernemen.  
-   V2.2 (22 juni 2011): De informatie over het vervangen van het bulletin is verbeterd. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.  
-   V2.3 (26 oktober 2011): De informatie over het vervangen van het bulletin is verbeterd voor .Net Framework 4 op 32-bits versies van Microsoft Windows. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden. Ook is de toepasbaarheid van Server Core-installatie verbeterd voor .Net Framework 4 op Windows Server 2008 R2 voor x64-systemen.  
-   V2.4 (30 november 2011): De informatie over het vervangen van het bulletin is verbeterd voor .Net Framework 4 op Windows 7 voor x64-systemen Service Pack 1, Windows Server 2008 R2 voor x64-systemen Service Pack 1 en Windows Server 2008 R2 voor Itanium-systemen Service Pack 1. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.
