---
TOCTitle: 'MS11-039'
Title: 'Microsoft-beveiligingsbulletin MS11-039 - Kritiek'
ms:assetid: 'ms11-039'
ms:contentKeyID: 61231916
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-039(v=Security.10)'
author: SharonSears
...
Beveiligingslek in .NET Framework en Microsoft Silverlight kan leiden tot uitvoering van externe code (2514842)
---------------------------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor alle getroffen edities van Microsoft .NET Framework voor Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2; en Microsoft Silverlight 4. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop .NET Framework waarden die worden doorgegeven aan vertrouwde API's valideert. Zie de subsectie Veelgestelde vragen in de volgende sectie, **Informatie over** **het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2514842](http://support.microsoft.com/kb/2514842) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 1 en Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=2eabacce-394f-4b9a-8306-0875ca19a3a9)  
(KB2478657)  
[Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=55fd3254-7e59-4cf9-afa8-45ae66bc7390)  
(KB2478659)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 en Microsoft .NET Framework 3.5 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=afa11dda-a543-42a7-b997-5292fd869a8b)  
(KB2478660)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
**Bestaat er een verband tussen deze beveiligingsupdate en MS11-044, Een beveiligingslek in .NET Framework kan leiden tot uitvoering van externe code?**
...
Microsoft Silverlight-build 4.0.60531.0, de huidige build van Microsoft Silverlight op het moment dat dit bulletin het eerst wordt uitgegeven, lost het beveiligingslek op en heeft er dus geen last van. Builds van Microsoft Silverlight vóór 4.0.60531.0 worden wel getroffen.
...
De versie die met deze beveiligingsupdate wordt geïnstalleerd is 4.0.60531.0. Als uw versienummer hoger is dan of gelijk is aan dit versienummer, loopt uw systeem geen gevaar.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot matrix-offset in .NET Framework - CVE-2011-0664
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 op Windows 7 voor x64-systemen en Windows 7 voor x64-systemen<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in Microsoft .NET Framework waardoor een speciaal vervaardigde Microsoft .NET-toepassing toegang kan krijgen tot geheugen. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de beveiligingscontext van de huidige aangemelde gebruiker. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

Zie [CVE-2011-0664](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot matrix-offset in .NET Framework - CVE-2011-0664
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot matrix-offset in .NET Framework - CVE-2011-0664
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot matrix-offset in .NET Framework - CVE-2011-0664
...
| Microsoft Silverlight 3 op Mac                                                                                  | Ja   |
| Microsoft Silverlight 3 op alle versies van Microsoft Windows-clients                                           | Ja   |
| Microsoft Silverlight 3 op alle versies van Microsoft Windows-servers                                           | Ja   |
| Microsoft Silverlight 4 op Mac                                                                                  | Ja   |
...
| Microsoft Silverlight 3 op Mac                                                                                  | Ja                | Ja                         |
| Microsoft Silverlight 3 op alle versies van Microsoft Windows-clients                                           | Ja                | Ja                         |
| Microsoft Silverlight 3 op alle versies van Microsoft Windows-servers                                           | Ja                | Ja                         |
| Microsoft Silverlight 4 op Mac                                                                                  | Ja                | Ja                         |
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2514842">Microsoft Knowledge Base-artikel 2514842</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 4.0 op Windows Server 2003 voor 32-bits systemen:<br />
NDP40-KB2478663-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 3.5 op Windows Server 2003 voor Itanium-systemen:<br />
...
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">Deze beveiligingsupdate ondersteunt Hotpatching niet. Zie <a href="http://support.microsoft.com/kb/897341">Microsoft Knowledge Base-artikel 897341</a> voor meer informatie over Hotpatching.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informatie over verwijderen</strong></td>
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm voor alle ondersteunde versies van Microsoft .NET Framework.</td>
...
-   Michael J. Liu voor het melden van het beveiligingslek met betrekking tot matrix-offset in .NET Framework (CVE-2011-0664)
...
-   V1.1 (26 oktober 2011): De toepasbaarheid van Server Core-installatie is verbeterd voor .Net Framework 4 op Windows Server 2008 R2 voor x64-systemen.
