---
TOCTitle: 'MS11-042'
Title: 'Microsoft-beveiligingsbulletin MS11-042 - Kritiek'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61232009
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-042(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-042 - Kritiek
=================================================

Beveiligingslekken in Distributed File System kunnen leiden tot uitvoering van externe code (2535512)
-----------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 14 juni 2011 | Bijgewerkt: dinsdag 14 juni 2011
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor alle ondersteunde edities van Windows XP en Windows Server 2003, Belangrijk voor alle ondersteunde edities van Windows Vista en Windows Server 2008 en Belangrijk voor Windows 7 voor 32-bits systemen, Windows 7 voor x64-systemen, Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor Itanium-systemen. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost de beveiligingslekken op door de manier te corrigeren waarop de DFS-client velden in speciaal vervaardigd DFS-verwijzingsantwoorden valideert en door de manier te corrigeren waarop de DFS-service speciaal vervaardigde DFS-verwijzingsantwoorden behandelt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                               | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                      | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                      | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                          | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                       | Uitvoering van externe code mogelijk    | Kritiek           | Geen                                            |
| [Windows Vista Service Pack 1 en Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                            | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                    | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\* | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*         | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4)   | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                         | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                             | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                              | Denial of service                       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                            | Denial of service                       | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot ontregeld geheugen in DFS - CVE-2011-1868</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot DFS-verwijzingsantwoorden - CVE-2011-1869</th>
...
Beveiligingslek met betrekking tot ontregeld geheugen in DFS - CVE-2011-1868  
----------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot de uitvoering van niet-geverifieerde externe code in de manier waarop de DFS-client (Distributed File System) speciaal vervaardigde DFS-antwoorden parseert. Er is geen verificatie nodig om het beveiligingslek te kunnen misbruiken. Dat betekent dat een aanvaller dit beveiligingslek kan misbruiken door een speciaal vervaardigde DFS-antwoord te verzenden op een DFS-aanvraag van de client. Een aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor beveiligingslek met betrekking tot ontregeld geheugen in DFS - CVE-2011-1868
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot ontregeld geheugen in DFS - CVE-2011-1868
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over beveiligingslek met betrekking tot ontregeld geheugen in DFS - CVE-2011-1868
...
Het beveiligingslek wordt veroorzaakt wanneer de Microsoft DFS-implementatie (Distributed File System) alle velden binnen speciaal vervaardigde DFS-antwoorden op onjuiste wijze valideert.
  
**Wat het Distributed Files System (DFS)?**    
Met Distributed File System (DFS) kunnen beheerders gedeelde mappen die zich op verschillende servers bevinden, groeperen door ze transparant te verbinden met een of meer DFS-naamruimten. Een DFS-naamruimte is een virtuele weergave van gedeelde mappen in een organisatie. Met de DFS-hulpprogramma's kan een beheerder selecteren welke gedeelde mappen in de naamruimte moeten worden weergegeven, de hiërarchie ontwerpen waarin deze mappen worden weergegeven, en de namen opgeven waarmee de gedeelde mappen in de naamruimte worden weergegeven. Wanneer een gebruiker de naamruimte bekijkt, lijkt het alsof de mappen zich bevinden op een enkele vaste schijf met hoge capaciteit. Gebruikers kunnen door de mappen in de naamruimte navigeren zonder de servernamen te moeten weten van de gedeelde mappen waarin de gegevens zich bevinden. Raadpleeg de [DFS Technical Reference](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) voor meer informatie.
...
Een aanvaller kan een speciaal vervaardigde server hosten die is ontworpen om misbruik te maken van dit beveiligingslek en vervolgens een gebruiker ertoe overhalen een DFS-verbinding met deze server tot stand te brengen. Daarnaast kan een aanvaller op het lokale netwerk een man-in-the-middle-aanval uitvoeren door een verkeerd ingedeeld DFS-antwoord te verzenden op een geldige DFS-aanvraag.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt een risico voor alle ondersteunde edities van Windows XP en Windows Server 2003.
  
**Wat doet de update?**    
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de DFS-client velden in speciaal vervaardigde DFS-antwoorden valideert.
...
Beveiligingslek met betrekking tot DFS-verwijzingsantwoorden - CVE-2011-1869  
----------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service in de manier waarop Microsoft Distributed File System (DFS) speciaal vervaardigde DFS-verwijzingsantwoorden behandelt. Er is geen verificatie nodig om het beveiligingslek te kunnen misbruiken, waardoor een aanvaller dit beveiligingslek kan misbruiken door een speciaal vervaardigd netwerkbericht te verzenden naar een computer waarop de serverservice wordt uitgevoerd.
  
Zie [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor beveiligingslek met betrekking tot DFS-verwijzingsantwoorden - CVE-2011-1869
...
#### Tijdelijke oplossingen voor beveiligingslek met betrekking tot DFS-verwijzingsantwoorden - CVE-2011-1869
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over beveiligingslek met betrekking tot DFS-verwijzingsantwoorden - CVE-2011-1869
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op een denial of service. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan ervoor zorgen dat het getroffen systeem niet meer reageert tot het handmatig opnieuw is opgestart. Het beveiligingslek betreft een 'denial-of-service'-probleem. Een aanvaller kan geen code uitvoeren of zichzelf gebruikersrechten toekennen, maar kan er wel voor zorgen dat het systeem waarin dit probleem optreedt geen aanvragen meer accepteert.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt doordat de DFS-implementatie (Distributed File System) speciaal vervaardigde DFS-verwijzingsantwoorden op onjuiste wijze behandelt.
...
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Dit beveiligingslek vormt een risico voor alle ondersteunde versies van Windows.
  
**Wat doet de update?**    
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop de DFS-service speciaal vervaardigde DFS-verwijzingsantwoorden behandelt.
...
| Windows 7 voor 32-bits systemen                                                                       | Ja                | Ja                         |  
| Windows 7 voor x64-systemen                                                                           | Ja                | Ja                         |  
| Windows Server 2008 R2 voor x64-systemen                                                              | Ja                | Ja                         |  
| Windows Server 2008 R2 voor Itanium-systemen                                                          | Ja                | Ja                         |
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2535512$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2535512">Microsoft Knowledge Base-artikel 2535512</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Windows 7 voor 32-bits systemen:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows 7 voor x64-systemen:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor alle Windows 7 voor x64-systemen:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installeren zonder tussenkomst van de gebruiker</td>
<td style="border:1px solid black;">Voor Windows 2008 R2 voor x64-systemen:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Windows 2008 R2 voor Itanium-systemen:<br />
...
-   Laurent Gaffié van [NGS Software](http://www.ngssoftware.com/) voor het melden van het beveiligingslek met betrekking tot DFS-verwijzingsantwoorden (CVE-2011-1869)
...
-   V1.1 (14 juni 2011): Windows 7 voor 32-bits systemen met Service Pack 1, Windows 7 voor x64-systemen met Service Pack 1, Windows Server 2008 R2 voor x64-systemen met Service Pack 1 en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1 zijn van de tabel met software waarin dit probleem optreedt, verplaatst naar de tabel met software waarin dit probleem niet optreedt. Het gaat alleen om een wijziging in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.
