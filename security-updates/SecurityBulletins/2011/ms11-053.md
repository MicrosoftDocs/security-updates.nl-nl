---
TOCTitle: 'MS11-053'
Title: 'Microsoft-beveiligingsbulletin MS11-053 - Kritiek'
ms:assetid: 'ms11-053'
ms:contentKeyID: 61232020
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-053(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-053 - Kritiek
=================================================

Door een beveiligingslek in de Bluetooth-stack kan externe code worden uitgevoerd (2566220)
-------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor ondersteunde versies van Windows Vista en Windows 7. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop de Windows Bluetooth-stack objecten in het geheugen verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2566220](http://support.microsoft.com/kb/2566220) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01">Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<sup>[1]</sup>Windows Vista Service Pack 1 wordt alleen getroffen wanneer de optionele Windows Vista Feature Pack for Wireless is geïnstalleerd. Zie de veelgestelde vragen in de update voor details.
...
**Ik werk met Windows Vista Service Pack 1.** **Is mijn systeem getroffen door dit beveiligingslek?**    
Windows Vista Service Pack 1 is alleen getroffen op systemen met ondersteuning voor Bluetooth 2.1-technologie. Klanten met Windows Vista Service Pack 1 die de [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567) hebben geïnstalleerd, beschikken over ondersteuning voor Bluetooth 2.1-technologie en hebben daarom last van dit beveiligingslek. Deze klanten moeten beveiligingsupdate KB2561109 installeren. Klanten die de Windows Vista Feature Pack for Wireless niet hebben geïnstalleerd, hebben geen ondersteuning voor Bluetooth 2.1 en hebben daarom geen last van dit beveiligingslek. Zie [Microsoft Knowledge Base-artikel 2566220](http://support.microsoft.com/kb/2566220) voor meer informatie.
  
**Ik heb de Windows Vista Feature Pack for Wireless voor Windows Vista Service Pack 1 geïnstalleerd, maar heb een upgrade naar Windows Vista Service Pack 2 uitgevoerd. Welke updates moet ik installeren?**    
Klanten met Windows Vista Service Pack 1 die de [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567)voor Windows Vista Service Pack 1 hebben ingeschakeld en die een upgrade naar Windows Vista Service Pack 2 hebben uitgevoerd, moeten beveiligingsupdate KB2532531 installeren. Zie [Microsoft Knowledge Base-artikel 2566220](http://support.microsoft.com/kb/2566220) voor meer informatie.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot Bluetooth-stack - CVE-2011-1265</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot Bluetooth-stack - CVE-2011-1265  
------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in de Windows Bluetooth 2.1-stack vanwege de wijze waarop een object in het geheugen wordt benaderd wanneer het niet correct is geïnitialiseerd of is verwijderd. Een aanvaller kan misbruik maken van het beveiligingslek door een reeks speciaal vervaardigde Bluetooth-pakketten te maken en deze naar de doelcomputer te verzenden. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot Bluetooth-stack - CVE-2011-1265
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Dit beveiligingslek treft alleen systemen waarop Bluetooth is geïnstalleerd.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot Bluetooth-stack - CVE-2011-1265
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **Het Bluetooth-stuurprogramma stoppen en uitschakelen**
  
    U kunt het stuurprogramma ook uitschakelen door de volgende opdracht in te voeren achter de opdrachtprompt:
  
    `sc config bthport start= disabled`
  
    **De tijdelijke oplossing ongedaan maken.**
  
    U kunt het Bluetooth-stuurprogramma ook opnieuw inschakelen door de volgende opdracht in te voeren achter de opdrachtprompt:
  
    `sc config bthport start= demand`
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot Bluetooth-stack - CVE-2011-1265
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op de uitvoering van externe code.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt door de manier waarop de Windows Bluetooth-stack toegang heeft tot geheugen dat niet correct is geïnitialiseerd of is verwijderd.
  
**Wat is Bluetooth?**    
Bluetooth is een standaardprotocol dat draadloze connectiviteit biedt voor computers, handheldapparatuur, mobiele telefoons en andere apparaten. Zie het MSDN-artikel, [Bluetooth](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx), voor meer informatie.
...
Om misbruik te maken van dit beveiligingslek, moet de aanvaller zich in de buurt van de doelcomputer bevinden om radio-uitzendingen binnen het Bluetooth-radiospectrum te verzenden en te ontvangen. Een aanvaller kan in dat geval misbruik maken van het beveiligingslek door een reeks speciaal vervaardigde Bluetooth-pakketten te maken en deze naar de doelcomputer te verzenden.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**    
Werkstations zijn het meest kwetsbaar voor dit beveiligingslek.
  
**Mijn Windows Vista- of Windows 7-werkstation heeft geen Bluetooth-technologie. Ben ik getroffen?**    
Ja. Windows Vista en Windows 7 ondersteunen een grote assortiment van Bluetooth-radioapparaten en zullen het Bluetooth-stuurprogramma installeren wanneer een verwisselbaar Bluetooth-apparaat aan het systeem wordt toegevoegd. Dat betekent dat alle ondersteunde versies van Windows Vista en Windows 7 zijn getroffen. Voor meer informatie raadpleegt u het MSDN-artikel, [Bluetooth Wireless Technology FAQ - 2010](http://msdn.microsoft.com/en-us/windows/hardware/gg487349.aspx).
  
**Wat doet de update?**    
De beveiligingsupdate lost het beveiligingslek op door de manier te wijzigen waarop de Windows Bluetooth 2.1-stack objecten in het geheugen verwerkt.
...
<td style="border:1px solid black;">Voor 32-bits versies van Windows Vista Service Pack 1 waarop Windows Vista Feature Pack for Wireless is ingeschakeld:<br />
Windows6.0-KB2561109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor alle ondersteunde 32-bits edities van Windows Vista Service Pack 2:<br />
Windows6.0-KB2532531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor x64-bits versies van Windows Vista Service Pack 1 waarop Windows Vista Feature Pack for Wireless is ingeschakeld:<br />
Windows6.0-KB2561109-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor alle ondersteunde op x64-edities van Windows Vista Service Pack 2:<br />
...
<td style="border:1px solid black;">Voor Windows Vista Service Pack 1 waarop Windows Vista Feature Pack for Wireless is ingeschakeld:<br />
Zie <a href="http://support.microsoft.com/kb/2561109">Microsoft Knowledge Base-artikel 2561109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">For Windows Vista Service Pack 2:<br />
Zie <a href="http://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-artikel 2532531</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2532531">Microsoft Knowledge Base-artikel 2532531</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;"><strong>Opmerking</strong> Er bestaat geen registersleutel waarmee de aanwezigheid van deze update kan worden gevalideerd.</td>
