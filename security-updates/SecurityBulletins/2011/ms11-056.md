---
TOCTitle: 'MS11-056'
Title: 'Microsoft-beveiligingsbulletin MS11-056 - Belangrijk'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61232023
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-056(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-056 - Belangrijk
====================================================

Beveiligingslekken in Windows Client/Server Run-time Subsystem kunnen leiden tot misbruik van bevoegdheden (2507938)
--------------------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 12 juli 2011 | Bijgewerkt: donderdag 21 juli 2011
...
De beveiligingsupdate lost de beveiligingslekken op door niet toe te staan dat meerdere consoleobjecten aan één proces worden gekoppeld, door de manier te wijzigen waarop het CSRSS geheugen initialiseert, door gebruikersinvoer te valideren voordat deze wordt gebruikt als een index voor een matrix en door grenscontroles te wijzigen om ontregeling van geheugen te voorkomen. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2507938](http://support.microsoft.com/kb/2507938) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 met SP2 voor Itanium-systemen</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a5e192af-dae5-47ef-a9d0-f761a8caa974">Windows Vista Service Pack 1 en Windows Vista Service Pack 2</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1007f5d3-9be1-4f03-a3f0-12ddb555653c">Windows Vista x64 Edition Service Pack 1 en Windows Vista x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">Windows Server 2008 voor 32-bits systemen en Windows Server 2008 voor 32-bits systemen Service Pack 2</a>*</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">Windows Server 2008 voor x64-systemen en Windows Server 2008 voor x64-systemen Service Pack 2</a>*</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008 voor Itanium-systemen en Windows Server 2008 voor Itanium-systemen Service Pack 2</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1</a>*</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1</a></td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
</tr>
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole - CVE-2011-1281</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284</th>
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole - CVE-2011-1281  
-------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop het CSRSS geheugen toewijst voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole - CVE-2011-1281
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole - CVE-2011-1281
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole - CVE-2011-1281
...
Dit beveiligingslek wordt veroorzaakt doordat een ontregeling van geheugen ontstaat wanneer meerdere consoleobjecten aan één proces worden gekoppeld. Wanneer het proces wordt afgesloten, blijven de objecten achter zonder bovenliggend object. Deze objecthandle kan vervolgens worden verkregen door een ander vervaardigd proces met een hogere bevoegdheid dan was bedoeld.
  
**Wat is het Windows Client/Server Runtime Subsystem (CSRSS)?**    
Het Client Server Runtime Subsystem (CSRSS) is het gebruikersmodusgedeelte van het Win32-subsysteem (Win32.sys is het kernelmodusgedeelte). CSRSS is een essentieel subsysteem, dat altijd actief dient te zijn. CSRSS is verantwoordelijk voor consoles en maakt en/of verwijdert threads.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die misbruik weet te maken van het beveiligingslek, kan een willekeurige code op een gebruikerssysteem uitvoeren. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door niet toe te staan dat meerdere consoleobjecten aan één proces worden gekoppeld.
...
Beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282  
-----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop het CSRSS geheugen toewijst voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken
  
Zie [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Als een aanvaller misbruik wil maken van het beveiligingslek, moet deze zich lokaal bij het systeem kunnen aanmelden en een programma kunnen uitvoeren.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Dit is een beveiligingslek met betrekking tot ontregeld geheugen dat uitvoering van code in de systeemcontext kan toestaan. Een NULL-aanwijzer wordt zonder validatie doorgegeven aan een functie in het CSRSS. Op die manier kan het CSRSS gegevens wegschrijven naar een NULL-pagina in de procesruimte. Op Windows XP-systemen kan deze pagina onder bepaalde omstandigheden door een aanvaller worden gebruikt om code uit te voeren met verhoogde machtigingen.
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door de manier te wijzigen waarop het CSRSS geheugen initialiseert om te voorkomen dat willekeurige code in de systeemcontext wordt uitgevoerd.
...
Beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283  
-----------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop het CSRSS geheugen toewijst voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Als een aanvaller misbruik wil maken van het beveiligingslek, moet deze zich lokaal bij het systeem kunnen aanmelden en een programma kunnen uitvoeren.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Dit beveiligingslek wordt veroorzaakt wanneer gebruikersinvoer wordt gebruikt als een index voor een matrix zonder deze eerst op negatieve waarden te controleren. Dit kan ertoe leiden dat een aanvaller gegevens leest uit gebieden in het geheugen of uit ontregeld geheugen, op dusdanige wijze dat uitvoering van code mogelijk is.
...
**Wat doet de update?**    
De update los dit beveiligingslek op door gebruikersinvoer te valideren voordat deze als een index voor een matrix wordt gebruikt.
...
Beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284  
----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop het CSRSS geheugen toewijst voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
...
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Dit beveiligingslek wordt veroorzaakt door een integeroverloop waarvan een aanvaller misbruik kan maken om code uit te voeren in de context van de systeemaccount.
...
**Wat doet de update?**    
De update lost dit beveiligingslek door grenscontroles te wijzigen om ontregeling van geheugen en uitvoering van code te voorkomen.
...
Beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870  
----------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het Windows CSRSS vanwege de manier waarop het CSRSS geheugen toewijst voor specifieke gebruikerstransacties. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
...
**Wat doet de update?**    
De update lost dit beveiligingslek op door grenscontroles te wijzigen om ontregeling van geheugen en uitvoering van code te voorkomen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2507938$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2507938">Microsoft Knowledge Base-artikel 2507938</a></td>
</tr>
<tr class="even">
...
-   Matthew ‘j00 ru' Jurczyk van [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) voor het melden van het beveiligingslek met betrekking tot CSRSS Local EOP AllocConsole (CVE-2011-1281)  
-   Matthew ‘j00 ru' Jurczyk van [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) voor het melden van het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleLocalEUDC (CVE-2011-1282)  
-   Matthew ‘j00 ru' Jurczyk van [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) voor het melden van het beveiligingslek met betrekking tot CSRSS Local EOP SrvSetConsoleNumberOfCommand (CVE-2011-1283)  
-   Matthew ‘j00 ru' Jurczyk van [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) voor het melden van het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutput (CVE-2011-1284)  
-   Matthew ‘j00 ru' Jurczyk van [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) voor het melden van het beveiligingslek met betrekking tot CSRSS Local EOP SrvWriteConsoleOutputString (CVE-2011-1870)
...
-   V1.1 (21 juli 2011): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2507938 onder Bekende problemen in de Samenvatting.
