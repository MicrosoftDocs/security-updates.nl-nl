---
TOCTitle: 'MS11-059'
Title: 'Microsoft-beveiligingsbulletin MS11-059 - Belangrijk'
ms:assetid: 'ms11-059'
ms:contentKeyID: 61232026
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-059(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-059 - Belangrijk
====================================================

Beveiligingslek in Data Access Components kan leiden tot uitvoering van externe code (2560656)
----------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in de Windows Data Access Tracing-component. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e)                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc)                                   | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4)\*       | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
Ja, het beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken (CVE-2011-1975) dat wordt opgelost in deze update, behoort tot de groep beveiligingslekken die van invloed zijn op hoe toepassingen externe bibliotheken laden. Deze groep wordt beschreven in [Microsoft-beveiligingsadvies 2269637](http://technet.microsoft.com/security/advisory/2269637). Deze beveiligingsupdate lost een bijzonder geval van dit soort beveiligingslek op.
...
<th style="border:1px solid black;" >Beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1975</th>
...
Beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1975  
----------------------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop DLL-bestanden worden geladen in de Windows Data Access Tracing-component. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2011-1975](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1975
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en een Excel-bestand (zoals een .xlsx-bestand) opent.  
...
#### Tijdelijke oplossingen voor het beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1975
...
#### Veelgestelde vragen over het beveiligingslek in Data Access Components met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1975
...
Het beveiligingslek wordt veroorzaakt wanneer de Windows Data Access Tracing-component het pad voor het laden van externe bibliotheken niet goed beperkt.
  
**Wat is Windows Data Access Components (Windows DAC)?**    
Windows Data Access Components (Windows DAC) 6.0 is een reeks technologieën in Windows Vista, Windows 7, Windows Server 2008 en Windows Server 2008 R2 en biedt toegang tot informatie in de volledige onderneming. Deze technologieën omvatten Microsoft ActiveX-gegevensobjecten (ADO), OLE DB en Microsoft Open Database Connectivity (ODBC). Gegevenstoepassingen op de client of server die via het web of een LAN worden gebruikt, kunnen deze componenten gebruiken om informatie van diverse bronnen, zowel gerelateerd (SQL) als niet-gerelateerd, eenvoudig te integreren. Zie het MSDN-artikel [Windows Data Access Components SDK](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) voor meer informatie.
...
Een aanvaller kan een gebruiker overhalen om een legitiem Excel-bestand (zoals een .xlsx-bestand) te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het legitieme bestand wordt geopend, kan Microsoft Office proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitieme Excel-bijlage (zoals een .xlsx-bestand) naar een gebruiker te sturen, de gebruiker over te halen om de bijlage te plaatsen in een map die een speciaal vervaardigd DLL-bestand bevat en het legitieme bestand te openen. Wanneer het legitieme bestand wordt geopend, kan Microsoft Office proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
...
Bekende aanvalsvectoren kunnen via Microsoft Office-software, zoals Microsoft Excel, werken maar de kwetsbare code bevindt zich in een gedeelde component van Microsoft Windows.
...
**Wat doet de update?**    
De update lost het beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in de Windows Data Access Tracing-component.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2560656">Microsoft Knowledge Base-artikel 2560656</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (10 augustus 2011): De opstartvereisten voor de update op alle getroffen besturingssystemen zijn verbeterd.
