---
TOCTitle: 'MS11-062'
Title: 'Microsoft-beveiligingsbulletin MS11-062 - Belangrijk'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61232029
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-062(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-062 - Belangrijk
====================================================

Beveiligingslek in NDISTAPI-stuurprogramma voor Remote Access-service kan leiden tot misbruik van bevoegdheden (2566454)
------------------------------------------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop het NDISTAPI-stuurprogramma invoer van de gebruikermodus valideert voordat deze naar de Windows-kernel wordt verzonden. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                          | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b) | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                 | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)     | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d)  | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden - CVE-2011-1974</th>
...
Beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden - CVE-2011-1974  
----------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in het NDISTAPI-stuurprogramma voor de Remote Access-service. Het beveiligingslek wordt veroorzaakt wanneer het NDISTAPI-stuurprogramma door de gebruiker ingevoerde gegevens onjuist valideert wanneer deze gegevens van de gebruikersmodus naar de kernel worden doorgestuurd. Een lokale aanvaller die dit beveiligingslek weet te misbruiken, kan willekeurige programmacode uitvoeren en volledige controle krijgen over het systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden - CVE-2011-1974
...
#### Tijdelijke oplossingen voor het beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden - CVE-2011-1974
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden - CVE-2011-1974
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer het NDISTAPI-stuurprogramma door de gebruiker ingevoerde gegevens onjuist valideert wanneer deze gegevens van de gebruikersmodus naar de kernel worden doorgestuurd.
  
**In welke component treedt het beveiligingslek op?**    
NDISTAPI.sys is het onderdeel dat door het beveiligingslek wordt getroffen.
  
**Wat is de Remote Access-service (RAS)?**    
Door de Remote Access-service (RAS) kunnen gebruikers via de telefoonlijn, internet of een andere netwerkverbinding verbinding maken met een externe computer, zodat ze kunnen werken alsof hun systeem fysiek is verbonden met het externe netwerk. Met RAS kunnen gebruikers op afstand activiteiten uitvoeren zoals het verzenden en ontvangen van e-mail, het verzenden van faxen, het ophalen van bestanden en het afdrukken van documenten op een kantoorprinter. Raadpleeg het MSDN-artikel [RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx)Architecture Overview (NDIS 5.1) voor meer informatie.
  
RAS is een oorspronkelijke service in Windows XP en Windows Server 2003. RAS werd in nieuwere besturingssystemen vervangen door de Routing and Remote Access-service (RRAS). Dankzij RRAS kan een computer functioneren als een netwerkrouter. RRAS biedt ook de nieuwste serverfunctionaliteit voor RAS voor Windows. De RRAS-serverfunctionaliteit borduurt voort op de RAS-functionaliteit die in eerdere besturingssystemen was ingebouwd.
  
**Wat is het NDISTAPI-stuurprogramma?**    
Het NDISTAPI-stuurprogramma is een onderdeel van de RAS-architectuur en koppelt de NDISWAN aan TAPI-services. Telefonietoepassingen voeren de TAPI-services uit en kunnen TAPI-aanvragen maken voor het instellen, controleren en verbreken van verbindingen en oproepen. Het NDISTAPI-stuurprogramma geeft deze TAPI-aanvragen door aan de NDISWAN. Raadpleeg het MSDN-artikel [NDISTAPI Overview (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx) voor meer informatie.
  
**Wat is de NDISWAN?**    
De NDISWAN (Network Driver Interface Standard Wide Area Network) is een bij het systeem geleverd NDIS-hulpstuurprogramma dat functionaliteit biedt zoals gegevenscompressie, encryptie, loopback en eenvoudige PPP-framing voor WAN-minipoortstuurprogramma's. WAN-minipoortstuurprogramma's moeten daarom alleen de specifieke functies voor het medium implementeren (bijvoorbeeld: Q931-signalen zijn nodig voor ISDN). Zie het MSDN-artikel [NDISWAN Overview](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx) voor meer informatie.
  
**Wat is de TAPI-service?**    
De TAPI-service (Telephony Application Programming Interface) is een programmeerinterfaces die telefonieservices biedt voor toepassingen voor telefonische communicatie.
  
**Wat is de NDIS?**    
De NDIS (Network Driver Interface Standard) is onderdeel van de Windows Driver Kit, een volledig geïntegreerd ontwikkelsysteem voor stuurprogramma's met de Windows Driver Device Kit en tests waarmee de stabiliteit en betrouwbaarheid van Windows-stuurprogramma's kunnen worden gecontroleerd. De NDIS-bibliotheek abstraheert de netwerkhardware van de netwerkstuurprogramma's. De NDIS specificeert ook een standaardinterface tussen gelaagde netwerkstuurprogramma's en abstraheert daarbij stuurprogramma's op een lager niveau die hardware beheren van stuurprogramma's op een hoger niveau, zoals netwerktransports. De NDIS verzamelt ook statusinformatie en parameters voor netwerkstuurprogramma's, waaronder pointers naar functies, handles en parameterblokkeringen voor koppelingen en andere systeemwaarden.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**    
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de context van het lokale systeem. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
...
**Wat doet de update?**    
De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop het NDISTAPI-stuurprogramma invoer van de gebruikermodus valideert voordat deze naar de Windows-kernel wordt verzonden.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2566454$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2566454">Microsoft Knowledge Base-artikel 2566454</a></td>
</tr>
<tr class="even">
...
-   Lufeng Li van voor het melden van het beveiligingslek in NDISTAPI met betrekking tot misbruik van bevoegdheden (CVE-2011-1974)
