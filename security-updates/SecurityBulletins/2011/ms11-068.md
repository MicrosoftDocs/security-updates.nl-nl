---
TOCTitle: 'MS11-068'
Title: 'Microsoft-beveiligingsbulletin MS11-068 - Matig'
ms:assetid: 'ms11-068'
ms:contentKeyID: 61232035
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-068(v=Security.10)'
---
...
Gepubliceerd: dinsdag 9 augustus 2011 | Bijgewerkt: woensdag 10 augustus 2011
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9713b7b8-f260-440d-a994-845f17683fe9)                                   | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4d67ec00-e86a-49b6-a9a2-85b2520fa4bb)                       | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=da219735-b8b7-4f97-b8a8-7c253838de6b)\*\*\* | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e077af5-5823-4377-a997-44b022a694d8)\*\*\*     | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=560efa6f-c956-47cb-a2f4-a1f45278b7cd)       | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 voor 32-bits systemen](http://www.microsoft.com/downloads/details.aspx?familyid=6c8dd72b-abf8-4e1f-aafc-777c1a3ef3db)                                | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 voor 32-bits systemen Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6c8dd72b-abf8-4e1f-aafc-777c1a3ef3db)                 | Denial of service                       | Matig             | Geen                                                      |
| [Windows 7 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=d90c07c1-3c07-4989-825c-fb8453541a0e)                                    | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7 voor x64-systemen Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d90c07c1-3c07-4989-825c-fb8453541a0e)                     | Denial of service                       | Matig             | Geen                                                      |
| [Windows Server 2008 R2 voor x64-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=67cccd09-5b82-4546-884a-d2a9e2400820)\*\*\*                 | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2 voor x64-systemen Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=67cccd09-5b82-4546-884a-d2a9e2400820)\*\*\*  | Denial of service                       | Matig             | Geen                                                      |
| [Windows Server 2008 R2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)                   | Denial of service                       | Matig             | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2 voor Itanium-systemen Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)    | Denial of service                       | Matig             | Geen                                                      |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot DOS bij het parseren van metagegevens in de Windows-kernel - CVE-2011-1971</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service in Windows door de wijze waarop de kernel metagegevens van bestanden parseert tijdens het bladeren naar een map. Een aanvaller die dit lek weet te misbruiken, kan ervoor zorgen dat het systeem waarin dit probleem optreedt niet meer reageert.
  
Zie [CVE-2011-1971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1971) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot DOS bij het parseren van metagegevens in de Windows-kernel - CVE-2011-1971
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   In het geval van een aanval vanaf het web kan de aanvaller beschikken over een website waarop zich een webpagina bevindt waarmee dit beveiligingslek wordt misbruikt. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens of advertenties staan of gegevens of advertenties kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. In het geval van een aanval vanaf een gedeelde netwerklocatie kan een aanvaller een speciaal vervaardigd bestand plaatsen op een gedeelde netwerklocatie die wordt gebruikt om misbruik te maken van dit beveiligingslek. Een aanvaller kan een gebruiker echter niet dwingen om naar een dergelijke website of gedeelde netwerklocatie te gaan. In plaats daarvan moet een aanvaller een gebruiker overhalen om de website of netwerklocatie te bezoeken. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot DOS bij het parseren van metagegevens in de Windows-kernel - CVE-2011-1971
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot DOS bij het parseren van metagegevens in de Windows-kernel - CVE-2011-1971
  
**Wat is de omvang van het probleem?**    
Dit beveiligingslek heeft betrekking op een denial of service. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan ervoor zorgen dat het getroffen systeem opnieuw wordt opgestart. Een aanvaller kan geen code uitvoeren of zichzelf gebruikersrechten toekennen.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**    
Het beveiligingslek wordt veroorzaakt wanneer de Windows-kernel informatie over metagegevens in bestanden onjuist parseert.
...
Een aanvaller die dit lek weet te misbruiken, kan ervoor zorgen dat het systeem waarin dit probleem optreedt opnieuw wordt opgestart.
  
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**    
In het geval van een aanval vanaf het web moet een aanvaller beschikken over een website die verwijst naar een speciaal vervaardigd bestand op een gedeelde netwerklocatie. Wanneer de gebruiker vervolgens naar de website navigeert, wordt het pad van het getroffen besturingselement geopend via het Detailvenster of het Voorbeeldvenster in Windows Verkenner. Met behulp van het speciaal vervaardigde bestand kan de aanvaller dan misbruik maken van het beveiligingslek en ervoor zorgen dat het systeem opnieuw wordt opgestart. Een aanvaller kan een gebruiker er niet toe dwingen om naar de speciaal vervaardigde website te gaan. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling te klikken waarmee de gebruiker naar de website van de aanvaller gaat.
  
In het geval van een aanval vanaf een gedeelde netwerklocatie moet een aanvaller beschikken over een speciaal vervaardigd bestand op een gedeelde netwerklocatie. Wanneer de gebruiker vervolgens naar de gedeelde locatie navigeert in Windows Verkenner, wordt het pad van het getroffen besturingselement geopend via het Detailvenster of het Voorbeeldvenster. Met behulp van het speciaal vervaardigde bestand kan de aanvaller dan misbruik maken van het beveiligingslek en ervoor zorgen dat het systeem opnieuw wordt opgestart.
...
**Wat doet de update?**    
De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop de Windows-kernel informatie over metagegevens in bestanden parseert.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2556532">Microsoft Knowledge Base-artikel 2556532</a></td>
</tr>
<tr class="odd">
...
-   Zheng Wenbin van [Qihoo 360 Security Center](http://www.360.cn/) voor het melden van het beveiligingslek met betrekking tot DOS bij het parseren van metagegevens in de Windows-kernel (CVE-2011-1971)
