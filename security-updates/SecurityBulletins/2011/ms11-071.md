---
TOCTitle: 'MS11-071'
Title: 'Microsoft-beveiligingsbulletin MS11-071 - Belangrijk'
ms:assetid: 'ms11-071'
ms:contentKeyID: 61232038
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-071(v=Security.10)'
author: SharonSears
...
Gepubliceerd: dinsdag 13 september 2011 | Bijgewerkt: dinsdag 8 november 2011
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d)                                                                                       | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289)                                                              | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f)                                                                              | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a)                                                                  | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e)                                                               | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7)                                                                                    | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8)                                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799)\*                                                      | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547)\*                                                          | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f)                                                        | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48)                           | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe)                                   | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776)\*       | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8) | Uitvoering van externe code mogelijk    | Belangrijk        | Geen                                            |
...
Microsoft heeft wijzigingen in dit bulletin aangebracht om de beschikbaarheid van een update voor Windows 7 Embedded aan te kondigen. Wij raden klanten met dit platform aan de update te downloaden en op hun systeem toe te passen. Beveiligingsupdates zijn beschikbaar op [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130). Deze hernieuwde uitgave heeft geen gevolgen voor andere updatepakketten.
...
Ja, het beveiligingslek in Windows-componenten met betrekking tot het onveilig laden van bibliotheken (CVE-2011-1991) dat wordt opgelost in deze update, behoort tot de groep beveiligingslekken die van invloed zijn op hoe toepassingen externe bibliotheken laden. Deze groep wordt beschreven in [Microsoft-beveiligingsadvies 2269637](http://technet.microsoft.com/security/advisory/2269637). Deze beveiligingsupdate lost een bijzonder geval van dit soort beveiligingslek op.
...
<th style="border:1px solid black;" >Beveiligingslek in Windows-componenten met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1991</th>
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop DLL-bestanden worden geladen door Windows-componenten. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Windows-componenten met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1991
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-share bezoekt en moet een RTF-bestand, (.rtf), tekstbestand (.txt) of Word-document (.doc) opent.  
...
#### Tijdelijke oplossingen voor het beveiligingslek in Windows-componenten met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1991
...
#### Veelgestelde vragen over het beveiligingslek in Windows-componenten met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1991
...
Het beveiligingslek wordt veroorzaakt wanneer bepaalde Windows-componenten op onjuiste wijze het pad beperken dat wordt gebruikt voor het laden van externe bibliotheken.
  
**Op welke componenten wordt deze update toegepast?**  
De update wordt toegepast op de componenten Configuratiescherm-uitbreiding Beeldscherm-panning (deskpan.dll), Microsoft EAPHost Authenticator-service, Microsoft Management Console (MMC), mapomleiding, de invoermethode-editor voor Japans (IME) en HyperTerminal.
  
**Wat is de Configuratiescherm-uitbreiding Beeldscherm-panning?**  
De Configuratiescherm-uitbreiding Beeldscherm-panning (deskpan.DLL) is een module met betrekking tot de weergave-instellingen van afbeeldingen die op het scherm van een gebruiker worden weergegeven. Gebruikers kunnen met deze uitbreiding in combinatie met bijbehorende DLL's de geavanceerde eigenschappen van de beeldschermadapter en monitor aanpassen.
  
**Wat is de Microsoft** **EAPHost** **Authenticator-service?**  
EAPHost is een netwerkonderdeel van Microsoft Windows dat een EAP-infrastructuur (Extensible Authentication Protocol) biedt voor de verificatie van protocolimplementaties van "aanvragers" zoals 802.1X en Point-to-Point (PPP). EAPHost kan ook worden gebruikt voor verificatie met "verificator"-technologieën zoals Microsoft NPS (Network Policy Server). Zie het MSDN-artikel [Extensible Authentication Protocol Host](http://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx) voor meer informatie.
  
**Wat is Microsoft Management Console (MMC)?**  
Microsoft Management Console (MMC) is een uitbreidbare algemene presentatieservice voor beheertoepassingen. MMC biedt een algemene omgeving voor modules van Microsoft en andere softwareleveranciers. Modules bieden de daadwerkelijke beheerfunctionaliteit, niet MMC. De MMC-omgeving zorgt voor een naadloze integratie tussen modules. Zie het TechNet-artikel [Microsoft Management Console - Overview](http://technet.microsoft.com/en-us/library/bb742441.aspx) voor meer informatie.
  
**Wat is de component Mapomleiding?**  
Mapomleiding is een functie van IntelliMirror waarmee gebruikers en beheerders het pad van een map kunnen omleiden naar een nieuwe locatie. De nieuwe locatie kan een map op de lokale computer of een map op een gedeelde netwerklocatie zijn. Gebruikers kunnen met documenten op een server werken alsof deze documenten op het lokale station staan. U kunt bijvoorbeeld de map Mijn documenten, die doorgaans op de vaste schijf van de computer staat, omleiden naar een netwerklocatie. De documenten in de map zijn via elke computer in het netwerk beschikbaar voor de gebruiker. Zie het TechNet-artikel [Folder Redirection Overview](http://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx) voor meer informatie.
  
**Wat is de invoermethode-editor voor Japans?**  
Met de invoermethode-editor voor Japans kunnen gebruikers Japanse tekst invoeren in documenten, werkbladen, presentaties, e-mailberichten, publicaties en webpagina's. Zie het MSDN-artikel [Installing and Using Input Method Editors](http://msdn.microsoft.com/en-us/library/ee418266%28v=vs.85%29.aspx) voor meer informatie over deze en andere invoermethode-editors.
  
**Wat is HyperTerminal?**  
HyperTerminal is een programma dat u kunt gebruiken om via uw modem, een null-modemkabel of een Ethernet-verbinding verbinding te maken met andere computers, Telnet-websites, Bulletin Board-systemen (BBS), onlineservices en hostcomputers, met of uw modem, een NULL-modemkabel of Ethernet-verbinding.
  
**Waarom worden er meerdere componenten genoemd voor dit beveiligingslek?**  
Hoewel er meerdere componenten worden genoemd voor dit beveiligingslek, wordt de hoofdoorzaak van het probleem gedeeld door alle componenten.
...
Een aanvaller kan een gebruiker ertoe overtuigen een legitiem RTF-bestand (.rtf), tekstbestand (.txt) of Word-document (.doc) opent dat zich in dezelfde netwerkmap bevindt als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het legitieme bestand wordt geopend, kan de getroffen component proberen om het DLL-bestand te laden en code in het bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitiem RTF-bestand, (.rtf), tekstbestand (.txt) of Word-document (.doc) naar een gebruiker te sturen en de gebruiker ertoe over te halen de bijlage in een directory met een speciaal vervaardigd DLL-bestand te plaatsen en het legitieme bestand te openen. Wanneer het legitieme bestand wordt geopend, kan de getroffen component proberen om het DLL-bestand te laden en code in het bestand uit te voeren.
  
In het geval van een netwerkaanval kan een aanvaller een legitiem RTF bestand (.rtf), tekstbestand (. txt) of Word-document (.doc) en een speciaal vervaardigd DLL-bestand op een gedeelde netwerklocatie, een UNC of WebDAV-locatie plaatsen en de gebruiker vervolgens overhalen om het bestand te openen.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te verbeteren waarop Windows-componenten externe bibliotheken laden. De update verbetert ook registersleutelgegevens om het laden van externe bibliotheken te beperken.
...
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) toegewezen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2570947$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Bestandsgegevens</td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2570947">Microsoft Knowledge Base-artikel 2570947</a></td>
</tr>
<tr class="even">
...
**Opmerking** U kunt deze schakelopties combineren in één opdracht. Met het oog op compatibiliteit met eerdere versies biedt deze beveiligingsupdate ook ondersteuning voor de installatieschakelopties die worden gebruikt door de eerdere versie van het installatieprogramma. Zie [Microsoft Knowledge Base-artikel 262841](http://support.microsoft.com/kb/262841) voor meer informatie over de ondersteunde schakelopties voor de installatie.
...
**Opmerking** U kunt deze schakelopties combineren in één opdracht. Met het oog op compatibiliteit met eerdere versies biedt deze beveiligingsupdate ook ondersteuning voor veel van de installatieschakelopties die worden gebruikt door de eerdere versie van het installatieprogramma. Zie [Microsoft Knowledge Base-artikel 262841](http://support.microsoft.com/kb/262841) voor meer informatie over de ondersteunde schakelopties voor de installatie.
