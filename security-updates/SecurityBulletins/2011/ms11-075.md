---
TOCTitle: 'MS11-075'
Title: 'Microsoft-beveiligingsbulletin MS11-075 - Belangrijk'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61232042
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-075(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-075 - Belangrijk
====================================================

Door een beveiligingslek in Microsoft Active Accessibility kan externe code worden uitgevoerd (2623699)
-------------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 11 oktober 2011 | Bijgewerkt: dinsdag 25 oktober 2011
...
Deze beveiligingsupdate lost een privé gemeld beveiligingslek in het Microsoft Active Accessibility-onderdeel op. Door het beveiligingslek kan externe code worden uitgevoerd als een aanvaller een gebruiker overhaalt om een legitiem bestand te openen dat zich bevindt in dezelfde netwerkmap als een speciaal vervaardigd bibliotheekbestand (DLL-bestand). Wanneer het legitieme bestand wordt geopend, kan het getroffen Microsoft Active Accessibility-onderdeel proberen om het DLL-bestand te laden en code in het bestand uit te voeren. Een aanval lukt alleen als een gebruiker een niet-vertrouwde externe bestandssysteemlocatie of WebDAV-locatie bezoekt en vanaf die locatie een document opent dat vervolgens door een kwetsbare toepassing wordt geladen.
...
De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in het Microsoft Active Accessibility-onderdeel. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Windows Server 2003 met SP2 voor Itanium-systemen</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5">Windows Server 2008 voor 32-bits systemen Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca">Windows Server 2008 voor x64-systemen Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b">Windows Server 2008 voor Itanium-systemen Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42">Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07">Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8">Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87">Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<th style="border:1px solid black;" >Beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1247</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1247  
--------------------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop DLL-bestanden worden geladen in het Microsoft Active Accessibility-onderdeel. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2011-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1247
...
#### Tijdelijke oplossingen voor het beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1247
...
#### Veelgestelde vragen over het beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken - CVE-2011-1247
...
Het beveiligingslek wordt veroorzaakt doordat het Microsoft Active Accessibility-onderdeel het pad dat wordt gebruikt voor het laden van externe bibliotheken niet goed beperkt.
  
**Wat is het Microsoft Active Accessibility-onderdeel?**  
Het Microsoft Active Accessibility-onderdeel is een COM-technologie (Component Object Model) die de manier verbeterd waarop toegangshulpprogramma's werken met toepassingen die worden uitgevoerd op Microsoft Windows. Het levert DLL-bestanden van het besturingssysteem en een COM-interface en API-elementen die betrouwbare methoden bieden om informatie over UI-elementen vrij te geven. Zie het MSDN artikel [Microsoft Active Accessibility](http://msdn.microsoft.com/en-us/library/ms971350.aspx) voor meer informatie.
...
Een aanvaller kan een gebruiker ertoe overhalen om een legitiem bestand te openen dat zich in dezelfde netwerkmap bevindt als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het legitieme bestand wordt geopend, kan het getroffen Microsoft Active Accessibility-onderdeel proberen om het DLL-bestand te laden en code in het bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitieme bestandsbijlage naar een gebruiker te sturen en de gebruiker ertoe over te halen de bijlage in een directory met een speciaal vervaardigd DLL-bestand te plaatsen en het legitieme bestand te openen. Wanneer het legitieme bestand wordt geopend, kan het getroffen Microsoft Active Accessibility-onderdeel proberen om het DLL-bestand te laden en code in het bestand uit te voeren.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te verbeteren waarop externe bibliotheken worden geladen in het Microsoft Active Accessibility-onderdeel.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2564958$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2564958">Microsoft Knowledge Base-artikel 2564958</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Voor alle ondersteunde 32-bits en x64-edities van Windows Server 2003:  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
Voor alle ondersteunde 32-bits en x64-edities van Windows Server 2003:  
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2564958$\\Spuninst
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Voor alle ondersteunde Itanium-edities van Windows Server 2003:  
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2605295$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Voor alle ondersteunde 32-bits en x64-edities van Windows Server 2003:  
Zie [Microsoft Knowledge Base-artikel 2564958](http://support.microsoft.com/kb/2564958)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Voor alle ondersteunde Itanium-edities van Windows Server 2003:  
Zie [Microsoft Knowledge Base-artikel 2605295](http://support.microsoft.com/kb/2605295)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](http://contagiodump.com), in samenwerking met Anshul Kothari en Nishant Kaushik van [Adobe Systems, Inc.](http://www.adobe.com), voor het melden van het beveiligingslek in Active Accessibility met betrekking tot het onveilig laden van bibliotheken (CVE-2011-1247)
...
-   V1.1 (12 oktober 2011): De informatie over het vervangen van het bulletin is verbeterd voor alle ondersteunde edities van Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2. Het gaat alleen om een wijziging in de informatie. Er waren geen veranderingen in de detectielogica of de updatebestanden.  
-   Versie 1.2 (25 oktober 2011): De bestandsnamen van de updates voor 32-bits en x64-edities van Windows XP en Windows Server 2003 zijn herzien in overeenstemming met het schema dat in Microsoft Knowledge Base-artikel KB816915 is gedocumenteerd. Dit is alleen een wijziging van de bestandsnamen. Er zijn geen veranderingen in de detectielogica of de inhoud van de updates. Klanten die deze update al hebben geïnstalleerd, hoeven geen actie te ondernemen.
