---
TOCTitle: 'MS11-076'
Title: 'Microsoft-beveiligingsbulletin MS11-076 - Belangrijk'
ms:assetid: 'ms11-076'
ms:contentKeyID: 61232043
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-076(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-076 - Belangrijk
====================================================

Door een beveiligingslek in Windows Media Center kan externe code worden uitgevoerd (2604926)
---------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde edities van Windows Vista en Windows 7; en voor Windows Media Center TV Pack voor Windows Vista. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op door de manier te verbeteren waarop Windows Media Center externe bibliotheken laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=76fcf0ec-9062-4090-acb2-401355341a2b">Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1</a><br />
(KB2579686)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=78c099b7-4bcb-4da7-8967-512c6541c541">Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1</a><br />
(KB2579686)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=60e50f72-4001-423c-831c-8ff1f1b8f090">Windows Media Center TV Pack voor Windows Vista (32-bits edities</a>)[2]<br />
(KB2579692)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=371c7dab-5aa6-4502-80ee-ae69b736b972">Windows Media Center TV Pack voor Windows Vista (64-bits edities</a>)[2]<br />
(KB2579692)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;">Geen</td>
...
Windows Media Center TV Pack voor Windows Vista is alleen verkrijgbaar op OEM-installaties (Original Equipment Manufacturer) van de Home Premium- en Ultimate-edities van Windows Vista als een optioneel onderdeel. Klanten die dit optionele onderdeel hebben geïnstalleerd op hun x64-systeem, moeten beide beschikbare updates installeren. Microsoft raadt u aan de update voor het besturingssysteem (KB2579686) te installeren voordat u de update voor Windows Media Center TV Pack (KB2579692) installeert. Klanten die Windows Media Center TV Pack hebben geïnstalleerd op een 32-bits systeem, moeten alleen KB2579692 installeren.
...
<span></span>
Bij de volgende prioriteitsniveaus is uitgegaan van de potentiële maximale uitwerking van het beveiligingslek. Raadpleeg binnen 30 dagen na het uitbrengen van dit beveiligingsbulletin de exploitatie-index in de [samenvatting van de bulletins voor oktober](http://technet.microsoft.com/en-us/security/bulletin/ms11-oct) voor informatie over de waarschijnlijkheid van misbruik van dit beveiligingslek in samenhang met het prioriteitsniveau en de maximale omvang van het lek. Zie voor meer informatie de [exploitatie-index van Microsoft](http://technet.microsoft.com/en-us/security/cc998259.aspx).
...
<th style="border:1px solid black;" >Beveiligingslek in Media Center met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2009</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek in Media Center met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2009  
------------------------------------------------------------------------------------------------------
  
<span></span>
Er is een beveiligingslek met betrekking tot de uitvoering van externe code door de manier waarop Windows Media Center het laden van DLL-bestanden afhandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.
  
Zie [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Media Center met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2009
...
#### Tijdelijke oplossingen voor het beveiligingslek in Media Center met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2009
...
#### Veelgestelde vragen over het beveiligingslek in Media Center met betrekking tot het onveilig laden van bibliotheken - CVE-2011-2009
...
Het beveiligingslek wordt veroorzaakt doordat Windows Media Player het pad dat wordt gebruikt voor het laden van externe bibliotheken niet goed beperkt.
...
Een aanvaller kan een gebruiker ertoe overhalen om een legitiem bestand te openen dat zich in dezelfde netwerkmap bevindt als een speciaal vervaardigd DLL-bestand (Dynamic Link Library). Wanneer het legitieme bestand wordt geopend, kan Windows Media Center proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
  
In een aanval per e-mail kan een aanvaller misbruik maken van het beveiligingslek door een legitiem bestand naar een gebruiker te sturen en de gebruiker ertoe over te halen de bijlage in een directory met een speciaal vervaardigd DLL-bestand te plaatsen en het legitieme bestand te openen. Wanneer het legitieme bestand wordt geopend, kan Windows Media Center proberen het DLL-bestand te laden en eventuele code in dit bestand uit te voeren.
...
**Wat doet de update?**  
De update lost het beveiligingslek op door de manier te verbeteren waarop Windows Media Center externe bibliotheken laadt.
...
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009) toegewezen.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2579686">Microsoft Knowledge Base-artikel 2579686</a></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2579692">Microsoft Knowledge Base-artikel 2579692</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
<td style="border:1px solid black;"><strong>Opmerking</strong> Er bestaat geen registratiesleutel waarmee de aanwezigheid van deze update kan worden gevalideerd.</td>
