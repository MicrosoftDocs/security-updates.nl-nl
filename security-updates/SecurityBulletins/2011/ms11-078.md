---
TOCTitle: 'MS11-078'
Title: 'Microsoft-beveiligingsbulletin MS11-078 - Kritiek'
ms:assetid: 'ms11-078'
ms:contentKeyID: 61232045
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-078(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-078 - Kritiek
=================================================

Beveiligingslek in .NET Framework en Microsoft Silverlight kan leiden tot uitvoering van externe code (2604930)
---------------------------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van dit beveiligingsupdate is kritiek voor Microsoft .NET Framework 1.0 Service Pack 3, Microsoft .NET Framework 1.1 Service Pack 1, Microsoft .NET Framework 2.0 Service Pack 2, Microsoft .NET Framework 3.5.1 en Microsoft .NET Framework 4 op alle ondersteunde edities van Microsoft Windows, en voor Microsoft Silverlight 4. Voor meer informatie, zie de subsectie, **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt**, in dit onderdeel.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop het .NET Framework erfenis binnen klassen beperkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2604930](http://support.microsoft.com/kb/2604930) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<td style="border:1px solid black;">
KB953295 in [MS09-061](http://go.microsoft.com/fwlink/?linkid=160527) is vervangen door KB2572066  
KB2416447 in [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409) is vervangen door KB2572067  
KB983583 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) is vervangen door KB2572073  
Geen bulletin vervangen door KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB953298 in [MS09-061](http://go.microsoft.com/fwlink/?linkid=?????) is vervangen door KB2572069  
KB983583 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) is vervangen door KB2572073  
Geen bulletin vervangen door KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB2416447 in [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409) is vervangen door KB2572067  
KB983589 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) is vervangen door KB2572075  
Geen bulletin vervangen door KB2572078
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
Geen bulletin vervangen door KB2572076  
Geen bulletin vervangen door KB2572078
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
Geen bulletin vervangen door KB2572077  
Geen bulletin vervangen door KB2572078
</td>
</tr>
<tr>
...
De herdistribueerbare pakketten van .NET Framework versie 4 zijn beschikbaar in twee profielen: .NET Framework 4 en .NET Framework 4 Client Profile. .NET Framework 4 Client Profile is een subset van het .NET Framework 4-profiel dat voor clienttoepassingen is geoptimaliseerd. Het biedt functionaliteit voor de meeste clienttoepassingen, waaronder Windows Presentation Foundation (WPF), Windows Forms, Windows Communication Foundation (WCF) en ClickOnce-functies. Hierdoor is snellere implementatie mogelijk evenals een kleiner installatiepakket voor toepassingen die zijn gericht op .NET Framework 4 Client Profile. Voor meer informatie raadpleegt u het MSDN-artikel [.NET Framework Client Profile](http://msdn.microsoft.com/en-us/library/5a4x27ek.aspx).

**Welke webbrowsers ondersteunen Microsoft Silverlight-toepassingen?**
Voor het uitvoeren van Microsoft Silverlight-toepassingen moet bij de meeste webbrowsers, inclusief Microsoft Internet Explorer, Microsoft Silverlight zijn geïnstalleerd en de bijbehorende invoegtoepassing zijn ingeschakeld. Zie de officiële website van [Microsoft Silverlight](http://www.microsoft.com/silverlight/) voor meer informatie over Microsoft Silverlight. In de documentatie van uw browser kunt u vinden hoe u invoegtoepassingen kunt uitschakelen of verwijderen.

**Welke versies van Microsoft Silverlight 4 worden door het beveiligingslek getroffen?**
Microsoft Silverlight-build 4.0.60831, de huidige build van Microsoft Silverlight op het moment dat dit bulletin het eerst wordt uitgegeven, lost het beveiligingslek op en heeft er dus geen last van. Builds van Microsoft Silverlight vóór 4.0.60831 worden wel getroffen.
...
De versie die met deze beveiligingsupdate wordt geïnstalleerd is 4.0.60831. Als uw versienummer hoger is dan of gelijk is aan dit versienummer, loopt uw systeem geen gevaar.
...
**Worden de Silverlight 5 Beta- of Release Candidate-versies getroffen door dit beveiligingslek?**
Nee, geen enkele versie van Silverlight 5 wordt door dit probleem getroffen.
...
In dit bulletin wordt een beveiligingslek in de functielagen van .NET Framework 1.1, .NET Framework 2.0 en .NET Framework 4 beschreven. Het installatieprogramma van .NET Framework 3.0 Service Pack 2 omvat de installatie van .NET Framework 2.0 Service Pack 2. Als u het eerste Service Pack installeert, installeert u dus ook het tweede. Daarom moeten klanten die .NET Framework 3.0 Service Pack 2 hebben geïnstalleerd, beveiligingsupdates voor .NET Framework 2.0 Service Pack 2 installeren.

**Ik heb .NET Framework 3.5 Service Pack 1 geïnstalleerd. Moet ik updates installeren?**
In dit bulletin wordt een beveiligingslek in de .NET Framework 1.1-functielaag, .NET Framework 2.0-functielaag en .NET Framework 4 beschreven. Het .NET Framework 3.5 Service Pack 1-installatieprogramma omvat zowel de installatie van .NET Framework 2.0 Service Pack 2 als de installatie van .NET Framework 3.0 Service Pack 2. Daarom moeten klanten die .NET Framework 3.5 Service Pack 1 hebben geïnstalleerd, beveiligingsupdates voor .NET Framework 2.0 Service Pack 2 installeren.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot erfenis van .NET Framework-klassen - CVE-2011-1253
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Silverlight 4 op alle versies van Microsoft Windows-clients
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
<tr>
<td style="border:1px solid black;">
Microsoft Silverlight 4 op alle versies van Microsoft Windows-servers\*\*
</td>
<td style="border:1px solid black;">
**Kritiek**  
Uitvoering van externe code mogelijk
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot erfenis van .NET Framework-klassen - CVE-2011-1253
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot erfenis van .NET Framework-klassen - CVE-2011-1253
...
Het beveiligingslek wordt veroorzaakt doordag .NET Framework erfenis binnen klassen op onjuiste wijze beperkt.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2604930">Microsoft Knowledge Base-artikel 2604930</a></td>
</tr>
<tr class="odd">
...
**De update installeren voor Microsoft .NET Framework 1.0 Service Pack 3 (KB2572066)**
...
**De update installeren voor Microsoft .NET Framework 1.1 Service Pack 1 (KB2572067)**
...
****De update verwijderen voor** **Microsoft .NET Framework 2.0 Service Pack 2**(KB2572073)en** **Microsoft .NET Framework 4(KB2572078)**
...
**De update verwijderen voor Microsoft .NET Framework 1.0 Service Pack 3** **(KB2572066)**
...
**De update verwijderen voor Microsoft .NET Framework 1.1 Service Pack 1 (KB2572067)**
...
**De update verwijderen voor Microsoft .NET Framework 2.0 Service Pack 2 (KB2572073** **en Microsoft .NET Framework 4.0 (KB2572078)**
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 1.1 Service Pack 1 op Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 1.1 Service Pack 1 op Windows Server 2003 Itanium-editie Service Pack 2:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
**De update installeren voor Microsoft .NET Framework 1.1 Service Pack 1** **op** **Windows Server 2003 Service Pack 2** **(KB2572069)**

Deze beveiligingsupdate ondersteunt de volgende installatieschakelopties voor Microsoft .Net Framework 1.1 Service Pack 1 op Windows Server 2003 Service Pack 2 (KB2572069).
...
**De update installeren voor Microsoft .NET Framework 1.1 Service Pack 1** **op Windows Server 2003 x64 Edition Service Pack 2** **en** **Windows Server 2003 Itanium-edities Service Pack 2** **(KB2572067)**
...
**De update verwijderen voor** **Microsoft .NET Framework 1.1 Service Pack 1 op Windows Server 2003 Service Pack 2 (KB2572069)**
...
**De update verwijderen** **voor** **Microsoft .NET Framework 1.1 Service Pack 1 op Windows Server 2003 x64 Edition Service Pack 2 en Windows Server 2003 Itanium-edities Service Pack 2 (KB2572067)**
...
**De update installeren voor Microsoft .NET Framework 2.0 Service Pack 2 (KB2572075)**
...
**De update installeren voor Microsoft .NET Framework 4 (KB2572078)**
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Voor Microsoft .NET Framework 1.1 Service Pack 1 op Windows Server 2008 voor x64-bits systemen Service Pack 2:<br />
...
-   Een anonieme medewerker aan het [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html)-programma voor het melden van het beveiligingslek met betrekking tot erfenis van .NET Framework-klassen (CVE-2011-1253)
...
-   V1.1 (19 oktober 2011): De informatie over schakelopties voor installatie zonder opnieuw opstarten is verbeterd voor Microsoft .NET Framework 1.1 Service Pack 1. Het gaat alleen om een wijziging in de informatie. De detectielogica en bestanden van de beveiligingsupdate zijn niet gewijzigd.
