---
TOCTitle: 'MS11-081'
Title: 'Microsoft-beveiligingsbulletin MS11-081 - Kritiek'
ms:assetid: 'ms11-081'
ms:contentKeyID: 61232048
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-081(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-081 - Kritiek
=================================================

Cumulatieve beveiligingsupdate voor Internet Explorer (2586448)
---------------------------------------------------------------

Gepubliceerd: dinsdag 11 oktober 2011 | Bijgewerkt: woensdag 2 november 2011
...
Het prioriteitsniveau van deze beveiligingsupdate is Kritiek voor Internet Explorer op Windows-clients en Gemiddeld voor Internet Explorer op Windows-servers. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De update lost de beveiligingslekken op doordat de manier wordt gewijzigd waarop Internet Explorer objecten in het geheugen verwerkt en de manier waarop Internet Explorer geheugen toewijst en gebruikt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2586448](http://support.microsoft.com/kb/2586448) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht. Wanneer bekende problemen en aanbevolen oplossingen alleen betrekking hebben op specifieke versies van deze software, vindt u in dit artikel koppelingen naar andere artikelen.
...
<span></span>
**Waarom zijn er op** **2** **november 2011** **wijzigingen in dit bulletin aangebracht?**
Microsoft heeft wijzigingen in dit bulletin aangebracht om een hotfix aan te kondigen waarmee een probleem in Internet Explorer 7 wordt opgelost, waarbij bepaalde vervolgkeuzelijsten en keuzelijsten met invoervakken niet worden weergegeven in Internet Explorer 7 nadat de beveiligingsupdate van KB2586448 is geïnstalleerd. Zie [Microsoft Knowledge Base-artikel 2586448](http://support.microsoft.com/kb/2586448) voor meer informatie over dit probleem en instructies voor het toepassen van de hotfix om het probleem op te lossen.
...
Ja. Naast de wijzigingen die worden genoemd in de sectie Informatie over het beveiligingslek van dit bulletin, bevat deze update een ingrijpende update om de geheugenbeveiliging, het beheer van frames en cookies, de Bing API en het XSS-filter in Internet Explorer te verbeteren.
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot uitvoering van externe code bij bladeren - CVE-2011-1993
</th>
<th style="border:1px solid black;" >
Beveiligingslek in OLEAuto32.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1995
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot uitvoering van externe code in opties - CVE-2011-1996
</th>
<th colspan="2">
Beveiligingslek in OnLoad met betrekking tot het uitvoeren van externe code - CVE-2011-1997
</th>
</tr>
<tr>
<th colspan="6">
...
<th style="border:1px solid black;" >
Beveiligingslek in Jscript9.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1998
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot uitvoering van externe code bij selecties - CVE-2011-1999
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot uitvoering van externe code in berichtteksten - CVE-2011-2000
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot uitvoering van externe code door beschadiging van virtuele functietabellen - CVE-2011-2001
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
Zie [CVE-2011-1993](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code bij bladeren - CVE-2011-1993
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code bij bladeren - CVE-2011-1993
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code bij bladeren - CVE-2011-1993
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer objecten opent die niet goed zijn geïnitialiseerd. Het beveiligingslek kan geheugen op dusdanige wijze ontregelen dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.

Zie [CVE-2011-1995](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in OLEAuto32.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1995
...
#### Tijdelijke oplossingen voor het beveiligingslek in OLEAuto32.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1995
...
#### Veelgestelde vragen over het beveiligingslek in OLEAuto32.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1995

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Wanneer Internet Explorer toegang probeert te krijgen tot een object dat niet is geïnitialiseerd, kan het geheugen dusdanig worden ontregeld dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.
...
Zie [CVE-2011-1996](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in opties - CVE-2011-1996
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in opties - CVE-2011-1996
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in opties - CVE-2011-1996
...
Zie [CVE-2011-1997](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in OnLoad met betrekking tot het uitvoeren van externe code - CVE-2011-1997
...
#### Tijdelijke oplossingen voor het beveiligingslek in OnLoad met betrekking tot het uitvoeren van externe code - CVE-2011-1997
...
#### Veelgestelde vragen over het beveiligingslek in OnLoad met betrekking tot het uitvoeren van externe code - CVE-2011-1997
...
Zie [CVE-2011-1998](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek in Jscript9.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1998
...
#### Tijdelijke oplossingen voor het beveiligingslek in Jscript9.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1998
...
#### Veelgestelde vragen over het beveiligingslek in Jscript9.dll met betrekking tot het uitvoeren van externe code - CVE-2011-1998
...
**Hoe kan een aanvaller dit beveiligingslek misbruiken?**
Een aanvaller kan over een website beschikken die speciaal is ontworpen om via Internet Explorer misbruik te maken van dit lek, en vervolgens de gebruiker ertoe overhalen deze website te bekijken en er bewerkingen op uit te voeren. De aanvaller zou ook misbruik kunnen maken van gemanipuleerde websites en websites die inhoud of advertenties van gebruikers accepteren of hosten. Deze websites kunnen speciaal vervaardigde inhoud bevatten, die misbruik van dit beveiligingslek kan maken. Een aanvaller kan een gebruiker er echter niet toe dwingen de inhoud van de aanvaller weer te geven. In plaats daarvan zou een aanvaller gebruikers ertoe moeten overhalen een handeling uit te voeren, doorgaans door op een koppeling in een e-mailbericht of een Instant Messenger-bericht te klikken, waardoor de gebruiker naar de website van de aanvaller gaat, of door een bijlage bij een e-mail te openen.
...
<span></span>
Er is een beveiligingslek met betrekking tot het uitvoeren van externe code in de manier waarop Internet Explorer een geheugenadres waarvan de referentie is verwijderd, opent. Het beveiligingslek kan geheugen op dusdanige wijze ontregelen dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.

Zie [CVE-2011-1999](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code bij selecties - CVE-2011-1999
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code bij selecties - CVE-2011-1999
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code bij selecties - CVE-2011-1999

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Wanneer Internet Explorer in bepaalde omstandigheden probeert toegang te krijgen tot een geheugenadres waarvan de referentie is verwijderd, kan het geheugen zodanig ontregeld raken dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Internet Explorer geheugen toewijst en gebruikt.
...
Zie [CVE-2011-2000](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code in berichtteksten - CVE-2011-2000
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code in berichtteksten - CVE-2011-2000
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code in berichtteksten - CVE-2011-2000
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code door de manier waarop Internet Explorer toegang krijgt tot een virtuele functietabel nadat deze is beschadigd. Het beveiligingslek kan geheugen op dusdanige wijze ontregelen dat een aanvaller willekeurige code kan uitvoeren in de context van de aangemelde gebruiker.

Zie [CVE-2011-2001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot uitvoering van externe code door beschadiging van virtuele functietabellen - CVE-2011-2001
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot uitvoering van externe code door beschadiging van virtuele functietabellen - CVE-2011-2001
...
#### Veelgestelde vragen over het beveiligingslek met betrekking tot uitvoering van externe code door beschadiging van virtuele functietabellen - CVE-2011-2001

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op de uitvoering van externe code. Een aanvaller die erin slaagt misbruik te maken van dit beveiligingslek, kan dezelfde rechten over het systeem krijgen als de lokale gebruiker. Gebruikers met accounts waarvoor minder gebruikersrechten op het systeem zijn ingesteld, lopen minder risico dan gebruikers die met beheerdersrechten werken.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Wanneer Internet Explorer probeert toegang te krijgen tot een beschadigde virtuele functietabel te hebben, kan een aanvaller willekeurige code uitvoeren in de context van de aangemelde gebruiker.
...
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2586448$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie7updates\KB2586448-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 voor alle ondersteunde edities van Windows XP:<br />
Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\ie8updates\KB2586448-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2586448">Microsoft Knowledge Base-artikel 2586448</a></td>
</tr>
<tr class="even">
...
-   Vishwas Sharma van McAfee Labs voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code bij bladeren (CVE-2011-1993)  
-   David Bloom van [Greplin](https://www.greplin.com) voor het melden van het beveiligingslek in OLEAuto32.dll met betrekking tot het uitvoeren van externe code (CVE-2011-1995)  
-   Ivan Fratric, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in opties (CVE-2011-1996)  
-   [GWSlabs](http://www.gwslabs.com), in samenwerking met [VeriSign iDefense Labs](http://labs.idefense.com), voor het melden van het beveiligingslek in OnLoad met betrekking tot het uitvoeren van externe code (CVE-2011-1997)  
-   David Bloom van [Greplin](https://www.greplin.com) voor het melden van het beveiligingslek in Jscript9.dll met betrekking tot het uitvoeren van externe code (CVE-2011-1998)  
-   Ivan Fratric, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code bij selecties (CVE-2011-1999)  
-   Sebastian Apelt, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code in berichtteksten (CVE-2011-2000)  
-   Een anonieme onderzoeker, in samenwerking met [Zero Day Initiative](http://www.zerodayinitiative.com/) van [TippingPoint](http://www.tippingpoint.com), voor het melden van het beveiligingslek met betrekking tot uitvoering van externe code door beschadiging van virtuele functietabellen (CVE-2011-2001)  
-   Eduardo Vela Nava van [Google Inc.](http://www.google.com) en David Bloom van [Greplin](https://www.greplin.com) voor de samenwerking bij het ontwikkelen van ingrijpende wijzigingen die zijn beschreven in dit bulletin  
-   [Soroush Dalili](http://www.secproject.com) voor de samenwerking bij het ontwikkelen van ingrijpende wijzigingen die zijn beschreven in dit bulletin  
-   Billy Rios van [Google Inc.](http://www.google.com) voor de samenwerking bij het ontwikkelen van ingrijpende wijzigingen die zijn beschreven in dit bulletin
...
-   V1.1 (12 oktober 2011): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2586448 onder Bekende problemen in de Samenvatting.  
-   V1.2 (2 november 2011): Aankondiging van de publicatie van een hotfix om een bekend probleem op te lossen om dat optreedt in Internet Explorer 7 nadat de beveiligingsupdate van KB2586448 is geïnstalleerd. Zie de veelgestelde vragen in de update voor details.
