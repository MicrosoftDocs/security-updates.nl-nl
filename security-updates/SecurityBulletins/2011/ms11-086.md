---
TOCTitle: 'MS11-086'
Title: 'Microsoft-beveiligingsbulletin MS11-086 - Belangrijk'
ms:assetid: 'ms11-086'
ms:contentKeyID: 61232053
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-086(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS11-086 - Belangrijk
====================================================

Beveiligingslek in Active Directory kan leiden tot misbruik van bevoegdheden (2630837)
--------------------------------------------------------------------------------------
...
De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Active Directory certificaten verifieert op basis van de Certificate Revocation List (CRL). Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6">Active Directory and Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=190509">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965">Active Directory and Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=190509">MS10-068</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9">Active Directory and Active Directory Lightweight Directory Service (AD LDS)</a>*<br />
(KB2601626)</td>
<td style="border:1px solid black;">Misbruik van bevoegdheden</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=190509">MS10-068</a></td>
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot het niet uitvoeren van LDAPS-verificatie- - CVE-2011-2014  
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau  
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in Active Directory wanneer Active Directory is geconfigureerd voor het gebruik van LDAP over SSL (LDAPS). Een aanvaller kan misbruik maken van dit beveiligingslek door een eerder ingetrokken certificaat te gebruiken om zich aan te melden bij het Active Directory-domein en daardoor toegang te krijgen tot netwerkbronnen of code uit te voeren onder de bevoegdheden van een specifieke bevoegde gebruiker aan wie het certificaat is gekoppeld.

Zie [CVE-2011-2014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot het niet uitvoeren van LDAPS-verificatie - CVE-2011-2014
...
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot het niet uitvoeren van LDAPS-verificatie - CVE-2011-2014

Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:

-   **Het** **gebruikers** **account** **verwijderen van het domein waarop het ingetrokken** **certificaat betrekking had.**
-   **Verbindingen op basis van IPsec in de modus "CRL altijd controleren" gebruiken naast LDAPS.**

    Zie het TechNet-artikel [Certificate revocation list (CRL) verification - an application choice](http://social.technet.microsoft.com/wiki/contents/articles/964.aspx) voor informatie over het inschakelen van CRL-controles met IPsec.

    **Opmerkingen**

    1.  IPSec gebruiken om de verbinding met LDAPS te versleutelen en te beschermen met certificaatverificatie met CRL-controle.
    2.  IPSec gebruiken om de verbinding met LDAPS te beschermen met certificaatverificatie met CRL-controle, zonder versleuteling. In dit geval zorgt LDAPS voor de versleuteling.

        In getroffen edities van Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2 kan AuthIP (de IPSec-uitbreiding voor gebruikersverificatie) worden gebruikt om te voorkomen dat een aanvaller IPsec-certificaatverificaties uitvoert met een machinecertificaat en vervolgens het ingetrokken gebruikerscertificaat gebruikt om LDAPS-verificatie uit te voeren.

    3.  NULL-inkapseling gebruiken voor LDAPS om dubbele versleuteling te voorkomen en herkennen dat de certificaatverificatie op IPsec-niveau onafhankelijk is van de verificatie in SSL. Dit betekent dan het gebruik van verschillende certificaten in elke laag er nog steeds toe kan leiden dat via het verlopen certificaat toegang kan worden verkregen tot LDAPS.

#### Veelgestelde vragen over het beveiligingslek met betrekking tot het niet uitvoeren van LDAPS-verificatie - CVE-2011-2014

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan toegang krijgen tot netwerkbronnen of code uitvoeren met de bevoegdheden van een specifiek bevoegde gebruiker.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Het beveiligingslek wordt veroorzaakt wanneer Active Directory wordt geconfigureerd voor het gebruik van LDAPS en de ingetrokken status van een SSL-certificaat niet wordt gecontroleerd op basis van de CRL die aan het domeinaccount is gekoppeld. Daardoor kan een certificaat zelfs nadat het is ingetrokken door de certificeringsinstantie als geldig worden beschouwd.
...
**Wat** **isActive Directory** **Services?**
...
**CRL is een digitaal ondertekende lijst, uitgegeven door een certificeringsinstantie, met certificaten die door de certificeringsinstantie zijn uitgegeven en daarna door de certificeringsinstantie zijn ingetrokken. Voor elk afzonderlijk ingetrokken certificaat vermeldt de lijst het serienummer van het certificaat, de datum waarop het certificaat is ingetrokken en de reden van intrekking. Toepassingen kunnen een CRL-controle uitvoeren om de intrekkingsstatus van een bepaald certificaat na te gaan. Voor meer informatie over de controle op ingetrokken certificaten, raadpleegt u het TechNet-artikel [Certificate Revocation and Status Checking](http://technet.microsoft.com/en-us/library/ee619730(ws.10).aspx).

**Wat is LDAP over SSL** **(LDAPS)?
**LDAP over SSL (LDAPS) versleutelt verkeer tussen clientcomputers en servercomputers met een Secure Sockets Layer- of Transport Layer Security-technologie (SSL of TLS).
...
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan toegang krijgen tot netwerkbronnen of code uitvoeren met de bevoegdheden van een specifiek bevoegde gebruiker. Als de gebruiker beheerdersbevoegdheden heeft, kan een aanvaller programma's installeren, gegevens weergeven, wijzigen of verwijderen, of nieuwe accounts met volledige gebruikersrechten maken.

**Hoe kan een aanvaller dit beveiligingslek** **misbruiken?**
Een aanvaller kan alleen misbruik maken van dit beveiligingslek als hij eerst een ingetrokken certificaat dat is gekoppeld aan een geldig account op het domein bemachtigt. Een aanvaller kan vervolgens misbruik maken van dit beveiligingslek door dit eerder ingetrokken certificaat te gebruiken om zich aan te melden bij het Active Directory-domein en daardoor toegang te krijgen tot netwerkbronnen of code uit te voeren onder de bevoegdheden van een specifieke bevoegde gebruiker aan wie het certificaat is gekoppeld.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop Active Directory de geldigheid van certificaten verifieert op basis van de CRL.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2616310$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2616310">Microsoft Knowledge Base-artikel 2616310</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik voor Active Directory het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2601626$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Gebruik voor Active Directory Application Mode (ADAM) het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2616310$\\Spuninst
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2601626](http://support.microsoft.com/kb/2601626) voor Active Directory op Windows Server 2003
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2616310](http://support.microsoft.com/kb/2616310) voor Active Directory Application Mode (ADAM) op Windows Server 2003
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2601626">Microsoft Knowledge Base-artikel 2601626</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
...
-   Xavier Lassoie en Sébastien Godard van Autosécurité voor het melden van het beveiligingslek met betrekking tot het niet uitvoeren van LDAPS-verificatie - (CVE-2011-2014)
