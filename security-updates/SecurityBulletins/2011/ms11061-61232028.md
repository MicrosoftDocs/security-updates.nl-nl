---
TOCTitle: 'MS11-061'
Title: 'Microsoft-beveiligingsbulletin MS11-061 - Belangrijk'
ms:assetid: 'ms11-061'
ms:contentKeyID: 61232028
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms11-061(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS11-061 - Belangrijk
====================================================

Beveiligingslek in Extern bureaublad-webtoegang kan leiden tot misbruik van bevoegdheden (2546250)
--------------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor ondersteunde edities van Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt verbeterd waarop de aanmeldingspagina voor Extern bureaublad-webtoegang invoerparameters valideert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2546250](http://support.microsoft.com/kb/2546250) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=777f3bbe-094c-411d-879d-34a5a20ae7f3)\*\* | Misbruik van bevoegdheden               | Belangrijk        | Geen                                            |
...
<span></span>
**Ik heb mijn ASP-internetregistratiepagina's aangepast. Moet ik mij zorgen maken om de bekende problemen die worden opgesomd in Microsoft Knowledge Base-artikel 2546250?**  
Ja, Microsoft raadt klanten die hun ASP-internetregistratiepagina's hebben bewerkt aan om naar [Microsoft Knowledge Base-artikel 2546250](http://support.microsoft.com/kb/2546250) te gaan voor belangrijke informatie over bekende problemen die van toepassing kunnen zijn op hun systemen.
...
<th style="border:1px solid black;" >Beveiligingslek in Extern bureaublad-webtoegang - CVE-2011-1263</th>
...
Beveiligingslek in Extern bureaublad-webtoegang - CVE-2011-1263  
---------------------------------------------------------------
  
<span></span>
Er bestaat een niet-aanhoudend beveiligingslek met betrekking tot cross-site scripting (XSS) in Extern bureaublad-webtoegang waardoor een aanvaller een script op een client in de Internet Explorer-versie van de gebruiker kan injecteren. Het script zou inhoud kunnen vervalsen, informatie kunnen vrijgeven of elke actie kunnen uitvoeren die de gebruiker kan uitvoeren op de website voor Extern bureaublad-webtoegang.
  
Zie [CVE-2011-1263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1263) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek in Extern bureaublad-webtoegang - CVE-2011-1263
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Het XSS-filter in Internet Explorer 8 en Internet Explorer 9 blokkeert deze aanval wanneer de gebruiker naar een server voor Extern bureaublad-webtoegang navigeert in de zone Internet. Het XSS-filter in Internet Explorer 8 en Internet Explorer 9 is niet standaard in de zone Lokaal intranet ingeschakeld.  
...
-   Extern bureaublad-webtoegang is niet standaard geïnstalleerd. U moet de service voor Extern bureaublad-webtoegang installeren op de server waarmee gebruikers verbinding moeten maken om toegang te krijgen tot RemoteApp-programma's. Wanneer u Extern bureaublad-webtoegang installeert, wordt Microsoft Internet Information Services (IIS) ook geïnstalleerd als een vereist onderdeel.
  
#### Tijdelijke oplossingen voor het beveiligingslek in Extern bureaublad-webtoegang - CVE-2011-1263
...
-   **Internet Explorer 8 en Internet Explorer 9 XSS filter voor zone Lokaal intranet inschakelen**
    ...
    **De tijdelijke oplossing ongedaan maken.**
    ...
    3.  Klik onder **Beveiligingsniveau voor deze zone** op **Aangepast niveau…**  
    4.  Blader naar **XSS-filter inschakelen** (onder in de lijst).  
    5.  Wijzig de standaardinstelling **Inschakelen** in **Uitschakelen**.  
    6.  Klik op **OK** en klik vervolgens op **Ja** in het dialoogvenster **Weet u zeker dat u de instellingen voor deze zone wilt wijzigen?**.  
    7.  Klik op **OK** op het dialoogvenster **Internet-opties**.
  
#### Veelgestelde vragen over het beveiligingslek in Extern bureaublad-webtoegang - CVE-2011-1263
...
Het beveiligingslek wordt veroorzaakt wanneer de aanmeldingspagina voor Extern bureaublad-webtoegang een URL-parameter onjuist valideert.
  
**Wat is Extern bureaublad-webtoegang?**    
Extern bureaublad-webtoegang is een service in de rol Extern bureaublad-services waarmee u RemoteApp-programma's, virtuele bureaubladen en bureaubladen op sessiebasis via een webbrowser beschikbaar kunt stellen aan gebruikers. Daarnaast kunnen gebruikers met Extern bureaublad-webtoegang via een webbrowser verbinding maken met het externe bureaublad van een server of computer waarvoor zij de juiste bevoegdheden hebben. Zie het TechNet-artikel [Remote Desktop Web Access](http://technet.microsoft.com/en-us/library/ff608245(ws.10).aspx) voor meer informatie.
...
Dit beveiligingslek vormt het grootste risico voor servers waarop de rol voor Extern bureaublad-webtoegang wordt uitgevoerd. Servers waarop deze specifieke rol niet wordt uitgevoerd, lopen geen risico.
  
**Wat doet de update?**    
De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop de aanmeldingspagina voor Extern bureaublad-webtoegang invoerparameters valideert.
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2546250">Microsoft Knowledge Base-artikel 2546250</a></td>
</tr>
<tr class="odd">
...
-   Sven Taute voor het melden van het beveiligingslek in Extern bureaublad-webtoegang (CVE-2011-1263)
