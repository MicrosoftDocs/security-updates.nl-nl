---
TOCTitle: 'MS12-001'
Title: 'Microsoft-beveiligingsbulletin MS12-001 - Belangrijk'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61232068
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-001(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS12-001 - Belangrijk
====================================================

Door een beveiligingslek in de Windows-kernel kan een beveiligingsfunctie worden omzeild (2644615)
--------------------------------------------------------------------------------------------------

Gepubliceerd: dinsdag 10 januari 2012 | Bijgewerkt: woensdag 22 februari 2012
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle ondersteunde x64-edities van Windows XP en alle ondersteunde edities van Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 en Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de Windows-kernel gestructureerde uitzonderingshandlertabellen laadt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2644615](http://support.microsoft.com/kb/2644615) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-------------------|-------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                              | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                              | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                  | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2003 met SP2 voor Itanium-systemen](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                               | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                    | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                        | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor 32-bits systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                      | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor x64-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                          | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2008 voor Itanium-systemen Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                        | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows 7 voor 32-bits systemen en Windows 7 voor 32-bits systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                           | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows 7 voor x64-systemen en Windows 7 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
| [Windows Server 2008 R2 voor Itanium-systemen en Windows Server 2008 R2 voor Itanium-systemen met Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Omzeiling van beveiligingsfunctie       | Belangrijk        | Geen                                            |
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel - CVE-2012-0001</th>
...
Beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel - CVE-2012-0001  
---------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot omzeiling van de beveiligingsfunctie in Windows door de manier waarop de kernel de gestructureerde uitzonderingshandlertabellen laadt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan het ingrijpende SafeSEH-beveiligingsmechanisme omzeilen om misbruik van andere beveiligingslekken te vereenvoudigen.
  
Zie [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel - CVE-2012-0001
  
Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:
  
-   Alleen softwaretoepassingen die zijn gecompileerd met Microsoft Visual C++ .NET 2003 kunnen worden gebruikt om misbruik te maken van dit beveiligingslek.
  
    **Opmerking** Zie [Microsoft Knowledge Base-artikel 2644615](http://support.microsoft.com/kb/2644615) voor meer informatie over hoe u kunt vaststellen welk product is gebruikt om een bepaalde softwaretoepassing te compileren.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel - CVE-2012-0001
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **Software** **opnieuw compileren** **me** **t een nieuwere versie van** **Microsoft Visual** **C++**
  
    Alleen softwaretoepassingen die zijn gecompileerd met Microsoft Visual C++ .NET 2003 kunnen worden gebruikt om misbruik te maken van dit beveiligingslek. U kunt dit probleem tijdelijk oplossen door het model opnieuw te compileren met Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 of Microsoft Visual C++ 2010.
  
-   **Structured Exception Handling Overwrite Protection** **(SEHOP) inschakelen**
  
    Voor Windows Vista, Windows 7, Windows Server 2008 en Windows Server 2008 R2: zie [How to enable Structured Exception Handling Overwrite Protection (SEHOP) in Windows operating systems](http://support.microsoft.com/kb/956607) voor instructies voor het inschakelen van SEHOP voor bestaande toepassingen.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel - CVE-2012-0001
  
**Wat is de omvang van het beveiligingslek?**  
Dit is een beveiligingslek met betrekking tot omzeiling van een beveiligingsfunctie. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan de SafeSEH-beveiligingsfunctie omzeilen om misbruik van andere beveiligingslekken te vereenvoudigen.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer de Windows-kernel een gestructureerde uitzonderingshandlertabel laadt in de PE-header "Load Configuration" tijdens het uitvoeren van binaire bestanden.
...
Ntdll.dll is het onderdeel dat door het beveiligingslek wordt getroffen.
  
**Met welk doel kan een aanvaller het beveiligingslek misbruiken?**  
Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan de SafeSEH-beveiligingsfunctie in een softwaretoepassing omzeilen. Een aanvaller kan vervolgens misbruik maken van andere beveiligingslekken om de gestructureerde uitzonderingshandler toe te passen en willekeurige code uit te voeren.
  
**Hoe kan een aanvaller dit beveiligingslek** **misbruiken?**  
Om misbruik te kunnen maken van dit beveiligingslek en willekeurige code te kunnen uitvoeren, moet een aanvaller eerst de SafeSEH-beveiligingsfunctie omzeilen en vervolgens misbruik maken van andere beveiligingslekken om willekeurige code uit te kunnen voeren.
  
**Wat is** **de gestructureerde** **uitzonder** **ingshan** **dler?**  
De gestructureerde uitzonderingshandler (Structured Exception Handler, SEH) is een mechanisme in een softwaretoepassing voor het verwerken van hardware- en software-uitzonderingen. Met de SEH hebben programmeurs volledige controle over de verwerking van uitzonderingen. Daarnaast biedt de SEH ondersteuning voor foutopsporingsprogramma's en kan de SEH in alle programmeertalen en op alle computers worden gebruikt.
  
**Wat is** **SafeSEH?**  
SafeSEH is een beveiligingsfunctie die de Structured Exception Handler beschermd tegen beschadiging of misbruik in het geval van een bufferoverloop.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Zowel werkstations als servers zijn kwetsbaar voor dit beveiligingslek.
  
**Wat doet de update?**  
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de Windows-kernel gestructureerde uitzonderingshandlertabellen laadt.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2644615">Microsoft Knowledge Base-artikel 2644615</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2644615$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2644615](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Joshua J. Drake van [Accuvant LABS](http://www.accuvant.com/) voor het melden van het beveiligingslek met betrekking tot omzeiling van SafeSEH in de Windows-kernel (CVE-2012-0001)
...
-   V1.1 (22 februari 2012): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2644615 onder Bekende problemen in de Samenvatting.
