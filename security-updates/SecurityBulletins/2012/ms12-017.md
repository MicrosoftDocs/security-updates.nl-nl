---
TOCTitle: 'MS12-017'
Title: 'Microsoft-beveiligingsbulletin MS12-017 - Belangrijk'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61232084
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-017(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS12-017 - Belangrijk
====================================================

Beveiligingslek in DNS-server kan leiden tot Denial of Service (2647170)
------------------------------------------------------------------------

Gepubliceerd: dinsdag 13 maart 2012 | Bijgewerkt: woensdag 18 april 2012
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Het beveiligingslek kan leiden tot denial of service indien een externe, niet-geverifieerde aanvaller een speciaal vervaardigde DNS-query naar de DNS-server verzendt.

Het prioriteitsniveau van dit beveiligingsupdate is Belangrijk voor alle ondersteunden edities van Windows Server 2003, 32-bits en x64-edities van Windows Server 2008 en x64-edities van Windows Server 2008 R2. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de DNS-server objecten in het geheugen verwerkt. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2647170](http://support.microsoft.com/kb/2647170) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 met SP2 voor Itanium-systemen</a></td>
<td style="border:1px solid black;">Denial of service</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">Windows Server 2008 voor 32-bits systemen Service Pack 2</a>*</td>
<td style="border:1px solid black;">Denial of service</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008 voor x64-systemen Service Pack 2</a>*</td>
<td style="border:1px solid black;">Denial of service</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 voor x64-systemen en Windows Server 2008 R2 voor x64-systemen met Service Pack 1</a>*</td>
<td style="border:1px solid black;">Denial of service</td>
<td style="border:1px solid black;">Belangrijk</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
...
De update kan alleen worden geïnstalleerd als DNS is ingeschakeld op de besturingssystemen die worden genoemd in de tabel Software waarin dit probleem optreedt. Standaard is DNS op deze besturingssystemen niet ingeschakeld, zodat de update niet zal worden aangeboden tenzij DNS is ingeschakeld.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot denial of service in DNS - CVE-2012-0006</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot denial of service in DNS - CVE-2012-0006  
---------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot denial of service door de manier waarop de DNS-server objecten in het geheugen onjuist verwerkt bij het opzoeken van de bronrecord van een domein. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan ervoor zorgen dat de DNS-server op het doelsysteem niet meer reageert en opnieuw wordt opgestart.
  
Zie [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot denial of service in DNS - CVE-2012-0006
  
Microsoft heeft nog geen beperkende factoren voor dit beveiligingslek.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot denial of service in DNS - CVE-2012-0006
  
Tijdelijke oplossingen zijn wijzigingen in een instelling of configuratie waardoor het beveiligingslek zelf niet wordt gedicht, maar waarmee aanvalsvectoren wel worden geblokkeerd voordat u de update uitvoert. Microsoft heeft de volgende methoden en statussen om het probleem te omzeilen getest om uit te zoeken of een tijdelijke oplossing functionaliteit vermindert:
  
-   **De DNS-cache regelmatig wissen**
  
    Voer de volgende dnscmd-opdracht uit zoals beschreven in het artikel [Dnscmd Syntax](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx):
  
    `dnscmd [Servernaam] /clearcache`
  
    U kunt deze taak uitvoeren als een geplande taak of wanneer nodig.
  
    **Gevolgen van de tijdelijke oplossing.** Bronrecords worden gewist uit de DNS-cache van de opgegeven DNS-server.
  
    **De tijdelijke oplossing ongedaan maken.**
  
    Verwijder geplande taken met de dnscmd-opdracht of schakel deze taken uit.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot denial of service in DNS - CVE-2012-0006
  
**Wat is de omvang van het beveiligingslek?**  
Dit beveiligingslek heeft betrekking op een denial of service.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer de DNS-server objecten in het geheugen onjuist verwerkt bij het opzoeken van een bronrecord.
...
Een externe niet-geverifieerde aanvaller kan misbruik maken van dit beveiligingslek door een speciaal vervaardigde DNS-query naar de DNS-server te verzenden.
...
**Wat doet de update?**  
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de DNS-server objecten in het geheugen verwerkt.
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2647170$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2647170](http://support.microsoft.com/kb/2647170)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2647170">Microsoft Knowledge Base-artikel 2647170</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (18 april 2012): Koppeling toegevoegd aan Microsoft Knowledge Base-artikel 2647170 onder Bekende problemen in de samenvatting en de informatie over het vervangen van het bulletin is gecorrigeerd voor Windows Server 2003 Service Pack 2, Windows Server 2003 x64 Edition Service Pack 2 en Windows Server 2003 met SP2 voor Itanium-systemen. Dit is alleen een wijziging in het bulletin. Er zijn geen veranderingen in de detectielogica of de updatebestanden.
