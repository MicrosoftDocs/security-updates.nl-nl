---
TOCTitle: 'MS12-024'
Title: 'Microsoft-beveiligingsbulletin MS12-024 - Kritiek'
ms:assetid: 'ms12-024'
ms:contentKeyID: 61232091
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-024(v=Security.10)'
author: SharonSears
...
Microsoft-beveiligingsbulletin MS12-024 - Kritiek
=================================================

Een beveiligingslek in Windows kan leiden tot uitvoering van externe code (2653956)
-----------------------------------------------------------------------------------
...
Met deze beveiligingsupdate wordt een privé gemeld beveiligingslek in Microsoft Windows opgelost. Door het beveiligingslek kan externe code worden uitgevoerd indien een gebruiker of toepassing een speciaal vervaardigd, ondertekend PE-bestand (Portable Executable) uitvoert of installeert op een getroffen systeem.
...
De beveiligingsupdate lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de functie Windows Authenticode-handtekeningcontrole de Authenticode-handtekeningcontrole uitvoert bij het controleren van PE-bestanden. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over het beveiligingslek.
...
**Bekende problemen.** In [Microsoft Knowledge Base-artikel 2653956](http://support.microsoft.com/kb/2653956) worden bekende problemen beschreven die klanten mogelijk ondervinden bij de installatie van deze beveiligingsupdate. In het artikel worden ook de aanbevolen oplossingen voor deze problemen toegelicht.
...
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=734ff97a-7d72-4bfe-9557-7fac91902f8e">Windows Server 2003 met SP2 voor Itanium-systemen</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">Windows Server 2008 voor 32-bits systemen Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">Windows Server 2008 voor x64-systemen Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ec74522-ec1e-4b3c-bfeb-6a505cc4f11a">Windows Server 2008 voor Itanium-systemen Service Pack 2</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 voor 32-bits systemen</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 voor 32-bits systemen Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 voor x64-systemen</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 voor x64-systemen Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 voor x64-systemen</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 voor x64-systemen Service Pack 1</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 voor Itanium-systemen</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">KB978601 in <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> vervangen door KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 voor Itanium-systemen Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Uitvoering van externe code mogelijk</td>
<td style="border:1px solid black;">Kritiek</td>
<td style="border:1px solid black;">Geen</td>
...
Ja. De KB2653956-update is beschikbaar voor de Windows Developer Preview. Klanten met Windows Developer Preview worden aangeraden de update toe te passen op hun systemen. De update is alleen verkrijgbaar via [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
  
**Wordt Windows** **8** **Consumer Preview getroffen door** **het beveiligingslek dat in dit bulletin wordt opgelost?**  
Ja. De KB2653956-update is beschikbaar voor de Windows 8 Consumer Preview. Klanten met Windows Consumer Preview worden aangeraden de update toe te passen op hun systemen. De update is alleen verkrijgbaar via [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
  
**Ik heb deze update toegepast en nu is de digitale handtekening van mijn software ongeldig. Wat moet ik doen?** **  
**Deze update zorgt ervoor dat de functie Windows Authenticode-handtekeningcontrole een strikte controle op PE-bestanden uitvoert. PE-bestanden worden beschouwd als "niet ondertekend" als Windows inhoud herkent die niet voldoet aan de Authenticode-specificatie in het bestand. Dit kan invloed hebben op enkele installatieprogramma's. Indien u een getroffen installatieprogramma gebruikt, raadt Microsoft u aan een installatieprogramma te gebruiken dat alleen inhoud van gevalideerde delen van het ondertekende bestand uitpakt.
  
PE-bestanden worden ook beschouwd als "niet-ondertekend" als extra inhoud is toegevoegd aan het bestand nadat de handtekening is toegepast. Het ondertekenen van toepassingen behoort de laatste stap te zijn in het ontwikkelproces voordat binaire bestanden worden gepubliceerd. Zie [Microsoft Knowledge Base-artikel 2653956](http://support.microsoft.com/kb/2653956) voor meer informatie over deze en andere bekende problemen met deze beveiligingsupdate.
  
**Bevat deze update andere functionaliteitswijzigingen met betrekking tot beveiliging?**  
Ja. Naast de wijzigingen die worden genoemd in de sectie Informatie over het beveiligingslek van dit bulletin, bevat deze update ingrijpende wijzigingen voor verbeterde beveiligingsgerelateerde functies in Windows.
...
<th style="border:1px solid black;" >Beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust - CVE-2012-0151</th>
<th style="border:1px solid black;" >Prioriteitsniveau</th>
</tr>
</thead>
<tbody>
...
Beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust - CVE-2012-0151  
------------------------------------------------------------------------------------------
  
<span></span>
Er bestaat een beveiligingslek met betrekking tot het uitvoeren van externe code in de functie Authenticode-handtekeningcontrole van Windows, die wordt gebruikt voor PE-bestanden. Een anonieme aanvaller kan het beveiligingslek misbruiken door een bestaand ondertekend uitvoerbaar bestand zo te wijzigen dat ongecontroleerde delen van het bestand op een dusdanige wijze worden gemanipuleerd dat schadelijke code aan het bestand wordt toegevoegd zonder de handtekening ongeldig te maken. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan volledige controle krijgen over een systeem waarin dit probleem optreedt. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige gebruikersrechten maken.
  
Zie [CVE-2012-0151](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0151) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.
  
#### Beperkende factoren voor het beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust - CVE-2012-0151
  
Microsoft heeft nog geen beperkende factoren voor dit beveiligingslek.
  
#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust - CVE-2012-0151
  
Microsoft heeft nog geen oplossingen voor dit beveiligingslek.
  
#### Veelgestelde vragen over het beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust - CVE-2012-0151
  
**Wat is de omvang van het beveiligingslek?**  
Dit beveiligingslek heeft betrekking op de uitvoering van externe code.
  
**Waardoor wordt het beveiligingslek veroorzaakt?**  
Het beveiligingslek wordt veroorzaakt wanneer de Windows Authenticode-handtekeningcontrole het bestandoverzicht van een speciaal vervaardigd PE-bestand onjuist valideert.
  
**Wat is de functie Authenticode-handtekeningcontrole van Windows?** **  
**De functie Authenticode-handtekeningcontrole van Windows, oftewel WinVerifyTrust, voert een verificatieactie van de vertrouwensrelatie uit op een opgegeven object. De functie geeft het verzoek door aan een vertrouwensrelatieprovider die de actie-id ondersteunt, als deze bestaat. De WinVerifyTrust-functie voert twee acties uit: handtekeningcontrole voor een opgegeven object en controle van vertrouwensrelatie. Zie het MSDN-artikel [WinVerifyTrust function](http://msdn.microsoft.com/en-us/library/aa388208(vs.85).aspx) voor meer technische informatie over de WinVerifyTrust-functie.
  
Zie het MSDN-artikel [Introduction to Code Signing](http://msdn.microsoft.com/en-us/library/ms537361(v=vs.85).aspx) voor een inleiding in Authenticode.
...
Om misbruik van dit beveiligingslek te kunnen maken, moet een gebruiker of toepassing een speciaal vervaardigd, ondertekend PE-bestand uitvoeren of installeren. Een aanvaller kan een bestaand, ondertekend bestand zo wijzigen dat het schadelijke code bevat, zonder de handtekening ongeldig te maken. Deze code wordt dan uitgevoerd binnen de context van de bevoegdheid waarin het PE-bestand is gestart.
  
In een aanval per e-mail kan een aanvaller misbruik maken van dit beveiligingslek door een gebruiker een e-mailbericht te sturen dat een speciaal vervaardigd PE-bestand bevat en de gebruiker vervolgens over te halen om het PE-bestand te openen.
  
In het geval van een aanval vanaf het web moet de aanvaller beschikken over een website die een speciaal vervaardigd PE-bestand bevat. Daarnaast kunnen ook gemanipuleerde websites en websites waarop gegevens kunnen worden ingevoerd, schadelijke inhoud bevatten die dit beveiligingslek kunnen misbruiken. Een aanvaller kan op geen enkele manier gebruikers dwingen om een website te bezoeken die het speciaal vervaardigde mediabestand host. De aanvaller moet een gebruiker er dus van overtuigen een bezoek te brengen aan de website. In de meeste gevallen doet de aanvaller dat door de gebruiker ertoe te bewegen op een koppeling in een e-mailbericht of een verzoek in een expresbericht te klikken waarmee de gebruiker naar de website van de aanvaller wordt omgeleid.
  
**Voor welke systemen vormt dit beveiligingslek het grootste risico?**  
Werkstations en servers zijn beide kwetsbaar voor dit beveiligingslek.
  
**Wat doet de update?**  
De update lost het beveiligingslek op doordat de manier wordt gewijzigd waarop de Windows Authenticode-handtekeningcontrolefunctie de Windows Authenticode-handtekeningcontrole uitvoert bij het controleren van PE-bestanden.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2653956$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2653956">Microsoft Knowledge Base-artikel 2653956</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2653956$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2653956](http://support.microsoft.com/kb/2653956)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Robert Zacek en Igor Glucksmann van [Avast Software](http://www.avast.com/) voor het melden van het beveiligingslek met betrekking tot handtekeningvalidatie in WinVerifyTrust (CVE-2012-0151)
