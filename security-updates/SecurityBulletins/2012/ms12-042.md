---
TOCTitle: 'MS12-042'
Title: 'Microsoft-beveiligingsbulletin MS12-042 - Belangrijk'
ms:assetid: 'ms12-042'
ms:contentKeyID: 61232109
ms:mtpsurl: 'https://technet.microsoft.com/nl-NL/library/ms12-042(v=Security.10)'
---

Security Bulletin

Microsoft-beveiligingsbulletin MS12-042 - Belangrijk
====================================================

Beveiligingslekken in de Windows-kernel kunnen leiden tot misbruik van bevoegdheden (2711167)
---------------------------------------------------------------------------------------------
...
Het prioriteitsniveau van deze beveiligingsupdate is Belangrijk voor alle 32-bits versies van Windows XP en Windows Server 2003, voor Windows 7 voor x64-systemen en voor Windows Server 2008 R2 voor x64-systemen. Zie de subsectie **Software waarin dit probleem optreedt en software waarin dit probleem niet optreedt** in deze sectie voor meer informatie.

De beveiligingsupdate lost de beveiligingslekken op doordat de manier wordt verbeterd waarop de Windows User Mode Scheduler een bepaalde systeemaanvraag behandelt en de manier waarop Windows BIOS ROM beheert. Zie de subsectie Veelgestelde vragen over het specifieke beveiligingslek in de volgende sectie, **Informatie over het beveiligingslek**, voor meer informatie over de beveiligingslekken.
...
<td style="border:1px solid black;">
KB2633171 in [MS11-098](http://go.microsoft.com/fwlink/?linkid=232424) is vervangen door KB2707511
</td>
</tr>
...
<td style="border:1px solid black;">
KB2556532 in [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) is vervangen door KB2709715
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld geheugen in User Mode Scheduler - CVE-2012-0217
</th>
<th style="border:1px solid black;" >
Beveiligingslek met betrekking tot ontregeld BIOS ROM - CVE-2012-1515
</th>
<th style="border:1px solid black;" >
Prioriteitsniveau
</th>
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in de wijze waarop Windows User Mode Scheduler systeemaanvragen behandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige beheerdersrechten maken.

Zie [CVE-2012-0217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld geheugen in User Mode Scheduler - CVE-2012-0217
...
-   Dit beveiligingslek treft alleen Intel x64-versies van Windows 7 en Windows Server 2008 R2.
-   Systemen met een op AMD of ARM gebaseerde CPU worden door dit beveiligingslek niet getroffen.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld geheugen in User Mode Scheduler - CVE-2012-0217

Microsoft heeft nog geen oplossingen voor dit beveiligingslek.

#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld geheugen in User Mode Scheduler - CVE-2012-0217

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Het beveiligingslek wordt veroorzaakt omdat Windows User Mode Scheduler een bepaalde systeemaanvraag niet correct behandelt.

**Wat is** **de User Mode Scheduler (UMS)?**
De User Mode Scheduler (UMS) is een lichtgewicht mechanisme met systeem-API's waarmee toepassingen hun eigen threads kunnen plannen. Een toepassing kan tussen UMS-threads in gebruikersmodus schakelen zonder de systeemplanner daarbij te betrekken en de controle over de processor terugkrijgen als een UMS-thread de kernel blokkeert.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop de Windows User Mode Scheduler een bepaalde systeemaanvraag behandelt.
...
<span></span>
Er bestaat een beveiligingslek met betrekking tot misbruik van bevoegdheden in de wijze waarop Windows BIOS-geheugen behandelt. Een aanvaller die misbruik weet te maken van dit beveiligingslek, kan willekeurige code uitvoeren in de kernelmodus. De aanvaller kan vervolgens programma's installeren, gegevens bekijken, wijzigen of wissen, of nieuwe accounts met volledige beheerdersrechten maken.

Zie [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) als u dit beveiligingslek wilt weergeven als standaardvermelding in de lijst met veelvoorkomende beveiligingslekken en blootstellingen.

#### Beperkende factoren voor het beveiligingslek met betrekking tot ontregeld BIOS ROM - CVE-2012-1515

Met beperkende factoren wordt verwezen naar een instelling, de algehele configuratie of algemene tips voor een standaardstatus waarmee de ernst van misbruik via een beveiligingslek kan worden verminderd. De volgende beperkende factoren kunnen in uw situatie van pas komen:

-   Een aanvaller moet geldige aanmeldingsreferenties hebben en zich lokaal kunnen aanmelden om het beveiligingslek te kunnen misbruiken. Het beveiligingslek kan niet vanaf een externe locatie of door anonieme gebruikers worden misbruikt.

#### Tijdelijke oplossingen voor het beveiligingslek met betrekking tot ontregeld BIOS ROM - CVE-2012-1515

Microsoft heeft nog geen oplossingen voor dit beveiligingslek.

#### Veelgestelde vragen over het beveiligingslek met betrekking tot ontregeld BIOS ROM - CVE-2012-1515

**Wat is de omvang van het beveiligingslek?**
Dit beveiligingslek heeft betrekking op misbruik van bevoegdheden.

**Waardoor wordt het beveiligingslek veroorzaakt?**
Het beveiligingslek wordt veroorzaakt omdat Windows het BIOS ROM niet correct beschermt.
...
**Wat doet de update?**
De update lost het beveiligingslek op doordat de manier wordt verbeterd waarop Windows BIOS ROM beheert.

**Was dit beveiligingslek openbaar gemaakt op het moment dat dit beveiligingsbulletin werd uitgegeven?**
Ja. Dit beveiligingslek is openbaar gemaakt. Aan dit beveiligingslek is nummer [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) toegewezen.
...
<td style="border:1px solid black;">Gebruik het onderdeel <strong>Software</strong> in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\$NTUninstallKB2707511$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2707511">Microsoft Knowledge Base-artikel 2707511</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Gebruik het onderdeel **Software** in het Configuratiescherm of het hulpprogramma Spuninst.exe in de map %Windir%\\$NTUninstallKB2707511$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zie [Microsoft Knowledge Base-artikel 2707511](http://support.microsoft.com/kb/2707511)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Bestandsgegevens</strong></td>
<td style="border:1px solid black;">Zie <a href="http://support.microsoft.com/kb/2709715">Microsoft Knowledge Base-artikel 2709715</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificatie van registersleutel</strong></td>
...
-   Rafal Wojtczuk van [Bromium](http://www.bromium.com/) en Jan Beulich van [SUSE](http://www.suse.com/) voor het melden van het beveiligingslek met betrekking tot ontregeld geheugen in User Mode Scheduler (CVE-2012-0217)
