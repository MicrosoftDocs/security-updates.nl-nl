...
ms:contentKeyID: 18126710
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720428(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720428.note(WS.10).gif)Opmerking                                                                                                                              |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
