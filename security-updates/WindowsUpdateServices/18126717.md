...
ms:contentKeyID: 18126717
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720449(v=WS.10)'
---
...
1.  Double-click the installer file **WSUSSetup.exe**.
    ...
    | ![](/security-updates/images/Cc720449.note(WS.10).gif)Opmerking                                                                                                                                     |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
