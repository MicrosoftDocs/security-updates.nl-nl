...
ms:contentKeyID: 18126753
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720470(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720470.note(WS.10).gif)Opmerking                                             |
|------------------------------------------------------------------------------------------------------------------------|
