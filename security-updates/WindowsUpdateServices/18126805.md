...
ms:contentKeyID: 18126805
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720512(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720512.note(WS.10).gif)Opmerking                                                                    |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
