...
ms:contentKeyID: 18126841
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708436(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708436.note(WS.10).gif)Opmerking                                                                                              |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
