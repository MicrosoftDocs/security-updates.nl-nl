...
ms:contentKeyID: 18126848
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708465(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708465.note(WS.10).gif)Opmerking |
|----------------------------------------------------------------------------|
