...
ms:contentKeyID: 18126888
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708483(v=WS.10)'
---

Determine WSUS Capacity Requirements
====================================

Van toepassing op: Windows Server 2003, Windows Server 2003 R2, Windows Server 2003 with SP1, Windows Server 2003 with SP2, Windows Server 2008, Windows Server Update Services
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="/security-updates/images/Cc708483.Important(WS.10).gif" />Belangrijk</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="/security-updates/images/Cc708483.note(WS.10).gif" />Opmerking</th>
</tr>
</thead>
<tbody>
<tr class="odd">
