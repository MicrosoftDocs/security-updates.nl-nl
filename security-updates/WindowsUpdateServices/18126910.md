...
ms:contentKeyID: 18126910
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708517(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708517.note(WS.10).gif)Opmerking                                                                              |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|
