...
ms:contentKeyID: 18126964
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708571(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708571.note(WS.10).gif)Opmerking                                                                    |
|-----------------------------------------------------------------------------------------------------------------------------------------------|
