...
ms:contentKeyID: 18126992
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708604(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708604.note(WS.10).gif)Opmerking               |
|------------------------------------------------------------------------------------------|
...
| ![](/security-updates/images/Cc708604.Important(WS.10).gif)Belangrijk                                                                   |  
|----------------------------------------------------------------------------------------------------------------------------------------------------|  
