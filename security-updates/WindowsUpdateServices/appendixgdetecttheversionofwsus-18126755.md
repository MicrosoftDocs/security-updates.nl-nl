...
ms:contentKeyID: 18126755
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720492(v=WS.10)'
---
...
---------------------
        ...
        ```
| ![](/security-updates/images/Cc720492.note(WS.10).gif)Opmerking                              |
|---------------------------------------------------------------------------------------------------------|
