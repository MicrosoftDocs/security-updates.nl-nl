...
ms:contentKeyID: 18126941
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708536(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708536.Important(WS.10).gif)Belangrijk                        |
|---------------------------------------------------------------------------------------------------------|
