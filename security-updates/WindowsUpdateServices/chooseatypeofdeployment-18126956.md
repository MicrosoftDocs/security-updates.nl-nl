...
ms:contentKeyID: 18126956
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708565(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708565.note(WS.10).gif)Opmerking                                                                                     |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
