...
ms:contentKeyID: 18126737
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720473(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720473.note(WS.10).gif)Opmerking   |
|------------------------------------------------------------------------------|
...
| ![](/security-updates/images/Cc720473.Important(WS.10).gif)Belangrijk                                                                                       |  
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
