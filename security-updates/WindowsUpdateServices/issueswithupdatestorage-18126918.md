...
ms:contentKeyID: 18126918
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708524(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708524.note(WS.10).gif)Opmerking           |
|--------------------------------------------------------------------------------------|
