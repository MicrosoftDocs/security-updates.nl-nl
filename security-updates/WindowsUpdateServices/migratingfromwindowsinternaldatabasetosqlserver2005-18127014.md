...
ms:contentKeyID: 18127014
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708558(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708558.note(WS.10).gif)Opmerking |
|----------------------------------------------------------------------------|
