...
ms:contentKeyID: 18126735
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720471(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720471.Important(WS.10).gif)Belangrijk                                  |
|-------------------------------------------------------------------------------------------------------------------|
