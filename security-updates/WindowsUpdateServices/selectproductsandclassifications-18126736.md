...
ms:contentKeyID: 18126736
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720453(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720453.note(WS.10).gif)Opmerking                                           |
|----------------------------------------------------------------------------------------------------------------------|
