...
ms:contentKeyID: 18126854
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708470(v=WS.10)'
---
...
1.  Double-click the installer file **WSUSSetup.exe**.
    ...
    | ![](/security-updates/images/Cc708470.note(WS.10).gif)Opmerking                                                                        |
    |---------------------------------------------------------------------------------------------------------------------------------------------------|
