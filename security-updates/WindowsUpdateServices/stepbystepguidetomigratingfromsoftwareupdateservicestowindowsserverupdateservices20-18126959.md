...
ms:contentKeyID: 18126959
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc708553(v=WS.10)'
---
...
| ![](/security-updates/images/Cc708553.note(WS.10).gif)Opmerking                                                                         |
|----------------------------------------------------------------------------------------------------------------------------------------------------|
