...
ms:contentKeyID: 18126821
ms:mtpsurl: 'https://technet.microsoft.com/nl-nl/library/Cc720542(v=WS.10)'
---
...
| ![](/security-updates/images/Cc720542.note(WS.10).gif)Opmerking    |
|-------------------------------------------------------------------------------|
